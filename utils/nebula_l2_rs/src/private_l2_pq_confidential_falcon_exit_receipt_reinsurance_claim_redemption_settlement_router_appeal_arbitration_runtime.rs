...
pub type PrivateL2PqConfidentialFalconExitReceiptReinsuranceClaimRedemptionSettlementRouterAppealArbitrationRuntimeResult<
    T,
> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_PQ_CONFIDENTIAL_FALCON_EXIT_RECEIPT_REINSURANCE_CLAIM_REDEMPTION_SETTLEMENT_ROUTER_APPEAL_ARBITRATION_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-falcon-exit-receipt-reinsurance-claim-redemption-settlement-router-appeal-arbitration-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_PQ_CONFIDENTIAL_FALCON_EXIT_RECEIPT_REINSURANCE_CLAIM_REDEMPTION_SETTLEMENT_ROUTER_APPEAL_ARBITRATION_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const FALCON_ROUTER_APPEAL_ARBITRATION_SETTLEMENT_SUITE: &str =
    "falcon-1024-ntru-exit-receipt-reinsurance-claim-redemption-settlement-router-appeal-arbitration-v1";
...
pub struct Config {
    ...
    pub falcon_router_appeal_arbitration_settlement_suite: String,
...
impl Config {
    pub fn devnet() -> Self {
        Self {
            ...
            falcon_router_appeal_arbitration_settlement_suite:
                FALCON_ROUTER_APPEAL_ARBITRATION_SETTLEMENT_SUITE.to_string(),
    ...
    pub fn validate(&self) -> Result<()> {
        if self.min_pq_security_bits < DEFAULT_MIN_PQ_SECURITY_BITS {
            return Err(
                "pq security bits below falcon-router appeal arbitration settlement minimum"
                    .to_string(),
            );
        }
        ...
        {
            return Err(
                "invalid falcon-router appeal arbitration settlement parameter schedule"
                    .to_string(),
            );
        }
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "suites": {
                "falcon_router_appeal_settlement": self.falcon_router_appeal_arbitration_settlement_suite,
...
pub fn public_record(state: &State) -> Value {
    json!({
        ...
        "FALCON_ROUTER_APPEAL_ARBITRATION_SETTLEMENT_SUITE": FALCON_ROUTER_APPEAL_ARBITRATION_SETTLEMENT_SUITE,
