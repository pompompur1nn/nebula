...
pub type PrivateL2PqSmartAccountRecoveryMarketRuntimeResult<T> = Result<T, String>;

pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-smart-account-recovery-market-runtime-v1";
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_SCHEMA_VERSION: u64 = 1;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_HASH_SUITE: &str =
    "SHAKE256-domain-separated-canonical-json";
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_PQ_SUITE: &str =
    "ML-KEM-1024+ML-DSA-87+SLH-DSA-SHAKE-256f-smart-account-recovery-market-v1";
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_ACCOUNT_POLICY_SCHEME: &str =
    "shielded-smart-account-recovery-policy-root-v1";
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_GUARDIAN_COMMITTEE_SCHEME: &str =
    "pq-guardian-recovery-market-bid-root-v1";
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_RECOVERY_INTENT_SCHEME: &str =
    "private-smart-account-recovery-intent-root-v1";
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_REPLAY_FENCE_SCHEME: &str =
    "smart-account-recovery-market-replay-nullifier-fence-v1";
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_LOW_FEE_SPONSOR_SCHEME: &str =
    "low-fee-smart-account-recovery-sponsor-reservation-v1";
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_EXECUTION_BATCH_SCHEME: &str =
    "pq-smart-account-recovery-market-execution-batch-v1";
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_RECEIPT_SCHEME: &str =
    "pq-smart-account-recovery-market-receipt-root-v1";
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEVNET_HEIGHT: u64 = 720_000;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MAX_ACCOUNT_POLICIES: usize =
    262_144;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MAX_COMMITTEES: usize =
    131_072;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MAX_RECOVERY_INTENTS: usize =
    1_048_576;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MAX_SPONSOR_RESERVATIONS:
    usize = 1_048_576;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MAX_BATCHES: usize = 262_144;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MAX_RECEIPTS: usize =
    1_048_576;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MAX_BATCH_INTENTS: usize =
    4_096;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_POLICY_TTL_BLOCKS: u64 =
    43_200;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_INTENT_TTL_BLOCKS: u64 = 360;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_SPONSOR_TTL_BLOCKS: u64 = 96;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_BATCH_TTL_BLOCKS: u64 = 48;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MIN_PRIVACY_SET_SIZE: u64 =
    4_096;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_BATCH_PRIVACY_SET_SIZE: u64 =
    65_536;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MIN_PQ_SECURITY_BITS: u16 =
    256;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MIN_GUARDIAN_COUNT: u16 = 3;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MIN_THRESHOLD_WEIGHT_BPS:
    u64 = 6_700;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_FAST_THRESHOLD_WEIGHT_BPS:
    u64 = 8_000;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MAX_RECOVERY_FEE_BPS: u64 =
    12;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_SPONSOR_COVERAGE_BPS: u64 =
    9_000;
pub const PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_MAX_BPS: u64 = 10_000;
...
impl Config {
    pub fn devnet() -> Self {
        Self {
            protocol_version: PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_PROTOCOL_VERSION
                .to_string(),
            schema_version: PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_SCHEMA_VERSION,
            chain_id: CHAIN_ID.to_string(),
            l2_network: "nebula-private-l2-devnet".to_string(),
            fee_asset_id: "piconero-devnet".to_string(),
            low_fee_lane: "private-l2-pq-smart-account-recovery-market".to_string(),
            hash_suite: PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_HASH_SUITE.to_string(),
            pq_suite: PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_PQ_SUITE.to_string(),
            account_policy_scheme:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_ACCOUNT_POLICY_SCHEME.to_string(),
            guardian_committee_scheme:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_GUARDIAN_COMMITTEE_SCHEME.to_string(),
            recovery_intent_scheme:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_RECOVERY_INTENT_SCHEME.to_string(),
            replay_fence_scheme: PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_REPLAY_FENCE_SCHEME
                .to_string(),
            low_fee_sponsor_scheme:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_LOW_FEE_SPONSOR_SCHEME.to_string(),
            execution_batch_scheme:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_EXECUTION_BATCH_SCHEME.to_string(),
            receipt_scheme: PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_RECEIPT_SCHEME.to_string(),
            max_account_policies:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MAX_ACCOUNT_POLICIES,
            max_committees: PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MAX_COMMITTEES,
            max_recovery_intents:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MAX_RECOVERY_INTENTS,
            max_sponsor_reservations:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MAX_SPONSOR_RESERVATIONS,
            max_batches: PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MAX_BATCHES,
            max_receipts: PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MAX_RECEIPTS,
            max_batch_intents:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MAX_BATCH_INTENTS,
            policy_ttl_blocks:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_POLICY_TTL_BLOCKS,
            intent_ttl_blocks:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_INTENT_TTL_BLOCKS,
            sponsor_ttl_blocks:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_SPONSOR_TTL_BLOCKS,
            batch_ttl_blocks: PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_BATCH_TTL_BLOCKS,
            min_privacy_set_size:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MIN_PRIVACY_SET_SIZE,
            batch_privacy_set_size:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_BATCH_PRIVACY_SET_SIZE,
            min_pq_security_bits:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MIN_PQ_SECURITY_BITS,
            min_guardian_count:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MIN_GUARDIAN_COUNT,
            min_threshold_weight_bps:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MIN_THRESHOLD_WEIGHT_BPS,
            fast_threshold_weight_bps:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_FAST_THRESHOLD_WEIGHT_BPS,
            max_recovery_fee_bps:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_MAX_RECOVERY_FEE_BPS,
            default_sponsor_coverage_bps:
                PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEFAULT_SPONSOR_COVERAGE_BPS,
            require_low_fee_sponsor: true,
            require_replay_fence: true,
            require_roots_only: true,
            current_height: PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_DEVNET_HEIGHT,
        }
    }

    pub fn validate(&self) -> PrivateL2PqSmartAccountRecoveryMarketRuntimeResult<()> {
        require_non_empty("protocol_version", &self.protocol_version)?;
        require(
            self.protocol_version
                == PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_PROTOCOL_VERSION,
            "unsupported PQ smart account recovery market protocol version",
        )?;
        require(self.schema_version > 0, "schema version must be positive")?;
        require_non_empty("chain_id", &self.chain_id)?;
        require(
            self.chain_id == CHAIN_ID,
            "PQ smart account recovery market chain id mismatch",
        )?;
        ...
        require(
            ...
            "PQ smart account recovery market requires roots-only private records",
        )?;
        Ok(())
    }
    ...
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_smart_account_recovery_market_config",
...
impl RegisterShieldedAccountPolicyRequest {
    pub fn validate(
        &self,
        config: &Config,
    ) -> PrivateL2PqSmartAccountRecoveryMarketRuntimeResult<()> {
...
impl State {
    pub fn devnet() -> PrivateL2PqSmartAccountRecoveryMarketRuntimeResult<Self> {
        Self::new(Config::devnet())
    }

    pub fn new(config: Config) -> PrivateL2PqSmartAccountRecoveryMarketRuntimeResult<Self> {
        config.validate()?;
        Ok(Self {
    ...
    pub fn register_account_policy(
    ...
    ) -> PrivateL2PqSmartAccountRecoveryMarketRuntimeResult<ShieldedAccountPolicyRecord> {
        ...
        let policy_root = payload_root(
            PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_ACCOUNT_POLICY_SCHEME,
            &json!({
    ...
    pub fn register_guardian_committee(
    ...
    ) -> PrivateL2PqSmartAccountRecoveryMarketRuntimeResult<PqGuardianCommitteeRecord> {
        self.config.validate()?;
        request.validate(&self.config)?;
        require(
        ...
        let committee_root = payload_root(
            PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_GUARDIAN_COMMITTEE_SCHEME,
            &json!({
    ...
    pub fn submit_recovery_intent(
    ...
    ) -> PrivateL2PqSmartAccountRecoveryMarketRuntimeResult<PrivateRecoveryIntentRecord> {
        self.config.validate()?;
        ...
        let intent_root = payload_root(
            PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_RECOVERY_INTENT_SCHEME,
            &json!({
    ...
    pub fn reserve_low_fee_sponsor(
    ...
    ) -> PrivateL2PqSmartAccountRecoveryMarketRuntimeResult<LowFeeSponsorReservationRecord> {
        self.config.validate()?;
        ...
        let reservation_root = payload_root(
            PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_LOW_FEE_SPONSOR_SCHEME,
            &json!({
    ...
    pub fn build_recovery_execution_batch(
    ...
    ) -> PrivateL2PqSmartAccountRecoveryMarketRuntimeResult<RecoveryExecutionBatchRecord> {
        self.config.validate()?;
        ...
        let intent_root = public_record_root(
            "private-l2-pq-smart-account-recovery-market-BATCH-INTENTS",
            &intent_records
                .iter()
        ...
        let sponsor_reservation_root = public_record_root(
            "private-l2-pq-smart-account-recovery-market-BATCH-SPONSORS",
            &sponsor_records,
        );
        ...
        let batch_root = payload_root(
            PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_EXECUTION_BATCH_SCHEME,
            &json!({
                "batch_id": batch_id,
                "sequence": sequence,
    ...
    pub fn publish_recovery_receipt(
    ...
    ) -> PrivateL2PqSmartAccountRecoveryMarketRuntimeResult<RecoveryReceiptRecord> {
        self.config.validate()?;
        ...
        let receipt_root = payload_root(
            PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_RECEIPT_SCHEME,
            &json!({
    ...
    pub fn roots(&self) -> Roots {
        let config_root = root_from_record(
            "private-l2-pq-smart-account-recovery-market-CONFIG",
            &self.config.public_record(),
        );
        let counter_root = root_from_record(
            "private-l2-pq-smart-account-recovery-market-COUNTERS",
            &self.counters.public_record(),
        );
        let account_policy_root = public_record_root(
            "private-l2-pq-smart-account-recovery-market-ACCOUNT-POLICIES",
            &self
                .account_policies
                .values()
        ...
        let guardian_committee_root = public_record_root(
            "private-l2-pq-smart-account-recovery-market-GUARDIAN-COMMITTEES",
            &self
                .guardian_committees
                .values()
        ...
        let recovery_intent_root = public_record_root(
            "private-l2-pq-smart-account-recovery-market-RECOVERY-INTENTS",
            &self
                .recovery_intents
                .values()
                .map(PrivateRecoveryIntentRecord::public_record)
        ...
        let sponsor_reservation_root = public_record_root(
            "private-l2-pq-smart-account-recovery-market-SPONSOR-RESERVATIONS",
            &self
                .sponsor_reservations
                .values()
                .map(LowFeeSponsorReservationRecord::public_record)
        ...
        let execution_batch_root = public_record_root(
            "private-l2-pq-smart-account-recovery-market-EXECUTION-BATCHES",
            &self
                .execution_batches
                .values()
        ...
        let receipt_root = public_record_root(
            "private-l2-pq-smart-account-recovery-market-RECEIPTS",
            &self
                .receipts
                .values()
        ...
        let replay_nullifier_root = merkle_root(
            "private-l2-pq-smart-account-recovery-market-REPLAY-NULLIFIERS",
            &self
                .replay_nullifiers
                .iter()
        ...
        let consumed_nullifier_root = merkle_root(
            "private-l2-pq-smart-account-recovery-market-CONSUMED-NULLIFIERS",
            &self
                .consumed_nullifiers
                .iter()
                .map(|nullifier| json!({ "nullifier": nullifier }))
        ...
        let account_state_root = merkle_root(
            "private-l2-pq-smart-account-recovery-market-ACCOUNT-STATES",
            &self
                .account_policies
                .values()
                .map(|policy| {
        ...
        let guardian_authorization_root = merkle_root(
            "private-l2-pq-smart-account-recovery-market-GUARDIAN-AUTHORIZATIONS",
            &self
                .recovery_intents
                .values()
                .map(|intent| {
        ...
        let low_fee_sponsor_root = merkle_root(
            "private-l2-pq-smart-account-recovery-market-LOW-FEE-SPONSORS",
            &self
                .sponsor_reservations
                .values()
                .map(|reservation| {
        ...
        let public_record_root = merkle_root(
            "private-l2-pq-smart-account-recovery-market-PUBLIC-RECORDS",
            &self
        ...
        let state_root = root_from_record(
            "private-l2-pq-smart-account-recovery-market-STATE",
            &json!({
                "chain_id": CHAIN_ID,
                "protocol_version": PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_PROTOCOL_VERSION,
                "current_height": self.current_height,
    ...
    pub fn public_record(&self) -> Value {
        ...
        json!({
            "kind": "PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME",
            "chain_id": CHAIN_ID,
            "protocol_version": PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_PROTOCOL_VERSION,
            "schema_version": PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_SCHEMA_VERSION,
            "hash_suite": PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_HASH_SUITE,
            "pq_suite": PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_PQ_SUITE,
            "account_policy_scheme": PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_ACCOUNT_POLICY_SCHEME,
            "guardian_committee_scheme": PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_GUARDIAN_COMMITTEE_SCHEME,
            "recovery_intent_scheme": PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_RECOVERY_INTENT_SCHEME,
            "replay_fence_scheme": PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_REPLAY_FENCE_SCHEME,
            "low_fee_sponsor_scheme": PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_LOW_FEE_SPONSOR_SCHEME,
            "execution_batch_scheme": PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_EXECUTION_BATCH_SCHEME,
            "receipt_scheme": PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_RECEIPT_SCHEME,
            "current_height": self.current_height,
            "runtime_root": self.runtime_root,
...
pub fn PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_state_root(state: &State) -> String {
    state.state_root()
}

pub fn PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_public_record(state: &State) -> Value {
    state.public_record()
}

pub fn devnet() -> PrivateL2PqSmartAccountRecoveryMarketRuntimeResult<State> {
    State::devnet()
}
...
pub fn shielded_account_policy_id(
    ...
    root_from_record(
        "private-l2-pq-smart-account-recovery-market-ACCOUNT-POLICY-ID",
        &json!({
            "sequence": sequence,
...
pub fn pq_guardian_committee_id(
    ...
    root_from_record(
        "private-l2-pq-smart-account-recovery-market-GUARDIAN-COMMITTEE-ID",
        &json!({
            "sequence": sequence,
...
pub fn private_recovery_intent_id(
    ...
    root_from_record(
        "private-l2-pq-smart-account-recovery-market-RECOVERY-INTENT-ID",
        &json!({
            "sequence": sequence,
...
pub fn low_fee_sponsor_reservation_id(
    ...
    root_from_record(
        "private-l2-pq-smart-account-recovery-market-SPONSOR-RESERVATION-ID",
        &json!({
            "sequence": sequence,
...
pub fn recovery_execution_batch_id(
    ...
    root_from_record(
        "private-l2-pq-smart-account-recovery-market-EXECUTION-BATCH-ID",
        &json!({
            "sequence": sequence,
            "intent_root": intent_root,
...
pub fn recovery_receipt_id(request: &PublishRecoveryReceiptRequest, sequence: u64) -> String {
    root_from_record(
        "private-l2-pq-smart-account-recovery-market-RECOVERY-RECEIPT-ID",
        &json!({
            "sequence": sequence,
...
pub fn replay_fence_root(
    ...
    root_from_record(
        "private-l2-pq-smart-account-recovery-market-REPLAY-FENCE",
        &json!({
            "account_policy_id": account_policy_id,
...
pub fn nullifier_root(kind: &str, nullifier: &str) -> String {
    root_from_record(
        "private-l2-pq-smart-account-recovery-market-NULLIFIER",
        &json!({
            "kind": kind,
            "nullifier": nullifier,
        }),
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, PartialOrd, Ord, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum GuardianMarketBidKind {
    ThresholdRecovery,
    SocialRecovery,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, PartialOrd, Ord, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum GuardianMarketBidStatus {
    Submitted,
    Bonded,
    Matched,
    Attesting,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, PartialOrd, Ord, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum RecoveryChallengeKind {
    InvalidGuardianBid,
    InvalidSessionAttestation,
...
impl RecoveryChallengeKind {
    pub fn as_str(self) -> &'static str {
        match self {
            Self::InvalidGuardianBid => "invalid_guardian_bid",
            Self::InvalidSessionAttestation => "invalid_session_attestation",
            ...
            Self::InvalidBatchProof => "invalid_batch_proof",
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct GuardianMarketBidRecord {
    pub guardian_bid_id: String,
    pub bid_kind: GuardianMarketBidKind,
    pub bid_status: GuardianMarketBidStatus,
...
impl GuardianMarketBidRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "guardian_bid_id": self.guardian_bid_id,
            "bid_kind": self.bid_kind.as_str(),
            "bid_status": self.bid_status.as_str(),
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct RecoverySessionAttestationRecord {
    pub session_attestation_id: String,
    pub guardian_bid_id: String,
    pub recovery_intent_id: String,
...
impl RecoverySessionAttestationRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "session_attestation_id": self.session_attestation_id,
            "guardian_bid_id": self.guardian_bid_id,
            "recovery_intent_id": self.recovery_intent_id,
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct RecoveryChallengeReceiptRecord {
    pub challenge_receipt_id: String,
    pub challenge_kind: RecoveryChallengeKind,
    pub challenge_status: RecoveryChallengeStatus,
    pub batch_id: String,
    pub challenger_commitment: String,
    pub evidence_root: String,
    pub challenged_nullifier: String,
...
impl RecoveryChallengeReceiptRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "challenge_receipt_id": self.challenge_receipt_id,
            "challenge_kind": self.challenge_kind.as_str(),
            "challenge_status": self.challenge_status.as_str(),
            "batch_id": self.batch_id,
            "challenger_commitment": self.challenger_commitment,
            "evidence_root": self.evidence_root,
            "challenged_nullifier": self.challenged_nullifier,
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct MarketRebateReceiptRecord {
    pub rebate_id: String,
    pub rebate_status: MarketRebateStatus,
    pub sponsor_reservation_id: String,
    pub batch_id: String,
    pub recipient_commitment: String,
    pub rebate_amount_commitment: String,
    pub rebate_route_root: String,
...
impl MarketRebateReceiptRecord {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "rebate_route_root": self.rebate_route_root,
...
pub fn root_from_record(domain: &str, record: &Value) -> String {
    domain_hash(
        domain,
        &[
            HashPart::Str(PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_PROTOCOL_VERSION),
...
pub fn state_root_from_record(record: &Value) -> String {
    root_from_record(
        "private-l2-pq-smart-account-recovery-market-STATE-ROOT",
        record,
    )
}
...
pub fn empty_runtime_root() -> String {
    domain_hash(
        "private-l2-pq-smart-account-recovery-market-EMPTY-RUNTIME-ROOT",
        &[
            HashPart::Str(PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_PROTOCOL_VERSION),
            HashPart::Str(CHAIN_ID),
        ],
...
fn require_bps(label: &str, value: u64) -> PrivateL2PqSmartAccountRecoveryMarketRuntimeResult<()> {
    require(
        value <= PRIVATE_L2_PQ_SMART_ACCOUNT_RECOVERY_MARKET_RUNTIME_MAX_BPS,
