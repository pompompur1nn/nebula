...
pub type MoneroL2PqPrivateMicropaymentNettingLaneRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const MONERO_L2_PQ_PRIVATE_MICROPAYMENT_NETTING_LANE_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-monero-l2-pq-private-micropayment-netting-lane-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    MONERO_L2_PQ_PRIVATE_MICROPAYMENT_NETTING_LANE_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const DEVNET_L2_NETWORK: &str = "nebula-devnet";
pub const DEVNET_MONERO_NETWORK: &str = "monero-devnet";
pub const DEVNET_ASSET_ID: &str = "wxmr-devnet";
pub const DEVNET_FEE_ASSET_ID: &str = "piconero-devnet";
pub const DEVNET_ROUTER_ID: &str = "devnet-monero-l2-pq-private-micropayment-netting-lane";
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const PQ_ENDPOINT_ATTESTATION_SUITE: &str =
    "ML-KEM-1024+ML-DSA-87+SLH-DSA-SHAKE-256f-private-endpoint-v1";
pub const SEALED_CHANNEL_SCHEME: &str = "ml-kem-sealed-monero-l2-private-micropayment-open-v1";
...
pub const FEE_SPONSOR_SCHEME: &str = "low-fee-private-micropayment-route-sponsor-root-v1";
pub const MICROBATCH_SETTLEMENT_SCHEME: &str = "batched-private-micropayment-settlement-root-v1";
pub const FAST_RECEIPT_SCHEME: &str = "fast-private-route-receipt-root-v1";
pub const REORG_ANCHOR_SCHEME: &str = "monero-reorg-safe-micropayment-anchor-root-v1";
pub const NULLIFIER_FENCE_SCHEME: &str = "private-micropayment-nullifier-fence-root-v1";
pub const WATCHTOWER_CHALLENGE_SCHEME: &str =
    "private-watchtower-stale-settlement-challenge-root-v1";
pub const SLASHING_EVIDENCE_SCHEME: &str = "private-micropayment-misrouting-slashing-root-v1";
...
pub fn monero_l2_pq_private_micropayment_netting_lane_runtime_state_root(state: &State) -> String {
    state.state_root()
}
pub fn monero_l2_pq_private_micropayment_netting_lane_runtime_public_record(
    state: &State,
) -> Value {
    state.public_record()
}
pub fn sealed_channel_id(request: &SealedChannelOpenRequest) -> String {
    domain_hash(
        "FAST-MICROPAYMENT-SEALED-CHANNEL-ID",
        &[
...
pub fn endpoint_attestation_id(request: &EndpointAttestationRequest) -> String {
    domain_hash(
        "FAST-MICROPAYMENT-ENDPOINT-ATTESTATION-ID",
        &[
            HashPart::Str(CHAIN_ID),
...
pub fn liquidity_path_reservation_id(request: &LiquidityPathReservationRequest) -> String {
    domain_hash(
        "FAST-MICROPAYMENT-LIQUIDITY-RESERVATION-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(&request.channel_id),
...
pub fn private_claim_lock_id(request: &PrivateClaimLockRequest) -> String {
    domain_hash(
        "FAST-MICROPAYMENT-PRIVATE-CLAIM-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(&request.channel_id),
...
pub fn fee_sponsorship_id(request: &FeeSponsorshipRequest) -> String {
    domain_hash(
        "FAST-MICROPAYMENT-FEE-SPONSORSHIP-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(&request.channel_id),
            HashPart::Str(&request.reservation_id),
...
pub fn microbatch_settlement_id(request: &MicrobatchSettlementRequest) -> String {
    domain_hash(
        "FAST-MICROPAYMENT-MICROBATCH-SETTLEMENT-ID",
        &[
            HashPart::Str(CHAIN_ID),
...
pub fn reorg_anchor_id(request: &ReorgAnchorRequest) -> String {
    domain_hash(
        "FAST-MICROPAYMENT-REORG-ANCHOR-ID",
        &[
            HashPart::Str(CHAIN_ID),
...
pub fn nullifier_fence_id(request: &NullifierFenceRequest) -> String {
    domain_hash(
        "FAST-MICROPAYMENT-NULLIFIER-FENCE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(&request.subject_id),
            HashPart::Str(&request.owner_commitment),
...
pub fn watchtower_challenge_id(request: &WatchtowerChallengeRequest) -> String {
    domain_hash(
        "FAST-MICROPAYMENT-WATCHTOWER-CHALLENGE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(&request.subject_id),
...
pub fn slashing_evidence_id(request: &SlashingEvidenceRequest) -> String {
    domain_hash(
        "FAST-MICROPAYMENT-SLASHING-EVIDENCE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(&request.subject_id),
...
pub fn sequence_id(kind: &str, sequence: u64, parts: &[&str]) -> String {
    ...
    domain_hash("FAST-MICROPAYMENT-SEQUENCE-ID", &hash_parts, 32)
}
...
pub fn state_root_from_record(record: &Value) -> String {
    payload_root("FAST-MICROPAYMENT-ROUTER-STATE-ROOT", record)
}
