...
pub type PrivateL2FastPqConfidentialWitnessDerivativeLatencyBankruptcyInsuranceFundBackstopRuntimeResult<
    T,
> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_FAST_PQ_CONFIDENTIAL_WITNESS_DERIVATIVE_LATENCY_BANKRUPTCY_INSURANCE_FUND_BACKSTOP_RUNTIME_PROTOCOL_VERSION: &str = "nebula-private-l2-fast-pq-confidential-witness-derivative-latency-bankruptcy-insurance-fund-backstop-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_FAST_PQ_CONFIDENTIAL_WITNESS_DERIVATIVE_LATENCY_BANKRUPTCY_INSURANCE_FUND_BACKSTOP_RUNTIME_PROTOCOL_VERSION;
