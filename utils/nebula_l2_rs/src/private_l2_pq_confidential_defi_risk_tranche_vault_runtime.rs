...
pub const PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-defi-risk-tranche-vault-runtime-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_PROTOCOL_VERSION: &str =
    PROTOCOL_VERSION;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_SCHEMA_VERSION: u64 = 1;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_HASH_SUITE: &str =
    "SHAKE256-domain-separated-canonical-json";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_CASE_SCHEME: &str =
    "ml-kem-1024+zk-pq-confidential-risk_tranche-case-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_ORACLE_SCHEME: &str =
    "ml-dsa-87+slh-dsa-shake-256s-oracle-risk-attestation-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_BID_SCHEME: &str =
    "pq-commitment-sealed-risk_tranche-bid-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_BACKSTOP_SCHEME: &str =
    "zk-private-backstop-liquidity-pool-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_SETTLEMENT_SCHEME: &str =
    "zk-pq-fast-lane-risk_tranche-settlement-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_RECURSIVE_PROOF_SCHEME: &str =
    "pq-recursive-proof-risk_tranche-receipt-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_CHALLENGE_SCHEME: &str =
    "roots-only-private-risk_tranche-challenge-bond-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_REBATE_SCHEME: &str =
    "roots-only-private-low-fee-risk_tranche-rebate-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_MEV_GUARD_SCHEME: &str =
    "deterministic-private-risk_tranche-mev-guard-fence-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MONERO_NETWORK: &str =
    "monero-devnet";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_FAST_LANE: &str =
    "devnet-private-l2-pq-risk_tranche-fast-lane";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_LOW_FEE_LANE: &str =
    "devnet-private-l2-pq-risk_tranche-low-fee";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEVNET_HEIGHT: u64 = 1_104_000;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_MAX_BPS: u64 = 10_000;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_CASE_TTL_BLOCKS: u64 =
    72;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_ATTESTATION_TTL_BLOCKS:
    u64 = 18;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_BID_TTL_BLOCKS: u64 =
    24;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_LANE_TTL_BLOCKS: u64 =
    12;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_SETTLEMENT_TTL_BLOCKS:
    u64 = 18;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_CHALLENGE_TTL_BLOCKS:
    u64 = 48;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_REBATE_EPOCH_BLOCKS:
    u64 = 1_440;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_BACKSTOP_TTL_BLOCKS:
    u64 = 21_600;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_CASES: usize =
    262_144;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_ATTESTATIONS:
    usize = 1_048_576;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_BIDS: usize =
    1_048_576;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_BACKSTOP_POOLS:
    usize = 262_144;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_LANES: usize =
    524_288;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_RECEIPTS: usize =
    524_288;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_CHALLENGES: usize =
    524_288;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_REBATES: usize =
    1_048_576;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_FENCES: usize =
    524_288;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_BIDS_PER_CASE:
    usize = 256;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_CASES_PER_RECEIPT:
    usize = 128;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MIN_PRIVACY_SET_SIZE:
    u64 = 512;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_BATCH_PRIVACY_SET_SIZE:
    u64 = 8_192;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MIN_PQ_SECURITY_BITS:
    u16 = 256;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_USER_FEE_BPS: u64 =
    16;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_KEEPER_FEE_BPS:
    u64 = 20;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MIN_BONUS_BPS: u64 =
    90;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_BONUS_BPS: u64 =
    1_250;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MIN_REBATE_BPS: u64 =
    4;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_REBATE_BPS: u64 =
    24;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MIN_SLASH_BPS: u64 =
    200;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_SLASH_BPS: u64 =
    10_000;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_FAST_LANE_BUDGET_MICRO_UNITS:
    u64 = 1_000_000_000;

#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum RiskTrancheDomain {
    Lending,
    Perpetuals,
    Options,
    Stablecoin,
...
impl RiskVerdict {
    ...
    pub fn allows_risk_tranche(self) -> bool {
        matches!(
            self,
...
pub struct Config {
    ...
    pub min_risk_tranche_bonus_bps: u64,
    pub max_risk_tranche_bonus_bps: u64,
...
impl Config {
    pub fn devnet() -> Self {
        Self {
            ...
            schema_version:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_SCHEMA_VERSION,
            hash_suite: PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_HASH_SUITE
                .to_string(),
            monero_network:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MONERO_NETWORK
                    .to_string(),
            fast_lane:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_FAST_LANE
                    .to_string(),
            low_fee_lane:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_LOW_FEE_LANE
                    .to_string(),
            encrypted_case_scheme:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_CASE_SCHEME
                    .to_string(),
            oracle_attestation_scheme:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_ORACLE_SCHEME
                    .to_string(),
            sealed_bid_scheme:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_BID_SCHEME
                    .to_string(),
            backstop_pool_scheme:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_BACKSTOP_SCHEME
                    .to_string(),
            settlement_scheme:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_SETTLEMENT_SCHEME
                    .to_string(),
            recursive_proof_scheme:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_RECURSIVE_PROOF_SCHEME
                    .to_string(),
            challenge_scheme:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_CHALLENGE_SCHEME
                    .to_string(),
            rebate_scheme:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_REBATE_SCHEME
                    .to_string(),
            mev_guard_scheme:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_MEV_GUARD_SCHEME
                    .to_string(),
            case_ttl_blocks:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_CASE_TTL_BLOCKS,
            attestation_ttl_blocks:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_ATTESTATION_TTL_BLOCKS,
            bid_ttl_blocks:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_BID_TTL_BLOCKS,
            lane_ttl_blocks:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_LANE_TTL_BLOCKS,
            settlement_ttl_blocks:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_SETTLEMENT_TTL_BLOCKS,
            challenge_ttl_blocks:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_CHALLENGE_TTL_BLOCKS,
            rebate_epoch_blocks:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_REBATE_EPOCH_BLOCKS,
            backstop_pool_ttl_blocks:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_BACKSTOP_TTL_BLOCKS,
            max_cases:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_CASES,
            max_attestations:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_ATTESTATIONS,
            max_bids:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_BIDS,
            max_backstop_pools:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_BACKSTOP_POOLS,
            max_fast_lanes:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_LANES,
            max_receipts:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_RECEIPTS,
            max_challenges:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_CHALLENGES,
            max_rebates:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_REBATES,
            max_mev_fences:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_FENCES,
            max_bids_per_case:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_BIDS_PER_CASE,
            max_cases_per_receipt:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_CASES_PER_RECEIPT,
            min_privacy_set_size:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MIN_PRIVACY_SET_SIZE,
            batch_privacy_set_size:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_BATCH_PRIVACY_SET_SIZE,
            min_pq_security_bits:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MIN_PQ_SECURITY_BITS,
            max_user_fee_bps:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_USER_FEE_BPS,
            max_keeper_fee_bps:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_KEEPER_FEE_BPS,
            min_risk_tranche_bonus_bps:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MIN_BONUS_BPS,
            max_risk_tranche_bonus_bps:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_BONUS_BPS,
            min_rebate_bps:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MIN_REBATE_BPS,
            max_rebate_bps:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_REBATE_BPS,
            min_slash_bps:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MIN_SLASH_BPS,
            max_slash_bps:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_MAX_SLASH_BPS,
            fast_lane_budget_micro_units:
                PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEFAULT_FAST_LANE_BUDGET_MICRO_UNITS,
    ...
    pub fn validate(&self) -> Result<()> {
        ...
        ensure_bps(
            self.min_risk_tranche_bonus_bps,
            "min risk_tranche bonus bps",
        )?;
        ensure_bps(
            self.max_risk_tranche_bonus_bps,
            "max risk_tranche bonus bps",
        )?;
        ...
        if self.min_risk_tranche_bonus_bps > self.max_risk_tranche_bonus_bps {
            return Err("min risk_tranche bonus exceeds max risk_tranche bonus".to_string());
        }
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "min_risk_tranche_bonus_bps": self.min_risk_tranche_bonus_bps,
            "max_risk_tranche_bonus_bps": self.max_risk_tranche_bonus_bps,
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct EncryptedRiskTrancheCaseRequest {
    pub account_commitment: String,
    pub domain: RiskTrancheDomain,
    pub venue: RiskTrancheVenue,
    ...
    pub risk_tranche_policy_root: String,
...
impl EncryptedRiskTrancheCaseRequest {
    pub fn validate(&self, config: &Config) -> Result<()> {
        ...
        require_root("risk_tranche policy root", &self.risk_tranche_policy_root)?;
        ...
        if self.requested_bonus_bps < config.min_risk_tranche_bonus_bps
            || self.requested_bonus_bps > config.max_risk_tranche_bonus_bps
        {
            return Err("requested bonus outside configured risk_tranche range".to_string());
        }
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "risk_tranche_policy_root": self.risk_tranche_policy_root,
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct EncryptedRiskTrancheCaseRecord {
    pub case_id: String,
    pub request: EncryptedRiskTrancheCaseRequest,
...
impl PublicRecord for EncryptedRiskTrancheCaseRecord {
    fn public_record(&self) -> Value {
        json!({
            "kind": "encrypted_risk_tranche_case",
...
impl SealedBidRequest {
    pub fn validate(&self, config: &Config) -> Result<()> {
        ...
        if self.bonus_bps < config.min_risk_tranche_bonus_bps
            || self.bonus_bps > config.max_risk_tranche_bonus_bps
        {
            return Err("bonus bps outside configured risk_tranche range".to_string());
        }
        if self.privacy_set_size < config.min_privacy_set_size {
            return Err("tranche vault privacy set below configured minimum".to_string());
        }
        if self.expires_at_height > 0 && self.expires_at_height <= self.committed_at_height {
            return Err("tranche vault expiry must be after commit height".to_string());
        }
        Ok(())
    }
...
pub struct State {
    ...
    pub cases: BTreeMap<String, EncryptedRiskTrancheCaseRecord>,
...
impl State {
    pub fn new(config: Config, current_height: u64) -> Result<Self> {
        ...
        Ok(Self {
            ...
            runtime_root: payload_root(
                "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-SEALED-BID-GENESIS",
    ...
    pub fn devnet() -> Result<Self> {
        let mut state = Self::new(
            Config::devnet(),
            PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_DEVNET_HEIGHT,
        )?;

        let pool_id = state.register_backstop_pool(
            "devnet-xmr-liquidity-backstop",
            RiskTrancheVenue::LendingPool,
        ...
        let case_id = state.open_encrypted_risk_tranche_case(EncryptedRiskTrancheCaseRequest {
            account_commitment: commitment_root("account", "devnet-account-alpha"),
            domain: RiskTrancheDomain::Lending,
            venue: RiskTrancheVenue::LendingPool,
            ...
            collateral_legs: vec![
                TokenCollateralLeg {
                    ...
                    haircut_bps: 650,
                    venue: RiskTrancheVenue::PrivateAmm,
        ...
        let bid_id = state.commit_sealed_bid(SealedBidRequest {
            ...
            sealed_commitment_root: commitment_root("tranche-vault", "devnet-tranche-vault-alpha"),
    ...
    pub fn open_encrypted_risk_tranche_case(
        &mut self,
        mut request: EncryptedRiskTrancheCaseRequest,
    ) -> Result<String> {
        ...
        let collateral_root = public_record_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-COLLATERAL",
            request
                .collateral_legs
                .iter()
        ...
        let case = EncryptedRiskTrancheCaseRecord {
            case_id: case_id.clone(),
            request,
            ...
            latest_risk_root: payload_root(
                "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-EMPTY-RISK",
    ...
    pub fn submit_oracle_risk_attestation(
        ...
        let status = if request.verdict.allows_risk_tranche() {
        ...
        case.latest_risk_root = payload_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-LATEST-RISK",
            &json!({
        ...
        } else if request.verdict.allows_risk_tranche() {
            CaseStatus::RiskAttested
        } else {
            case.status
        };
        if request.verdict.allows_risk_tranche() {
    ...
    pub fn commit_sealed_bid(&mut self, mut request: SealedBidRequest) -> Result<String> {
        ...
        let (case_status, case_bid_len, case_venue) = {
            let case = self
                .cases
                .get(&request.case_id)
                .ok_or_else(|| "case not found for tranche vault".to_string())?;
            (case.status, case.bid_ids.len(), case.request.venue)
        };
        if !case_status.can_bid() {
            return Err("case no longer accepts tranche vaults".to_string());
        }
        if case_bid_len >= self.config.max_bids_per_case {
            return Err("tranche vault capacity reached for case".to_string());
        }
        ...
        let case = self
            .cases
            .get_mut(&record.request.case_id)
            .ok_or_else(|| "case not found for tranche vault insertion".to_string())?;
    ...
    pub fn register_backstop_pool(
        ...
        let pool = PrivateBackstopPool {
            ...
            liquidity_commitment: payload_root(
                "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-BACKSTOP-LIQUIDITY",
    ...
    pub fn roots(&self) -> Roots {
        let config_root = payload_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-CONFIG",
            &self.config.public_record(),
        );
        let counter_root = payload_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-COUNTERS",
            &self.counters.public_record(),
        );
        let case_root = public_record_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-CASES",
            self.cases
                .values()
                .map(EncryptedRiskTrancheCaseRecord::public_record)
                .collect(),
        );
        let attestation_root = public_record_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-ATTESTATIONS",
            self.oracle_attestations
                .values()
        ...
        let bid_root = public_record_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-BIDS",
            self.sealed_bids
                .values()
        ...
        let backstop_pool_root = public_record_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-BACKSTOP-POOLS",
        ...
        let lane_root = public_record_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-LANES",
            self.fast_lanes
                .values()
        ...
        let receipt_root = public_record_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-RECEIPTS",
        ...
        let challenge_root = public_record_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-CHALLENGES",
            self.challenges
                .values()
        ...
        let rebate_root = public_record_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-REBATES",
            self.rebates
                .values()
        ...
        let mev_fence_root = public_record_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-MEV-FENCES",
            self.mev_fences
                .values()
        ...
        let active_case_root = public_record_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-ACTIVE-CASES",
        ...
        let settlement_ready_root = public_record_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-SETTLEMENT-READY",
        ...
        let consumed_nullifier_root = public_record_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-CONSUMED-NULLIFIERS",
        ...
        let public_record_root_value = public_record_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-PUBLIC-RECORDS",
    ...
    pub fn public_record_without_state_root(&self) -> Value {
        ...
        json!({
            "kind": "private_l2_pq_confidential_defi_risk_tranche_vault_runtime_state",
            "protocol_version": PROTOCOL_VERSION,
            "schema_version": PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_SCHEMA_VERSION,
            "chain_id": CHAIN_ID,
            "hash_suite": PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_HASH_SUITE,
            "current_height": self.current_height,
            "runtime_root": self.runtime_root,
    ...
    fn consume_nullifier(&mut self, nullifier: &str) -> Result<()> {
        ...
        let nullifier_hash = payload_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-NULLIFIER",
    ...
    fn best_backstop_pool(&self, venue: RiskTrancheVenue, bonus_bps: u64) -> Option<String> {
        self.private_backstop_pools
            .values()
            .filter(|pool| {
...
pub fn deterministic_id(kind: &str, nonce: u64, labels: &[&str]) -> String {
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-DETERMINISTIC-ID",
        &parts,
        32,
    )
}
...
pub fn state_root_from_record(record: &Value) -> String {
    root_from_record(
        "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-STATE-ROOT",
        record,
    )
}
...
pub fn public_record_id(record_kind: &str, subject_id: &str, payload: &Value) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-PUBLIC-RECORD-ID",
        &[
            HashPart::Str(PROTOCOL_VERSION),
...
pub fn roots_only_public_record(record_kind: &str, subject_id: &str, payload: &Value) -> Value {
    json!({
        ...
        "payload_root": payload_root(
            "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-PAYLOAD-ROOT",
            payload
        ),
...
pub fn roots_only_payload(kind: &str, subject_id: &str, payload: &Value) -> String {
    payload_root(
        "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-ROOTS-ONLY-PAYLOAD",
        &json!({
            "kind": kind,
            "subject_id": subject_id,
            "payload": payload
...
pub fn commitment_root(domain: &str, label: &str) -> String {
    payload_root(
        "PRIVATE-L2-PQ-CONFIDENTIAL-DEFI-RISK_TRANCHE-COMMITMENT",
...
pub fn ensure_bps(value: u64, label: &str) -> Result<()> {
    if value > PRIVATE_L2_PQ_CONFIDENTIAL_DEFI_RISK_TRANCHE_VAULT_RUNTIME_MAX_BPS {
