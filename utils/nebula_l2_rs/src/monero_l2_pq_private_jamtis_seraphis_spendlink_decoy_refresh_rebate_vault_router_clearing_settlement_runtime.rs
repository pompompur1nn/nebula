...
pub type MoneroL2PqPrivateJamtisSeraphisSpendlinkDecoyRefreshRebateVaultRouterClearingSettlementRuntimeResult<
    T,
> = Result<T>;
pub type Runtime = State;

pub const MONERO_L2_PQ_PRIVATE_JAMTIS_SERAPHIS_SPENDLINK_DECOY_REFRESH_REBATE_VAULT_ROUTER_CLEARING_SETTLEMENT_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-monero-l2-pq-private-jamtis-seraphis-spendlink-decoy-refresh-rebate-vault-router-clearing-settlement-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    MONERO_L2_PQ_PRIVATE_JAMTIS_SERAPHIS_SPENDLINK_DECOY_REFRESH_REBATE_VAULT_ROUTER_CLEARING_SETTLEMENT_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const STATE_ROOT_DOMAIN: &str =
    "MONERO-L2-PQ-PRIVATE-JAMTIS-SERAPHIS-SPENDLINK-DECOY-REFRESH-REBATE-VAULT-ROUTER-CLEARING_SETTLEMENT";
pub const DEVNET_L2_NETWORK: &str = "nebula-private-l2-devnet";
pub const DEVNET_MONERO_NETWORK: &str = "monero-devnet";
pub const DEVNET_FEE_ASSET_ID: &str = "piconero-devnet";
pub const DEVNET_REBATE_ASSET_ID: &str =
    "refresh-vault-router-clearing-settlement-rebate-credit-devnet";
...
pub const VAULT_ROUTER_INTENT_SCHEME: &str =
    "jamtis-seraphis-spendlink-decoy-refresh-rebate-vault-router-clearing-settlement-intent-root-v1";
pub const VAULT_ROUTER_POOL_SCHEME: &str =
    "pq-private-jamtis-seraphis-decoy-refresh-vault-router-clearing-settlement-pool-root-v1";
pub const VAULT_ROUTER_QUOTE_SCHEME: &str =
    "defi-style-private-refresh-rebate-vault-router-clearing-settlement-quote-root-v1";
...
pub const VAULT_ROUTE_SPLIT_SCHEME: &str =
    "private-refresh-rebate-vault-router-clearing-settlement-split-commitment-root-v1";
...
pub const VAULT_ROUTER_PQ_ATTESTATION_SCHEME: &str =
    "ML-DSA-87+SLH-DSA-SHAKE-256f-jamtis-seraphis-refresh-rebate-vault-router-clearing-settlement-attestation-v1";
pub const VAULT_ROUTER_AUDIT_SCHEME: &str =
    "low-fee-private-refresh-rebate-vault-router-clearing-settlement-audit-root-v1";
pub const PUBLIC_RECORD_SCHEME: &str =
    "roots-only-jamtis-seraphis-spendlink-decoy-refresh-rebate-vault-router-clearing-settlement-public-record-v1";
...
impl State {
    ...
    pub fn run_clearing_settlement_round(
        ...
        let record = json!({
            "scheme": "confidential-refresh-cohort-clearing-settlement-round-v1",
            "round_id": round_id,
        ...
        Ok(root_from_record("clearing-settlement-round", &record))
    }
    ...
    pub fn check_decoy_quality(
        ...
        let record = json!({
            "scheme": "confidential-decoy-quality-check-vault-router-clearing-settlement-v1",
    ...
    pub fn viewtag_privacy_budget_root(
        ...
        let record = json!({
            "scheme": "jamtis-seraphis-viewtag-privacy-budget-vault-router-clearing-settlement-v1",
            "cohort_root": cohort_root,
    ...
    pub fn anti_linkability_score_root(
        ...
        let blended_score_bps = decoy_entropy_bps
            ...
            / 4;
        let record = json!({
            "scheme": "anti-linkability-score-vault-router-clearing-settlement-v1",
            "cohort_root": cohort_root,
            "decoy_entropy_bps": decoy_entropy_bps,
            "spendlink_shield_bps": spendlink_shield_bps,
    ...
    pub fn run_clearing_round(
        ...
        let record = json!({
            "scheme": "confidential-refresh-cohort-vault-router-clearing-settlement-round-v1",
            "round_id": round_id,
            "epoch": self.epoch,
            "l2_height": self.l2_height,
    ...
    pub fn apply_low_fee_rebate(
        ...
        let record = json!({
            "scheme": "low-fee-refresh-rebate-vault-router-clearing-settlement-v1",
    ...
    pub fn quarantine_clearing_item(
        ...
        let record = json!({
            "scheme": "privacy-preserving-vault-router-clearing-settlement-quarantine-v1",
            "item_id": item_id,
            "item_root": item_root,
            "reason_root": reason_root,
