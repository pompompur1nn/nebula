...
pub type PrivateL2FastPqConfidentialWitnessDerivativeLatencyBankruptcyInsuranceFundBackstopLiquidationAuctionRuntimeResult<
    T,
> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_FAST_PQ_CONFIDENTIAL_WITNESS_DERIVATIVE_LATENCY_BANKRUPTCY_INSURANCE_FUND_BACKSTOP_LIQUIDATION_AUCTION_RUNTIME_PROTOCOL_VERSION: &str = "nebula-private-l2-fast-pq-confidential-witness-derivative-latency-bankruptcy-insurance-fund-backstop-liquidation-auction-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_FAST_PQ_CONFIDENTIAL_WITNESS_DERIVATIVE_LATENCY_BANKRUPTCY_INSURANCE_FUND_BACKSTOP_LIQUIDATION_AUCTION_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "shake256-domain-separated-canonical-json-v1";
pub const PQ_INSURANCE_FUND_BACKSTOP_ATTESTATION_SUITE: &str =
    "ml-dsa-87+slh-dsa-shake-256f-latency-bankruptcy-insurance-fund-backstop-resolution-root-v1";
pub const INSURANCE_FUND_BACKSTOP_POSITION_SUITE: &str =
    "ml-kem-1024-sealed-defi-derivative-bankruptcy-insurance-fund-backstop-position-root-v1";
pub const SOCIALIZED_LOSS_SUITE: &str =
    "roots-only-socialized-loss-resolution-derivative-bankruptcy-insurance-fund-backstop-v1";
pub const PRIVACY_BOUNDARY: &str =
    "roots_only_no_plaintext_witnesses_addresses_keys_insurance_fund_backstop_terms_positions_losses_reserves_or_backstop_members";
pub const PUBLIC_RECORD_SUITE: &str =
    "roots-only-private-l2-fast-pq-confidential-derivative-latency-bankruptcy-insurance-fund-backstop-record-v1";
...
pub const DEFAULT_INSURANCE_FUND_BACKSTOP_CYCLE_MS: u64 = 30;
...
pub const DEFAULT_INSURANCE_FUND_BACKSTOP_FEE_BPS: u64 = 32;
pub const DEFAULT_INSURANCE_FUND_BACKSTOP_DISCOUNT_BPS: u64 = 650;
...
pub const DEFAULT_MAX_INSURANCE_FUND_BACKSTOP_DRAWS: usize = 262_144;
pub const DEFAULT_ROOT_BYTES: usize = 32;

const D_CONFIG: &str =
    "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND-BACKSTOP:CONFIG";
const D_COUNTERS: &str =
    "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND-BACKSTOP:COUNTERS";
const D_ROOTS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND-BACKSTOP:ROOTS";
const D_STATE: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND-BACKSTOP:STATE";
const D_POOLS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND-BACKSTOP:POOLS";
const D_CLAIMS: &str =
    "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND-BACKSTOP:CLAIMS";
const D_CASES: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND-BACKSTOP:CASES";
const D_LOSS_EPOCHS: &str =
    "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND-BACKSTOP:SOCIALIZED-LOSS-EPOCHS";
const D_INSURANCE_FUND_BACKSTOP_DRAWS: &str =
    "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND-BACKSTOP:DRAWS";
const D_ATTESTATIONS: &str =
    "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND-BACKSTOP:ATTESTATIONS";
const D_RECEIPTS: &str =
    "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND-BACKSTOP:RECEIPTS";
const D_AUCTION_BIDS: &str =
    "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND-BACKSTOP-LIQUIDATION-AUCTION:BIDS";
const D_AUCTION_SETTLEMENTS: &str =
    "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND-BACKSTOP-LIQUIDATION-AUCTION:SETTLEMENTS";
const D_NULLIFIERS: &str =
    "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND-BACKSTOP:NULLIFIERS";
const D_PUBLIC: &str =
    "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND-BACKSTOP:PUBLIC";
const D_DEVNET: &str =
    "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND-BACKSTOP:DEVNET";

#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum InsuranceFundBackstopMode {
    Continuous,
    BatchAuction,
    InsuranceFirst,
    SocializedLoss,
...
pub enum DerivativeClass {
    ...
    CongestionOption,
    ReliabilityVariance,
    BankruptcyInsuranceFundBackstop,
    SocializedLossNote,
}
...
#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum BackstopLossEpochStatus {
    Open,
    Attested,
    Applied,
    Settled,
...
#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum InsuranceFundBackstopDrawStatus {
    Requested,
    Attested,
    Applied,
    Repaid,
...
pub struct Config {
    ...
    pub pq_insurance_fund_backstop_attestation_suite: String,
    pub insurance_fund_backstop_position_suite: String,
    pub socialized_loss_suite: String,
    pub roots_only_public_records: bool,
    pub min_pq_security_bits: u16,
    pub min_privacy_set_size: u64,
    pub target_privacy_set_size: u64,
    pub insurance_fund_backstop_cycle_ms: u64,
    pub max_latency_ms: u64,
    pub resolution_delay_slots: u64,
    pub low_fee_cap_bps: u64,
    pub taker_fee_bps: u64,
    pub insurance_fund_backstop_fee_bps: u64,
    pub insurance_fund_backstop_discount_bps: u64,
    ...
    pub max_insurance_fund_backstop_draws: usize,
}
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            pq_insurance_fund_backstop_attestation_suite:
                PQ_INSURANCE_FUND_BACKSTOP_ATTESTATION_SUITE.to_string(),
            insurance_fund_backstop_position_suite: INSURANCE_FUND_BACKSTOP_POSITION_SUITE
                .to_string(),
            ...
            insurance_fund_backstop_cycle_ms: DEFAULT_INSURANCE_FUND_BACKSTOP_CYCLE_MS,
            max_latency_ms: DEFAULT_MAX_LATENCY_MS,
            resolution_delay_slots: DEFAULT_RESOLUTION_DELAY_SLOTS,
            low_fee_cap_bps: DEFAULT_LOW_FEE_CAP_BPS,
            taker_fee_bps: DEFAULT_TAKER_FEE_BPS,
            insurance_fund_backstop_fee_bps: DEFAULT_INSURANCE_FUND_BACKSTOP_FEE_BPS,
            insurance_fund_backstop_discount_bps: DEFAULT_INSURANCE_FUND_BACKSTOP_DISCOUNT_BPS,
            ...
            max_insurance_fund_backstop_draws: DEFAULT_MAX_INSURANCE_FUND_BACKSTOP_DRAWS,
        }
    }
}
...
impl Config {
    pub fn validate(&self) -> Result<()> {
        ...
        ensure_bps(
            "insurance_fund_backstop_fee_bps",
            self.insurance_fund_backstop_fee_bps,
        )?;
        ensure_bps(
            "insurance_fund_backstop_discount_bps",
            self.insurance_fund_backstop_discount_bps,
        )?;
        ...
        if self.insurance_fund_backstop_cycle_ms == 0 || self.max_latency_ms == 0 {
            return Err("insurance_fund cycle and max latency must be non-zero".to_string());
        }
        if !self.roots_only_public_records {
            return Err(
                "bankruptcy insurance_fund runtime requires roots-only public records".to_string(),
            );
        }
        Ok(())
    }
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "pq_insurance_fund_backstop_attestation_suite": self.pq_insurance_fund_backstop_attestation_suite,
            "insurance_fund_backstop_position_suite": self.insurance_fund_backstop_position_suite,
            ...
            "insurance_fund_backstop_cycle_ms": self.insurance_fund_backstop_cycle_ms,
...
pub struct Counters {
    ...
    pub insurance_fund_draws_requested: u64,
    pub insurance_fund_draws_applied: u64,
    pub liquidation_bids_opened: u64,
    pub liquidation_bids_scored: u64,
    pub liquidation_auctions_settled: u64,
    ...
    pub total_insurance_fund_draw_micros: u128,
    pub total_fee_micros: u128,
    pub total_fee_savings_micros: u128,
    pub total_bid_recovery_micros: u128,
    pub total_rebate_micros: u128,
    pub peak_score_confidential_claims_micros: u128,
    pub last_height: u64,
    pub last_epoch: u64,
}
...
pub struct Roots {
    ...
    pub insurance_fund_resolutions_root: String,
    pub socialized_loss_epochs_root: String,
    pub insurance_fund_draws_root: String,
    pub liquidation_bids_root: String,
    pub auction_settlements_root: String,
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct RegisterInsuranceFundBackstopPoolInput {
    pub pool_id: String,
    pub derivative_class: DerivativeClass,
    pub bankruptcy_mode: InsuranceFundBackstopMode,
    pub maker_commitment_root: String,
    pub insurance_vault_root: String,
    pub insurance_fund_vault_root: String,
    pub encrypted_curve_root: String,
    pub loss_waterfall_root: String,
    pub privacy_set_size: u64,
    pub pq_security_bits: u16,
    pub max_latency_ms: u64,
    pub score_confidential_claim_limit_micros: u128,
    pub insurance_capacity_micros: u128,
    pub insurance_fund_capacity_micros: u128,
    pub created_at_height: u64,
}

pub type LiquidationIntakeInput = RegisterInsuranceFundBackstopPoolInput;

#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct InsuranceFundBackstopPool {
    pub pool_id: String,
    pub derivative_class: DerivativeClass,
    pub bankruptcy_mode: InsuranceFundBackstopMode,
    ...
    pub insurance_fund_capacity_micros: u128,
    pub insurance_fund_remaining_micros: u128,
    pub score_confidential_claims_micros: u128,
...
impl InsuranceFundBackstopPool {
    pub fn from_input(input: RegisterInsuranceFundBackstopPoolInput) -> Self {
        Self {
            ...
            insurance_fund_vault_root: input.insurance_fund_vault_root,
            ...
            score_confidential_claim_limit_micros: input.score_confidential_claim_limit_micros,
            insurance_capacity_micros: input.insurance_capacity_micros,
            insurance_remaining_micros: input.insurance_capacity_micros,
            insurance_fund_capacity_micros: input.insurance_fund_capacity_micros,
            insurance_fund_remaining_micros: input.insurance_fund_capacity_micros,
            score_confidential_claims_micros: 0,
    ...
    pub fn available_resolution_micros(&self) -> u128 {
        self.insurance_remaining_micros
            .saturating_add(self.insurance_fund_remaining_micros)
    }
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "insurance_fund_vault_root": self.insurance_fund_vault_root,
            "encrypted_curve_root": self.encrypted_curve_root,
            "loss_waterfall_root": self.loss_waterfall_root,
            "privacy_set_size": self.privacy_set_size,
            "pq_security_bits": self.pq_security_bits,
            "max_latency_ms": self.max_latency_ms,
            "score_confidential_claims_micros": self.score_confidential_claims_micros,
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct OpenInsuranceFundBackstopClaimInput {
    pub claim_id: String,
    pub pool_id: String,
    pub side: ClaimSide,
...
pub type ConfidentialInsolvencyClaimInput = OpenInsuranceFundBackstopClaimInput;
pub type LiquidationClaimIntakeInput = OpenInsuranceFundBackstopClaimInput;

#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct InsuranceFundBackstopClaim {
    pub claim_id: String,
    pub pool_id: String,
    pub side: ClaimSide,
    ...
    pub expires_slot: u64,
    pub created_at_height: u64,
    pub insurance_fund_resolution_id: Option<String>,
    pub loss_epoch_id: Option<String>,
}

impl InsuranceFundBackstopClaim {
    pub fn from_input(input: OpenInsuranceFundBackstopClaimInput) -> Self {
        ...
        Self {
            ...
            created_at_height: input.created_at_height,
            insurance_fund_resolution_id: None,
            loss_epoch_id: None,
        }
    }
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "insurance_fund_resolution_id": self.insurance_fund_resolution_id,
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct OpenInsuranceFundResolutionInput {
    pub case_id: String,
    pub pool_id: String,
...
pub type ActivateInsuranceFundBackstopInput = OpenInsuranceFundResolutionInput;
pub type ActivateLiquidationBackstopInput = OpenInsuranceFundResolutionInput;
pub type LiquidationSettlementInput = OpenInsuranceFundResolutionInput;

#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct InsuranceFundResolution {
    pub case_id: String,
    pub pool_id: String,
    ...
    pub insurance_fund_draw_micros: u128,
    pub socialized_loss_micros: u128,
    pub fee_micros: u64,
...
impl InsuranceFundResolution {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "insurance_fund_draw_micros": self.insurance_fund_draw_micros,
            "socialized_loss_micros": self.socialized_loss_micros,
...
pub type ProveSloBreachInput = AllocateSocializedLossInput;

#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct SocializedBackstopLossEpoch {
    pub loss_epoch_id: String,
    pub pool_id: String,
    pub status: BackstopLossEpochStatus,
...
impl SocializedBackstopLossEpoch {
    pub fn public_record(&self) -> Value {
        json!({
            "loss_epoch_id": self.loss_epoch_id,
            "pool_id": self.pool_id,
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct RequestInsuranceFundBackstopDrawInput {
    pub draw_id: String,
    pub pool_id: String,
    pub case_id: String,
...
pub type ReserveBackstopAccountingInput = RequestInsuranceFundBackstopDrawInput;

#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct InsuranceFundBackstopDraw {
    pub draw_id: String,
    pub pool_id: String,
    pub case_id: String,
    pub status: InsuranceFundBackstopDrawStatus,
    pub provider_set_root: String,
    pub draw_commitment_root: String,
    pub repayment_terms_root: String,
    pub requested_micros: u64,
...
impl InsuranceFundBackstopDraw {
    pub fn public_record(&self) -> Value {
        json!({
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct PqInsuranceFundBackstopAttestationInput {
...
pub type RecordPqInsuranceFundBackstopAttestationInput = PqInsuranceFundBackstopAttestationInput;

#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct PqInsuranceFundBackstopAttestation {
    pub attestation_id: String,
    pub subject_id: String,
    pub subject_root: String,
...
impl PqInsuranceFundBackstopAttestation {
    pub fn public_record(&self) -> Value {
        serde_json::to_value(self).unwrap_or_else(|_| json!({"serialization":"failed"}))
    }
}
...
pub type RebateAccountingInput = ReplayReceiptInput;
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct LiquidationAuctionBidInput {
    pub bid_id: String,
    pub case_id: String,
    pub pool_id: String,
    ...
    pub nullifier_root: String,
    pub bid_amount_micros: u64,
    pub reserve_price_micros: u64,
    pub max_fee_micros: u64,
    pub latency_ms: u64,
    pub fill_bps: u64,
    pub rebate_bps: u64,
...
impl LiquidationAuctionBid {
    pub fn from_input(input: LiquidationAuctionBidInput, score: u128, accepted: bool) -> Self {
        Self {
            bid_id: input.bid_id,
            ...
            inventory_commitment_root: input.inventory_commitment_root,
            pq_attestation_root: input.pq_attestation_root,
            nullifier_root: input.nullifier_root,
            bid_amount_micros: input.bid_amount_micros,
            reserve_price_micros: input.reserve_price_micros,
            max_fee_micros: input.max_fee_micros,
            latency_ms: input.latency_ms,
            fill_bps: input.fill_bps,
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct AuctionSettlementInput {
    pub settlement_id: String,
    pub case_id: String,
    pub winning_bid_ids: Vec<String>,
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct AuctionSettlementReceipt {
    pub settlement_id: String,
    pub case_id: String,
    pub winning_bids_root: String,
    pub distribution_root: String,
    pub rebate_root: String,
    pub fee_root: String,
    pub recovery_micros: u64,
...
pub struct State {
    ...
    pub roots: Roots,
    pub pools: BTreeMap<String, InsuranceFundBackstopPool>,
    pub claims: BTreeMap<String, InsuranceFundBackstopClaim>,
    pub insurance_fund_resolutions: BTreeMap<String, InsuranceFundResolution>,
    pub socialized_loss_epochs: BTreeMap<String, SocializedBackstopLossEpoch>,
    pub insurance_fund_draws: BTreeMap<String, InsuranceFundBackstopDraw>,
    pub liquidation_bids: BTreeMap<String, LiquidationAuctionBid>,
    pub auction_settlements: BTreeMap<String, AuctionSettlementReceipt>,
    pub pq_attestations: BTreeMap<String, PqInsuranceFundBackstopAttestation>,
...
impl State {
    pub fn new(config: Config) -> Self {
        let mut state = Self {
            ...
            pools: BTreeMap::new(),
            claims: BTreeMap::new(),
            insurance_fund_resolutions: BTreeMap::new(),
            socialized_loss_epochs: BTreeMap::new(),
            insurance_fund_draws: BTreeMap::new(),
            liquidation_bids: BTreeMap::new(),
    ...
    pub fn fund_intake(&mut self, input: RegisterInsuranceFundBackstopPoolInput) -> Result<()> {
        ...
        ensure_non_empty(
            "insurance_fund_vault_root",
            &input.insurance_fund_vault_root,
        )?;
        ...
        let pool = InsuranceFundBackstopPool::from_input(input);
    ...
    pub fn liquidation_intake(&mut self, input: LiquidationIntakeInput) -> Result<()> {
        self.fund_intake(input)
    }

    pub fn score_confidential_claim(
        &mut self,
        input: OpenInsuranceFundBackstopClaimInput,
    ) -> Result<()> {
        ...
        if !pool.status.accepts_claims() {
            return Err("pool does not accept insurance_fund claims".to_string());
        }
        ...
        let next_claims = pool
            .score_confidential_claims_micros
            .saturating_add(u128::from(input.claim_notional_micros));
        if next_claims > pool.score_confidential_claim_limit_micros {
            return Err("pool open claim limit exceeded".to_string());
        }
        let claim = InsuranceFundBackstopClaim::from_input(input);
        pool.score_confidential_claims_micros = next_claims;
        ...
        self.update_peak_score_confidential_claims();
        self.claims.insert(claim.claim_id.clone(), claim);
        self.refresh_roots();
        Ok(())
    }

    pub fn intake_confidential_insolvency_claim(
        &mut self,
        input: ConfidentialInsolvencyClaimInput,
    ) -> Result<()> {
        self.score_confidential_claim(input)
    }

    pub fn open_insurance_fund_resolution(
        &mut self,
        input: OpenInsuranceFundResolutionInput,
    ) -> Result<()> {
        ensure_capacity(
            self.insurance_fund_resolutions.len(),
            self.config.max_cases,
            "insurance_fund resolutions",
        )?;
        ensure_unique(
            &self.insurance_fund_resolutions,
            "insurance_fund resolution",
            &input.case_id,
        )?;
        ...
        if input.creditor_approval_bps < self.config.min_creditor_approval_bps {
            return Err("creditor approval below configured insurance_fund floor".to_string());
        }
        ...
        if input.observed_latency_ms > pool_snapshot.max_latency_ms {
            return Err("insurance_fund resolution exceeds pool latency bound".to_string());
        }
        ...
        for claim_id in &input.claim_ids {
            ...
            if claim.pool_id != input.pool_id || !claim.status.live() {
                return Err(format!("claim `{claim_id}` is not insurance_fund-nettable"));
            }
            gross_claim_micros =
        ...
        if deficit_micros == 0 {
            return Err(
                "insurance_fund resolution requires a positive confidential deficit".to_string(),
            );
        }
        ...
        let insurance_fund_draw_micros =
            deficit_after_insurance.min(pool_snapshot.insurance_fund_remaining_micros);
        let socialized_loss_micros =
            deficit_after_insurance.saturating_sub(insurance_fund_draw_micros);
        let fee_micros = bankruptcy_fee(gross_claim_micros, deficit_micros, &self.config);
        let fee_savings_micros = fee_savings_for_resolution(
            deficit_micros,
            self.config.insurance_fund_backstop_discount_bps,
        );
        ...
        for claim_id in &input.claim_ids {
            if let Some(claim) = self.claims.get_mut(claim_id) {
                ...
                claim.insurance_fund_resolution_id = Some(input.case_id.clone());
            }
        }
        if let Some(pool) = self.pools.get_mut(&input.pool_id) {
            ...
            pool.insurance_fund_remaining_micros = pool
                .insurance_fund_remaining_micros
                .saturating_sub(insurance_fund_draw_micros);
        ...
        let case = InsuranceFundResolution {
            case_id: input.case_id,
            pool_id: input.pool_id,
        ...
        self.counters.total_insurance_fund_draw_micros = self
            .counters
            .total_insurance_fund_draw_micros
            .saturating_add(insurance_fund_draw_micros);
    ...
    pub fn liquidation_auction_intake(&mut self, input: LiquidationAuctionBidInput) -> Result<()> {
        ensure_capacity(
            self.liquidation_bids.len(),
            self.config.max_receipts,
            "liquidation auction bids",
        )?;
        ensure_unique(
            &self.liquidation_bids,
            "liquidation auction bid",
            &input.bid_id,
        )?;
        ensure_bps("fill_bps", input.fill_bps)?;
        ensure_bps("rebate_bps", input.rebate_bps)?;
        ensure_non_empty("bidder_commitment_root", &input.bidder_commitment_root)?;
        ensure_non_empty("sealed_bid_root", &input.sealed_bid_root)?;
        ensure_non_empty("payment_commitment_root", &input.payment_commitment_root)?;
        ensure_non_empty(
            "inventory_commitment_root",
            &input.inventory_commitment_root,
        )?;
        ensure_non_empty("pq_attestation_root", &input.pq_attestation_root)?;
        ensure_non_empty("nullifier_root", &input.nullifier_root)?;
        if input.expires_slot <= input.opened_slot {
            return Err("auction bid expires before it opens".to_string());
        }
        let case = self
            .insurance_fund_resolutions
            .get(&input.case_id)
            .ok_or_else(|| format!("case `{}` not found", input.case_id))?;
        if case.pool_id != input.pool_id {
            return Err("auction bid pool does not match case pool".to_string());
        }
        if input.bid_amount_micros < input.reserve_price_micros {
            return Err("auction bid below sealed reserve price".to_string());
        }
        if input.max_fee_micros > self.config.low_fee_cap_bps {
            return Err("auction bid fee exceeds low-fee cap".to_string());
        }
        if input.latency_ms > self.config.max_latency_ms {
            return Err("auction bid latency exceeds configured SLO".to_string());
        }
        let duplicate = !self.seen_nullifiers.insert(input.nullifier_root.clone());
        if duplicate {
            return Err("auction bid nullifier already seen".to_string());
        }
        let score = sealed_bid_score(
            u128::from(input.bid_amount_micros),
            u128::from(input.reserve_price_micros),
            input.latency_ms,
            input.fill_bps,
            input.rebate_bps,
            &self.config,
        ...
        let bid = LiquidationAuctionBid::from_input(input, score, accepted);
        self.counters.liquidation_bids_opened =
            self.counters.liquidation_bids_opened.saturating_add(1);
        if accepted {
            self.counters.liquidation_bids_scored =
                self.counters.liquidation_bids_scored.saturating_add(1);
        }
        self.liquidation_bids.insert(bid.bid_id.clone(), bid);
        self.refresh_roots();
        Ok(())
    }

    pub fn score_sealed_bid(&mut self, input: LiquidationAuctionBidInput) -> Result<()> {
        self.liquidation_auction_intake(input)
    }

    pub fn activate_backstop(&mut self, input: ActivateInsuranceFundBackstopInput) -> Result<()> {
        self.open_insurance_fund_resolution(input)
    }

    pub fn activate_liquidation_backstop(
        &mut self,
        input: ActivateLiquidationBackstopInput,
    ) -> Result<()> {
        self.open_insurance_fund_resolution(input)
    }

    pub fn calculate_reserve_haircut(
        &self,
        claim_notional_micros: u128,
        collateral_value_micros: u128,
        reserve_available_micros: u128,
    ) -> u128 {
        reserve_haircut(
            claim_notional_micros,
            collateral_value_micros,
            reserve_available_micros,
            self.config.socialized_loss_cap_bps,
        )
    }

    pub fn rebalance_reserve(
        &mut self,
        input: RequestInsuranceFundBackstopDrawInput,
    ) -> Result<()> {
        ensure_capacity(
            self.insurance_fund_draws.len(),
            self.config.max_insurance_fund_backstop_draws,
            "insurance_fund draws",
        )?;
        ensure_unique(
            &self.insurance_fund_draws,
            "insurance_fund draw",
            &input.draw_id,
        )?;
        let case = self
        ...
        if case.pool_id != input.pool_id {
            return Err(
                "insurance_fund draw pool does not match insurance_fund resolution".to_string(),
            );
        }
        let pool = self
            .pools
        ...
        if requested > pool.insurance_fund_remaining_micros {
            return Err(
                "insurance_fund draw exceeds remaining insurance_fund capacity".to_string(),
            );
        }
        pool.insurance_fund_remaining_micros = pool
            .insurance_fund_remaining_micros
        ...
        pool.updated_at_height = input.height;
        let draw = InsuranceFundBackstopDraw {
            draw_id: input.draw_id,
            pool_id: input.pool_id,
            case_id: input.case_id,
            status: InsuranceFundBackstopDrawStatus::Requested,
        ...
        self.counters.insurance_fund_draws_requested = self
            .counters
            .insurance_fund_draws_requested
            .saturating_add(1);
        self.insurance_fund_draws.insert(draw.draw_id.clone(), draw);
        self.refresh_roots();
        Ok(())
    }

    pub fn account_reserve_backstop(
        &mut self,
        input: ReserveBackstopAccountingInput,
    ) -> Result<()> {
        self.rebalance_reserve(input)
    }
    ...
    pub fn allocate_socialized_loss(&mut self, input: AllocateSocializedLossInput) -> Result<()> {
        ...
        if !pool.status.can_resolve() {
            return Err("pool is not in a insurance_fund resolution state".to_string());
        }
        ...
        for case_id in &input.case_ids {
            if let Some(case) = self.insurance_fund_resolutions.get_mut(case_id) {
        ...
        let epoch = SocializedBackstopLossEpoch {
            loss_epoch_id: input.loss_epoch_id,
            pool_id: input.pool_id,
            status: BackstopLossEpochStatus::Open,
            case_ids_root,
    ...
    pub fn prove_slo_breach(&mut self, input: ProveSloBreachInput) -> Result<()> {
        self.allocate_socialized_loss(input)
    }

    pub fn attest_insurance_fund_resolution(
        &mut self,
        input: PqInsuranceFundBackstopAttestationInput,
    ) -> Result<()> {
        ensure_capacity(
        ...
        let attestation = PqInsuranceFundBackstopAttestation {
    ...
    pub fn record_pq_attestation(
        &mut self,
        input: RecordPqInsuranceFundBackstopAttestationInput,
    ) -> Result<()> {
        self.attest_insurance_fund_resolution(input)
    }

    pub fn apply_insurance_fund_draw(&mut self, draw_id: &str, height: u64) -> Result<()> {
        let draw = self
            .insurance_fund_draws
            .get_mut(draw_id)
            .ok_or_else(|| format!("insurance_fund draw `{draw_id}` not found"))?;
        if draw.status != InsuranceFundBackstopDrawStatus::Attested {
            return Err("insurance_fund draw must be PQ-attested before application".to_string());
        }
        draw.status = InsuranceFundBackstopDrawStatus::Applied;
        draw.applied_micros = draw.requested_micros;
        draw.height = height;
        self.counters.insurance_fund_draws_applied =
            self.counters.insurance_fund_draws_applied.saturating_add(1);
        self.counters.total_insurance_fund_draw_micros = self
            .counters
            .total_insurance_fund_draw_micros
    ...
    pub fn apply_socialized_loss(&mut self, loss_epoch_id: &str, height: u64) -> Result<()> {
        ...
        if epoch.status != BackstopLossEpochStatus::Attested {
            return Err("socialized loss epoch must be PQ-attested before application".to_string());
        }
        epoch.status = BackstopLossEpochStatus::Applied;
        epoch.height = height;
    ...
    pub fn settle_case(&mut self, case_id: &str, height: u64, epoch: u64) -> Result<()> {
        ...
        for claim in self
            .claims
            .values_mut()
            .filter(|claim| claim.insurance_fund_resolution_id.as_deref() == Some(case_id))
        {
    ...
    pub fn settle_liquidation(&mut self, case_id: &str, height: u64, epoch: u64) -> Result<()> {
        self.settle_case(case_id, height, epoch)
    }

    pub fn low_fee_liquidation_settlement(
        &mut self,
        case_id: &str,
        height: u64,
        epoch: u64,
    ...
    pub fn settle_liquidation_auction(&mut self, input: AuctionSettlementInput) -> Result<()> {
        ensure_unique(
            &self.auction_settlements,
            "auction settlement",
            &input.settlement_id,
        )?;
        ensure_non_empty("distribution_root", &input.distribution_root)?;
        ensure_non_empty("rebate_root", &input.rebate_root)?;
        ensure_non_empty("fee_root", &input.fee_root)?;
        if input.winning_bid_ids.is_empty() {
            return Err("auction settlement requires at least one winning bid".to_string());
        }
        let case = self
            .insurance_fund_resolutions
            .get(&input.case_id)
            .ok_or_else(|| format!("case `{}` not found", input.case_id))?;
        let mut scored_recovery = 0_u128;
        for bid_id in &input.winning_bid_ids {
            let bid = self
                .liquidation_bids
                .get_mut(bid_id)
                .ok_or_else(|| format!("auction bid `{bid_id}` not found"))?;
            if bid.case_id != input.case_id {
                return Err(format!("auction bid `{bid_id}` belongs to another case"));
            }
            if !bid.accepted {
                return Err(format!("auction bid `{bid_id}` was not accepted"));
            }
            scored_recovery = scored_recovery.saturating_add(u128::from(bid.bid_amount_micros));
            bid.accepted = false;
        }
        if u128::from(input.recovery_micros) > scored_recovery.min(case.deficit_micros) {
            return Err("auction settlement recovery exceeds sealed winning capacity".to_string());
        }
        if input.fee_micros > bankruptcy_fee(u128::from(input.recovery_micros), 0, &self.config) {
            return Err("auction settlement fee exceeds low-fee policy".to_string());
        }
        let winning_bids_root = merkle_string_root(D_AUCTION_BIDS, &input.winning_bid_ids);
        let receipt = AuctionSettlementReceipt {
            settlement_id: input.settlement_id,
            case_id: input.case_id.clone(),
            winning_bids_root,
            distribution_root: input.distribution_root,
            rebate_root: input.rebate_root,
            fee_root: input.fee_root,
            recovery_micros: input.recovery_micros,
            rebate_micros: input.rebate_micros,
            fee_micros: input.fee_micros,
            height: input.height,
            epoch: input.epoch,
        };
        self.counters.liquidation_auctions_settled =
            self.counters.liquidation_auctions_settled.saturating_add(1);
        self.counters.total_bid_recovery_micros = self
            .counters
            .total_bid_recovery_micros
            .saturating_add(u128::from(receipt.recovery_micros));
        self.counters.total_rebate_micros = self
            .counters
            .total_rebate_micros
            .saturating_add(u128::from(receipt.rebate_micros));
        self.counters.total_fee_micros = self
            .counters
            .total_fee_micros
            .saturating_add(u128::from(receipt.fee_micros));
        self.auction_settlements
            .insert(receipt.settlement_id.clone(), receipt);
        self.settle_case(&input.case_id, input.height, input.epoch)
    }

    pub fn auction_settlement(&mut self, input: AuctionSettlementInput) -> Result<()> {
        self.settle_liquidation_auction(input)
    }
    ...
    pub fn account_rebate(&mut self, input: RebateAccountingInput) -> Result<()> {
        self.record_replay_receipt(input)
    }

    pub fn quarantine(&mut self, pool_id: &str, height: u64) -> Result<()> {
        let pool = self
            .pools
            .get_mut(pool_id)
    ...
    pub fn refresh_roots(&mut self) {
        ...
        self.roots.insurance_fund_resolutions_root =
            map_root(D_CASES, &self.insurance_fund_resolutions);
        self.roots.socialized_loss_epochs_root =
            map_root(D_LOSS_EPOCHS, &self.socialized_loss_epochs);
        self.roots.insurance_fund_draws_root =
            map_root(D_INSURANCE_FUND_BACKSTOP_DRAWS, &self.insurance_fund_draws);
        self.roots.liquidation_bids_root = map_root(D_AUCTION_BIDS, &self.liquidation_bids);
        self.roots.auction_settlements_root =
            map_root(D_AUCTION_SETTLEMENTS, &self.auction_settlements);
        ...
        self.roots.state_root = domain_hash(
            ...
            &[
                ...
                HashPart::Str(self.roots.insurance_fund_resolutions_root.as_str()),
                HashPart::Str(self.roots.socialized_loss_epochs_root.as_str()),
                HashPart::Str(self.roots.insurance_fund_draws_root.as_str()),
                HashPart::Str(self.roots.liquidation_bids_root.as_str()),
                HashPart::Str(self.roots.auction_settlements_root.as_str()),
    ...
    pub fn public_record(&self) -> Value {
        self.roots_only_record().public_record()
    }

    pub fn public_record_at(&mut self, height: u64, epoch: u64) -> Result<PublicRecord> {
        self.config.validate()?;
        self.counters.last_height = height;
        self.counters.last_epoch = epoch;
        self.refresh_roots();
    ...
    fn roots_only_record(&self) -> PublicRecord {
        PublicRecord {
            ...
            insurance_fund_resolutions_root: self.roots.insurance_fund_resolutions_root.clone(),
            socialized_loss_epochs_root: self.roots.socialized_loss_epochs_root.clone(),
            insurance_fund_draws_root: self.roots.insurance_fund_draws_root.clone(),
            liquidation_bids_root: self.roots.liquidation_bids_root.clone(),
            auction_settlements_root: self.roots.auction_settlements_root.clone(),
    ...
    fn mark_subject_attested(&mut self, subject_id: &str) {
        if let Some(case) = self.insurance_fund_resolutions.get_mut(subject_id) {
        ...
        if let Some(epoch) = self.socialized_loss_epochs.get_mut(subject_id) {
            epoch.status = BackstopLossEpochStatus::Attested;
            epoch.attestation_count = epoch.attestation_count.saturating_add(1);
        }
        if let Some(draw) = self.insurance_fund_draws.get_mut(subject_id) {
            draw.status = InsuranceFundBackstopDrawStatus::Attested;
            draw.attestation_count = draw.attestation_count.saturating_add(1);
        }
    }

    fn update_peak_score_confidential_claims(&mut self) {
        let score_confidential_claims = self
            .pools
            .values()
            .map(|pool| pool.score_confidential_claims_micros)
            .sum::<u128>();
        self.counters.peak_score_confidential_claims_micros = self
            .counters
            .peak_score_confidential_claims_micros
            .max(score_confidential_claims);
    }
}
...
pub fn devnet() -> State {
    ...
    state
        .fund_intake(RegisterInsuranceFundBackstopPoolInput {
            pool_id: pool_id.clone(),
            derivative_class: DerivativeClass::BankruptcyInsuranceFundBackstop,
            bankruptcy_mode: InsuranceFundBackstopMode::SocializedLoss,
            maker_commitment_root: devnet_commitment("maker", 0),
            insurance_vault_root: devnet_commitment("insurance-vault", 0),
            insurance_fund_vault_root: devnet_commitment("insurance_fund-vault", 0),
            ...
            max_latency_ms: DEFAULT_MAX_LATENCY_MS,
            score_confidential_claim_limit_micros: 5_000_000_000,
            insurance_capacity_micros: 1_000_000,
            insurance_fund_capacity_micros: 500_000,
            created_at_height: DEVNET_HEIGHT,
        })
        .expect("devnet insurance_fund pool must register");
    state
        .score_confidential_claim(OpenInsuranceFundBackstopClaimInput {
    ...
    state
        .open_insurance_fund_resolution(OpenInsuranceFundResolutionInput {
            case_id: "devnet-insurance_fund-resolution-0".to_string(),
            pool_id: pool_id.clone(),
            claim_ids: vec![
        ...
        .expect("devnet insurance_fund resolution must open");
    state
        .attest_insurance_fund_resolution(PqInsuranceFundBackstopAttestationInput {
            attestation_id: "devnet-insurance_fund-resolution-attestation-0".to_string(),
            subject_id: "devnet-insurance_fund-resolution-0".to_string(),
    ...
    state
        .allocate_socialized_loss(AllocateSocializedLossInput {
            ...
            pool_id,
            case_ids: vec!["devnet-insurance_fund-resolution-0".to_string()],
    ...
    state
        .attest_insurance_fund_resolution(PqInsuranceFundBackstopAttestationInput {
            attestation_id: "devnet-insurance_fund-loss-attestation-0".to_string(),
    ...
    state
        .liquidation_auction_intake(LiquidationAuctionBidInput {
            bid_id: "devnet-liquidation-auction-bid-0".to_string(),
            case_id: "devnet-insurance_fund-resolution-0".to_string(),
            pool_id: pool_id.clone(),
            bidder_commitment_root: devnet_commitment("auction-bidder", 0),
            sealed_bid_root: devnet_commitment("sealed-bid", 0),
            payment_commitment_root: devnet_commitment("bid-payment", 0),
            inventory_commitment_root: devnet_commitment("bid-inventory", 0),
            pq_attestation_root: devnet_commitment("bid-pq", 0),
            nullifier_root: devnet_commitment("bid-nullifier", 0),
            bid_amount_micros: 44_000,
            reserve_price_micros: 40_000,
            max_fee_micros: 12,
            latency_ms: 18,
            fill_bps: 9_500,
            rebate_bps: 120,
            opened_slot: DEVNET_EPOCH + 2,
            expires_slot: DEVNET_EPOCH + 8,
            created_at_height: DEVNET_HEIGHT + 6,
        })
        .expect("devnet liquidation auction bid must intake");
    state
        .settle_liquidation_auction(AuctionSettlementInput {
            settlement_id: "devnet-liquidation-auction-settlement-0".to_string(),
            case_id: "devnet-insurance_fund-resolution-0".to_string(),
            winning_bid_ids: vec!["devnet-liquidation-auction-bid-0".to_string()],
            distribution_root: devnet_commitment("auction-distribution", 0),
            rebate_root: devnet_commitment("auction-rebate", 0),
            fee_root: devnet_commitment("auction-fee", 0),
            recovery_micros: 44_000,
            rebate_micros: 528,
            fee_micros: 79,
            height: DEVNET_HEIGHT + 7,
            epoch: DEVNET_EPOCH + 3,
        })
        .expect("devnet liquidation auction must settle");
    state.refresh_roots();
    state
}
...
pub fn public_record(state: &mut State, height: u64, epoch: u64) -> Result<PublicRecord> {
    state.public_record_at(height, epoch)
}
...
fn bankruptcy_fee(gross: u128, deficit: u128, config: &Config) -> u64 {
    let fee_bps = config
        ...
        .saturating_sub(
            config
                .insurance_fund_backstop_discount_bps
                .min(config.taker_fee_bps),
        )
        .saturating_add(config.insurance_fund_backstop_fee_bps)
...
fn sealed_bid_score(
    bid_amount_micros: u128,
    reserve_price_micros: u128,
    latency_ms: u64,
    fill_bps: u64,
    rebate_bps: u64,
    config: &Config,
) -> u128 {
    if bid_amount_micros < reserve_price_micros || latency_ms > config.max_latency_ms {
        return 0;
    }
    let premium = bid_amount_micros.saturating_sub(reserve_price_micros);
    let fill_weight = u128::from(fill_bps.min(MAX_BPS)).saturating_add(1);
    let rebate_weight =
        u128::from(MAX_BPS.saturating_sub(rebate_bps.min(MAX_BPS))).saturating_add(1);
    let latency_weight =
        u128::from(config.max_latency_ms.saturating_sub(latency_ms)).saturating_add(1);
    bid_amount_micros
        .saturating_add(premium.saturating_mul(2))
        .saturating_mul(fill_weight)
        .saturating_mul(rebate_weight)
        .saturating_mul(latency_weight)
        .saturating_div(u128::from(MAX_BPS))
}
...
fn reserve_haircut(
    ...
    let deficit = claim_notional_micros.saturating_sub(collateral_value_micros);
    let uncovered = deficit.saturating_sub(reserve_available_micros);
    let cap = claim_notional_micros
        .saturating_mul(u128::from(max_haircut_bps.min(MAX_BPS)))
        .saturating_div(u128::from(MAX_BPS));
    uncovered.min(cap)
}
