...
pub type PrivateL2PqContractUpgradeFeeMarketRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-contract-upgrade-fee-market-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PROTOCOL_VERSION;
pub const CHAIN_ID: &str = "nebula-l2-devnet";
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_SCHEMA_VERSION: u64 = 1;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_HASH_SUITE: &str =
    "SHAKE256-domain-separated-canonical-json";
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PQ_GOVERNANCE_SUITE: &str =
    "ML-KEM-1024+ML-DSA-87+SLH-DSA-SHAKE-256f-contract-upgrade-governance-v1";
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PROPOSAL_SCHEME: &str =
    "shielded-contract-upgrade-proposal-root-v1";
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_REVIEW_COMMITTEE_SCHEME: &str =
    "pq-upgrade-reviewer-committee-root-v1";
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PRIVATE_VOTE_SCHEME: &str =
    "private-upgrade-vote-attestation-root-v1";
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_UPGRADE_FEE_AUCTION_SCHEME: &str =
    "private-upgrade-fee-auction-reservation-v1";
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_EXECUTION_BATCH_SCHEME: &str =
    "fee-market-contract-upgrade-execution-batch-v1";
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_ROLLBACK_SCHEME: &str =
    "contract-upgrade-rollback-receipt-root-v1";
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_EMERGENCY_PAUSE_SCHEME: &str =
    "fast-emergency-contract-upgrade-pause-receipt-root-v1";
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEVNET_HEIGHT: u64 = 760_000;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_MAX_BPS: u64 = 10_000;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_CONTRACTS: usize = 262_144;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_PROPOSALS: usize =
    1_048_576;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_COMMITTEES: usize = 131_072;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_REVIEWS: usize = 2_097_152;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_VOTES: usize = 8_388_608;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_RESERVATIONS: usize =
    1_048_576;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_BATCHES: usize = 262_144;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_RECEIPTS: usize = 2_097_152;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_BATCH_PROPOSALS: usize =
    4_096;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MIN_PRIVACY_SET_SIZE: u64 =
    4_096;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_BATCH_PRIVACY_SET_SIZE: u64 =
    65_536;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_EMERGENCY_PRIVACY_SET_SIZE:
    u64 = 1_024;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MIN_PQ_SECURITY_BITS: u16 = 256;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MIN_REVIEWER_COUNT: u16 = 5;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MIN_REVIEW_QUORUM_WEIGHT_BPS:
    u64 = 6_700;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MIN_APPROVAL_WEIGHT_BPS: u64 =
    6_700;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_FAST_GUARD_WEIGHT_BPS: u64 =
    8_000;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MIN_TIMELOCK_BLOCKS: u64 = 720;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_TIMELOCK_BLOCKS: u64 =
    86_400;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_EMERGENCY_DELAY_BLOCKS: u64 =
    12;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_PROPOSAL_TTL_BLOCKS: u64 =
    14_400;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_VOTE_TTL_BLOCKS: u64 = 7_200;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_RESERVATION_TTL_BLOCKS: u64 =
    96;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_BATCH_TTL_BLOCKS: u64 = 48;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_ROLLBACK_WINDOW_BLOCKS: u64 =
    14_400;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_EXECUTION_FEE_BPS: u64 = 15;
pub const PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_SPONSOR_COVERAGE_BPS: u64 =
    9_000;
...
impl Config {
    pub fn devnet() -> Self {
        Self {
            protocol_version: PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PROTOCOL_VERSION
                .to_string(),
            schema_version: PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_SCHEMA_VERSION,
            chain_id: CHAIN_ID.to_string(),
            hash_suite: PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_HASH_SUITE.to_string(),
            pq_governance_suite:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PQ_GOVERNANCE_SUITE.to_string(),
            proposal_scheme: PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PROPOSAL_SCHEME
                .to_string(),
            review_committee_scheme:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_REVIEW_COMMITTEE_SCHEME.to_string(),
            private_vote_scheme:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PRIVATE_VOTE_SCHEME.to_string(),
            low_fee_reservation_scheme:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_UPGRADE_FEE_AUCTION_SCHEME
                    .to_string(),
            execution_batch_scheme:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_EXECUTION_BATCH_SCHEME.to_string(),
            rollback_scheme: PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_ROLLBACK_SCHEME
                .to_string(),
            emergency_pause_scheme:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_EMERGENCY_PAUSE_SCHEME.to_string(),
            devnet_height: PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEVNET_HEIGHT,
            max_contracts: PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_CONTRACTS,
            max_proposals: PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_PROPOSALS,
            max_committees: PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_COMMITTEES,
            max_reviews: PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_REVIEWS,
            max_votes: PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_VOTES,
            max_reservations:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_RESERVATIONS,
            max_batches: PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_BATCHES,
            max_receipts: PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_RECEIPTS,
            max_batch_proposals:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_BATCH_PROPOSALS,
            min_privacy_set_size:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MIN_PRIVACY_SET_SIZE,
            batch_privacy_set_size:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_BATCH_PRIVACY_SET_SIZE,
            emergency_privacy_set_size:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_EMERGENCY_PRIVACY_SET_SIZE,
            min_pq_security_bits:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MIN_PQ_SECURITY_BITS,
            min_reviewer_count:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MIN_REVIEWER_COUNT,
            min_review_quorum_weight_bps:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MIN_REVIEW_QUORUM_WEIGHT_BPS,
            min_approval_weight_bps:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MIN_APPROVAL_WEIGHT_BPS,
            fast_guard_weight_bps:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_FAST_GUARD_WEIGHT_BPS,
            min_timelock_blocks:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MIN_TIMELOCK_BLOCKS,
            max_timelock_blocks:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_TIMELOCK_BLOCKS,
            emergency_delay_blocks:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_EMERGENCY_DELAY_BLOCKS,
            proposal_ttl_blocks:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_PROPOSAL_TTL_BLOCKS,
            vote_ttl_blocks:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_VOTE_TTL_BLOCKS,
            reservation_ttl_blocks:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_RESERVATION_TTL_BLOCKS,
            batch_ttl_blocks:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_BATCH_TTL_BLOCKS,
            rollback_window_blocks:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_ROLLBACK_WINDOW_BLOCKS,
            max_execution_fee_bps:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_MAX_EXECUTION_FEE_BPS,
            sponsor_coverage_bps:
                PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_DEFAULT_SPONSOR_COVERAGE_BPS,
    ...
    pub fn validate(&self) -> PrivateL2PqContractUpgradeFeeMarketRuntimeResult<()> {
        ...
        if self.chain_id != CHAIN_ID {
            return Err("contract upgrade fee market config chain_id mismatch".to_string());
        }
        if self.schema_version == 0 {
            return Err("contract upgrade fee market schema version must be positive".to_string());
        }
        ...
        {
            return Err(
                "contract upgrade fee market privacy set configuration invalid".to_string(),
            );
        }
        if self.min_pq_security_bits < 128 {
            return Err("contract upgrade fee market PQ security floor too low".to_string());
        }
        if self.min_reviewer_count == 0 {
            return Err("contract upgrade fee market reviewer count must be positive".to_string());
        }
        if self.min_review_quorum_weight_bps
            > PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_MAX_BPS
            || self.min_approval_weight_bps
                > PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_MAX_BPS
            || self.fast_guard_weight_bps
                > PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_MAX_BPS
            || self.max_execution_fee_bps
                > PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_MAX_BPS
            || self.sponsor_coverage_bps > PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_MAX_BPS
        {
            return Err("contract upgrade fee market bps configuration invalid".to_string());
        }
        if self.min_timelock_blocks == 0 || self.max_timelock_blocks < self.min_timelock_blocks {
            return Err("contract upgrade fee market delay configuration invalid".to_string());
        }
...
impl State {
    pub fn devnet() -> PrivateL2PqContractUpgradeFeeMarketRuntimeResult<Self> {
        Self::new(Config::devnet())
    }

    pub fn new(config: Config) -> PrivateL2PqContractUpgradeFeeMarketRuntimeResult<Self> {
        config.validate()?;
        Ok(Self {
            config,
    ...
    pub fn register_contract(
    ...
    ) -> PrivateL2PqContractUpgradeFeeMarketRuntimeResult<UpgradeableContractRecord> {
        ...
        let contract_root = root_from_record(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-CONTRACT",
    ...
    pub fn submit_shielded_upgrade_proposal(
    ...
    ) -> PrivateL2PqContractUpgradeFeeMarketRuntimeResult<UpgradeProposalRecord> {
        ...
        let proposal_root = root_from_record(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-PROPOSAL",
            &request.public_record(),
        );
    ...
    pub fn register_reviewer_committee(
    ...
    ) -> PrivateL2PqContractUpgradeFeeMarketRuntimeResult<ReviewerCommitteeRecord> {
        ...
        let committee_root = root_from_record(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-COMMITTEE",
            &request.public_record(),
        );
    ...
    pub fn submit_review_attestation(
    ...
    ) -> PrivateL2PqContractUpgradeFeeMarketRuntimeResult<ReviewAttestationRecord> {
        ...
        let review_root = root_from_record(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-REVIEW",
            &request.public_record(),
        );
            ...
            proposal.status = match request.verdict {
                ReviewVerdict::Approve => {
                    proposal.review_weight_bps = proposal
                        ...
                        .min(PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_MAX_BPS);
    ...
    pub fn submit_private_upgrade_vote(
    ...
    ) -> PrivateL2PqContractUpgradeFeeMarketRuntimeResult<PrivateUpgradeVoteRecord> {
        ...
        let vote_root = root_from_record(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-VOTE",
            &request.public_record(),
        );
    ...
    pub fn reserve_low_fee_execution(
    ...
    ) -> PrivateL2PqContractUpgradeFeeMarketRuntimeResult<LowFeeExecutionReservationRecord> {
        ...
        let reservation_root = root_from_record(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-RESERVATION",
            &request.public_record(),
        );
    ...
    pub fn build_timelock_execution_batch(
    ...
    ) -> PrivateL2PqContractUpgradeFeeMarketRuntimeResult<TimelockExecutionBatchRecord> {
        ...
        let batch_root = root_from_record(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-BATCH",
            &request.public_record(),
        );
        for proposal_id in &request.proposal_ids {
    ...
    pub fn publish_rollback_receipt(
    ...
    ) -> PrivateL2PqContractUpgradeFeeMarketRuntimeResult<RollbackReceiptRecord> {
        ...
        let rollback_root = root_from_record(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-ROLLBACK",
            &request.public_record(),
        );
    ...
    pub fn publish_emergency_pause_receipt(
    ...
    ) -> PrivateL2PqContractUpgradeFeeMarketRuntimeResult<EmergencyPauseReceiptRecord> {
        ...
        let pause_root = root_from_record(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-EMERGENCY-PAUSE",
            &request.public_record(),
        );
    ...
    pub fn roots(&self) -> Roots {
        let contract_root = public_record_root(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-CONTRACTS",
            &self
                .contracts
                .values()
        ...
        let proposal_root = public_record_root(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-PROPOSALS",
            &self
                .proposals
                .values()
        ...
        let committee_root = public_record_root(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-COMMITTEES",
            &self
                .committees
                .values()
        ...
        let review_root = public_record_root(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-REVIEWS",
            &self
                .reviews
                .values()
        ...
        let vote_root = public_record_root(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-VOTES",
            &self
                .votes
                .values()
        ...
        let reservation_root = public_record_root(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-RESERVATIONS",
            &self
                .reservations
                .values()
        ...
        let batch_root = public_record_root(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-BATCHES",
            &self
                .batches
                .values()
        ...
        let rollback_root = public_record_root(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-ROLLBACKS",
            &self
                .rollbacks
                .values()
        ...
        let emergency_pause_root = public_record_root(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-EMERGENCY-PAUSES",
            &self
                .emergency_pauses
                .values()
        ...
        let nullifier_root = public_record_root(
            "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-NULLIFIERS",
            &self
                .consumed_nullifiers
                .iter()
    ...
    fn ensure_capacity(
        ...
        len: usize,
        max: usize,
    ) -> PrivateL2PqContractUpgradeFeeMarketRuntimeResult<()> {
        if len >= max {
            Err(format!(
                "contract upgrade fee market {label} capacity exhausted"
            ))
        } else {
            Ok(())
        }
    ...
    fn ensure_unused_nullifier(
        ...
        if self.consumed_nullifiers.contains(nullifier) {
            Err("contract upgrade fee market nullifier replay detected".to_string())
        } else {
            Ok(())
        }
    }
...
pub fn upgradeable_contract_id(
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-CONTRACT-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PROTOCOL_VERSION),
...
pub fn shielded_upgrade_proposal_id(
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-PROPOSAL-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PROTOCOL_VERSION),
            HashPart::Int(sequence as i128),
...
pub fn reviewer_committee_id(request: &RegisterReviewerCommitteeRequest, sequence: u64) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-COMMITTEE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PROTOCOL_VERSION),
            HashPart::Int(sequence as i128),
...
pub fn review_attestation_id(request: &SubmitReviewAttestationRequest, sequence: u64) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-REVIEW-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PROTOCOL_VERSION),
            HashPart::Int(sequence as i128),
...
pub fn private_upgrade_vote_id(request: &SubmitPrivateUpgradeVoteRequest, sequence: u64) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-VOTE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PROTOCOL_VERSION),
            HashPart::Int(sequence as i128),
...
pub fn low_fee_execution_reservation_id(
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-RESERVATION-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PROTOCOL_VERSION),
            HashPart::Int(sequence as i128),
...
pub fn timelock_execution_batch_id(
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-BATCH-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PROTOCOL_VERSION),
            HashPart::Int(sequence as i128),
...
pub fn rollback_receipt_id(request: &PublishRollbackReceiptRequest, sequence: u64) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-ROLLBACK-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PROTOCOL_VERSION),
            HashPart::Int(sequence as i128),
...
pub fn emergency_pause_receipt_id(
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-EMERGENCY-PAUSE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_PROTOCOL_VERSION),
            HashPart::Int(sequence as i128),
...
pub fn state_root_from_record(record: &Value) -> String {
    root_from_record("PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-STATE", record)
}

pub fn devnet() -> PrivateL2PqContractUpgradeFeeMarketRuntimeResult<State> {
    State::devnet()
}

fn id_list_root(domain: &str, ids: &[String]) -> String {
    public_record_root(
        &format!("PRIVATE-L2-PQ-CONTRACT-UPGRADE-FEE-MARKET-ID-LIST-{domain}"),
...
fn validate_committee(
    ...
    if request.min_weight_bps < config.min_review_quorum_weight_bps
        || request.min_weight_bps > PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_MAX_BPS
    {
...
fn validate_review(
    ...
    if request.reviewer_weight_bps == 0
        || request.reviewer_weight_bps > PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_MAX_BPS
    {
...
fn validate_vote(
    ...
    if request.voting_power_bps > PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_MAX_BPS {
...
fn validate_reservation(
    ...
    if request.sponsor_coverage_bps < config.sponsor_coverage_bps
        || request.sponsor_coverage_bps > PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_MAX_BPS
    {
...
fn validate_emergency_pause(
    ...
    if request.fast_guard_weight_bps < config.fast_guard_weight_bps
        || request.fast_guard_weight_bps > PRIVATE_L2_PQ_CONTRACT_UPGRADE_FEE_MARKET_RUNTIME_MAX_BPS
    {
...
fn validate_privacy_and_pq(
    ...
    if privacy_set_size < min_privacy_set_size {
        return Err("contract upgrade fee market privacy set below minimum".to_string());
    }
    if pq_security_bits < min_pq_security_bits {
        return Err("contract upgrade fee market PQ security bits below minimum".to_string());
    }
    Ok(())
}
...
fn ensure_non_empty(
    ...
    if value.trim().is_empty() {
        Err(format!(
            "contract upgrade fee market field {field} is required"
        ))
    } else {
        Ok(())
    }
...
fn ensure_root(field: &str, value: &str) -> PrivateL2PqContractUpgradeFeeMarketRuntimeResult<()> {
    ensure_non_empty(field, value)?;
    if value.len() < 16 {
        return Err(format!(
            "contract upgrade fee market field {field} must look like a commitment root"
        ));
    }
    Ok(())
}
...
fn ensure_positive(
    ...
    if value == 0 {
        Err(format!(
            "contract upgrade fee market {field} must be positive"
        ))
    } else {
        Ok(())
    }
...
fn ensure_non_empty_vec(
    ...
    if values.is_empty() {
        return Err(format!(
            "contract upgrade fee market {field} cannot be empty"
        ));
    }
    for value in values {
