...
pub const MONERO_L2_PQ_PRIVATE_VIEWKEY_AUDIT_BRIDGE_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-monero-l2-pq-private-viewkey-audit-bridge-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    MONERO_L2_PQ_PRIVATE_VIEWKEY_AUDIT_BRIDGE_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const DEVNET_L2_NETWORK: &str = "nebula-devnet";
pub const DEVNET_MONERO_NETWORK: &str = "monero-devnet";
pub const DEVNET_BRIDGE_ID: &str = "monero-l2-pq-private-viewkey-audit-bridge-devnet";
...
pub const PQ_AUDIT_SUITE: &str =
    "ML-KEM-1024+ML-DSA-87+SLH-DSA-SHAKE-256f-private-viewkey-audit-v1";
pub const VIEWKEY_POLICY_SCHEME: &str = "selective-monero-viewkey-audit-policy-root-v1";
...
pub const AUDIT_RECEIPT_SCHEME: &str = "private-viewkey-audit-receipt-root-v1";
pub const LOW_FEE_REBATE_SCHEME: &str = "viewkey-audit-low-fee-rebate-root-v1";
pub const AUDITOR_SLASHING_SCHEME: &str = "viewkey-audit-auditor-slashing-root-v1";
pub const REPLAY_DOMAIN: &str = "nebula-monero-l2-pq-private-viewkey-audit-bridge-devnet";
...
impl State {
    ...
    pub fn state_root(&self) -> String {
        ...
        domain_hash(
            "MONERO-L2-PQ-PRIVATE-VIEWKEY-AUDIT-BRIDGE-STATE",
            &[
