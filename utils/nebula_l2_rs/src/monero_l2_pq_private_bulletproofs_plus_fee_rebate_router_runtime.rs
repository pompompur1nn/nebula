...
pub type MoneroL2PqPrivateBulletproofsPlusFeeRebateRouterRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const MONERO_L2_PQ_PRIVATE_BULLETPROOFS_PLUS_FEE_REBATE_ROUTER_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-monero-l2-pq-private-bulletproofs-plus-fee-rebate-router-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    MONERO_L2_PQ_PRIVATE_BULLETPROOFS_PLUS_FEE_REBATE_ROUTER_RUNTIME_PROTOCOL_VERSION;
...
pub const ROUTER_SCHEME: &str = "monero-bulletproofs-plus-fee-rebate-router-v1";
pub const PROOF_COHORT_SCHEME: &str = "monero-bulletproofs-plus-proof-cohort-root-v1";
pub const AGGREGATION_CREDIT_SCHEME: &str =
    "range-proof-aggregation-credit-confidential-meter-root-v1";
pub const REBATE_INTENT_SCHEME: &str = "private-fee-rebate-intent-root-v1";
pub const PQ_ORACLE_ATTESTATION_SCHEME: &str =
    "ML-DSA-87+SLH-DSA-SHAKE-256f-fee-rebate-oracle-attestation-v1";
pub const SPONSOR_SETTLEMENT_SCHEME: &str = "sponsor-settlement-rebate-netting-root-v1";
pub const ABUSE_THROTTLE_SCHEME: &str = "private-rebate-abuse-throttle-root-v1";
pub const REDACTION_BUDGET_SCHEME: &str =
    "view-key-safe-bulletproofs-plus-fee-rebate-redaction-budget-root-v1";
pub const OPERATOR_SUMMARY_SCHEME: &str =
    "operator-safe-bulletproofs-plus-fee-rebate-summary-root-v1";
...
impl State {
    ...
    fn public_record_without_state_root(&self) -> Value {
        ...
        json!({
            "kind": "monero_l2_pq_private_bulletproofs_plus_fee_rebate_router_runtime",
...
pub fn state_root_from_record(record: &Value) -> String {
    domain_hash("BPP-FEE-REBATE-ROUTER-STATE", &[HashPart::Json(record)], 32)
}

pub fn deterministic_id(domain: &str, parts: &[HashPart<'_>]) -> String {
    domain_hash(&format!("BPP-FEE-REBATE-{domain}"), parts, 32)
}

pub fn value_root(domain: &str, value: &Value) -> String {
    domain_hash(
        &format!("BPP-FEE-REBATE-{domain}"),
        &[HashPart::Json(value)],
        32,
    )
}
...
pub fn empty_root(domain: &str) -> String {
    merkle_root(&format!("BPP-FEE-REBATE-{domain}"), &[])
}

pub fn map_root(domain: &str, records: Vec<Value>) -> String {
    merkle_root(&format!("BPP-FEE-REBATE-{domain}"), &records)
}
