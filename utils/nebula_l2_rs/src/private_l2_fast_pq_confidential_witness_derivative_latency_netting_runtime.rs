...
pub type PrivateL2FastPqConfidentialWitnessDerivativeLatencyNettingRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_FAST_PQ_CONFIDENTIAL_WITNESS_DERIVATIVE_LATENCY_NETTING_RUNTIME_PROTOCOL_VERSION: &str = "nebula-private-l2-fast-pq-confidential-witness-derivative-latency-netting-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_FAST_PQ_CONFIDENTIAL_WITNESS_DERIVATIVE_LATENCY_NETTING_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "shake256-domain-separated-canonical-json-v1";
pub const PQ_NETTING_ATTESTATION_SUITE: &str =
    "ml-dsa-87+slh-dsa-shake-256f-latency-netting-attestation-root-v1";
pub const NETTED_POSITION_SUITE: &str =
    "ml-kem-1024-sealed-defi-derivative-netted-position-root-v1";
pub const PRIVACY_BOUNDARY: &str =
    "roots_only_no_plaintext_witnesses_addresses_keys_margin_terms_or_positions";
pub const PUBLIC_RECORD_SUITE: &str =
    "roots-only-private-l2-fast-pq-confidential-derivative-latency-netting-record-v1";
...
pub const DEFAULT_NETTING_CYCLE_MS: u64 = 25;
...
pub const DEFAULT_NETTING_DISCOUNT_BPS: u64 = 620;
...
const D_CONFIG: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-NET:CONFIG";
const D_COUNTERS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-NET:COUNTERS";
const D_ROOTS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-NET:ROOTS";
const D_STATE: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-NET:STATE";
const D_POOLS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-NET:POOLS";
const D_ORDERS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-NET:ORDERS";
const D_ROUNDS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-NET:ROUNDS";
const D_ATTESTATIONS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-NET:ATTESTATIONS";
const D_RECEIPTS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-NET:RECEIPTS";
const D_PUBLIC: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-NET:PUBLIC";
const D_DEVNET: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-NET:DEVNET";
...
impl OrderStatus {
    pub fn live(self) -> bool {
        matches!(self, Self::Open | Self::Nettable | Self::Netted)
    }
}
...
pub struct Config {
    ...
    pub pq_netting_attestation_suite: String,
    pub netted_position_suite: String,
    pub roots_only_public_records: bool,
    pub min_pq_security_bits: u16,
    pub min_privacy_set_size: u64,
    pub target_privacy_set_size: u64,
    pub netting_cycle_ms: u64,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            pq_netting_attestation_suite: PQ_NETTING_ATTESTATION_SUITE.to_string(),
            netted_position_suite: NETTED_POSITION_SUITE.to_string(),
            roots_only_public_records: true,
            min_pq_security_bits: DEFAULT_MIN_PQ_SECURITY_BITS,
            min_privacy_set_size: DEFAULT_MIN_PRIVACY_SET_SIZE,
            target_privacy_set_size: DEFAULT_TARGET_PRIVACY_SET_SIZE,
            netting_cycle_ms: DEFAULT_NETTING_CYCLE_MS,
...
impl Config {
    pub fn validate(&self) -> Result<()> {
        ...
        ensure_bps("netting_discount_bps", self.netting_discount_bps)?;
        ...
        if self.min_privacy_set_size == 0 || self.netting_cycle_ms == 0 {
            return Err("privacy set and netting cycle must be non-zero".to_string());
        }
        Ok(())
    }
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "pq_netting_attestation_suite": self.pq_netting_attestation_suite,
            "netted_position_suite": self.netted_position_suite,
            "roots_only_public_records": self.roots_only_public_records,
            "min_pq_security_bits": self.min_pq_security_bits,
            "min_privacy_set_size": self.min_privacy_set_size,
            "target_privacy_set_size": self.target_privacy_set_size,
            "netting_cycle_ms": self.netting_cycle_ms,
...
pub struct NettingPool {
    ...
    pub netted_interest_micros: u128,
    pub order_count: u64,
    pub round_count: u64,
    pub created_at_height: u64,
...
impl NettingPool {
    pub fn from_input(input: RegisterPoolInput) -> Self {
        Self {
            ...
            netting_mode: input.netting_mode,
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "netting_mode": self.netting_mode,
            "status": self.status,
            ...
            "netted_interest_micros": self.netted_interest_micros,
        })
    }
}
...
pub struct NettingOrder {
    ...
    pub expires_slot: u64,
    pub created_at_height: u64,
    pub netted_round_id: Option<String>,
}
...
impl NettingOrder {
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "netted_round_id": self.netted_round_id,
        })
    }
}

#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct RunNettingInput {
    pub round_id: String,
    pub pool_id: String,
...
pub struct State {
    ...
    pub roots: Roots,
    pub pools: BTreeMap<String, NettingPool>,
    pub orders: BTreeMap<String, NettingOrder>,
...
impl State {
    ...
    pub fn register_pool(&mut self, input: RegisterPoolInput) -> Result<()> {
        ...
        let pool = NettingPool::from_input(input);
    ...
    pub fn open_order(&mut self, input: OpenOrderInput) -> Result<()> {
        ...
        let order = NettingOrder::from_input(input);
    ...
    pub fn run_netting(&mut self, input: RunNettingInput) -> Result<()> {
        ensure_capacity(
            self.netting_rounds.len(),
            self.config.max_netting_rounds,
            "netting rounds",
        )?;
        ensure_unique(&self.netting_rounds, "netting round", &input.round_id)?;
        let pool = self
            .pools
            .get(&input.pool_id)
            .ok_or_else(|| format!("pool `{}` not found", input.pool_id))?
        ...
        if input.observed_latency_ms > pool.max_latency_ms {
            return Err("netting round exceeds pool latency bound".to_string());
        }
        ...
        let fee_savings_micros =
            fee_savings_for_cross(crossed_notional_micros, self.config.netting_discount_bps);
        let order_ids_root = merkle_string_root(D_ORDERS, &input.order_ids);
        for order_id in &input.order_ids {
            if let Some(order) = self.orders.get_mut(order_id) {
                order.status = OrderStatus::Netted;
                order.netted_round_id = Some(input.round_id.clone());
            }
        }
        if let Some(pool_mut) = self.pools.get_mut(&input.pool_id) {
            pool_mut.netted_interest_micros = pool_mut
                .netted_interest_micros
        ...
        self.counters.orders_netted = self
            .counters
            .orders_netted
        ...
        self.netting_rounds.insert(round.round_id.clone(), round);
        self.refresh_roots();
        Ok(())
    }

    pub fn attest_netting(&mut self, input: PqNettingAttestationInput) -> Result<()> {
        ensure_capacity(
        ...
        let attestation = PqNettingAttestation {
    ...
    pub fn settle_round(&mut self, round_id: &str, height: u64, epoch: u64) -> Result<()> {
        ...
        for order in self
            .orders
            .values_mut()
            .filter(|order| order.netted_round_id.as_deref() == Some(round_id))
        {
    ...
    pub fn refresh_roots(&mut self) {
        ...
        self.roots.netting_rounds_root = map_root(D_ROUNDS, &self.netting_rounds);
        ...
        self.roots.state_root = domain_hash(
            ...
            &[
                ...
                HashPart::from(self.roots.netting_rounds_root.as_str()),
    ...
    fn roots_only_record(&self) -> PublicRecord {
        PublicRecord {
            ...
            netting_rounds_root: self.roots.netting_rounds_root.clone(),
...
pub fn devnet() -> State {
    ...
    let pool_id = "devnet-fast-pq-latency-netting-pool-0".to_string();
    state
        .register_pool(RegisterPoolInput {
            pool_id: pool_id.clone(),
            derivative_class: DerivativeClass::LatencyFuture,
            netting_mode: NettingMode::Continuous,
    ...
    state
        .open_order(OpenOrderInput {
            order_id: "devnet-netting-order-pay-0".to_string(),
            pool_id: pool_id.clone(),
    ...
    state
        .open_order(OpenOrderInput {
            order_id: "devnet-netting-order-receive-0".to_string(),
            pool_id: pool_id.clone(),
    ...
    state
        .run_netting(RunNettingInput {
            round_id: "devnet-netting-round-0".to_string(),
            pool_id,
            order_ids: vec![
                "devnet-netting-order-pay-0".to_string(),
                "devnet-netting-order-receive-0".to_string(),
            ],
    ...
    state
        .attest_netting(PqNettingAttestationInput {
            attestation_id: "devnet-netting-attestation-0".to_string(),
            round_id: "devnet-netting-round-0".to_string(),
...
fn fee_for_net(gross: u128, net: u128, config: &Config) -> u64 {
    let fee_bps = config
        .taker_fee_bps
        .saturating_sub(config.netting_discount_bps.min(config.taker_fee_bps))
