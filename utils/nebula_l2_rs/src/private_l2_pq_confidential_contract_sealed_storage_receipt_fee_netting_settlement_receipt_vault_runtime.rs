...
pub type PrivateL2PqConfidentialContractSealedStorageReceiptFeeNettingSettlementReceiptVaultRuntimeResult<
    T,
> = std::result::Result<T, String>;
pub type Result<T> =
    PrivateL2PqConfidentialContractSealedStorageReceiptFeeNettingSettlementReceiptVaultRuntimeResult<T>;
pub type Runtime = State;

pub const PRIVATE_L2_PQ_CONFIDENTIAL_CONTRACT_SEALED_STORAGE_RECEIPT_FEE_NETTING_SETTLEMENT_RECEIPT_VAULT_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-contract-sealed-storage-receipt-fee-netting-settlement-receipt-vault-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_PQ_CONFIDENTIAL_CONTRACT_SEALED_STORAGE_RECEIPT_FEE_NETTING_SETTLEMENT_RECEIPT_VAULT_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const VAULT_SUITE: &str =
    "pq-confidential-contract-sealed-storage-receipt-fee-netting-settlement-receipt-vault-v1";
pub const ROOTS_ONLY_PUBLIC_RECORD_SUITE: &str =
    "roots-only-confidential-contract-receipt-vault-public-record-v1";
pub const RECEIPT_CUSTODY_SCHEME: &str = "sealed-receipt-private-custody-root-v1";
pub const STORAGE_COMMITMENT_SCHEME: &str = "vault-storage-commitment-root-v1";
pub const CONTRACT_AUTHORIZATION_SCHEME: &str = "pq-contract-authorization-root-v1";
pub const CONTRACT_ATTESTATION_SCHEME: &str = "pq-contract-attestation-root-v1";
pub const VAULT_SEAL_SCHEME: &str = "receipt-vault-seal-root-v1";
pub const NET_SETTLEMENT_SCHEME: &str = "receipt-vault-fee-net-settlement-root-v1";
pub const LOW_FEE_REBATE_SCHEME: &str = "receipt-vault-low-fee-rebate-root-v1";
pub const DISCLOSURE_BUDGET_SCHEME: &str = "receipt-vault-disclosure-budget-root-v1";
pub const QUARANTINE_SCHEME: &str = "receipt-vault-quarantine-root-v1";
pub const NULLIFIER_SCHEME: &str = "receipt-vault-nullifier-root-v1";
pub const PUBLIC_RECORD_ROOT_SCHEME: &str = "receipt-vault-roots-only-public-record-root-v1";
pub const POLICY_ROOT_SCHEME: &str = "receipt-vault-privacy-pq-policy-root-v1";
...
impl Default for Roots {
    fn default() -> Self {
        Self {
            config_root: empty_root("receipt-vault-config-root-v1"),
            counters_root: empty_root("receipt-vault-counters-root-v1"),
...
impl State {
    ...
    fn refresh_roots(&mut self) {
        self.roots.config_root =
            payload_root("receipt-vault-config-root-v1", &self.config.public_record());
        self.roots.counters_root = payload_root(
            "receipt-vault-counters-root-v1",
