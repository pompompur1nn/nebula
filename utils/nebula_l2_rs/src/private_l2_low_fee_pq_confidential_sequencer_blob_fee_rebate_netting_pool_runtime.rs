...
pub type PrivateL2LowFeePqConfidentialSequencerBlobFeeRebateNettingPoolRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_LOW_FEE_PQ_CONFIDENTIAL_SEQUENCER_BLOB_FEE_REBATE_NETTING_POOL_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-low-fee-pq-confidential-sequencer-blob-fee-rebate-netting-pool-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_LOW_FEE_PQ_CONFIDENTIAL_SEQUENCER_BLOB_FEE_REBATE_NETTING_POOL_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const PQ_ENVELOPE_SUITE: &str = "ml-kem-1024+ml-dsa-87-netting-pool-fee-rebate-envelope-v1";
pub const NETTING_POOL_SUITE: &str =
    "private-l2-low-fee-confidential-sequencer-rebate-netting-pool-v1";
pub const BALANCE_COMMITMENT_SUITE: &str = "pedersen+bulletproofs-plus-pool-balance-root-v1";
pub const SETTLEMENT_PROOF_SUITE: &str = "slh-dsa-shake-256f-netting-pool-settlement-proof-root-v1";
pub const FAST_PATH_PROOF_SUITE: &str = "ml-dsa-87-fast-netting-pool-attestation-root-v1";
pub const NULLIFIER_SUITE: &str = "confidential-netting-pool-nullifier-set-v1";
pub const PUBLIC_RECORD_SUITE: &str =
    "roots-only-confidential-sequencer-blob-fee-rebate-netting-pool-record-v1";
pub const PRIVACY_BOUNDARY: &str =
    "roots_only_no_plaintext_accounts_amounts_addresses_view_keys_blob_payloads_or_secret_keys";
pub const DEVNET_L2_NETWORK: &str = "nebula-private-l2-netting-pool-devnet";
pub const DEVNET_POOL_ID: &str = "private-l2-sequencer-blob-fee-rebate-netting-pool-devnet";
pub const DEVNET_OPERATOR_SET_ID: &str = "private-l2-netting-pool-operator-set-devnet";
...
pub const DEFAULT_POOL_EPOCH_BLOCKS: u64 = 720;
...
const D_STATE: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-POOL:STATE";
const D_CONFIG: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-POOL:CONFIG";
const D_COUNTERS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-POOL:COUNTERS";
const D_ROOTS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-POOL:ROOTS";
const D_DEBITS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-POOL:DEBITS";
const D_CREDITS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-POOL:CREDITS";
const D_WINDOWS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-POOL:WINDOWS";
const D_SETTLEMENTS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-POOL:SETTLEMENTS";
const D_BUCKETS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-POOL:BUCKETS";
const D_ATTESTATIONS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-POOL:ATTESTATIONS";
const D_NULLIFIERS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-POOL:NULLIFIERS";
const D_PUBLIC_RECORDS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-POOL:PUBLIC-RECORDS";
...
impl Config {
    pub fn devnet() -> Self {
        Self {
            ...
            pool_id: DEVNET_POOL_ID.to_string(),
            ...
            netting_pool_suite: NETTING_POOL_SUITE.to_string(),
            ...
            pool_epoch_blocks: DEFAULT_POOL_EPOCH_BLOCKS,
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "netting_pool_suite": self.netting_pool_suite,
            ...
            "pool_epoch_blocks": self.pool_epoch_blocks,
...
pub struct State {
    ...
    pub attestations: BTreeMap<String, PqPoolAttestation>,
    pub nullifiers: BTreeSet<String>,
    pub public_records: BTreeMap<String, PoolPublicRecord>,
}
impl State {
    ...
    pub fn post_attestation(&mut self, input: AttestationInput) -> Result<String> {
        ...
        let attestation = PqPoolAttestation {
        ...
        self.emit_public_record("pq_pool_attestation", &id)?;
        self.recompute_roots();
        Ok(id)
    }
    ...
    pub fn advance(&mut self, input: AdvanceInput) -> Result<()> {
        ...
        } else if self.config.pool_epoch_blocks > 0 {
            self.epoch = self.height / self.config.pool_epoch_blocks;
        }
    ...
    fn subject_root(&self, record_kind: &str, subject_id: &str) -> Result<String> {
        match record_kind {
            ...
            "pq_pool_attestation" => self
                .attestations
                .get(subject_id)
                .map(PqPoolAttestation::state_root)
...
pub fn devnet() -> State {
    ...
    let bucket_id = state
        .open_liquidity_bucket(LiquidityBucketInput {
            bucket_id: "devnet-netting-pool-liquidity-bucket-0001".to_string(),
            lane: PoolLane::SequencerBlobFee,
