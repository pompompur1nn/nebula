...
pub type MoneroL2PqPrivateBridgeFeeDerivativesRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-monero-l2-pq-private-bridge-fee-derivatives-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_PROTOCOL_VERSION;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_SCHEMA_VERSION: u64 = 1;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEVNET_HEIGHT: u64 = 631_200;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEVNET_MONERO_NETWORK: &str =
    "monero-devnet";
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEVNET_L2_NETWORK: &str =
    "nebula-devnet";
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEVNET_FEE_ASSET_ID: &str =
    "piconero-devnet";
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEVNET_COLLATERAL_ASSET_ID: &str =
    "dusd-devnet";
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_HASH_SUITE: &str =
    "SHAKE256-domain-separated-canonical-json";
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_PQ_RFQ_SCHEME: &str =
    "ml-kem-1024-sealed-private-bridge-fee-derivative-rfq-v1";
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_PQ_QUOTE_SCHEME: &str =
    "ml-kem-1024+ml-dsa-87-liquidity-provider-fee-derivative-quote-v1";
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_ORACLE_SCHEME: &str =
    "ml-dsa-87+slh-dsa-shake-192f-bridge-fee-oracle-attestation-v1";
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_SETTLEMENT_SCHEME: &str =
    "zk-pq-private-bridge-fee-derivative-settlement-batch-v1";
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_NULLIFIER_SCHEME: &str =
    "monero-l2-pq-private-bridge-fee-derivative-nullifier-root-v1";
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_RECEIPT_SCHEME: &str =
    "private-bridge-fee-derivative-receipt-rebate-root-v1";
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_REPLAY_DOMAIN: &str =
    "monero-l2-pq-private-bridge-fee-derivatives-devnet";
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_BPS: u64 = 10_000;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_RQF_TTL_BLOCKS: u64 = 12;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_QUOTE_TTL_BLOCKS: u64 = 8;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_EXPIRY_BLOCKS: u64 = 720;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_SETTLEMENT_TTL_BLOCKS: u64 =
    36;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_MIN_PRIVACY_SET_SIZE: u64 =
    32_768;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_TARGET_PQ_SECURITY_BITS: u16 =
    256;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_MIN_MARGIN_BPS: u64 = 1_250;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_TARGET_MARGIN_BPS: u64 =
    2_250;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_LP_SPREAD_BPS: u64 = 18;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_OPTION_PREMIUM_BPS: u64 = 35;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_REBATE_BPS: u64 = 8;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_INSTRUMENTS: usize = 262_144;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_POSITIONS: usize = 524_288;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_RFQS: usize = 524_288;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_QUOTES: usize = 1_048_576;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_ATTESTATIONS: usize = 1_048_576;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_SETTLEMENTS: usize = 262_144;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_RESERVATIONS: usize = 524_288;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_RECEIPTS: usize = 524_288;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_REBATES: usize = 524_288;
pub const MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_FENCES: usize = 1_048_576;
...
impl BridgeDirection {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::MarketMakerRefill => "market_maker_refill",
        }
    }
}
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            monero_network:
                MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEVNET_MONERO_NETWORK
                    .to_string(),
            l2_network: MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEVNET_L2_NETWORK
                .to_string(),
            fee_asset_id: MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEVNET_FEE_ASSET_ID
                .to_string(),
            collateral_asset_id:
                MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEVNET_COLLATERAL_ASSET_ID
                    .to_string(),
            hash_suite: MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_HASH_SUITE.to_string(),
            pq_rfq_scheme: MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_PQ_RFQ_SCHEME
                .to_string(),
            pq_quote_scheme: MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_PQ_QUOTE_SCHEME
                .to_string(),
            pq_oracle_scheme: MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_ORACLE_SCHEME
                .to_string(),
            settlement_scheme:
                MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_SETTLEMENT_SCHEME.to_string(),
            receipt_scheme: MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_RECEIPT_SCHEME
                .to_string(),
            nullifier_scheme: MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_NULLIFIER_SCHEME
                .to_string(),
            replay_domain: MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_REPLAY_DOMAIN
                .to_string(),
            default_rfq_ttl_blocks:
                MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_RQF_TTL_BLOCKS,
            default_quote_ttl_blocks:
                MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_QUOTE_TTL_BLOCKS,
            default_expiry_blocks:
                MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_EXPIRY_BLOCKS,
            default_settlement_ttl_blocks:
                MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_SETTLEMENT_TTL_BLOCKS,
            min_privacy_set_size:
                MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_MIN_PRIVACY_SET_SIZE,
            target_pq_security_bits:
                MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_TARGET_PQ_SECURITY_BITS,
            min_margin_bps:
                MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_MIN_MARGIN_BPS,
            target_margin_bps:
                MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_TARGET_MARGIN_BPS,
            default_lp_spread_bps:
                MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_LP_SPREAD_BPS,
            default_option_premium_bps:
                MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_OPTION_PREMIUM_BPS,
            default_rebate_bps:
                MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEFAULT_REBATE_BPS,
        }
    }
}
...
impl Config {
    ...
    pub fn validate(&self) -> MoneroL2PqPrivateBridgeFeeDerivativesRuntimeResult<()> {
...
pub struct FeeDerivativeInstrument {
    ...
    pub notional_bridge_amount_units: u64,
...
impl FeeDerivativeInstrument {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "notional_bridge_amount_units": self.notional_bridge_amount_units,
    ...
    pub fn payload_root(&self) -> String {
        payload_root("BRIDGE-FEE-DERIVATIVE-INSTRUMENT", &self.public_record())
    }

    pub fn validate(
        &self,
        config: &Config,
    ) -> MoneroL2PqPrivateBridgeFeeDerivativesRuntimeResult<String> {
        ...
        require_positive("notional bridge amount", self.notional_bridge_amount_units)?;
...
impl HedgePosition {
    ...
    pub fn validate(&self) -> MoneroL2PqPrivateBridgeFeeDerivativesRuntimeResult<String> {
        ...
        require_positive("position notional", self.notional_bridge_amount_units)?;
...
impl Counters {
    ...
    pub fn counters_root(&self) -> String {
        payload_root("BRIDGE-FEE-DERIVATIVES-COUNTERS", &self.public_record())
    }
}
...
impl Roots {
    ...
    pub fn roots_root(&self) -> String {
        payload_root("BRIDGE-FEE-DERIVATIVES-ROOTS", &self.public_record())
    }
}
...
impl State {
    ...
    pub fn devnet() -> Self {
        ...
        let height = MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_DEVNET_HEIGHT;
        let mut state = Self::empty(config.clone(), height);

        let fee_index_root = string_root("DEVNET-FEE-INDEX", "monero-l2-private-bridge-p50");
        let future_id = bridge_fee_derivative_instrument_id(
            DerivativeKind::FeeFuture,
            BridgeDirection::L2ToMonero,
            &fee_index_root,
            420,
            50_000_000_000,
            height,
        ...
        let option_id = bridge_fee_derivative_instrument_id(
            DerivativeKind::FeeCallOption,
            BridgeDirection::EmergencyExit,
            &fee_index_root,
            680,
            25_000_000_000,
            height,
        ...
        let future = FeeDerivativeInstrument {
            ...
            notional_bridge_amount_units: 50_000_000_000,
        ...
        let option = FeeDerivativeInstrument {
            ...
            direction: BridgeDirection::EmergencyExit,
            status: InstrumentStatus::Trading,
            fee_index_root: fee_index_root.clone(),
            strike_fee_micro_units: 680,
            cap_fee_micro_units: 1_400,
            floor_fee_micro_units: 0,
            notional_bridge_amount_units: 25_000_000_000,
        ...
        let position = HedgePosition {
            ...
            quantity_contracts: 48,
            notional_bridge_amount_units: 48_000_000_000,
    ...
    pub fn counters(&self) -> Counters {
        Counters {
            ...
            total_notional_units: self
                .positions
                .values()
                .map(|position| position.notional_bridge_amount_units as u128)
                .sum(),
    ...
    pub fn roots(&self) -> Roots {
        ...
        Roots {
            config_root: payload_root(
                "BRIDGE-FEE-DERIVATIVES-CONFIG",
                &self.config.public_record(),
            ),
            instrument_root: keyed_record_root(
                "BRIDGE-FEE-DERIVATIVES-INSTRUMENTS",
                self.instruments
                    .iter()
            ...
            position_root: keyed_record_root(
                "BRIDGE-FEE-DERIVATIVES-POSITIONS",
                self.positions
                    .iter()
            ...
            oracle_attestation_root: keyed_record_root(
                "BRIDGE-FEE-DERIVATIVES-ORACLE-ATTESTATIONS",
            ...
            settlement_root: keyed_record_root(
                "BRIDGE-FEE-DERIVATIVES-SETTLEMENTS",
            ...
            sponsor_reservation_root: keyed_record_root(
                "BRIDGE-FEE-DERIVATIVES-SPONSOR-RESERVATIONS",
            ...
            receipt_root: keyed_record_root(
                "BRIDGE-FEE-DERIVATIVES-RECEIPTS",
                self.receipts
                    .iter()
            ...
            rebate_root: keyed_record_root(
                "BRIDGE-FEE-DERIVATIVES-REBATES",
                self.rebates
                    .iter()
            ...
            privacy_fence_root: keyed_record_root(
                "BRIDGE-FEE-DERIVATIVES-PRIVACY-FENCES",
                self.privacy_fences
                    .iter()
            ...
            volatility_metric_root: keyed_record_root(
                "BRIDGE-FEE-DERIVATIVES-VOLATILITY-METRICS",
    ...
    fn public_record_without_root(&self) -> Value {
        ...
        json!({
            ...
            "schema_version": MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_SCHEMA_VERSION,
            "chain_id": CHAIN_ID,
            "height": self.height,
    ...
    pub fn public_record(&self) -> Value {
        with_root_field(
            ...
            "bridge_fee_derivatives_state_root",
            self.state_root(),
        )
    }
    ...
    pub fn validate(&self) -> MoneroL2PqPrivateBridgeFeeDerivativesRuntimeResult<String> {
        ...
        require_len(
            ...
            MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_INSTRUMENTS,
        )?;
        require_len(
            "positions",
            self.positions.len(),
            MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_POSITIONS,
        )?;
        require_len(
            "rfqs",
            self.encrypted_rfqs.len(),
            MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_RFQS,
        )?;
        require_len(
            "quotes",
            self.lp_quotes.len(),
            MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_QUOTES,
        )?;
        require_len(
            "oracle attestations",
            self.oracle_attestations.len(),
            MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_ATTESTATIONS,
        )?;
        require_len(
            "settlements",
            self.settlement_batches.len(),
            MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_SETTLEMENTS,
        )?;
        require_len(
            "sponsor reservations",
            self.sponsor_reservations.len(),
            MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_RESERVATIONS,
        )?;
        require_len(
            "receipts",
            self.receipts.len(),
            MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_RECEIPTS,
        )?;
        require_len(
            "rebates",
            self.rebates.len(),
            MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_REBATES,
        )?;
        require_len(
            "privacy fences",
            self.privacy_fences.len(),
            MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_FENCES,
        )?;
        ...
        let instrument_ids = self
            ...
            .collect::<MoneroL2PqPrivateBridgeFeeDerivativesRuntimeResult<Vec<_>>>()?;
...
pub fn state_root_from_record(record: &Value) -> String {
    payload_root("BRIDGE-FEE-DERIVATIVES-STATE", record)
}

pub fn public_record_root(record: &Value) -> String {
    payload_root("BRIDGE-FEE-DERIVATIVES-PUBLIC-RECORD", record)
}
...
pub fn bridge_fee_derivative_instrument_id(
    kind: DerivativeKind,
    direction: BridgeDirection,
    fee_index_root: &str,
    strike_fee_micro_units: u64,
    notional_bridge_amount_units: u64,
    listed_at_height: u64,
    expires_at_height: u64,
) -> String {
    domain_hash(
        "BRIDGE-FEE-DERIVATIVE-INSTRUMENT-ID",
        &[
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Str(CHAIN_ID),
            ...
            HashPart::Int(notional_bridge_amount_units as i128),
...
pub fn encrypted_rfq_id(
    ...
    domain_hash(
        "BRIDGE-FEE-DERIVATIVE-ENCRYPTED-RFQ-ID",
        &[
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Str(CHAIN_ID),
...
pub fn liquidity_provider_quote_id(
    ...
    domain_hash(
        "BRIDGE-FEE-DERIVATIVE-LP-QUOTE-ID",
        &[
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Str(CHAIN_ID),
            HashPart::Str(rfq_id),
...
pub fn pq_oracle_attestation_id(
    ...
    domain_hash(
        "BRIDGE-FEE-DERIVATIVE-PQ-ORACLE-ATTESTATION-ID",
        &[
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Str(CHAIN_ID),
            HashPart::Str(kind.as_str()),
...
pub fn settlement_batch_id(
    ...
    domain_hash(
        "BRIDGE-FEE-DERIVATIVE-SETTLEMENT-BATCH-ID",
        &[
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Str(CHAIN_ID),
            HashPart::Str(instrument_id),
...
pub fn sponsor_reservation_id(
    ...
    domain_hash(
        "BRIDGE-FEE-DERIVATIVE-SPONSOR-RESERVATION-ID",
        &[
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Str(CHAIN_ID),
...
pub fn derivative_receipt_id(
    ...
    domain_hash(
        "BRIDGE-FEE-DERIVATIVE-RECEIPT-ID",
        &[
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Str(CHAIN_ID),
            HashPart::Str(settlement_id),
...
pub fn fee_rebate_id(
    ...
    domain_hash(
        "BRIDGE-FEE-DERIVATIVE-REBATE-ID",
        &[
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Str(CHAIN_ID),
...
pub fn privacy_fence_id(
    ...
    domain_hash(
        "BRIDGE-FEE-DERIVATIVE-PRIVACY-FENCE-ID",
        &[
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Str(CHAIN_ID),
            HashPart::Str(kind.as_str()),
...
pub fn volatility_metric_id(
    ...
    domain_hash(
        "BRIDGE-FEE-DERIVATIVE-VOLATILITY-METRIC-ID",
        &[
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Str(CHAIN_ID),
            HashPart::Str(direction.as_str()),
...
pub fn runtime_event_id(event_kind: &str, subject_id: &str, height: u64, sequence: u64) -> String {
    domain_hash(
        "BRIDGE-FEE-DERIVATIVE-RUNTIME-EVENT-ID",
        &[
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Str(CHAIN_ID),
...
fn require_non_empty(
    label: &str,
    value: &str,
) -> MoneroL2PqPrivateBridgeFeeDerivativesRuntimeResult<()> {
...
fn require_bps(label: &str, value: u64) -> MoneroL2PqPrivateBridgeFeeDerivativesRuntimeResult<()> {
    if value > MONERO_L2_PQ_PRIVATE_BRIDGE_FEE_DERIVATIVES_RUNTIME_MAX_BPS {
