...
pub type PrivateL2PqConfidentialBridgeDecoyStemRouteLiquidityBalancerRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-bridge-decoy-stem-route-liquidity-balancer-runtime-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_BRIDGE_DECOY_STEM_ROUTE_LIQUIDITY_BALANCER_RUNTIME_PROTOCOL_VERSION:
    &str = PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const PQ_STEM_ROUTE_BALANCER_SUITE: &str = "ML-DSA-87+ML-KEM-1024+SLH-DSA-SHAKE-256f";
pub const DECOY_STEM_ROUTE_LIQUIDITY_BALANCER_SUITE: &str =
    "monero-bridge-decoy-stem-route-liquidity-balancer-root-v1";
pub const REBATE_SUITE: &str = "decoy-stem-route-liquidity-balancer-low-fee-rebate-root-v1";
pub const REDACTION_SUITE: &str =
    "operator-safe-decoy-stem-route-liquidity-balancer-redaction-root-v1";
...
pub const DEFAULT_DECOY_STEM_ROUTE_LIQUIDITY_WINDOW_SLOTS: u64 = 720;
...
impl DecoyStemRouteLiquidityScope {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::EmergencyStemRouteLiquidity => "emergency_stem_route_liquidity_balancer",
...
#[serde(rename_all = "snake_case")]
pub enum SignalKind {
    FluffPhaseLinkagePressure,
    FluffRelayFragmentation,
    FluffRelaySkew,
    FluffPhaseGraphLinkagePressure,
    FluffTimingCorrelationPressure,
    ReserveMismatch,
    FeeSpikeStemRouteBalanceFailure,
    WatchtowerEmergency,
}
...
pub enum AttestationVerdict {
    ConfirmStemRouteLiquidityPressure,
    ConfirmPrivacyRisk,
    RequireStemRouteLiquidityRebalance,
    RequireStemRouteLiquidityRebalanceGuard,
    RequireQuarantine,
    ClearFalsePositive,
}
...
#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum DecoyStemRouteLiquidityAction {
    Observe,
    QueueStemRouteLiquidityReview,
    ApplyStemRouteLiquidityBalance,
    RotateStemRouteLiquidityCohort,
    QuarantineRoute,
    EmergencyPause,
    Release,
    Reject,
...
pub struct Config {
    ...
    pub pq_stem_route_balancer_suite: String,
    pub decoy_stem_route_liquidity_balancer_suite: String,
    ...
    pub decoy_stem_route_liquidity_window_slots: u64,
    pub signal_window_slots: u64,
    pub max_stem_route_fee_bps: u64,
    pub target_rebate_bps: u64,
    pub min_stem_lane_decoy_stem_route_liquidity_micro_units: u64,
    pub min_fluff_lane_decoy_stem_route_liquidity_micro_units: u64,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            pq_stem_route_balancer_suite: PQ_STEM_ROUTE_BALANCER_SUITE.to_string(),
            decoy_stem_route_liquidity_balancer_suite: DECOY_STEM_ROUTE_LIQUIDITY_BALANCER_SUITE
                .to_string(),
            ...
            decoy_stem_route_liquidity_window_slots:
                DEFAULT_DECOY_STEM_ROUTE_LIQUIDITY_WINDOW_SLOTS,
            signal_window_slots: DEFAULT_SIGNAL_WINDOW_SLOTS,
            max_stem_route_fee_bps: DEFAULT_MAX_ROUTE_FEE_BPS,
            target_rebate_bps: DEFAULT_TARGET_REBATE_BPS,
            min_stem_lane_decoy_stem_route_liquidity_micro_units:
                DEFAULT_MIN_SOURCE_LIQUIDITY_MICRO_UNITS,
            min_fluff_lane_decoy_stem_route_liquidity_micro_units:
...
pub struct Counters {
    ...
    pub fluff_filters_settled: u64,
    pub cohorts_rotated: u64,
    pub stem_routes_quarantined: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct DecoyStemRouteLiquidityPolicy {
    pub policy_id: String,
    pub scope: DecoyStemRouteLiquidityScope,
    pub owner_commitment: String,
    pub policy_commitment_root: String,
    pub source_stem_route_relay_set_root: String,
    pub target_stem_route_relay_set_root: String,
    pub stem_route_allowlist_root: String,
    pub min_privacy_set_size: u64,
    pub min_stem_lane_decoy_stem_route_liquidity_micro_units: u64,
    pub min_fluff_lane_decoy_stem_route_liquidity_micro_units: u64,
    pub max_stem_route_fee_bps: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct DecoyStemRouteLiquidityBalancerCohort {
    ...
    pub decoy_balancer_commitment_root: String,
    pub stem_lane_decoy_stem_route_liquidity_micro_units: u64,
    pub fluff_lane_decoy_stem_route_liquidity_micro_units: u64,
    pub privacy_set_size: u64,
    pub stem_route_fee_bps: u64,
    pub active_signal_count: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct DecoyStemRouteLiquiditySignal {
    ...
    pub observed_stem_route_root: String,
    pub fluff_linkage_pressure_root: String,
    pub reporter_commitment: String,
    pub stem_lane_decoy_stem_route_liquidity_delta_micro_units: i128,
    pub fluff_lane_decoy_stem_route_liquidity_delta_micro_units: i128,
    pub privacy_set_size: u64,
    pub fluff_linkage_risk_score_bps: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct PqDecoyStemRouteLiquidityAttestation {
    ...
    pub observed_fluff_linkage_risk_score_bps: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct DecoyStemRouteLiquidityDecision {
    pub decision_id: String,
    pub signal_id: String,
    pub cohort_id: String,
    pub policy_id: String,
    pub action: DecoyStemRouteLiquidityAction,
    pub decision_root: String,
    pub replacement_stem_route_root: String,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct LowFeeDecoyStemRouteLiquidityRebate {
...
pub struct State {
    ...
    pub roots: Roots,
    pub policies: BTreeMap<String, DecoyStemRouteLiquidityPolicy>,
    pub cohorts: BTreeMap<String, DecoyStemRouteLiquidityBalancerCohort>,
    pub signals: BTreeMap<String, DecoyStemRouteLiquiditySignal>,
    pub attestations: BTreeMap<String, PqDecoyStemRouteLiquidityAttestation>,
    pub decisions: BTreeMap<String, DecoyStemRouteLiquidityDecision>,
    pub rebates: BTreeMap<String, LowFeeDecoyStemRouteLiquidityRebate>,
...
impl State {
    ...
    pub fn devnet() -> Self {
        ...
        let withdrawal_policy = state
            .register_policy(RegisterPolicyRequest {
                scope: DecoyStemRouteLiquidityScope::WithdrawalSubaddressLane,
                owner_commitment: "owner:dandelion-decoy-stem-route-liquidity-balancer-council-a"
                    .to_string(),
                policy_commitment_root: devnet_root(
                    "policy",
                    "withdrawal-dandelion-decoy-stem-route-liquidity-balancer",
                ),
                source_stem_route_relay_set_root: devnet_root(
                    "source-fluff-relay-set",
                    "withdrawal-alpha",
                ),
                target_stem_route_relay_set_root: devnet_root(
                    "target-fluff-relay-set",
                    "withdrawal-alpha",
                ),
                stem_route_allowlist_root: devnet_root("route-allowlist", "withdrawal-alpha"),
                min_privacy_set_size: 524_288,
                min_stem_lane_decoy_stem_route_liquidity_micro_units: 160_000_000,
                min_fluff_lane_decoy_stem_route_liquidity_micro_units: 72_000_000,
                max_stem_route_fee_bps: 16,
                min_attestation_quorum_bps: 7_200,
                signal_window_slots: 96,
                decoy_stem_route_liquidity_window_slots: 720,
                redaction_profile:
                    "withdrawal-dandelion-decoy-stem-route-liquidity-balancer-profile".to_string(),
            })
            .expect("devnet withdrawal policy");
        let fast_dandelion_exit_policy = state
            .register_policy(RegisterPolicyRequest {
                scope: DecoyStemRouteLiquidityScope::FastDandelionStemRouteBalanceLane,
                owner_commitment: "owner:fast-dandelion-decoy-balancer-route-council-b".to_string(),
                policy_commitment_root: devnet_root(
                    "policy",
                    "fast-dandelion-decoy-balancer-dandelion-decoy-stem-route-liquidity-balancer",
                ),
                source_stem_route_relay_set_root: devnet_root(
                    "source-fluff-relay-set",
                    "fast-dandelion-decoy-balancer-beta",
                ),
                target_stem_route_relay_set_root: devnet_root(
                    "target-fluff-relay-set",
                    "fast-dandelion-decoy-balancer-beta",
                ),
                stem_route_allowlist_root: devnet_root(
                    "route-allowlist",
                    "fast-dandelion-decoy-balancer-beta",
                ),
                min_privacy_set_size: 393_216,
                min_stem_lane_decoy_stem_route_liquidity_micro_units: 144_000_000,
                min_fluff_lane_decoy_stem_route_liquidity_micro_units: 64_000_000,
                max_stem_route_fee_bps: 18,
                min_attestation_quorum_bps: 7_000,
                signal_window_slots: 80,
                decoy_stem_route_liquidity_window_slots: 640,
                redaction_profile:
                    "fast-dandelion-decoy-balancer-dandelion-decoy-stem-route-liquidity-balancer-profile"
                        .to_string(),
            })
            .expect("devnet fast decoy_stem_route_liquidity policy");
        let withdrawal_cohort = state
            .register_cohort(RegisterCohortRequest {
                policy_id: withdrawal_policy,
                bridge_lane_id: "withdrawal-decoy-balancer-alpha".to_string(),
                source_stem_route_relay_set_root: devnet_root(
                    "source-fluff-relay-set",
                    "cohort-alpha",
                ),
                ...
                decoy_balancer_commitment_root: devnet_root("liquidity", "cohort-alpha"),
                stem_lane_decoy_stem_route_liquidity_micro_units: 216_000_000,
                fluff_lane_decoy_stem_route_liquidity_micro_units: 96_000_000,
                privacy_set_size: 524_288,
                stem_route_fee_bps: 11,
        ...
        let fast_dandelion_exit_cohort = state
            .register_cohort(RegisterCohortRequest {
                ...
                bridge_lane_id: "fast-dandelion-decoy-balancer-route-beta".to_string(),
                source_stem_route_relay_set_root: devnet_root(
                    "source-fluff-relay-set",
                    "cohort-beta",
                ),
                ...
                decoy_balancer_commitment_root: devnet_root("liquidity", "cohort-beta"),
                stem_lane_decoy_stem_route_liquidity_micro_units: 168_000_000,
                fluff_lane_decoy_stem_route_liquidity_micro_units: 76_000_000,
                privacy_set_size: 393_216,
                stem_route_fee_bps: 13,
                public_hint_root: devnet_root("hint", "cohort-beta"),
            })
            .expect("devnet fast decoy_stem_route_liquidity cohort");
        let signal = state
            .submit_signal(SubmitSignalRequest {
                cohort_id: withdrawal_cohort,
                kind: SignalKind::FluffPhaseLinkagePressure,
                signal_commitment_root: devnet_root("signal", "withdrawal-cluster-pressure"),
                observed_stem_route_root: devnet_root(
                    "observed-route",
                    "withdrawal-cluster-pressure",
                ),
                fluff_linkage_pressure_root: devnet_root("pressure", "withdrawal-cluster-pressure"),
                reporter_commitment: "reporter:dandelion-route-watchtower-11".to_string(),
                stem_lane_decoy_stem_route_liquidity_delta_micro_units: -48_000_000,
                fluff_lane_decoy_stem_route_liquidity_delta_micro_units: 24_000_000,
                privacy_set_size: 524_288,
                fluff_linkage_risk_score_bps: 7_300,
        ...
        state
            .submit_attestation(SubmitAttestationRequest {
                ...
                verdict: AttestationVerdict::RequireStemRouteLiquidityRebalanceGuard,
                attestor_commitment: "attestor:pq-dandelion-decoy-stem-route-liquidity-balancer-a"
                    .to_string(),
                pq_signature_root: devnet_root(
                    "ml-dsa-signature",
                    "withdrawal-decoy_stem_route_liquidity-a",
                ),
                ...
                observed_fluff_linkage_risk_score_bps: 7_500,
        ...
        state
            .submit_attestation(SubmitAttestationRequest {
                signal_id: signal.clone(),
                verdict: AttestationVerdict::ConfirmStemRouteLiquidityPressure,
                attestor_commitment: "attestor:pq-dandelion-decoy-stem-route-liquidity-balancer-b"
                    .to_string(),
                pq_signature_root: devnet_root(
                    "slh-dsa-signature",
                    "withdrawal-decoy_stem_route_liquidity-b",
                ),
                pq_public_key_root: devnet_root(
                    "ml-kem-public-key",
                    "withdrawal-decoy_stem_route_liquidity-b",
                ...
                pq_security_bits: 256,
                observed_fluff_linkage_risk_score_bps: 7_800,
                observed_privacy_set_size: 524_288,
        ...
        let decision = state
            .settle_decision(SettleDecisionRequest {
                signal_id: signal,
                action: DecoyStemRouteLiquidityAction::ApplyStemRouteLiquidityBalance,
                decision_root: devnet_root(
                    "decision",
                    "withdrawal-liquidity-decoy_stem_route_liquidity",
                ),
                replacement_stem_route_root: devnet_root(
                    "replacement-route",
                    "withdrawal-decoy_stem_route_liquidity",
                ),
            ...
            .expect("devnet decoy_stem_route_liquidity decision");
        state
            .publish_rebate(PublishRebateRequest {
                decision_id: decision,
                recipient_commitment:
                    "recipient:dandelion-decoy-stem-route-liquidity-balancer-fee-sponsor"
                        .to_string(),
                rebate_micro_units: 22_000,
                fee_saved_micro_units: 88_000,
                rebate_bps: 8,
                settlement_slot: DEVNET_SLOT + 6,
                rebate_root: devnet_root("rebate", "withdrawal-decoy_stem_route_liquidity"),
            })
    ...
    pub fn register_policy(&mut self, request: RegisterPolicyRequest) -> Result<String> {
        ensure_capacity(
            self.policies.len(),
            MAX_POLICIES,
            "Dandelion fluff-phase privacy guard policies",
        )?;
        ...
        ensure_non_empty(
            &request.source_stem_route_relay_set_root,
            "source_stem_route_relay_set_root",
        )?;
        ensure_non_empty(
            &request.target_stem_route_relay_set_root,
            "target_stem_route_relay_set_root",
        )?;
        ensure_non_empty(
            &request.stem_route_allowlist_root,
            "stem_route_allowlist_root",
        )?;
        ensure_non_empty(&request.redaction_profile, "redaction_profile")?;
        ensure_bps(request.max_stem_route_fee_bps, "max_stem_route_fee_bps")?;
        ensure_bps(
        ...
        if request.min_stem_lane_decoy_stem_route_liquidity_micro_units
            < self
                .config
                .min_stem_lane_decoy_stem_route_liquidity_micro_units
        {
        ...
        if request.min_fluff_lane_decoy_stem_route_liquidity_micro_units
            < self
                .config
                .min_fluff_lane_decoy_stem_route_liquidity_micro_units
        {
        ...
        let policy_id = stable_id(
            "dandelion-decoy-stem-route-liquidity-balancer-policy",
            &[
                HashPart::Str(request.scope.as_str()),
                HashPart::Str(&request.owner_commitment),
                HashPart::Str(&request.policy_commitment_root),
                HashPart::Str(&request.source_stem_route_relay_set_root),
            ],
        );
        if self.policies.contains_key(&policy_id) {
            return Err(format!(
                "Dandelion fluff-phase privacy guard policy {policy_id} already exists"
            ));
        }
        self.policies.insert(
            policy_id.clone(),
            DecoyStemRouteLiquidityPolicy {
                policy_id: policy_id.clone(),
                scope: request.scope,
                owner_commitment: request.owner_commitment,
                policy_commitment_root: request.policy_commitment_root,
                source_stem_route_relay_set_root: request.source_stem_route_relay_set_root,
                target_stem_route_relay_set_root: request.target_stem_route_relay_set_root,
                stem_route_allowlist_root: request.stem_route_allowlist_root,
                min_privacy_set_size: request.min_privacy_set_size,
                min_stem_lane_decoy_stem_route_liquidity_micro_units: request
                    .min_stem_lane_decoy_stem_route_liquidity_micro_units,
                min_fluff_lane_decoy_stem_route_liquidity_micro_units: request
                    .min_fluff_lane_decoy_stem_route_liquidity_micro_units,
                max_stem_route_fee_bps: request.max_stem_route_fee_bps,
                min_attestation_quorum_bps: request.min_attestation_quorum_bps,
                signal_window_slots: request.signal_window_slots,
                decoy_stem_route_liquidity_window_slots: request
                    .decoy_stem_route_liquidity_window_slots,
                active: true,
    ...
    pub fn register_cohort(&mut self, request: RegisterCohortRequest) -> Result<String> {
        ensure_capacity(
            self.cohorts.len(),
            MAX_COHORTS,
            "Dandelion route privacy cohorts",
        )?;
        let policy = self.policies.get(&request.policy_id).ok_or_else(|| {
            format!(
                "unknown Dandelion fluff-phase privacy guard policy {}",
                request.policy_id
            )
        })?;
        ...
        ensure_non_empty(
            &request.decoy_balancer_commitment_root,
            "decoy_balancer_commitment_root",
        )?;
        ensure_non_empty(&request.public_hint_root, "public_hint_root")?;
        ensure_bps(request.stem_route_fee_bps, "stem_route_fee_bps")?;
        if request.stem_route_fee_bps > policy.max_stem_route_fee_bps {
            return Err("cohort route fee exceeds policy cap".to_string());
        }
        if request.stem_lane_decoy_stem_route_liquidity_micro_units
            < policy.min_stem_lane_decoy_stem_route_liquidity_micro_units
        {
            return Err("cohort source liquidity below policy floor".to_string());
        }
        if request.fluff_lane_decoy_stem_route_liquidity_micro_units
            < policy.min_fluff_lane_decoy_stem_route_liquidity_micro_units
        {
        ...
        let cohort_id = stable_id(
            "dandelion-decoy-stem-route-liquidity-balancer-cohort",
            &[
                HashPart::Str(&request.policy_id),
                HashPart::Str(&request.bridge_lane_id),
                HashPart::Str(&request.source_stem_route_relay_set_root),
                HashPart::Str(&request.decoy_balancer_commitment_root),
            ],
        );
        if self.cohorts.contains_key(&cohort_id) {
            return Err(format!(
                "Dandelion fluff-phase privacy guard cohort {cohort_id} already exists"
            ));
        }
        self.cohorts.insert(
            cohort_id.clone(),
            DecoyStemRouteLiquidityBalancerCohort {
                ...
                decoy_balancer_commitment_root: request.decoy_balancer_commitment_root,
                stem_lane_decoy_stem_route_liquidity_micro_units: request
                    .stem_lane_decoy_stem_route_liquidity_micro_units,
                fluff_lane_decoy_stem_route_liquidity_micro_units: request
                    .fluff_lane_decoy_stem_route_liquidity_micro_units,
                privacy_set_size: request.privacy_set_size,
                stem_route_fee_bps: request.stem_route_fee_bps,
    ...
    pub fn submit_signal(&mut self, request: SubmitSignalRequest) -> Result<String> {
        ensure_capacity(
            self.signals.len(),
            MAX_SIGNALS,
            "Dandelion fluff-phase privacy guard signals",
        )?;
        let cohort = self
            .cohorts
            ...
            .ok_or_else(|| {
                format!(
                    "unknown Dandelion fluff-phase privacy guard cohort {}",
                    request.cohort_id
                )
            })?
            .clone();
        ...
        ensure_non_empty(
            &request.observed_stem_route_root,
            "observed_stem_route_root",
        )?;
        ensure_non_empty(
            &request.fluff_linkage_pressure_root,
            "fluff_linkage_pressure_root",
        )?;
        ensure_non_empty(&request.reporter_commitment, "reporter_commitment")?;
        ensure_bps(
            request.fluff_linkage_risk_score_bps,
            "fluff_linkage_risk_score_bps",
        )?;
        if request.privacy_set_size < policy.min_privacy_set_size {
            return Err("signal privacy set below policy floor".to_string());
        }
        let signal_id = stable_id(
            "dandelion-decoy-stem-route-liquidity-balancer-signal",
            &[
        ...
        if self.signals.contains_key(&signal_id) {
            return Err(format!(
                "Dandelion fluff-phase privacy guard signal {signal_id} already exists"
            ));
        }
        ...
        self.signals.insert(
            ...
            DecoyStemRouteLiquiditySignal {
                ...
                observed_stem_route_root: request.observed_stem_route_root,
                fluff_linkage_pressure_root: request.fluff_linkage_pressure_root,
                reporter_commitment: request.reporter_commitment,
                stem_lane_decoy_stem_route_liquidity_delta_micro_units: request
                    .stem_lane_decoy_stem_route_liquidity_delta_micro_units,
                fluff_lane_decoy_stem_route_liquidity_delta_micro_units: request
                    .fluff_lane_decoy_stem_route_liquidity_delta_micro_units,
                privacy_set_size: request.privacy_set_size,
                fluff_linkage_risk_score_bps: request.fluff_linkage_risk_score_bps,
    ...
    pub fn submit_attestation(&mut self, request: SubmitAttestationRequest) -> Result<String> {
        ensure_capacity(
            ...
            MAX_ATTESTATIONS,
            "Dandelion fluff-phase privacy guard attestations",
        )?;
        let signal = self
            .signals
            ...
            .ok_or_else(|| {
                format!(
                    "unknown Dandelion fluff-phase privacy guard signal {}",
                    request.signal_id
                )
            })?
            .clone();
        ...
        ensure_bps(
            request.observed_fluff_linkage_risk_score_bps,
            "observed_fluff_linkage_risk_score_bps",
        )?;
        ...
        let attestation_id = stable_id(
            "dandelion-decoy-stem-route-liquidity-balancer-pq-attestation",
            &[
        ...
        if self.attestations.contains_key(&attestation_id) {
            return Err(format!(
                "Dandelion fluff-phase privacy guard attestation {attestation_id} already exists"
            ));
        }
        self.attestations.insert(
            attestation_id.clone(),
            PqDecoyStemRouteLiquidityAttestation {
                ...
                observed_fluff_linkage_risk_score_bps: request
                    .observed_fluff_linkage_risk_score_bps,
    ...
    pub fn settle_decision(&mut self, request: SettleDecisionRequest) -> Result<String> {
        ensure_capacity(
            self.decisions.len(),
            MAX_DECISIONS,
            "Dandelion fluff-phase privacy guard decisions",
        )?;
        let signal = self
            .signals
            .get(&request.signal_id)
        ...
        ensure_non_empty(
            &request.replacement_stem_route_root,
            "replacement_stem_route_root",
        )?;
        ensure_bps(request.rebate_bps, "rebate_bps")?;
        let privacy_filter_deadline_slot = match request.action {
            DecoyStemRouteLiquidityAction::QueueStemRouteLiquidityReview
            | DecoyStemRouteLiquidityAction::ApplyStemRouteLiquidityBalance
            | DecoyStemRouteLiquidityAction::RotateStemRouteLiquidityCohort => request
                .decided_at_slot
                .saturating_add(policy.decoy_stem_route_liquidity_window_slots),
            DecoyStemRouteLiquidityAction::QuarantineRoute
            | DecoyStemRouteLiquidityAction::EmergencyPause => request
                .decided_at_slot
                .saturating_add(policy.decoy_stem_route_liquidity_window_slots / 2),
            _ => 0,
        };
        let decision_id = stable_id(
            "dandelion-decoy-stem-route-liquidity-balancer-decision",
            &[
                HashPart::Str(&request.signal_id),
        ...
        if self.decisions.contains_key(&decision_id) {
            return Err(format!(
                "Dandelion fluff-phase privacy guard decision {decision_id} already exists"
            ));
        }
        self.decisions.insert(
            decision_id.clone(),
            DecoyStemRouteLiquidityDecision {
                ...
                replacement_stem_route_root: request.replacement_stem_route_root,
        ...
        if let Some(signal) = self.signals.get_mut(&request.signal_id) {
            signal.status = match request.action {
                DecoyStemRouteLiquidityAction::QueueStemRouteLiquidityReview => {
                    SignalStatus::RouteQueued
                }
                DecoyStemRouteLiquidityAction::ApplyStemRouteLiquidityBalance
                | DecoyStemRouteLiquidityAction::RotateStemRouteLiquidityCohort => {
                    SignalStatus::Routing
                }
                DecoyStemRouteLiquidityAction::QuarantineRoute
                | DecoyStemRouteLiquidityAction::EmergencyPause => SignalStatus::Quarantined,
                DecoyStemRouteLiquidityAction::Release => SignalStatus::Settled,
                DecoyStemRouteLiquidityAction::Reject => SignalStatus::Rejected,
                DecoyStemRouteLiquidityAction::Expire => SignalStatus::Expired,
                DecoyStemRouteLiquidityAction::Observe => SignalStatus::Attested,
            };
        }
        if let Some(cohort) = self.cohorts.get_mut(&signal.cohort_id) {
            match request.action {
                DecoyStemRouteLiquidityAction::QueueStemRouteLiquidityReview => {
                    cohort.status = CohortStatus::RoutePending;
                    cohort.privacy_filter_deadline_slot = privacy_filter_deadline_slot;
                }
                DecoyStemRouteLiquidityAction::ApplyStemRouteLiquidityBalance => {
                    cohort.status = CohortStatus::Routing;
                    cohort.stem_lane_decoy_stem_route_liquidity_micro_units = cohort
                        .stem_lane_decoy_stem_route_liquidity_micro_units
                        .saturating_sub(request.privacy_filtered_micro_units);
                    cohort.fluff_lane_decoy_stem_route_liquidity_micro_units = cohort
                        .fluff_lane_decoy_stem_route_liquidity_micro_units
                        .saturating_add(request.privacy_filtered_micro_units);
                    cohort.privacy_filter_deadline_slot = privacy_filter_deadline_slot;
                    self.counters.fluff_filters_settled =
                        self.counters.fluff_filters_settled.saturating_add(1);
                ...
                DecoyStemRouteLiquidityAction::QuarantineRoute => {
                    ...
                    cohort.privacy_filter_deadline_slot = privacy_filter_deadline_slot;
                    self.counters.stem_routes_quarantined =
                        self.counters.stem_routes_quarantined.saturating_add(1);
                }
                DecoyStemRouteLiquidityAction::EmergencyPause => {
                    cohort.status = CohortStatus::Paused;
                    cohort.privacy_filter_deadline_slot = privacy_filter_deadline_slot;
                    self.counters.stem_routes_quarantined =
                        self.counters.stem_routes_quarantined.saturating_add(1);
                }
                DecoyStemRouteLiquidityAction::Release => {
    ...
    pub fn publish_rebate(&mut self, request: PublishRebateRequest) -> Result<String> {
        ensure_capacity(
            self.rebates.len(),
            MAX_REBATES,
            "Dandelion fluff-phase privacy guard rebates",
        )?;
        let decision = self.decisions.get(&request.decision_id).ok_or_else(|| {
            format!(
                "unknown Dandelion fluff-phase privacy guard decision {}",
                request.decision_id
            )
        })?;
        ...
        let rebate_id = stable_id(
            "dandelion-decoy-stem-route-liquidity-balancer-low-fee-rebate",
            &[
        ...
        if self.rebates.contains_key(&rebate_id) {
            return Err(format!(
                "Dandelion fluff-phase privacy guard rebate {rebate_id} already exists"
            ));
        }
        self.rebates.insert(
            rebate_id.clone(),
            LowFeeDecoyStemRouteLiquidityRebate {
    ...
    pub fn publish_redaction_budget(
        ...
        ensure_capacity(
            ...
            "Dandelion fluff-phase privacy guard redaction budgets",
        )?;
        ...
        let budget_id = stable_id(
            "dandelion-decoy-stem-route-liquidity-balancer-redaction-budget",
            &[
                HashPart::Str(request.scope.as_str()),
                HashPart::Str(&request.cohort_id),
        ...
        if self.redaction_budgets.contains_key(&budget_id) {
            return Err(format!(
                "Dandelion fluff-phase privacy guard redaction budget {budget_id} already exists"
            ));
        }
    ...
    pub fn publish_operator_summary(
        ...
        ensure_capacity(
            ...
            "Dandelion fluff-phase privacy guard operator summaries",
        )?;
        self.refresh_live_counts();
        ...
        let summary_id = stable_id(
            "dandelion-decoy-stem-route-liquidity-balancer-operator-summary",
            &[
                HashPart::U64(epoch),
                HashPart::U64(slot),
    ...
    fn refresh_roots(&mut self) {
        ...
        self.roots.state_root = merkle_root(
            "bridge-dandelion-decoy-stem-route-liquidity-balancer:state",
            &[
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "pq_stem_route_balancer_suite": self.config.pq_stem_route_balancer_suite,
            "decoy_stem_route_liquidity_balancer_suite": self.config.decoy_stem_route_liquidity_balancer_suite,
            ...
            "decoy_stem_route_liquidity_window_slots": self.config.decoy_stem_route_liquidity_window_slots,
            "signal_window_slots": self.config.signal_window_slots,
            "max_stem_route_fee_bps": self.config.max_stem_route_fee_bps,
            ...
            "policies": self.policies.values().map(|policy| json!({
                ...
                "min_stem_lane_decoy_stem_route_liquidity_micro_units": policy.min_stem_lane_decoy_stem_route_liquidity_micro_units,
                "min_fluff_lane_decoy_stem_route_liquidity_micro_units": policy.min_fluff_lane_decoy_stem_route_liquidity_micro_units,
                "max_stem_route_fee_bps": policy.max_stem_route_fee_bps,
            ...
            "cohorts": self.cohorts.values().map(|cohort| json!({
                ...
                "stem_lane_decoy_stem_route_liquidity_micro_units": cohort.stem_lane_decoy_stem_route_liquidity_micro_units,
                "fluff_lane_decoy_stem_route_liquidity_micro_units": cohort.fluff_lane_decoy_stem_route_liquidity_micro_units,
                "privacy_set_size": cohort.privacy_set_size,
                "stem_route_fee_bps": cohort.stem_route_fee_bps,
            ...
            "signals": self.signals.values().map(|signal| json!({
                ...
                "fluff_linkage_risk_score_bps": signal.fluff_linkage_risk_score_bps,
...
pub fn demo() -> State {
    ...
    let signal = state
        .submit_signal(SubmitSignalRequest {
            cohort_id,
            kind: SignalKind::FluffPhaseGraphLinkagePressure,
            signal_commitment_root: devnet_root("signal", "demo-viewtag-pressure"),
            observed_stem_route_root: devnet_root("observed-route", "demo-viewtag-pressure"),
            fluff_linkage_pressure_root: devnet_root("pressure", "demo-viewtag-pressure"),
            reporter_commitment: "reporter:demo-subaddress-watchtower".to_string(),
            stem_lane_decoy_stem_route_liquidity_delta_micro_units: -10_000_000,
            fluff_lane_decoy_stem_route_liquidity_delta_micro_units: 8_000_000,
            privacy_set_size: 524_288,
            fluff_linkage_risk_score_bps: 6_200,
    ...
    state
        .submit_attestation(SubmitAttestationRequest {
            signal_id: signal,
            verdict: AttestationVerdict::RequireStemRouteLiquidityRebalance,
            attestor_commitment: "attestor:demo-dandelion-decoy-stem-route-liquidity-balancer"
                .to_string(),
            ...
            pq_security_bits: 256,
            observed_fluff_linkage_risk_score_bps: 6_400,
            observed_privacy_set_size: 524_288,
...
fn object_root<T: Serialize>(domain: &str, value: &T) -> String {
    ...
    domain_hash(
        &format!("bridge-dandelion-decoy-stem-route-liquidity-balancer:{domain}"),
        &[HashPart::Json(&value)],
        32,
    )
}
...
fn devnet_root(domain: &str, label: &str) -> String {
    domain_hash(
        &format!("bridge-dandelion-decoy-stem-route-liquidity-balancer:devnet:{domain}"),
