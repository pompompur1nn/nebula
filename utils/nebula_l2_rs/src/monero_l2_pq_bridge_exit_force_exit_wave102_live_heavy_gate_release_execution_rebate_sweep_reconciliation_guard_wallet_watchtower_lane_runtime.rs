...
const PROTOCOL_VERSION: &str = "wave102-live-heavy-gate-release-execution-rebate-sweep-reconciliation-guard-wallet-watchtower-lane-runtime-v1";
const WAVE: u64 = 102;
...
const LANE_ID: &str =
    "wave102-live-heavy-gate-release-execution-rebate-sweep-reconciliation-guard-wallet-watchtower";
...
pub fn devnet() -> State {
    ...
    let claim_labels = [
        "wallet_visible_rebate",
        "watchtower_fee_refund",
        "user_escape_liquidity_sweep",
        "wallet_residual_settlement",
        "watchtower_quorum_packet",
        "wallet_release_hold",
    ];
