...
pub const PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-contract-intent-vm-runtime-v1";
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const INTENT_PROGRAM_SUITE: &str =
    "ML-DSA-87+SLH-DSA-SHAKE-256f-confidential-contract-intent-program-v1";
pub const ENCRYPTED_CALLDATA_SUITE: &str = "ML-KEM-1024+zk-encrypted-contract-calldata-envelope-v1";
pub const PQ_SESSION_ATTESTATION_SUITE: &str =
    "ML-DSA-87+SLH-DSA-SHAKE-256f-session-attestation-v1";
pub const VM_EXECUTION_SUITE: &str = "deterministic-confidential-contract-intent-vm-execution-v1";
pub const GAS_COMMITMENT_SUITE: &str = "confidential-vm-gas-commitment-root-v1";
pub const PROOF_CACHE_SUITE: &str = "pq-vm-proof-cache-hit-commitment-v1";
pub const SLASHING_EVIDENCE_SUITE: &str = "pq-signed-contract-intent-vm-slashing-challenge-v1";
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            sealed_intent_suite: INTENT_PROGRAM_SUITE.to_string(),
            solver_commitment_suite: ENCRYPTED_CALLDATA_SUITE.to_string(),
            route_quote_suite: PQ_SESSION_ATTESTATION_SUITE.to_string(),
            clearing_suite: VM_EXECUTION_SUITE.to_string(),
            privacy_fence_suite: GAS_COMMITMENT_SUITE.to_string(),
            fee_rebate_suite: PROOF_CACHE_SUITE.to_string(),
...
impl Config {
    ...
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_contract_intent_vm_config",
...
impl Counters {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_contract_intent_vm_counters",
...
impl SolverRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_contract_intent_vm",
...
impl ClearingBatchRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_contract_intent_clearing_batch",
            "batch_id": self.batch_id,
            "request": self.request,
            "status": self.status.as_str(),
...
impl FeeRebateRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_contract_intent_fee_rebate",
...
impl SlashingEvidenceRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_contract_intent_slashing_evidence",
...
impl PublicRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_contract_intent_public_record",
...
impl Roots {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_contract_intent_roots",
...
impl State {
    ...
    pub fn public_record_without_roots(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_contract_intent_vm_state",
    ...
    pub fn settle_clearing_batch(&mut self, request: SettleClearingBatchRequest) -> Result<String> {
        ...
        self.publish_public_record(
            ...
            &request.batch_id,
            json!({
                "kind": "private_l2_pq_confidential_contract_intent_settlement",
...
pub fn payload_root(domain: &str, payload: &Value) -> String {
    domain_hash(
        &format!("PRIVATE-L2-PQ-CONFIDENTIAL-CONTRACT-INTENT-VM-{domain}"),
...
pub fn solver_id(request: &RegisterSolverRequest, nonce: u64) -> String {
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-CONTRACT-INTENT-VM-ID",
        &[
            HashPart::Str(CHAIN_ID),
...
pub fn intent_id(request: &SubmitSealedSwapIntentRequest, nonce: u64) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-CONTRACT-INTENT-INTENT-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
...
pub fn commitment_id(request: &CommitSolverRouteRequest, score: u128, nonce: u64) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-CONTRACT-INTENT-COMMITMENT-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
...
pub fn quote_id(request: &RevealRouteQuoteRequest, score: u128, nonce: u64) -> String {
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-CONTRACT-INTENT-QUOTE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
...
pub fn fence_id(request: &RecordPrivacyFenceRequest, nonce: u64) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-CONTRACT-INTENT-FENCE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
            HashPart::Str(&request.intent_id),
...
pub fn batch_id(
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-CONTRACT-INTENT-BATCH-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
...
pub fn settlement_receipt_root(
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-CONTRACT-INTENT-SETTLEMENT-RECEIPT",
        &[
            HashPart::Str(CHAIN_ID),
...
pub fn rebate_id(request: &IssueFeeRebateRequest, nonce: u64) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-CONTRACT-INTENT-REBATE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
            HashPart::Str(&request.intent_id),
...
pub fn slash_id(
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-CONTRACT-INTENT-SLASH-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
            HashPart::Str(&request.solver_id),
...
pub fn public_record_id(
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-CONTRACT-INTENT-PUBLIC-RECORD-ID",
        &[
            HashPart::Str(CHAIN_ID),
...
pub fn roots_only_payload(
    ...
    json!({
        "kind": "private_l2_pq_confidential_contract_intent_roots_only_payload",
        "chain_id": CHAIN_ID,
...
impl IntentProgramKind {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::CustomContractCall => "custom_contract_call",
        }
    }
}
...
impl DependencyLockMode {
    pub fn as_str(self) -> &'static str {
        match self {
            Self::ReadOnly => "read_only",
            Self::WriteExclusive => "write_exclusive",
            Self::NullifierExclusive => "nullifier_exclusive",
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct ContractIntentProgram {
    pub program_id: String,
    pub program_kind: IntentProgramKind,
    ...
    pub defi_scope_root: String,
    pub max_gas: u64,
    pub max_fee_micro_xmr: u64,
    pub pq_author_commitment: String,
    pub pq_signature_root: String,
    pub created_height: u64,
}

impl ContractIntentProgram {
    pub fn public_record(&self) -> Value {
        json!({
            "program_id": self.program_id,
            "program_kind": self.program_kind.as_str(),
            ...
            "defi_scope_root": self.defi_scope_root,
            "max_gas": self.max_gas,
            "max_fee_micro_xmr": self.max_fee_micro_xmr,
            "pq_author_commitment": self.pq_author_commitment,
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct EncryptedCalldataEnvelope {
...
impl EncryptedCalldataEnvelope {
    pub fn public_record(&self) -> Value {
        json!({
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct PqSessionAttestation {
    pub session_id: String,
    pub solver_id: String,
    pub program_id: String,
    ...
    pub remote_attestation_root: String,
    pub forward_secrecy_epoch: u64,
    pub pq_security_bits: u16,
    pub attested_height: u64,
    pub expires_height: u64,
}

impl PqSessionAttestation {
    pub fn public_record(&self) -> Value {
        json!({
            "session_id": self.session_id,
            "solver_id": self.solver_id,
            ...
            "remote_attestation_root": self.remote_attestation_root,
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct SolverExecutionReceipt {
    pub receipt_id: String,
    pub status: SolverReceiptStatus,
    pub solver_id: String,
    pub session_id: String,
    pub program_id: String,
    pub envelope_id: String,
...
impl SolverExecutionReceipt {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "gas_commitment_id": self.gas_commitment_id,
            "proof_root": self.proof_root,
            "cache_hit_id": self.cache_hit_id,
...
pub struct VmGasCommitment {
    ...
    pub priority_fee_micro_xmr: u64,
    pub refund_commitment: String,
    pub witness_meter_root: String,
    pub created_height: u64,
}

impl VmGasCommitment {
    pub fn public_record(&self) -> Value {
        json!({
            "gas_commitment_id": self.gas_commitment_id,
            "program_id": self.program_id,
            ...
            "priority_fee_micro_xmr": self.priority_fee_micro_xmr,
            "refund_commitment": self.refund_commitment,
            "witness_meter_root": self.witness_meter_root,
            "created_height": self.created_height,
        })
    }

    pub fn fee_cap_micro_xmr(&self) -> u64 {
        self.base_fee_micro_xmr
            .saturating_add(self.priority_fee_micro_xmr)
    }
}
...
impl ProofCacheHit {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "cached_proof_root": self.cached_proof_root,
            "input_commitment_root": self.input_commitment_root,
            "saved_gas": self.saved_gas,
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct CrossContractDependencyLock {
    pub lock_id: String,
    pub program_id: String,
    pub envelope_id: String,
    pub contract_id: String,
    pub dependency_contract_id: String,
    pub mode: DependencyLockMode,
    pub storage_key_root: String,
    pub nullifier_domain: String,
    pub expires_height: u64,
    pub acquired_height: u64,
}

impl CrossContractDependencyLock {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "storage_key_root": self.storage_key_root,
...
pub struct FeeSponsorshipRecord {
    ...
    pub program_id: String,
    pub envelope_id: String,
    pub max_sponsored_fee_micro_xmr: u64,
    pub policy_root: String,
    pub refund_address_commitment: String,
    pub consumed_fee_micro_xmr: u64,
    pub opened_height: u64,
    pub expires_height: u64,
}

impl FeeSponsorshipRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "sponsorship_id": self.sponsorship_id,
            ...
            "program_id": self.program_id,
            "envelope_id": self.envelope_id,
            "max_sponsored_fee_micro_xmr": self.max_sponsored_fee_micro_xmr,
            "policy_root": self.policy_root,
            "refund_address_commitment": self.refund_address_commitment,
            "consumed_fee_micro_xmr": self.consumed_fee_micro_xmr,
...
pub struct PrivacyNullifierFence {
    ...
    pub observed_anonymity_set: u64,
...
impl PrivacyNullifierFence {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "observed_anonymity_set": self.observed_anonymity_set,
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct ContractIntentChallengeEvidence {
    pub evidence_id: String,
    pub receipt_id: String,
    pub challenger_commitment: String,
    pub solver_id: String,
    pub allegation_root: String,
    pub failing_trace_root: String,
    pub expected_post_state_root: String,
    pub observed_post_state_root: String,
    pub withheld_calldata_root: String,
    pub slash_amount_micro_xmr: u64,
    pub filed_height: u64,
}

impl ContractIntentChallengeEvidence {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "failing_trace_root": self.failing_trace_root,
            "expected_post_state_root": self.expected_post_state_root,
            "observed_post_state_root": self.observed_post_state_root,
            "withheld_calldata_root": self.withheld_calldata_root,
