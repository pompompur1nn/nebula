...
pub type PrivateL2PqConfidentialBridgeStemRouteFailoverLiquidityInsuranceRuntimeResult<T> =
    Result<T>;
pub type Runtime = State;

pub const PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-bridge-stem-route-failover-liquidity-insurance-runtime-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_BRIDGE_STEM_ROUTE_FAILOVER_LIQUIDITY_INSURANCE_RUNTIME_PROTOCOL_VERSION:
    &str = PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const PQ_STEM_ROUTE_INSURANCE_SUITE: &str = "ML-DSA-87+ML-KEM-1024+SLH-DSA-SHAKE-256f";
pub const STEM_ROUTE_FAILOVER_LIQUIDITY_INSURANCE_SUITE: &str =
    "monero-bridge-stem-route-failover-liquidity-insurance-root-v1";
pub const REBATE_SUITE: &str = "stem-route-failover-liquidity-insurance-low-fee-rebate-root-v1";
pub const REDACTION_SUITE: &str =
    "operator-safe-stem-route-failover-liquidity-insurance-redaction-root-v1";
...
pub const DEFAULT_STEM_ROUTE_FAILOVER_LIQUIDITY_WINDOW_SLOTS: u64 = 720;
...
pub enum StemRouteFailoverLiquidityScope {
    DepositSubaddressLane,
    WithdrawalSubaddressLane,
    FastDandelionStemRouteFailoverLane,
    MerchantPaymentSubaddressLane,
    AtomicSwapSubaddressLane,
    ReserveMirror,
    EmergencyStemRouteFailoverLiquidity,
    WatchtowerRecovery,
}

impl StemRouteFailoverLiquidityScope {
    pub fn as_str(self) -> &'static str {
        match self {
            Self::DepositSubaddressLane => "deposit_subaddress_lane",
            Self::WithdrawalSubaddressLane => "withdrawal_subaddress_lane",
            Self::FastDandelionStemRouteFailoverLane => "fast_dandelion_stem_route_balance_lane",
            ...
            Self::EmergencyStemRouteFailoverLiquidity => {
                "emergency_stem_route_failover_liquidity_insurance"
            }
...
pub enum SignalKind {
    ...
    ReserveMismatch,
    FeeSpikeStemRouteFailoverPressure,
    WatchtowerEmergency,
}
...
pub enum AttestationVerdict {
    ConfirmStemRouteFailoverLiquidityPressure,
    ConfirmPrivacyRisk,
    RequireStemRouteFailoverLiquidityCoverage,
    RequireStemRouteFailoverLiquidityCoverageGuard,
    RequireQuarantine,
    ClearFalsePositive,
}
...
#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum StemRouteFailoverLiquidityAction {
    Observe,
    QueueStemRouteFailoverReview,
    ApplyStemRouteFailoverCoverage,
    RotateStemRouteInsuranceCohort,
    QuarantineRoute,
    EmergencyPause,
    Release,
    Reject,
...
pub struct Config {
    ...
    pub pq_stem_route_insurance_suite: String,
    pub stem_route_failover_liquidity_insurance_suite: String,
    ...
    pub stem_route_failover_liquidity_window_slots: u64,
    pub signal_window_slots: u64,
    pub max_failover_route_fee_bps: u64,
    pub target_rebate_bps: u64,
    pub min_stem_lane_failover_liquidity_micro_units: u64,
    pub min_fluff_lane_failover_liquidity_micro_units: u64,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            pq_stem_route_insurance_suite: PQ_STEM_ROUTE_INSURANCE_SUITE.to_string(),
            stem_route_failover_liquidity_insurance_suite:
                STEM_ROUTE_FAILOVER_LIQUIDITY_INSURANCE_SUITE.to_string(),
            ...
            stem_route_failover_liquidity_window_slots:
                DEFAULT_STEM_ROUTE_FAILOVER_LIQUIDITY_WINDOW_SLOTS,
            signal_window_slots: DEFAULT_SIGNAL_WINDOW_SLOTS,
            max_failover_route_fee_bps: DEFAULT_MAX_ROUTE_FEE_BPS,
            target_rebate_bps: DEFAULT_TARGET_REBATE_BPS,
            min_stem_lane_failover_liquidity_micro_units: DEFAULT_MIN_SOURCE_LIQUIDITY_MICRO_UNITS,
            min_fluff_lane_failover_liquidity_micro_units: DEFAULT_MIN_TARGET_LIQUIDITY_MICRO_UNITS,
...
pub struct Counters {
    ...
    pub failover_routes_quarantined: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct StemRouteFailoverLiquidityPolicy {
    pub policy_id: String,
    pub scope: StemRouteFailoverLiquidityScope,
    pub owner_commitment: String,
    pub policy_commitment_root: String,
    pub source_failover_relay_set_root: String,
    pub target_failover_relay_set_root: String,
    pub failover_route_allowlist_root: String,
    pub min_privacy_set_size: u64,
    pub min_stem_lane_failover_liquidity_micro_units: u64,
    pub min_fluff_lane_failover_liquidity_micro_units: u64,
    pub max_failover_route_fee_bps: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct StemRouteFailoverLiquidityInsuranceCohort {
    ...
    pub stem_lane_failover_liquidity_micro_units: u64,
    pub fluff_lane_failover_liquidity_micro_units: u64,
    pub privacy_set_size: u64,
    pub failover_route_fee_bps: u64,
    pub active_signal_count: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct StemRouteFailoverLiquiditySignal {
    ...
    pub observed_failover_route_root: String,
    pub fluff_linkage_pressure_root: String,
    pub reporter_commitment: String,
    pub stem_lane_failover_liquidity_delta_micro_units: i128,
    pub fluff_lane_failover_liquidity_delta_micro_units: i128,
    pub privacy_set_size: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct PqStemRouteFailoverInsuranceAttestation {
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct StemRouteFailoverLiquidityDecision {
    pub decision_id: String,
    pub signal_id: String,
    pub cohort_id: String,
    pub policy_id: String,
    pub action: StemRouteFailoverLiquidityAction,
    pub decision_root: String,
    pub replacement_failover_route_root: String,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct LowFeeStemRouteFailoverInsuranceRebate {
...
pub struct State {
    ...
    pub roots: Roots,
    pub policies: BTreeMap<String, StemRouteFailoverLiquidityPolicy>,
    pub cohorts: BTreeMap<String, StemRouteFailoverLiquidityInsuranceCohort>,
    pub signals: BTreeMap<String, StemRouteFailoverLiquiditySignal>,
    pub attestations: BTreeMap<String, PqStemRouteFailoverInsuranceAttestation>,
    pub decisions: BTreeMap<String, StemRouteFailoverLiquidityDecision>,
    pub rebates: BTreeMap<String, LowFeeStemRouteFailoverInsuranceRebate>,
...
impl State {
    ...
    pub fn devnet() -> Self {
        ...
        let withdrawal_policy = state
            .register_policy(RegisterPolicyRequest {
                scope: StemRouteFailoverLiquidityScope::WithdrawalSubaddressLane,
                owner_commitment:
                    "owner:dandelion-stem-route-failover-liquidity-insurance-council-a".to_string(),
                policy_commitment_root: devnet_root(
                    "policy",
                    "withdrawal-dandelion-stem-route-failover-liquidity-insurance",
                ),
                source_failover_relay_set_root: devnet_root(
                    "source-fluff-relay-set",
                    "withdrawal-alpha",
                ),
                target_failover_relay_set_root: devnet_root(
                    "target-fluff-relay-set",
                    "withdrawal-alpha",
                ),
                failover_route_allowlist_root: devnet_root("route-allowlist", "withdrawal-alpha"),
                min_privacy_set_size: 524_288,
                min_stem_lane_failover_liquidity_micro_units: 160_000_000,
                min_fluff_lane_failover_liquidity_micro_units: 72_000_000,
                max_failover_route_fee_bps: 16,
                min_attestation_quorum_bps: 7_200,
                signal_window_slots: 96,
                stem_route_failover_liquidity_window_slots: 720,
                redaction_profile:
                    "withdrawal-dandelion-stem-route-failover-liquidity-insurance-profile"
                        .to_string(),
            })
            .expect("devnet withdrawal policy");
        let fast_dandelion_exit_policy = state
            .register_policy(RegisterPolicyRequest {
                scope: StemRouteFailoverLiquidityScope::FastDandelionStemRouteFailoverLane,
                owner_commitment: "owner:fast-dandelion-decoy-insurance-route-council-b".to_string(),
                policy_commitment_root: devnet_root(
                    "policy",
                    "fast-dandelion-decoy-insurance-dandelion-stem-route-failover-liquidity-insurance",
                ),
                source_failover_relay_set_root: devnet_root(
                    "source-fluff-relay-set",
                ...
                failover_route_allowlist_root: devnet_root(
                    "route-allowlist",
                    "fast-dandelion-decoy-insurance-beta",
                ),
                min_privacy_set_size: 393_216,
                min_stem_lane_failover_liquidity_micro_units: 144_000_000,
                min_fluff_lane_failover_liquidity_micro_units: 64_000_000,
                max_failover_route_fee_bps: 18,
                min_attestation_quorum_bps: 7_000,
                signal_window_slots: 80,
                stem_route_failover_liquidity_window_slots: 640,
                redaction_profile:
                    "fast-dandelion-decoy-insurance-dandelion-stem-route-failover-liquidity-insurance-profile"
                        .to_string(),
            })
            .expect("devnet fast stem_route_failover_liquidity policy");
        let withdrawal_cohort = state
            .register_cohort(RegisterCohortRequest {
                ...
                stem_lane_failover_liquidity_micro_units: 216_000_000,
                fluff_lane_failover_liquidity_micro_units: 96_000_000,
                privacy_set_size: 524_288,
                failover_route_fee_bps: 11,
        ...
        let fast_dandelion_exit_cohort = state
            .register_cohort(RegisterCohortRequest {
                ...
                bridge_lane_id: "fast-dandelion-decoy-insurance-route-beta".to_string(),
                source_failover_relay_set_root: devnet_root(
                    "source-fluff-relay-set",
                    "cohort-beta",
                ),
                ...
                stem_lane_failover_liquidity_micro_units: 168_000_000,
                fluff_lane_failover_liquidity_micro_units: 76_000_000,
                privacy_set_size: 393_216,
                failover_route_fee_bps: 13,
                public_hint_root: devnet_root("hint", "cohort-beta"),
            })
            .expect("devnet fast stem_route_failover_liquidity cohort");
        let signal = state
            .submit_signal(SubmitSignalRequest {
                ...
                observed_failover_route_root: devnet_root(
                    "observed-route",
                ...
                stem_lane_failover_liquidity_delta_micro_units: -48_000_000,
                fluff_lane_failover_liquidity_delta_micro_units: 24_000_000,
                privacy_set_size: 524_288,
        ...
        state
            .submit_attestation(SubmitAttestationRequest {
                ...
                verdict: AttestationVerdict::RequireStemRouteFailoverLiquidityCoverageGuard,
                attestor_commitment:
                    "attestor:pq-dandelion-stem-route-failover-liquidity-insurance-a".to_string(),
                pq_signature_root: devnet_root(
                    "ml-dsa-signature",
                    "withdrawal-stem_route_failover_liquidity-a",
                ),
        ...
        state
            .submit_attestation(SubmitAttestationRequest {
                signal_id: signal.clone(),
                verdict: AttestationVerdict::ConfirmStemRouteFailoverLiquidityPressure,
                attestor_commitment:
                    "attestor:pq-dandelion-stem-route-failover-liquidity-insurance-b".to_string(),
                pq_signature_root: devnet_root(
                    "slh-dsa-signature",
                    "withdrawal-stem_route_failover_liquidity-b",
                ),
                pq_public_key_root: devnet_root(
                    "ml-kem-public-key",
                    "withdrawal-stem_route_failover_liquidity-b",
        ...
        let decision = state
            .settle_decision(SettleDecisionRequest {
                signal_id: signal,
                action: StemRouteFailoverLiquidityAction::ApplyStemRouteFailoverCoverage,
                decision_root: devnet_root(
                    "decision",
                    "withdrawal-liquidity-stem_route_failover_liquidity",
                ),
                replacement_failover_route_root: devnet_root(
                    "replacement-route",
                    "withdrawal-stem_route_failover_liquidity",
                ),
            ...
            .expect("devnet stem_route_failover_liquidity decision");
        state
            .publish_rebate(PublishRebateRequest {
                decision_id: decision,
                recipient_commitment:
                    "recipient:dandelion-stem-route-failover-liquidity-insurance-fee-sponsor"
                        .to_string(),
                rebate_micro_units: 22_000,
                fee_saved_micro_units: 88_000,
                rebate_bps: 8,
                settlement_slot: DEVNET_SLOT + 6,
                rebate_root: devnet_root("rebate", "withdrawal-stem_route_failover_liquidity"),
            })
    ...
    pub fn register_policy(&mut self, request: RegisterPolicyRequest) -> Result<String> {
        ...
        ensure_non_empty(
            &request.source_failover_relay_set_root,
            "source_failover_relay_set_root",
        )?;
        ensure_non_empty(
            &request.target_failover_relay_set_root,
            "target_failover_relay_set_root",
        )?;
        ensure_non_empty(
            &request.failover_route_allowlist_root,
            "failover_route_allowlist_root",
        )?;
        ensure_non_empty(&request.redaction_profile, "redaction_profile")?;
        ensure_bps(
            request.max_failover_route_fee_bps,
            "max_failover_route_fee_bps",
        )?;
        ensure_bps(
        ...
        if request.min_stem_lane_failover_liquidity_micro_units
            < self.config.min_stem_lane_failover_liquidity_micro_units
        {
            return Err("policy source liquidity below runtime floor".to_string());
        }
        if request.min_fluff_lane_failover_liquidity_micro_units
            < self.config.min_fluff_lane_failover_liquidity_micro_units
        {
            return Err("policy target liquidity below runtime floor".to_string());
        }
        let policy_id = stable_id(
            "dandelion-stem-route-failover-liquidity-insurance-policy",
            &[
                HashPart::Str(request.scope.as_str()),
                HashPart::Str(&request.owner_commitment),
                HashPart::Str(&request.policy_commitment_root),
                HashPart::Str(&request.source_failover_relay_set_root),
            ],
        );
        ...
        self.policies.insert(
            policy_id.clone(),
            StemRouteFailoverLiquidityPolicy {
                policy_id: policy_id.clone(),
                scope: request.scope,
                owner_commitment: request.owner_commitment,
                policy_commitment_root: request.policy_commitment_root,
                source_failover_relay_set_root: request.source_failover_relay_set_root,
                target_failover_relay_set_root: request.target_failover_relay_set_root,
                failover_route_allowlist_root: request.failover_route_allowlist_root,
                min_privacy_set_size: request.min_privacy_set_size,
                min_stem_lane_failover_liquidity_micro_units: request
                    .min_stem_lane_failover_liquidity_micro_units,
                min_fluff_lane_failover_liquidity_micro_units: request
                    .min_fluff_lane_failover_liquidity_micro_units,
                max_failover_route_fee_bps: request.max_failover_route_fee_bps,
                min_attestation_quorum_bps: request.min_attestation_quorum_bps,
                signal_window_slots: request.signal_window_slots,
                stem_route_failover_liquidity_window_slots: request
                    .stem_route_failover_liquidity_window_slots,
                active: true,
    ...
    pub fn register_cohort(&mut self, request: RegisterCohortRequest) -> Result<String> {
        ...
        ensure_bps(request.failover_route_fee_bps, "failover_route_fee_bps")?;
        if request.failover_route_fee_bps > policy.max_failover_route_fee_bps {
            return Err("cohort route fee exceeds policy cap".to_string());
        }
        if request.stem_lane_failover_liquidity_micro_units
            < policy.min_stem_lane_failover_liquidity_micro_units
        {
            return Err("cohort source liquidity below policy floor".to_string());
        }
        if request.fluff_lane_failover_liquidity_micro_units
            < policy.min_fluff_lane_failover_liquidity_micro_units
        {
        ...
        let cohort_id = stable_id(
            "dandelion-stem-route-failover-liquidity-insurance-cohort",
            &[
        ...
        self.cohorts.insert(
            cohort_id.clone(),
            StemRouteFailoverLiquidityInsuranceCohort {
                ...
                stem_lane_failover_liquidity_micro_units: request
                    .stem_lane_failover_liquidity_micro_units,
                fluff_lane_failover_liquidity_micro_units: request
                    .fluff_lane_failover_liquidity_micro_units,
                privacy_set_size: request.privacy_set_size,
                failover_route_fee_bps: request.failover_route_fee_bps,
    ...
    pub fn submit_signal(&mut self, request: SubmitSignalRequest) -> Result<String> {
        ...
        ensure_non_empty(
            &request.observed_failover_route_root,
            "observed_failover_route_root",
        )?;
        ensure_non_empty(
        ...
        let signal_id = stable_id(
            "dandelion-stem-route-failover-liquidity-insurance-signal",
            &[
        ...
        self.signals.insert(
            signal_id.clone(),
            StemRouteFailoverLiquiditySignal {
                ...
                observed_failover_route_root: request.observed_failover_route_root,
                fluff_linkage_pressure_root: request.fluff_linkage_pressure_root,
                reporter_commitment: request.reporter_commitment,
                stem_lane_failover_liquidity_delta_micro_units: request
                    .stem_lane_failover_liquidity_delta_micro_units,
                fluff_lane_failover_liquidity_delta_micro_units: request
                    .fluff_lane_failover_liquidity_delta_micro_units,
                privacy_set_size: request.privacy_set_size,
    ...
    pub fn submit_attestation(&mut self, request: SubmitAttestationRequest) -> Result<String> {
        ...
        let attestation_id = stable_id(
            "dandelion-stem-route-failover-liquidity-insurance-pq-attestation",
            &[
        ...
        self.attestations.insert(
            ...
            PqStemRouteFailoverInsuranceAttestation {
    ...
    pub fn settle_decision(&mut self, request: SettleDecisionRequest) -> Result<String> {
        ...
        ensure_non_empty(
            &request.replacement_failover_route_root,
            "replacement_failover_route_root",
        )?;
        ensure_bps(request.rebate_bps, "rebate_bps")?;
        let privacy_filter_deadline_slot = match request.action {
            StemRouteFailoverLiquidityAction::QueueStemRouteFailoverReview
            | StemRouteFailoverLiquidityAction::ApplyStemRouteFailoverCoverage
            | StemRouteFailoverLiquidityAction::RotateStemRouteInsuranceCohort => request
                .decided_at_slot
                .saturating_add(policy.stem_route_failover_liquidity_window_slots),
            StemRouteFailoverLiquidityAction::QuarantineRoute
            | StemRouteFailoverLiquidityAction::EmergencyPause => request
                .decided_at_slot
                .saturating_add(policy.stem_route_failover_liquidity_window_slots / 2),
            _ => 0,
        };
        let decision_id = stable_id(
            "dandelion-stem-route-failover-liquidity-insurance-decision",
            &[
                HashPart::Str(&request.signal_id),
        ...
        self.decisions.insert(
            decision_id.clone(),
            StemRouteFailoverLiquidityDecision {
                ...
                replacement_failover_route_root: request.replacement_failover_route_root,
        ...
        if let Some(signal) = self.signals.get_mut(&request.signal_id) {
            signal.status = match request.action {
                ...
                StemRouteFailoverLiquidityAction::ApplyStemRouteFailoverCoverage
                | StemRouteFailoverLiquidityAction::RotateStemRouteInsuranceCohort => {
                    SignalStatus::Routing
                }
                StemRouteFailoverLiquidityAction::QuarantineRoute
                | StemRouteFailoverLiquidityAction::EmergencyPause => SignalStatus::Quarantined,
                StemRouteFailoverLiquidityAction::Release => SignalStatus::Settled,
                StemRouteFailoverLiquidityAction::Reject => SignalStatus::Rejected,
                StemRouteFailoverLiquidityAction::Expire => SignalStatus::Expired,
                StemRouteFailoverLiquidityAction::Observe => SignalStatus::Attested,
            };
        }
        if let Some(cohort) = self.cohorts.get_mut(&signal.cohort_id) {
            match request.action {
                ...
                StemRouteFailoverLiquidityAction::ApplyStemRouteFailoverCoverage => {
                    ...
                    cohort.stem_lane_failover_liquidity_micro_units = cohort
                        .stem_lane_failover_liquidity_micro_units
                        .saturating_sub(request.privacy_filtered_micro_units);
                    cohort.fluff_lane_failover_liquidity_micro_units = cohort
                        .fluff_lane_failover_liquidity_micro_units
                ...
                StemRouteFailoverLiquidityAction::QuarantineRoute => {
                    ...
                    cohort.privacy_filter_deadline_slot = privacy_filter_deadline_slot;
                    self.counters.failover_routes_quarantined =
                        self.counters.failover_routes_quarantined.saturating_add(1);
                }
                StemRouteFailoverLiquidityAction::EmergencyPause => {
                    cohort.status = CohortStatus::Paused;
                    cohort.privacy_filter_deadline_slot = privacy_filter_deadline_slot;
                    self.counters.failover_routes_quarantined =
                        self.counters.failover_routes_quarantined.saturating_add(1);
                }
                StemRouteFailoverLiquidityAction::Release => {
    ...
    pub fn publish_rebate(&mut self, request: PublishRebateRequest) -> Result<String> {
        ...
        let rebate_id = stable_id(
            "dandelion-stem-route-failover-liquidity-insurance-low-fee-rebate",
            &[
        ...
        self.rebates.insert(
            rebate_id.clone(),
            LowFeeStemRouteFailoverInsuranceRebate {
    ...
    pub fn publish_redaction_budget(
        ...
        let budget_id = stable_id(
            "dandelion-stem-route-failover-liquidity-insurance-redaction-budget",
            &[
                HashPart::Str(request.scope.as_str()),
                HashPart::Str(&request.cohort_id),
    ...
    pub fn publish_operator_summary(
        ...
        let summary_id = stable_id(
            "dandelion-stem-route-failover-liquidity-insurance-operator-summary",
            &[
                HashPart::U64(epoch),
                HashPart::U64(slot),
    ...
    fn refresh_roots(&mut self) {
        ...
        self.roots.state_root = merkle_root(
            "bridge-dandelion-stem-route-failover-liquidity-insurance:state",
            &[
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "pq_stem_route_insurance_suite": self.config.pq_stem_route_insurance_suite,
            "stem_route_failover_liquidity_insurance_suite": self.config.stem_route_failover_liquidity_insurance_suite,
            ...
            "stem_route_failover_liquidity_window_slots": self.config.stem_route_failover_liquidity_window_slots,
            "signal_window_slots": self.config.signal_window_slots,
            "max_failover_route_fee_bps": self.config.max_failover_route_fee_bps,
            ...
            "policies": self.policies.values().map(|policy| json!({
                ...
                "min_stem_lane_failover_liquidity_micro_units": policy.min_stem_lane_failover_liquidity_micro_units,
                "min_fluff_lane_failover_liquidity_micro_units": policy.min_fluff_lane_failover_liquidity_micro_units,
                "max_failover_route_fee_bps": policy.max_failover_route_fee_bps,
            ...
            "cohorts": self.cohorts.values().map(|cohort| json!({
                ...
                "stem_lane_failover_liquidity_micro_units": cohort.stem_lane_failover_liquidity_micro_units,
                "fluff_lane_failover_liquidity_micro_units": cohort.fluff_lane_failover_liquidity_micro_units,
                "privacy_set_size": cohort.privacy_set_size,
                "failover_route_fee_bps": cohort.failover_route_fee_bps,
...
pub fn demo() -> State {
    ...
    let signal = state
        .submit_signal(SubmitSignalRequest {
            ...
            observed_failover_route_root: devnet_root("observed-route", "demo-viewtag-pressure"),
            ...
            stem_lane_failover_liquidity_delta_micro_units: -10_000_000,
            fluff_lane_failover_liquidity_delta_micro_units: 8_000_000,
            privacy_set_size: 524_288,
    ...
    state
        .submit_attestation(SubmitAttestationRequest {
            signal_id: signal,
            verdict: AttestationVerdict::RequireStemRouteFailoverLiquidityCoverage,
            attestor_commitment: "attestor:demo-dandelion-stem-route-failover-liquidity-insurance"
                .to_string(),
...
fn object_root<T: Serialize>(domain: &str, value: &T) -> String {
    ...
    domain_hash(
        &format!("bridge-dandelion-stem-route-failover-liquidity-insurance:{domain}"),
        &[HashPart::Json(&value)],
        32,
    )
}
...
fn devnet_root(domain: &str, label: &str) -> String {
    domain_hash(
        &format!("bridge-dandelion-stem-route-failover-liquidity-insurance:devnet:{domain}"),
