...
pub type RegisterRouteBookRequest = RegisterSolverRequest;

pub const PRIVATE_L2_PQ_CONFIDENTIAL_TOKEN_BATCH_NETTING_ROUTER_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-token-batch-netting-router-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_PQ_CONFIDENTIAL_TOKEN_BATCH_NETTING_ROUTER_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const ROUTE_BOOK_SUITE: &str = "pq-confidential-token-batch-route-book-v1";
...
pub const FEE_REBATE_SUITE: &str = "confidential-token-batch-netting-router-fee-rebate-v1";
pub const SLASHING_EVIDENCE_SUITE: &str = "pq-signed-token-batch-netting-router-slashing-v1";
...
impl Config {
    ...
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_batch_netting_router_config",
...
impl Counters {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_batch_netting_router_counters",
...
impl SolverRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_batch_netting_router",
...
impl ClearingBatchRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_batch_netting_router_clearing_batch",
            "batch_id": self.batch_id,
            "request": self.request,
            "status": self.status.as_str(),
...
impl FeeRebateRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_batch_netting_router_fee_rebate",
...
impl SlashingEvidenceRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_batch_netting_router_slashing_evidence",
...
impl PublicRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_batch_netting_router_public_record",
...
impl Roots {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_batch_netting_router_roots",
...
impl State {
    ...
    pub fn public_record_without_roots(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_batch_netting_router_state",
    ...
    pub fn settle_clearing_batch(&mut self, request: SettleClearingBatchRequest) -> Result<String> {
        ...
        self.publish_public_record(
            ...
            &request.batch_id,
            json!({
                "kind": "private_l2_pq_confidential_token_batch_netting_router_settlement",
    ...
    pub fn register_route_book(&mut self, request: RegisterSolverRequest) -> Result<String> {
        self.register_solver(request)
    }
    ...
    pub fn submit_encrypted_intent(
        ...
        self.submit_sealed_intent(request)
    }

    pub fn commit_solver_path(&mut self, request: CommitSolverRouteRequest) -> Result<String> {
        self.commit_solver_route(request)
    }

    pub fn build_netted_batch(&mut self, request: BuildClearingBatchRequest) -> Result<String> {
        self.build_clearing_batch(request)
    }

    pub fn settle_batch(&mut self, request: SettleClearingBatchRequest) -> Result<String> {
        self.settle_clearing_batch(request)
    }

    pub fn publish_receipt_rebate(&mut self, request: IssueFeeRebateRequest) -> Result<String> {
        self.issue_fee_rebate(request)
    }

    pub fn challenge_slippage(
        &mut self,
        mut request: SubmitSlashingEvidenceRequest,
    ) -> Result<String> {
        request.reason = SlashReason::PriceManipulation;
        self.submit_slashing_evidence(request)
    }

    pub fn slash_stale_solver(
        &mut self,
        mut request: SubmitSlashingEvidenceRequest,
    ) -> Result<String> {
        request.reason = SlashReason::QuoteWithholding;
        self.submit_slashing_evidence(request)
    }
}
...
pub fn payload_root(domain: &str, payload: &Value) -> String {
    domain_hash(
        &format!("PRIVATE-L2-PQ-CONFIDENTIAL-TOKEN-BATCH-NETTING-ROUTER-{domain}"),
...
pub fn solver_id(request: &RegisterSolverRequest, nonce: u64) -> String {
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-TOKEN-BATCH-NETTING-ROUTER-ID",
        &[
            HashPart::Str(CHAIN_ID),
...
pub fn intent_id(request: &SubmitSealedSwapIntentRequest, nonce: u64) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-TOKEN-BATCH-NETTING-ROUTER-INTENT-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
...
pub fn commitment_id(request: &CommitSolverRouteRequest, score: u128, nonce: u64) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-TOKEN-BATCH-NETTING-ROUTER-COMMITMENT-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
...
pub fn quote_id(request: &RevealRouteQuoteRequest, score: u128, nonce: u64) -> String {
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-TOKEN-BATCH-NETTING-ROUTER-QUOTE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
...
pub fn fence_id(request: &RecordPrivacyFenceRequest, nonce: u64) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-TOKEN-BATCH-NETTING-ROUTER-FENCE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
            HashPart::Str(&request.intent_id),
...
pub fn batch_id(
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-TOKEN-BATCH-NETTING-ROUTER-BATCH-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
...
pub fn settlement_receipt_root(
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-TOKEN-BATCH-NETTING-ROUTER-SETTLEMENT-RECEIPT",
        &[
            HashPart::Str(CHAIN_ID),
...
pub fn rebate_id(request: &IssueFeeRebateRequest, nonce: u64) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-TOKEN-BATCH-NETTING-ROUTER-REBATE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
            HashPart::Str(&request.intent_id),
...
pub fn slash_id(
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-TOKEN-BATCH-NETTING-ROUTER-SLASH-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
            HashPart::Str(&request.solver_id),
...
pub fn public_record_id(
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-TOKEN-BATCH-NETTING-ROUTER-PUBLIC-RECORD-ID",
        &[
            HashPart::Str(CHAIN_ID),
...
pub fn roots_only_payload(
    ...
    json!({
        "kind": "private_l2_pq_confidential_token_batch_netting_router_roots_only_payload",
        "chain_id": CHAIN_ID,
