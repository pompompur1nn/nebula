...
pub type PrivateL2FastPqConfidentialWitnessDerivativeLatencyBankruptcyInsuranceFundRuntimeResult<
    T,
> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_FAST_PQ_CONFIDENTIAL_WITNESS_DERIVATIVE_LATENCY_BANKRUPTCY_INSURANCE_FUND_RUNTIME_PROTOCOL_VERSION: &str = "nebula-private-l2-fast-pq-confidential-witness-derivative-latency-bankruptcy-insurance-fund-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_FAST_PQ_CONFIDENTIAL_WITNESS_DERIVATIVE_LATENCY_BANKRUPTCY_INSURANCE_FUND_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "shake256-domain-separated-canonical-json-v1";
pub const PQ_INSURANCE_FUND_ATTESTATION_SUITE: &str =
    "ml-dsa-87+slh-dsa-shake-256f-latency-bankruptcy-insurance-fund-resolution-root-v1";
pub const INSURANCE_FUND_POSITION_SUITE: &str =
    "ml-kem-1024-sealed-defi-derivative-bankruptcy-insurance-fund-position-root-v1";
pub const SOCIALIZED_LOSS_SUITE: &str =
    "roots-only-socialized-loss-resolution-derivative-bankruptcy-insurance-fund-v1";
pub const PRIVACY_BOUNDARY: &str =
    "roots_only_no_plaintext_witnesses_addresses_keys_insurance_fund_terms_positions_losses_or_insurance_fund_members";
pub const PUBLIC_RECORD_SUITE: &str =
    "roots-only-private-l2-fast-pq-confidential-derivative-latency-bankruptcy-insurance-fund-record-v1";
...
pub const DEFAULT_INSURANCE_FUND_CYCLE_MS: u64 = 30;
...
pub const DEFAULT_INSURANCE_FUND_FEE_BPS: u64 = 32;
pub const DEFAULT_INSURANCE_FUND_DISCOUNT_BPS: u64 = 650;
...
pub const DEFAULT_MAX_INSURANCE_FUND_DRAWS: usize = 262_144;
pub const DEFAULT_ROOT_BYTES: usize = 32;

const D_CONFIG: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND:CONFIG";
const D_COUNTERS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND:COUNTERS";
const D_ROOTS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND:ROOTS";
const D_STATE: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND:STATE";
const D_POOLS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND:POOLS";
const D_CLAIMS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND:CLAIMS";
const D_CASES: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND:CASES";
const D_LOSS_EPOCHS: &str =
    "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND:SOCIALIZED-LOSS-EPOCHS";
const D_INSURANCE_FUND_DRAWS: &str =
    "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND:DRAWS";
const D_ATTESTATIONS: &str =
    "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND:ATTESTATIONS";
const D_RECEIPTS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND:RECEIPTS";
const D_NULLIFIERS: &str =
    "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND:NULLIFIERS";
const D_PUBLIC: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND:PUBLIC";
const D_DEVNET: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-BANKRUPTCY-INSURANCE-FUND:DEVNET";

#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum InsuranceFundMode {
    Continuous,
    BatchAuction,
    InsuranceFirst,
    SocializedLoss,
...
#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum InsuranceFundDrawStatus {
    Requested,
    Attested,
    Applied,
    Repaid,
...
pub struct Config {
    ...
    pub pq_insurance_fund_attestation_suite: String,
    pub insurance_fund_position_suite: String,
    pub socialized_loss_suite: String,
    pub roots_only_public_records: bool,
    pub min_pq_security_bits: u16,
    pub min_privacy_set_size: u64,
    pub target_privacy_set_size: u64,
    pub insurance_fund_cycle_ms: u64,
    pub max_latency_ms: u64,
    pub resolution_delay_slots: u64,
    pub low_fee_cap_bps: u64,
    pub taker_fee_bps: u64,
    pub insurance_fund_fee_bps: u64,
    pub insurance_fund_discount_bps: u64,
    ...
    pub max_insurance_fund_draws: usize,
}
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            pq_insurance_fund_attestation_suite: PQ_INSURANCE_FUND_ATTESTATION_SUITE.to_string(),
            insurance_fund_position_suite: INSURANCE_FUND_POSITION_SUITE.to_string(),
            socialized_loss_suite: SOCIALIZED_LOSS_SUITE.to_string(),
            roots_only_public_records: true,
            min_pq_security_bits: DEFAULT_MIN_PQ_SECURITY_BITS,
            min_privacy_set_size: DEFAULT_MIN_PRIVACY_SET_SIZE,
            target_privacy_set_size: DEFAULT_TARGET_PRIVACY_SET_SIZE,
            insurance_fund_cycle_ms: DEFAULT_INSURANCE_FUND_CYCLE_MS,
            max_latency_ms: DEFAULT_MAX_LATENCY_MS,
            resolution_delay_slots: DEFAULT_RESOLUTION_DELAY_SLOTS,
            low_fee_cap_bps: DEFAULT_LOW_FEE_CAP_BPS,
            taker_fee_bps: DEFAULT_TAKER_FEE_BPS,
            insurance_fund_fee_bps: DEFAULT_INSURANCE_FUND_FEE_BPS,
            insurance_fund_discount_bps: DEFAULT_INSURANCE_FUND_DISCOUNT_BPS,
            ...
            max_insurance_fund_draws: DEFAULT_MAX_INSURANCE_FUND_DRAWS,
        }
    }
}
...
impl Config {
    pub fn validate(&self) -> Result<()> {
        ...
        ensure_bps("insurance_fund_fee_bps", self.insurance_fund_fee_bps)?;
        ensure_bps(
            "insurance_fund_discount_bps",
            self.insurance_fund_discount_bps,
        )?;
        ...
        if self.insurance_fund_cycle_ms == 0 || self.max_latency_ms == 0 {
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "pq_insurance_fund_attestation_suite": self.pq_insurance_fund_attestation_suite,
            "insurance_fund_position_suite": self.insurance_fund_position_suite,
            ...
            "insurance_fund_cycle_ms": self.insurance_fund_cycle_ms,
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct RegisterInsuranceFundPoolInput {
    pub pool_id: String,
    pub derivative_class: DerivativeClass,
    pub bankruptcy_mode: InsuranceFundMode,
...
impl InsuranceFundPool {
    pub fn from_input(input: RegisterInsuranceFundPoolInput) -> Self {
        Self {
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct OpenInsuranceFundClaimInput {
    pub claim_id: String,
    pub pool_id: String,
    pub side: ClaimSide,
...
impl InsuranceFundClaim {
    pub fn from_input(input: OpenInsuranceFundClaimInput) -> Self {
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct RequestInsuranceFundDrawInput {
    pub draw_id: String,
    pub pool_id: String,
    pub case_id: String,
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct InsuranceFundDraw {
    pub draw_id: String,
    pub pool_id: String,
    pub case_id: String,
    pub status: InsuranceFundDrawStatus,
    pub provider_set_root: String,
    pub draw_commitment_root: String,
    pub repayment_terms_root: String,
    pub requested_micros: u64,
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct PqInsuranceFundAttestationInput {
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct PqInsuranceFundAttestation {
    pub attestation_id: String,
    pub subject_id: String,
    pub subject_root: String,
...
impl PqInsuranceFundAttestation {
    pub fn public_record(&self) -> Value {
        serde_json::to_value(self).unwrap_or_else(|_| json!({"serialization":"failed"}))
    }
}
...
pub struct State {
    ...
    pub roots: Roots,
    pub pools: BTreeMap<String, InsuranceFundPool>,
    pub claims: BTreeMap<String, InsuranceFundClaim>,
    ...
    pub insurance_fund_draws: BTreeMap<String, InsuranceFundDraw>,
    pub pq_attestations: BTreeMap<String, PqInsuranceFundAttestation>,
...
impl State {
    ...
    pub fn register_pool(&mut self, input: RegisterInsuranceFundPoolInput) -> Result<()> {
        ...
        let pool = InsuranceFundPool::from_input(input);
    ...
    pub fn open_claim(&mut self, input: OpenInsuranceFundClaimInput) -> Result<()> {
        ...
        let claim = InsuranceFundClaim::from_input(input);
    ...
    pub fn open_insurance_fund_resolution(
        ...
        let fee_savings_micros =
            fee_savings_for_resolution(deficit_micros, self.config.insurance_fund_discount_bps);
    ...
    pub fn request_insurance_fund_draw(
        &mut self,
        input: RequestInsuranceFundDrawInput,
    ) -> Result<()> {
        ensure_capacity(
            self.insurance_fund_draws.len(),
            self.config.max_insurance_fund_draws,
        ...
        pool.updated_at_height = input.height;
        let draw = InsuranceFundDraw {
            draw_id: input.draw_id,
            pool_id: input.pool_id,
            case_id: input.case_id,
            status: InsuranceFundDrawStatus::Requested,
    ...
    pub fn attest_insurance_fund_resolution(
        &mut self,
        input: PqInsuranceFundAttestationInput,
    ) -> Result<()> {
        ensure_capacity(
        ...
        let attestation = PqInsuranceFundAttestation {
    ...
    pub fn apply_insurance_fund_draw(&mut self, draw_id: &str, height: u64) -> Result<()> {
        ...
        if draw.status != InsuranceFundDrawStatus::Attested {
            return Err("insurance_fund draw must be PQ-attested before application".to_string());
        }
        draw.status = InsuranceFundDrawStatus::Applied;
    ...
    pub fn refresh_roots(&mut self) {
        ...
        self.roots.insurance_fund_draws_root =
            map_root(D_INSURANCE_FUND_DRAWS, &self.insurance_fund_draws);
    ...
    fn mark_subject_attested(&mut self, subject_id: &str) {
        ...
        if let Some(draw) = self.insurance_fund_draws.get_mut(subject_id) {
            draw.status = InsuranceFundDrawStatus::Attested;
...
pub fn devnet() -> State {
    ...
    state
        .register_pool(RegisterInsuranceFundPoolInput {
            pool_id: pool_id.clone(),
            derivative_class: DerivativeClass::BankruptcyInsuranceFund,
            bankruptcy_mode: InsuranceFundMode::SocializedLoss,
    ...
    state
        .open_claim(OpenInsuranceFundClaimInput {
    ...
    state
        .attest_insurance_fund_resolution(PqInsuranceFundAttestationInput {
...
fn bankruptcy_fee(gross: u128, deficit: u128, config: &Config) -> u64 {
    let fee_bps = config
        .taker_fee_bps
        .saturating_sub(config.insurance_fund_discount_bps.min(config.taker_fee_bps))
        .saturating_add(config.insurance_fund_fee_bps)
