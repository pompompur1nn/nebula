...
pub type PrivateL2LowFeeConfidentialTokenStreamingPaymentChannelRuntimeResult<T> = Result<T>;
pub type PrivateL2ConfidentialTokenStreamingRuntimeResult<T> = Result<T>;

pub const PROTOCOL_VERSION: &str =
    "nebula-private-l2-low-fee-confidential-token-streaming-payment-channel-runtime-v1";
pub const LOW_FEE_CONFIDENTIAL_TOKEN_STREAMING_PAYMENT_CHANNEL_PROTOCOL: &str = PROTOCOL_VERSION;
pub const PRIVATE_L2_CONFIDENTIAL_TOKEN_STREAMING_RUNTIME_PROTOCOL_VERSION: &str = PROTOCOL_VERSION;
...
pub const PRIVATE_L2_LOW_FEE_CONFIDENTIAL_TOKEN_STREAMING_PAYMENT_CHANNEL_RUNTIME_PROTOCOL_VERSION: &str = PROTOCOL_VERSION;
pub const PRIVATE_L2_LOW_FEE_CONFIDENTIAL_TOKEN_STREAMING_PAYMENT_CHANNEL_RUNTIME_CHANNEL_SCHEME:
    &str = "low-fee-confidential-token-streaming-payment-channel-root-v1";
pub const PRIVATE_L2_LOW_FEE_CONFIDENTIAL_TOKEN_STREAMING_PAYMENT_CHANNEL_RUNTIME_PQ_CHANNEL_AUTHORIZATION_SCHEME: &str = "ml-kem-1024+ml-dsa-87+slh-dsa-shake-256s-stream-channel-auth-v1";
pub const PRIVATE_L2_LOW_FEE_CONFIDENTIAL_TOKEN_STREAMING_PAYMENT_CHANNEL_RUNTIME_NETTING_SCHEME:
    &str = "low-fee-confidential-token-streaming-channel-netting-root-v1";
pub const PRIVATE_L2_LOW_FEE_CONFIDENTIAL_TOKEN_STREAMING_PAYMENT_CHANNEL_RUNTIME_DISPUTE_SCHEME:
    &str = "pause-close-confidential-stream-channel-dispute-root-v1";
pub const PRIVATE_L2_LOW_FEE_CONFIDENTIAL_TOKEN_STREAMING_PAYMENT_CHANNEL_RUNTIME_SLASHING_SCHEME: &str = "confidential-stream-channel-challenge-slashing-evidence-root-v1";

pub fn private_l2_low_fee_confidential_token_streaming_payment_channel_runtime_devnet() -> State {
    State::devnet()
}

pub fn private_l2_low_fee_confidential_token_streaming_payment_channel_runtime_public_record(
    state: &State,
) -> Value {
    state.public_record()
}

pub fn private_l2_low_fee_confidential_token_streaming_payment_channel_runtime_state_root(
    state: &State,
) -> String {
    state.state_root()
}

pub fn low_fee_streaming_payment_channel_id(
    ...
    domain_hash(
        "LOW-FEE-CONFIDENTIAL-TOKEN-STREAMING-PAYMENT-CHANNEL-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Str(payer_commitment),
            HashPart::Str(receiver_commitment),
...
pub fn low_fee_streaming_channel_authorization_id(
    channel_id: &str,
    role: AttestationParty,
    pq_key_commitment: &str,
    height: u64,
    nonce: u64,
) -> String {
    domain_hash(
        "LOW-FEE-CONFIDENTIAL-TOKEN-STREAMING-PQ-CHANNEL-AUTHORIZATION-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PROTOCOL_VERSION),
...
pub fn low_fee_streaming_channel_netting_root<I>(records: I) -> String
where
    I: IntoIterator<Item = Value>,
{
    merkle_root(
        PRIVATE_L2_LOW_FEE_CONFIDENTIAL_TOKEN_STREAMING_PAYMENT_CHANNEL_RUNTIME_NETTING_SCHEME,
        &records
            .into_iter()
            .map(|record| {
                json!(payload_root(
                    "LOW-FEE-STREAMING-CHANNEL-NETTING-LEAF",
                    &record
                ))
            })
            .collect::<Vec<_>>(),
...
pub fn low_fee_streaming_channel_dispute_root(record: &Value) -> String {
    payload_root(
        PRIVATE_L2_LOW_FEE_CONFIDENTIAL_TOKEN_STREAMING_PAYMENT_CHANNEL_RUNTIME_DISPUTE_SCHEME,
        record,
    )
}

pub fn low_fee_streaming_channel_slashing_evidence_root(record: &Value) -> String {
    payload_root(
        PRIVATE_L2_LOW_FEE_CONFIDENTIAL_TOKEN_STREAMING_PAYMENT_CHANNEL_RUNTIME_SLASHING_SCHEME,
        record,
    )
}
