...
const PROTOCOL_VERSION: &str =
    "wave104-live-heavy-gate-release-execution-monero-tx-relay-witness-confirmation-guard-compile-lane-runtime-v1";
const WAVE: u64 = 104;
const BROADCAST_QUARANTINE_WAVE: u64 = 103;
const MIN_CONFIRMATION_DEPTH: u64 = 10;
const MIN_RELAY_WITNESS_COUNT: u64 = 3;
const MIN_REORG_MONITOR_DEPTH: u64 = 720;
const LANE_ID: &str =
    "wave104-live-heavy-gate-release-execution-monero-tx-relay-witness-confirmation-guard-compile";
...
pub enum RelayWitnessConfirmationError {
    ...
    CompileSignedTransactionEnvelopeRootMissing,
...
impl LaneKind {
    ...
    pub fn command_scope(self) -> &'static str {
        match self {
            Self::Compile => "compile-monero-relay-witness-confirmation",
        }
    }
}
...
impl ConfirmationStatus {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::WitnessPending => "witness_pending",
...
pub enum ConfirmationBlockerKind {
    ...
    MissingCompileSignedTransactionEnvelopeRoot,
...
impl ConfirmationBlockerKind {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::MissingCompileSignedTransactionEnvelopeRoot => {
                "missing_compile_signed_transaction_envelope_root"
            }
...
pub struct Config {
    ...
    pub min_relay_witness_count: u64,
    pub min_reorg_monitor_depth: u64,
    pub require_wave103_broadcast_quarantine_root: bool,
    pub require_compile_signed_transaction_envelope_root: bool,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            min_relay_witness_count: MIN_RELAY_WITNESS_COUNT,
            min_reorg_monitor_depth: MIN_REORG_MONITOR_DEPTH,
            require_wave103_broadcast_quarantine_root: true,
            require_compile_signed_transaction_envelope_root: true,
...
impl Config {
    pub fn public_record(&self) -> PublicRecord {
        json!({
            ...
            "min_relay_witness_count": self.min_relay_witness_count,
            ...
            "require_compile_signed_transaction_envelope_root": self.require_compile_signed_transaction_envelope_root,
...
pub struct ConfirmationRoots {
    ...
    pub compile_signed_transaction_envelope_root: Option<String>,
...
impl ConfirmationRoots {
    pub fn public_record(&self) -> PublicRecord {
        json!({
            ...
            "compile_signed_transaction_envelope_root": self.compile_signed_transaction_envelope_root,
...
impl ConfirmationMeasurements {
    pub fn blocked(config: &Config) -> Self {
        Self {
            ...
            relay_witness_count: config.min_relay_witness_count.saturating_sub(1),
    ...
    pub fn public_record(self) -> PublicRecord {
        json!({
            ...
            "relay_witness_count": self.relay_witness_count,
...
impl ConfirmationPolicy {
    pub fn new(lane: LaneKind, claim_label: &str, ordinal: u64) -> Self {
        ...
        let command_hint = format!(
            "nebula wave104 relay-witness-confirmation --lane {} --claim {} --hold-release-credit",
            lane.as_str(),
            claim_label
        );
        Self {
...
impl RelayWitnessConfirmation {
    ...
    pub fn stage_confirmation(
        ...
        self.status = if self.blockers.is_empty() {
            ...
            ConfirmationStatus::WitnessPending
        } else {
    ...
    pub fn confirm_release_credit(mut self, config: &Config) -> Result<Self> {
        self.blockers = self.active_blockers(config);
    ...
    pub fn active_blockers(&self, config: &Config) -> Vec<ConfirmationBlockerKind> {
        ...
        if config.require_compile_signed_transaction_envelope_root
            && self
                .roots
                .compile_signed_transaction_envelope_root
                .is_none()
        {
            blockers.push(ConfirmationBlockerKind::MissingCompileSignedTransactionEnvelopeRoot);
        }
        ...
        if self.measurements.relay_witness_count < config.min_relay_witness_count {
            blockers.push(ConfirmationBlockerKind::RelayWitnessCountTooLow);
        }
        ...
        if config.deny_confirmation_when_any_blocker_active || !config.confirmation_allowed {
...
impl State {
    ...
    pub fn witness_pending_root(&self) -> String {
        status_root(
            "wave104_monero_tx_relay_witness_pending",
            &self.checkpoints,
            ConfirmationStatus::WitnessPending,
        )
    }
    ...
    pub fn public_record(&self) -> PublicRecord {
        json!({
            ...
            "witness_pending_root": self.witness_pending_root(),
