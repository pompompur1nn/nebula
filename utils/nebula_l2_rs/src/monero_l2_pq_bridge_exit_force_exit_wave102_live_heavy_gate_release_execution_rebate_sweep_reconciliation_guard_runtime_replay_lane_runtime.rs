...
const PROTOCOL_VERSION: &str = "wave102-live-heavy-gate-release-execution-rebate-sweep-reconciliation-guard-runtime-replay-lane-runtime-v1";
const WAVE: u64 = 102;
...
const LANE_ID: &str =
    "wave102-live-heavy-gate-release-execution-rebate-sweep-reconciliation-guard-runtime-replay";
...
pub fn devnet() -> State {
    ...
    let claim_labels = [
        "replay_archive_rebate",
        "deterministic_replay_fee_refund",
        "state_transition_liquidity_sweep",
        "rollback_residual_settlement",
        "watchtower_replay_root",
        "runtime_release_hold",
    ];
