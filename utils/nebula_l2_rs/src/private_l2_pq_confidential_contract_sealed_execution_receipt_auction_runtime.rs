...
pub type PrivateL2PqConfidentialContractSealedExecutionReceiptAuctionRuntimeResult<T> =
    std::result::Result<T, String>;
pub type Result<T> = PrivateL2PqConfidentialContractSealedExecutionReceiptAuctionRuntimeResult<T>;
pub type Runtime = State;

pub const PRIVATE_L2_PQ_CONFIDENTIAL_CONTRACT_SEALED_EXECUTION_RECEIPT_AUCTION_RUNTIME_PROTOCOL_VERSION:
    &str = "nebula-private-l2-pq-confidential-contract-sealed-execution-receipt-auction-runtime-v1";
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const SEALED_EXECUTION_RECEIPT_AUCTION_SUITE: &str =
    "sealed-confidential-smart-contract-execution-receipt-auction-v1";
pub const PRIVATE_EXECUTION_RECEIPT_BID_SUITE: &str = "private-execution-receipt-bid-commitment-v1";
pub const ENCRYPTED_CALL_RECEIPT_COMMITMENT_SUITE: &str =
    "ml-kem-1024-sealed-contract-call-receipt-commitment-v1";
pub const PQ_EXECUTOR_ATTESTATION_SUITE: &str =
    "ML-DSA-87+SLH-DSA-SHAKE-256f-pq-executor-attestation-v1";
pub const REPLAY_NULLIFIER_SUITE: &str = "sealed-execution-receipt-replay-nullifier-v1";
pub const LOW_FEE_SETTLEMENT_BATCH_SUITE: &str =
    "low-fee-confidential-contract-execution-receipt-settlement-batch-v1";
pub const SUBSCRIPTION_ACCOUNTING_SUITE: &str =
    "sealed-execution-receipt-subscription-accounting-root-v1";
pub const ROOTS_ONLY_EXECUTION_RECEIPT_PUBLIC_RECORD_SUITE: &str =
    "roots-only-public-record-confidential-contract-execution-receipt-auction-v1";
pub const RECEIPT_WINDOW_SCHEME: &str = "sealed-execution-receipt-auction-window-root-v1";
pub const PRIVATE_EXECUTION_RECEIPT_BID_SCHEME: &str =
    "private-contract-execution-receipt-bid-root-v1";
pub const ENCRYPTED_CALL_RECEIPT_COMMITMENT_SCHEME: &str =
    "encrypted-contract-call-receipt-commitment-root-v1";
pub const PQ_EXECUTOR_ATTESTATION_SCHEME: &str = "pq-contract-executor-attestation-root-v1";
pub const REPLAY_NULLIFIER_SCHEME: &str =
    "sealed-contract-execution-receipt-replay-nullifier-root-v1";
pub const LOW_FEE_SETTLEMENT_BATCH_SCHEME: &str =
    "low-fee-contract-execution-receipt-settlement-batch-root-v1";
pub const SUBSCRIPTION_ROOT_SCHEME: &str =
    "private-contract-execution-receipt-subscription-root-v1";
pub const ACCOUNTING_ROOT_SCHEME: &str = "private-contract-execution-receipt-accounting-root-v1";
pub const PUBLIC_RECORD_ROOT_SCHEME: &str =
    "private-contract-execution-receipt-public-record-root-v1";
pub const DEVNET_L2_NETWORK: &str = "nebula-private-l2-devnet";
pub const DEVNET_FEE_ASSET_ID: &str = "piconero-devnet";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_PQ_CONFIDENTIAL_CONTRACT_SEALED_EXECUTION_RECEIPT_AUCTION_RUNTIME_PROTOCOL_VERSION;
...
pub struct Config {
    ...
    pub SEALED_EXECUTION_RECEIPT_AUCTION_SUITE: String,
    pub PRIVATE_EXECUTION_RECEIPT_BID_SUITE: String,
    pub ENCRYPTED_CALL_RECEIPT_COMMITMENT_SUITE: String,
    ...
    pub ROOTS_ONLY_EXECUTION_RECEIPT_PUBLIC_RECORD_SUITE: String,
...
impl Config {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "SEALED_EXECUTION_RECEIPT_AUCTION_SUITE": self.SEALED_EXECUTION_RECEIPT_AUCTION_SUITE,
            "PRIVATE_EXECUTION_RECEIPT_BID_SUITE": self.PRIVATE_EXECUTION_RECEIPT_BID_SUITE,
            "ENCRYPTED_CALL_RECEIPT_COMMITMENT_SUITE": self.ENCRYPTED_CALL_RECEIPT_COMMITMENT_SUITE,
            "PQ_EXECUTOR_ATTESTATION_SUITE": self.PQ_EXECUTOR_ATTESTATION_SUITE,
            ...
            "ROOTS_ONLY_EXECUTION_RECEIPT_PUBLIC_RECORD_SUITE": self.ROOTS_ONLY_EXECUTION_RECEIPT_PUBLIC_RECORD_SUITE,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            SEALED_EXECUTION_RECEIPT_AUCTION_SUITE: SEALED_EXECUTION_RECEIPT_AUCTION_SUITE
                .to_string(),
            PRIVATE_EXECUTION_RECEIPT_BID_SUITE: PRIVATE_EXECUTION_RECEIPT_BID_SUITE.to_string(),
            ENCRYPTED_CALL_RECEIPT_COMMITMENT_SUITE: ENCRYPTED_CALL_RECEIPT_COMMITMENT_SUITE
                .to_string(),
            ...
            ROOTS_ONLY_EXECUTION_RECEIPT_PUBLIC_RECORD_SUITE:
                ROOTS_ONLY_EXECUTION_RECEIPT_PUBLIC_RECORD_SUITE.to_string(),
...
pub struct Counters {
    ...
    pub private_execution_receipt_bids: u64,
    pub encrypted_call_receipt_commitments: u64,
    pub pq_executor_attestations: u64,
...
impl Counters {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "private_execution_receipt_bids": self.private_execution_receipt_bids,
            "encrypted_call_receipt_commitments": self.encrypted_call_receipt_commitments,
            "pq_executor_attestations": self.pq_executor_attestations,
...
impl Default for Counters {
    fn default() -> Self {
        Self {
            receipt_windows: 0,
            private_execution_receipt_bids: 0,
            encrypted_call_receipt_commitments: 0,
            pq_executor_attestations: 0,
            replay_nullifiers: 0,
...
pub struct Roots {
    ...
    pub private_execution_receipt_bid_root: String,
    pub encrypted_receipt_commitment_root: String,
    pub pq_executor_attestation_root: String,
...
impl Roots {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "private_execution_receipt_bid_root": self.private_execution_receipt_bid_root,
            "encrypted_receipt_commitment_root": self.encrypted_receipt_commitment_root,
            "pq_executor_attestation_root": self.pq_executor_attestation_root,
...
impl Default for Roots {
    fn default() -> Self {
        Self {
            ...
            private_execution_receipt_bid_root: String::new(),
            encrypted_receipt_commitment_root: String::new(),
            pq_executor_attestation_root: String::new(),
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct PrivateExecutionReceiptBid {
    pub bid_id: String,
    pub window_id: String,
...
impl PrivateExecutionReceiptBid {
    pub fn public_record(&self) -> Value {
        json!({
            "bid_id": self.bid_id,
            "window_id": self.window_id,
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct EncryptedCallReceiptCommitment {
...
impl EncryptedCallReceiptCommitment {
    pub fn public_record(&self) -> Value {
        json!({
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct PqExecutorAttestation {
    pub attestation_id: String,
    pub commitment_id: String,
    pub executor_committee_id: String,
    pub executor_key_root: String,
...
impl PqExecutorAttestation {
    pub fn public_record(&self) -> Value {
        json!({
            "attestation_id": self.attestation_id,
            "commitment_id": self.commitment_id,
            "executor_committee_id": self.executor_committee_id,
            "executor_key_root": self.executor_key_root,
            "status": self.status.as_str(),
            "scheme": self.scheme,
...
pub struct State {
    ...
    pub private_execution_receipt_bids: BTreeMap<String, PrivateExecutionReceiptBid>,
    pub encrypted_call_receipt_commitments: BTreeMap<String, EncryptedCallReceiptCommitment>,
    pub pq_executor_attestations: BTreeMap<String, PqExecutorAttestation>,
...
impl State {
    pub fn new(config: Config) -> Self {
        let mut state = Self {
            ...
            private_execution_receipt_bids: BTreeMap::new(),
            encrypted_call_receipt_commitments: BTreeMap::new(),
            pq_executor_attestations: BTreeMap::new(),
    ...
    pub fn submit_private_execution_receipt_bid(
        &mut self,
        ...
        let record = PrivateExecutionReceiptBid {
            bid_id: bid_id.clone(),
        ...
        self.private_execution_receipt_bids
            .insert(bid_id.clone(), record);
        self.replay_nullifiers
            .insert(input.replay_nullifier, nullifier);
        self.counters.private_execution_receipt_bids += 1;
    ...
    pub fn commit_encrypted_receipts(&mut self, input: CommitReceiptInput) -> Result<String> {
        let bid = self
            .private_execution_receipt_bids
            .get(&input.bid_id)
        ...
        let record = EncryptedCallReceiptCommitment {
        ...
        if let Some(b) = self.private_execution_receipt_bids.get_mut(&input.bid_id) {
        ...
        self.encrypted_call_receipt_commitments
            .insert(commitment_id.clone(), record);
        self.counters.encrypted_call_receipt_commitments += 1;
    ...
    pub fn attest_receipt_commitment(&mut self, input: AttestReceiptInput) -> Result<String> {
        let commitment = self
            .encrypted_call_receipt_commitments
        ...
        let attestation_id = id(
            ...
            &[
                ...
                HashPart::Str(&input.executor_committee_id),
                HashPart::Str(&input.signature_root),
            ],
        );
        let record = PqExecutorAttestation {
            attestation_id: attestation_id.clone(),
            commitment_id: input.commitment_id.clone(),
            executor_committee_id: input.executor_committee_id,
            executor_key_root: input.executor_key_root,
            status: if input.quorum_bps >= self.config.strict_quorum_bps {
                AttestationStatus::QuorumSigned
            } else {
                AttestationStatus::Authenticated
            },
            scheme: PQ_EXECUTOR_ATTESTATION_SUITE.to_string(),
        ...
        self.pq_executor_attestations
            .insert(attestation_id.clone(), record);
        self.counters.pq_executor_attestations += 1;
        self.push_event(
            input.signed_height,
    ...
    pub fn settle_low_fee_batch(&mut self, input: SettleBatchInput) -> Result<String> {
        ...
        for commitment_id in &input.commitment_ids {
            ...
            if let Some(bid) = self.private_execution_receipt_bids.get(&commitment.bid_id) {
        ...
        for idv in &input.commitment_ids {
            if let Some(c) = self.encrypted_call_receipt_commitments.get_mut(idv) {
    ...
    pub fn post_accounting(
        ...
        let accounting_root = id(
            "execution-receipt-accounting-root",
    ...
    fn push_event(
        ...
        let event_id = id(
            "sealed-execution-receipt-auction-runtime-event",
            &[
                HashPart::U64(height),
    ...
    pub fn public_record_without_state_root(&self) -> Value {
        json!({ "kind": "private_l2_pq_confidential_contract_sealed_execution_receipt_auction_runtime_state", "protocol_version": PROTOCOL_VERSION, "schema_version": SCHEMA_VERSION, "chain_id": CHAIN_ID, "config": self.config.public_record(), "counters": self.counters.public_record(), "roots": self.roots.public_record() })
    }
    pub fn public_record(&self) -> Value {
    ...
    pub fn recompute_counters(&mut self) {
        ...
        self.counters.private_execution_receipt_bids =
            self.private_execution_receipt_bids.len() as u64;
        self.counters.encrypted_call_receipt_commitments =
            self.encrypted_call_receipt_commitments.len() as u64;
        self.counters.pq_executor_attestations = self.pq_executor_attestations.len() as u64;
    ...
    pub fn compute_roots(&self) -> Roots {
        Roots {
            config_root: record_root(
                "SEALED-EXECUTION-RECEIPT-AUCTION-CONFIG",
            ...
            private_execution_receipt_bid_root: map_root(
                PRIVATE_EXECUTION_RECEIPT_BID_SCHEME,
                self.private_execution_receipt_bids
                    .values()
                    .map(PrivateExecutionReceiptBid::public_record),
            ),
            encrypted_receipt_commitment_root: map_root(
                ENCRYPTED_CALL_RECEIPT_COMMITMENT_SCHEME,
                self.encrypted_call_receipt_commitments
                    .values()
                    .map(EncryptedCallReceiptCommitment::public_record),
            ),
            pq_executor_attestation_root: map_root(
                PQ_EXECUTOR_ATTESTATION_SCHEME,
                self.pq_executor_attestations
                    .values()
                    .map(PqExecutorAttestation::public_record),
            ),
            ...
            runtime_event_root: map_root(
                "sealed-execution-receipt-auction-runtime-eventS",
                self.runtime_events
                    .values()
