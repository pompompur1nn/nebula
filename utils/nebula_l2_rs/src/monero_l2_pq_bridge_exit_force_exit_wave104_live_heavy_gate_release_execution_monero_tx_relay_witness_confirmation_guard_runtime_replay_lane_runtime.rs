...
const PROTOCOL_VERSION: &str = "wave104-live-heavy-gate-release-execution-monero-tx-relay-witness-confirmation-guard-runtime-replay-lane-runtime-v1";
const WAVE: u64 = 104;
const PRIOR_WAVE: u64 = 103;
const LANE_ID: &str =
    "wave104-live-heavy-gate-release-execution-monero-tx-relay-witness-confirmation-guard-runtime-replay";
...
pub enum RelayWitnessConfirmationError {
    ...
    ReplaySignedTransactionEnvelopeRootMissing,
    DeterministicRelayReplayRootMissing,
...
impl LaneKind {
    ...
    pub fn command_scope(self) -> &'static str {
        match self {
            Self::RuntimeReplay => "runtime-replay-relay-witness-confirmation",
        }
    }
}
...
impl ConfirmationStatus {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ConfirmationCandidate => "confirmation_candidate",
...
pub enum ConfirmationBlockerKind {
    ...
    MissingReplaySignedTransactionEnvelopeRoot,
    MissingDeterministicRelayReplayRoot,
...
impl ConfirmationBlockerKind {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::MissingReplaySignedTransactionEnvelopeRoot => {
                "missing_replay_signed_transaction_envelope_root"
            }
            Self::MissingDeterministicRelayReplayRoot => "missing_deterministic_relay_replay_root",
...
pub struct Config {
    ...
    pub require_replay_signed_transaction_envelope_root: bool,
    pub require_deterministic_relay_replay_root: bool,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            require_replay_signed_transaction_envelope_root: true,
            require_deterministic_relay_replay_root: true,
...
impl Config {
    pub fn public_record(&self) -> PublicRecord {
        json!({
            ...
            "require_replay_signed_transaction_envelope_root": self.require_replay_signed_transaction_envelope_root,
            "require_deterministic_relay_replay_root": self.require_deterministic_relay_replay_root,
...
pub struct ConfirmationRoots {
    ...
    pub replay_signed_transaction_envelope_root: Option<String>,
    pub deterministic_relay_replay_root: Option<String>,
...
impl ConfirmationRoots {
    pub fn public_record(&self) -> PublicRecord {
        json!({
            ...
            "replay_signed_transaction_envelope_root": self.replay_signed_transaction_envelope_root,
            "deterministic_relay_replay_root": self.deterministic_relay_replay_root,
...
pub struct ConfirmationPolicy {
    ...
    pub relay_replay_policy_root: String,
...
impl ConfirmationPolicy {
    pub fn new(lane: LaneKind, claim_label: &str, ordinal: u64) -> Self {
        ...
        Self {
            ...
            relay_replay_policy_root: label_root(
                "relay_replay_policy",
                lane.as_str(),
                claim_label,
                ordinal,
            ...
            authorization_policy_root: label_root(
    ...
    pub fn public_record(&self) -> PublicRecord {
        json!({
            ...
            "relay_replay_policy_root": self.relay_replay_policy_root,
...
impl RelayWitnessConfirmation {
    ...
    pub fn stage_roots(mut self, roots: ConfirmationRoots, config: &Config) -> Self {
        self.roots = roots;
        self.blockers = self.active_blockers(config);
        self.status = if self.blockers.is_empty() {
            ConfirmationStatus::ConfirmationCandidate
            ...
            ConfirmationStatus::RelayAccepted
        } else if self.roots.deterministic_relay_replay_root.is_some() {
            ConfirmationStatus::ReplayCandidate
        } else {
    ...
    pub fn mark_confirmed(mut self, config: &Config) -> Result<Self> {
        self.blockers = self.active_blockers(config);
    ...
    pub fn active_blockers(&self, config: &Config) -> Vec<ConfirmationBlockerKind> {
        ...
        if config.require_replay_signed_transaction_envelope_root
            && self.roots.replay_signed_transaction_envelope_root.is_none()
        {
            blockers.push(ConfirmationBlockerKind::MissingReplaySignedTransactionEnvelopeRoot);
        }
        if config.require_deterministic_relay_replay_root
            && self.roots.deterministic_relay_replay_root.is_none()
        {
            blockers.push(ConfirmationBlockerKind::MissingDeterministicRelayReplayRoot);
        }
...
impl State {
    ...
    pub fn replay_candidate_root(&self) -> String {
        status_root(
            "wave104_relay_witness_replay_candidates",
            &self.checkpoints,
            ConfirmationStatus::ReplayCandidate,
        )
    }

    pub fn relay_accepted_root(&self) -> String {
        status_root(
            "wave104_relay_witness_mempool_accepted",
            &self.checkpoints,
            ConfirmationStatus::RelayAccepted,
        )
    }
    ...
    pub fn inclusion_candidate_root(&self) -> String {
        status_root(
            "wave104_relay_witness_inclusion_candidates",
            &self.checkpoints,
            ConfirmationStatus::InclusionCandidate,
        )
    }

    pub fn confirmation_candidate_root(&self) -> String {
        status_root(
            "wave104_relay_witness_confirmation_candidates",
            &self.checkpoints,
            ConfirmationStatus::ConfirmationCandidate,
        )
    }
    ...
    pub fn confirmed_root(&self) -> String {
        status_root(
            "wave104_relay_witness_confirmed_claims",
            &self.checkpoints,
    ...
    pub fn confirmation_denial_root(&self) -> String {
        let blocker_labels = self
            ...
            .collect::<Vec<_>>();
        root_from_strings(
            "wave104_relay_witness_confirmation_denial_blockers",
            blocker_labels,
        )
    }
    ...
    pub fn public_record(&self) -> PublicRecord {
        json!({
            ...
            "relay_accepted_root": self.relay_accepted_root(),
            "inclusion_candidate_root": self.inclusion_candidate_root(),
            "confirmation_candidate_root": self.confirmation_candidate_root(),
...
pub fn devnet() -> State {
    ...
    let claim_labels = [
        ...
        "replay_signed_transaction_envelope",
        "deterministic_relay_replay",
        "mempool_acceptance",
        "txid_commitment",
...
fn blocked_root(checkpoints: &[RelayWitnessConfirmation]) -> String {
    let leaves = checkpoints
        ...
        .collect::<Vec<_>>();
    merkle_root("wave104_blocked_relay_witness_confirmation_guards", &leaves)
}
...
fn relay_witness_confirmation_guard_root(
    guard_kind: &str,
    lane: LaneKind,
    claim_label: &str,
    ordinal: u64,
...
pub fn devnet_relay_witness_confirmation_guard_root() -> String {
    let state = devnet();
    relay_witness_confirmation_guard_root(
        "devnet_confirmation_hold",
        state.lane,
        LANE_ID,
        WAVE,
        &state.blocked_root(),
        &state.confirmation_denial_root(),
    )
}
