...
pub type PrivateL2FastPqConfidentialRecursiveWitnessLatencyAuctionRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_FAST_PQ_CONFIDENTIAL_RECURSIVE_WITNESS_LATENCY_AUCTION_RUNTIME_PROTOCOL_VERSION:
    &str = "nebula-private-l2-fast-pq-confidential-recursive-witness-latency-auction-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_FAST_PQ_CONFIDENTIAL_RECURSIVE_WITNESS_LATENCY_AUCTION_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "shake256-domain-separated-canonical-json-v1";
pub const RECURSIVE_WITNESS_AUCTION_SUITE: &str =
    "private-l2-fast-pq-confidential-recursive-witness-latency-auction-v1";
pub const PRECONFIRMATION_AUCTION_CURVE_SUITE: &str =
    "ml-kem-1024-sealed-preconfirmation-recursive-witness-auction-curve-v1";
pub const PQ_LANE_ATTESTATION_SUITE: &str =
    "ml-dsa-87+slh-dsa-shake-256f-recursive-witness-auction-lane-attestation-v1";
pub const WITNESS_DELIVERY_QOS_SUITE: &str =
    "private-l2-fast-confidential-recursive-witness-delivery-qos-score-v1";
pub const FEE_AWARE_SETTLEMENT_SUITE: &str =
    "private-l2-fast-confidential-recursive-witness-auction-fee-aware-settlement-v1";
pub const PUBLIC_RECORD_SCHEME: &str =
    "privacy-preserving-public-recursive-witness-latency-auction-record-v1";
pub const PRIVACY_BOUNDARY: &str =
    "roots_only_no_plaintext_witnesses_addresses_view_keys_payloads_curve_points_fee_amounts_or_witnesses";
...
pub const DEFAULT_AUCTION_TTL_SLOTS: u64 = 88;
...
pub const DEFAULT_MAX_AUCTION_ORDERS: usize = 1_048_576;
...
pub const DEFAULT_TARGET_WITNESS_FILL_BPS: u64 = 8_950;
...
pub const DEFAULT_LATE_WITNESS_PENALTY_BPS: u64 = 1_725;
...
const D_CONFIG: &str = "PL2-FAST-PQ-CONF-RECURSIVE-WITNESS-LATENCY-AUCTION:CONFIG";
const D_COUNTERS: &str = "PL2-FAST-PQ-CONF-RECURSIVE-WITNESS-LATENCY-AUCTION:COUNTERS";
const D_ROOTS: &str = "PL2-FAST-PQ-CONF-RECURSIVE-WITNESS-LATENCY-AUCTION:ROOTS";
const D_STATE: &str = "PL2-FAST-PQ-CONF-RECURSIVE-WITNESS-LATENCY-AUCTION:STATE";
const D_LANES: &str = "PL2-FAST-PQ-CONF-RECURSIVE-WITNESS-LATENCY-AUCTION:LANES";
const D_ORDERS: &str = "PL2-FAST-PQ-CONF-RECURSIVE-WITNESS-LATENCY-AUCTION:ORDERS";
const D_CURVES: &str = "PL2-FAST-PQ-CONF-RECURSIVE-WITNESS-LATENCY-AUCTION:CURVES";
const D_ATTESTATIONS: &str = "PL2-FAST-PQ-CONF-RECURSIVE-WITNESS-LATENCY-AUCTION:ATTESTATIONS";
const D_QOS: &str = "PL2-FAST-PQ-CONF-RECURSIVE-WITNESS-LATENCY-AUCTION:QOS";
const D_SETTLEMENTS: &str = "PL2-FAST-PQ-CONF-RECURSIVE-WITNESS-LATENCY-AUCTION:SETTLEMENTS";
const D_NULLIFIERS: &str = "PL2-FAST-PQ-CONF-RECURSIVE-WITNESS-LATENCY-AUCTION:NULLIFIERS";
const D_PUBLIC: &str = "PL2-FAST-PQ-CONF-RECURSIVE-WITNESS-LATENCY-AUCTION:PUBLIC";
const D_DEVNET: &str = "PL2-FAST-PQ-CONF-RECURSIVE-WITNESS-LATENCY-AUCTION:DEVNET";
...
#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum RecursiveWitnessClass {
    ValidityRollup,
    StateTransition,
    ReceiptInclusion,
    NullifierBatch,
...
pub enum AuctionSide {
    BuyLatency,
    SellWitnessAvailability,
    SponsorPreconfirmation,
    BackstopWitnessDelivery,
}
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            auction_ttl_slots: DEFAULT_AUCTION_TTL_SLOTS,
            ...
            max_auction_orders: DEFAULT_MAX_AUCTION_ORDERS,
            ...
            target_witness_fill_bps: DEFAULT_TARGET_WITNESS_FILL_BPS,
            ...
            late_witness_penalty_bps: DEFAULT_LATE_WITNESS_PENALTY_BPS,
...
impl Config {
    pub fn validate(&self) -> Result<()> {
        ...
        ensure_positive_u64("auction_ttl_slots", self.auction_ttl_slots)?;
        ...
        ensure_positive_usize("max_auction_orders", self.max_auction_orders)?;
        ...
        ensure_bps("target_witness_fill_bps", self.target_witness_fill_bps)?;
        ...
        ensure_bps("late_witness_penalty_bps", self.late_witness_penalty_bps)?;
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "recursive_witness_auction_suite": RECURSIVE_WITNESS_AUCTION_SUITE,
            "preconfirmation_auction_curve_suite": PRECONFIRMATION_AUCTION_CURVE_SUITE,
            "pq_lane_attestation_suite": PQ_LANE_ATTESTATION_SUITE,
            "witness_delivery_qos_suite": WITNESS_DELIVERY_QOS_SUITE,
...
pub struct Roots {
    ...
    pub auction_orders_root: String,
...
impl Default for Roots {
    fn default() -> Self {
        Self {
            ...
            auction_orders_root: empty_root(D_ORDERS),
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct ConfidentialRecursiveWitnessLane {
    pub lane_id: String,
    pub operator_commitment: String,
    pub lane_class: LaneClass,
    pub status: LaneStatus,
    pub pq_attestation_key_root: String,
    pub witness_capacity_commitment: String,
...
impl ConfidentialRecursiveWitnessLane {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "confidential_recursive_witness_lane",
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct RecursiveWitnessAuctionOrder {
    pub auction_id: String,
    pub lane_id: String,
    pub side: AuctionSide,
    pub witness_class: RecursiveWitnessClass,
...
impl RecursiveWitnessAuctionOrder {
    ...
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "recursive_witness_auction_order",
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct OpenAuctionOrderInput {
    pub auction_id: String,
    pub lane_id: String,
    pub side: AuctionSide,
    pub witness_class: RecursiveWitnessClass,
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct PreconfirmationAuctionCurve {
    pub curve_id: String,
    pub lane_id: String,
...
impl PreconfirmationAuctionCurve {
    pub fn accepts(&self, order: &RecursiveWitnessAuctionOrder, slot: u64) -> bool {
        self.status.live()
    ...
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "preconfirmation_auction_curve",
...
pub struct PqLaneAttestation {
    ...
    pub recursive_witness_root: String,
...
impl PqLaneAttestation {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "lane_id": self.lane_id,
            "auction_id": self.auction_id,
            "recursive_witness_root": self.recursive_witness_root,
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct WitnessDeliveryQosScore {
    pub qos_id: String,
    pub lane_id: String,
    pub auction_id: String,
    pub recursive_witness_root: String,
...
impl WitnessDeliveryQosScore {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "witness_delivery_qos_score",
            "qos_id": self.qos_id,
            "lane_id": self.lane_id,
            "auction_id": self.auction_id,
            "recursive_witness_root": self.recursive_witness_root,
...
pub struct State {
    ...
    pub roots: Roots,
    pub lanes: BTreeMap<String, ConfidentialRecursiveWitnessLane>,
    pub auction_orders: BTreeMap<String, RecursiveWitnessAuctionOrder>,
    pub curves: BTreeMap<String, PreconfirmationAuctionCurve>,
    pub attestations: BTreeMap<String, PqLaneAttestation>,
    pub delivery_qos: BTreeMap<String, WitnessDeliveryQosScore>,
...
impl State {
    pub fn new(config: Config) -> Self {
        config
            .validate()
            .expect("recursive witness latency auction config must validate");
        let mut state = Self {
            config,
    ...
    pub fn register_lane(&mut self, input: RegisterLaneInput) -> Result<String> {
        ...
        ensure_root(
            "witness_capacity_commitment",
            &input.witness_capacity_commitment,
        )?;
        ...
        let mut lane = ConfidentialRecursiveWitnessLane {
            ...
            witness_capacity_commitment: input.witness_capacity_commitment,
    ...
    pub fn open_auction_order(&mut self, input: OpenAuctionOrderInput) -> Result<String> {
        ensure_nonempty("auction_id", &input.auction_id)?;
        ensure_nonempty("lane_id", &input.lane_id)?;
        ensure_root(
        ...
        ensure_absent("auction_order", &self.auction_orders, &input.auction_id)?;
        ensure_capacity(
            "auction_orders",
            self.auction_orders.len(),
            self.config.max_auction_orders,
        )?;
        if self.consumed_nullifiers.contains(&input.nullifier) {
            return Err("auction order nullifier already consumed".to_string());
        }
        ...
        if !lane.status.accepts_orders() {
            return Err("lane does not accept auction orders".to_string());
        }
        ...
        let expires_at_slot = input
            .created_at_slot
            .saturating_add(self.config.auction_ttl_slots);
        let mut order = RecursiveWitnessAuctionOrder {
            auction_id: input.auction_id.clone(),
            lane_id: input.lane_id,
            side: input.side,
            witness_class: input.witness_class,
            ...
            qos_score_id: None,
            settlement_id: None,
            sequence: self.counters.auction_orders_opened.saturating_add(1),
            root: String::new(),
        };
        order.root = payload_root(D_ORDERS, &record_without_root(&order));
        self.counters.auction_orders_opened = self.counters.auction_orders_opened.saturating_add(1);
        ...
        self.auction_orders.insert(input.auction_id.clone(), order);
        self.refresh_roots();
        Ok(input.auction_id)
    }
    ...
    pub fn post_curve(&mut self, input: PostCurveInput) -> Result<String> {
        ...
        let mut curve = PreconfirmationAuctionCurve {
    ...
    pub fn match_curve(&mut self, auction_id: &str, curve_id: &str, slot: u64) -> Result<()> {
        let order = self
            .auction_orders
            .get(auction_id)
            .ok_or_else(|| format!("unknown auction order `{auction_id}`"))?
            .clone();
        let curve = self
            .curves
            .get(curve_id)
        ...
        if !curve.accepts(&order, slot) {
            return Err("curve does not accept auction order at slot".to_string());
        }

        if let Some(order) = self.auction_orders.get_mut(auction_id) {
            order.status = AuctionStatus::CurveMatched;
    ...
    pub fn submit_attestation(&mut self, input: SubmitAttestationInput) -> Result<String> {
        ...
        ensure_root("recursive_witness_root", &input.recursive_witness_root)?;
        ensure_root(
        ...
        let order = self
            ...
            .ok_or_else(|| format!("unknown auction order `{}`", input.auction_id))?;
        if order.lane_id != input.lane_id {
            return Err("attestation lane does not match auction order".to_string());
        }
        if input.quorum_weight_bps < self.config.min_quorum_weight_bps {
        ...
        let mut attestation = PqLaneAttestation {
            ...
            recursive_witness_root: input.recursive_witness_root,
        ...
        if matches!(input.verdict, AttestationVerdict::Slash) {
            self.mark_order_slashed(&input.auction_id)?;
        } else if let Some(order) = self.auction_orders.get_mut(&input.auction_id) {
            order.status = if matches!(input.verdict, AttestationVerdict::Include) {
                AuctionStatus::Attested
            } else {
                AuctionStatus::Recursing
            };
            order.sequence = order.sequence.saturating_add(1);
    ...
    pub fn score_delivery(&mut self, input: ScoreDeliveryInput) -> Result<String> {
        ...
        let order = self
            ...
            .clone();
        if order.lane_id != input.lane_id {
            return Err("qos lane does not match auction order".to_string());
        }
        ...
        let mut score = WitnessDeliveryQosScore {
        ...
        if let Some(order) = self.auction_orders.get_mut(&input.auction_id) {
    ...
    pub fn settle_auction(&mut self, input: SettleAuctionInput) -> Result<String> {
        ...
        if order.matched_curve_id.as_deref() != Some(input.curve_id.as_str()) {
            return Err("auction order is not matched to settlement curve".to_string());
        }
        ...
        let qos_id = order
            .qos_score_id
            .as_ref()
            .ok_or_else(|| "auction order has no witness delivery qos score".to_string())?;
        let qos = self
            .delivery_qos
            .get(qos_id)
        ...
        } else if matches!(order.status, AuctionStatus::Late) {
    ...
    pub fn cancel_order(&mut self, auction_id: &str) -> Result<()> {
        let order = self
            .auction_orders
            .get_mut(auction_id)
            .ok_or_else(|| format!("unknown auction order `{auction_id}`"))?;
        if !matches!(
            order.status,
            AuctionStatus::Open | AuctionStatus::CurveMatched
        ) {
            return Err("only open or curve-matched auction orders can be cancelled".to_string());
        }
    ...
    pub fn expire_orders(&mut self, slot: u64) -> Vec<String> {
        ...
        for (auction_id, order) in self.auction_orders.iter_mut() {
            if order.is_expired(slot) {
                order.status = AuctionStatus::Expired;
                order.sequence = order.sequence.saturating_add(1);
                order.root = payload_root(D_ORDERS, &record_without_root(order));
                expired.push(auction_id.clone());
            }
        }
        if !expired.is_empty() {
    ...
    pub fn public_record(&mut self, height: u64, epoch: u64) -> Result<PublicRecord> {
        ...
        let public_root = payload_root(
            ...
            &json!({
                ...
                "auction_orders_root": self.roots.auction_orders_root,
        ...
        let record = PublicRecord {
            ...
            auction_orders_root: self.roots.auction_orders_root.clone(),
    ...
    pub fn refresh_roots(&mut self) {
        ...
        self.roots.auction_orders_root =
            merkle_records(D_ORDERS, &self.public_auction_order_records());
    ...
    fn mark_order_slashed(&mut self, auction_id: &str) -> Result<()> {
        let order = self
            .auction_orders
            .get_mut(auction_id)
            .ok_or_else(|| format!("unknown auction order `{auction_id}`"))?;
        order.status = AuctionStatus::Slashed;
        order.sequence = order.sequence.saturating_add(1);
        order.root = payload_root(D_ORDERS, &record_without_root(order));
    ...
    fn refresh_lane_scores(&mut self, lane_id: &str) -> Result<()> {
        ...
        } else if lane.rolling_fill_bps >= self.config.target_witness_fill_bps {
            LaneStatus::Hot
    ...
    fn compute_settlement_pricing(
        &self,
        order: &RecursiveWitnessAuctionOrder,
        curve: &PreconfirmationAuctionCurve,
        qos: &WitnessDeliveryQosScore,
        lane: &ConfidentialRecursiveWitnessLane,
        priority_fee_micros: u64,
    ) -> SettlementPricing {
        let complexity_fee = order
            .notional_fee_micros
            .saturating_mul(order.witness_class.complexity_weight())
        ...
        let late_penalty_micros = if qos.aggregate_qos_bps < self.config.min_delivery_qos_bps {
            gross_fee_micros
                .saturating_mul(self.config.late_witness_penalty_bps)
                .saturating_div(MAX_BPS)
        } else {
            0
        };
    ...
    fn public_auction_order_records(&self) -> BTreeMap<String, Value> {
        self.auction_orders
            .iter()
...
pub fn devnet() -> State {
    ...
    let lane_id = "devnet-recursive-witness-latency-auction-lane-0".to_string();
    state
        .register_lane(RegisterLaneInput {
            ...
            witness_capacity_commitment: dev_hash("witness-capacity", 0),
    ...
    state
        .post_curve(PostCurveInput {
            curve_id: "devnet-preconfirmation-recursive-auction-curve-0".to_string(),
            lane_id,
...
fn empty_root(label: &str) -> String {
    payload_root(
        "EMPTY-RECURSIVE-WITNESS-LATENCY-AUCTION-ROOT",
        &json!({ "label": label }),
    )
}
