...
pub type MoneroL2PqPrivateSeraphisJamtisSpendlinkDecoyRefreshRebateClearingRuntimeResult<T> =
    Result<T>;
pub type Runtime = State;

pub const MONERO_L2_PQ_PRIVATE_SERAPHIS_JAMTIS_SPENDLINK_DECOY_REFRESH_REBATE_CLEARING_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-monero-l2-pq-private-seraphis-jamtis-spendlink-decoy-refresh-rebate-clearing-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    MONERO_L2_PQ_PRIVATE_SERAPHIS_JAMTIS_SPENDLINK_DECOY_REFRESH_REBATE_CLEARING_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const STATE_ROOT_DOMAIN: &str =
    "MONERO-L2-PQ-PRIVATE-SERAPHIS-JAMTIS-SPENDLINK-DECOY-REFRESH-REBATE-CLEARING";
pub const DEVNET_L2_NETWORK: &str = "nebula-private-l2-devnet";
pub const DEVNET_MONERO_NETWORK: &str = "monero-devnet";
pub const DEVNET_FEE_ASSET_ID: &str = "piconero-devnet";
pub const DEVNET_REBATE_ASSET_ID: &str = "refresh-rebate-credit-devnet";
...
pub const DEFAULT_MIN_REBATE_CLEARING_BPS: u64 = 9_150;
...
pub const DEFAULT_REFRESH_INTENT_TTL_BLOCKS: u64 = 1_440;
pub const DEFAULT_REBATE_QUOTE_TTL_BLOCKS: u64 = 192;
pub const DEFAULT_CLEARING_BATCH_TTL_BLOCKS: u64 = 288;
pub const DEFAULT_CLAIM_TTL_BLOCKS: u64 = 720;
pub const DEFAULT_ATTESTATION_TTL_BLOCKS: u64 = 288;
pub const REFRESH_INTENT_SCHEME: &str =
    "seraphis-jamtis-spendlink-decoy-refresh-rebate-intent-root-v1";
pub const REBATE_QUOTE_SCHEME: &str =
    "pq-private-seraphis-jamtis-decoy-refresh-rebate-quote-root-v1";
pub const CLEARING_BATCH_SCHEME: &str = "defi-style-private-refresh-rebate-clearing-batch-root-v1";
pub const REBATE_CLAIM_SCHEME: &str = "jamtis-seraphis-private-refresh-rebate-claim-root-v1";
pub const LIQUIDITY_VAULT_SCHEME: &str =
    "shielded-refresh-rebate-liquidity-vault-commitment-root-v1";
pub const PQ_CLEARING_ATTESTATION_SCHEME: &str =
    "ML-DSA-87+SLH-DSA-SHAKE-256f-seraphis-jamtis-refresh-rebate-clearing-attestation-v1";
pub const LOW_FEE_REBATE_AUDIT_SCHEME: &str =
    "low-fee-seraphis-jamtis-refresh-rebate-clearing-audit-root-v1";
pub const PUBLIC_RECORD_SCHEME: &str =
    "roots-only-seraphis-jamtis-spendlink-decoy-refresh-rebate-clearing-public-record-v1";
pub const PRIVACY_BOUNDARY: &str =
    "roots_only_no_addresses_view_keys_key_images_amounts_output_indices_viewtags_spendlinks_ring_members_decoy_graphs_solver_identities_quote_prices_claim_witnesses_or_liquidity_owner_ids";
...
impl RefreshIntentStatus {
    ...
    pub fn counts_as_private_success(self) -> bool {
        matches!(
            self,
            Self::Batched | Self::Claimed | Self::Attested | Self::Audited | Self::Sealed
        )
    }
}
...
impl RebateQuoteStatus {
    pub fn active(self) -> bool {
        matches!(
            self,
            Self::Committed | Self::Revealed | Self::Eligible | Self::Clearing
        )
    }
}
...
pub struct Config {
    ...
    pub refresh_intent_scheme: String,
    pub rebate_quote_scheme: String,
    pub clearing_batch_scheme: String,
    pub rebate_claim_scheme: String,
    pub liquidity_vault_scheme: String,
    pub pq_clearing_attestation_scheme: String,
    pub low_fee_rebate_audit_scheme: String,
    ...
    pub min_rebate_clearing_bps: u64,
    ...
    pub refresh_intent_ttl_blocks: u64,
    pub rebate_quote_ttl_blocks: u64,
    pub clearing_batch_ttl_blocks: u64,
...
impl Config {
    pub fn devnet() -> Self {
        Self {
            ...
            refresh_intent_scheme: REFRESH_INTENT_SCHEME.to_string(),
            rebate_quote_scheme: REBATE_QUOTE_SCHEME.to_string(),
            clearing_batch_scheme: CLEARING_BATCH_SCHEME.to_string(),
            rebate_claim_scheme: REBATE_CLAIM_SCHEME.to_string(),
            liquidity_vault_scheme: LIQUIDITY_VAULT_SCHEME.to_string(),
            pq_clearing_attestation_scheme: PQ_CLEARING_ATTESTATION_SCHEME.to_string(),
            low_fee_rebate_audit_scheme: LOW_FEE_REBATE_AUDIT_SCHEME.to_string(),
            ...
            min_rebate_clearing_bps: DEFAULT_MIN_REBATE_CLEARING_BPS,
            ...
            refresh_intent_ttl_blocks: DEFAULT_REFRESH_INTENT_TTL_BLOCKS,
            rebate_quote_ttl_blocks: DEFAULT_REBATE_QUOTE_TTL_BLOCKS,
            clearing_batch_ttl_blocks: DEFAULT_CLEARING_BATCH_TTL_BLOCKS,
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "refresh_intent_scheme": self.refresh_intent_scheme,
            "rebate_quote_scheme": self.rebate_quote_scheme,
            "clearing_batch_scheme": self.clearing_batch_scheme,
            "rebate_claim_scheme": self.rebate_claim_scheme,
            "liquidity_vault_scheme": self.liquidity_vault_scheme,
            "pq_clearing_attestation_scheme": self.pq_clearing_attestation_scheme,
            "low_fee_rebate_audit_scheme": self.low_fee_rebate_audit_scheme,
            ...
            "min_rebate_clearing_bps": self.min_rebate_clearing_bps,
            ...
            "refresh_intent_ttl_blocks": self.refresh_intent_ttl_blocks,
            "rebate_quote_ttl_blocks": self.rebate_quote_ttl_blocks,
            "clearing_batch_ttl_blocks": self.clearing_batch_ttl_blocks,
...
pub struct Counters {
    ...
    pub total_claimed_rebate_bucket: u64,
...
impl Counters {
    pub fn public_record(&self) -> Value {
        json!({
            "refresh_intents": self.refresh_intents,
            "rebate_quotes": self.rebate_quotes,
            "clearing_batches": self.clearing_batches,
            "rebate_claims": self.rebate_claims,
            "liquidity_vaults": self.liquidity_vaults,
            "pq_attestations": self.pq_attestations,
            "fee_rebate_audits": self.fee_rebate_audits,
            ...
            "total_claimed_rebate_bucket": self.total_claimed_rebate_bucket,
...
pub struct Roots {
    ...
    pub refresh_intent_root: String,
    pub rebate_quote_root: String,
    pub clearing_batch_root: String,
    pub rebate_claim_root: String,
    pub liquidity_vault_root: String,
    pub pq_attestation_root: String,
    pub low_fee_rebate_audit_root: String,
    pub quarantined_intent_root: String,
    pub used_quote_nullifier_root: String,
    pub used_claim_nullifier_root: String,
...
impl Roots {
    pub fn empty(config: &Config, counters: &Counters) -> Self {
        Self {
            ...
            refresh_intent_root: empty_root(REFRESH_INTENT_SCHEME),
            rebate_quote_root: empty_root(REBATE_QUOTE_SCHEME),
            clearing_batch_root: empty_root(CLEARING_BATCH_SCHEME),
            rebate_claim_root: empty_root(REBATE_CLAIM_SCHEME),
            liquidity_vault_root: empty_root(LIQUIDITY_VAULT_SCHEME),
            pq_attestation_root: empty_root(PQ_CLEARING_ATTESTATION_SCHEME),
            low_fee_rebate_audit_root: empty_root(LOW_FEE_REBATE_AUDIT_SCHEME),
            quarantined_intent_root: empty_root("quarantined-intent"),
            used_quote_nullifier_root: empty_root("used-quote-nullifier"),
            used_claim_nullifier_root: empty_root("used-claim-nullifier"),
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "refresh_intent_root": self.refresh_intent_root,
            "rebate_quote_root": self.rebate_quote_root,
            "clearing_batch_root": self.clearing_batch_root,
            "rebate_claim_root": self.rebate_claim_root,
            "liquidity_vault_root": self.liquidity_vault_root,
            "pq_attestation_root": self.pq_attestation_root,
            "low_fee_rebate_audit_root": self.low_fee_rebate_audit_root,
            "quarantined_intent_root": self.quarantined_intent_root,
            "used_quote_nullifier_root": self.used_quote_nullifier_root,
            "used_claim_nullifier_root": self.used_claim_nullifier_root,
...
pub struct RefreshIntentInput {
    ...
    pub status: RefreshIntentStatus,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct RefreshIntentEntry {
    pub intent_id: String,
    pub lane: RebateLane,
    pub epoch: u64,
    pub monero_height_bucket: u64,
...
impl RefreshIntentEntry {
    pub fn from_input(input: RefreshIntentInput) -> Self {
...
pub struct RebateQuoteInput {
    ...
    pub expires_at_height: u64,
    pub status: RebateQuoteStatus,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct RebateQuoteEntry {
    pub quote_id: String,
    pub solver_bucket: String,
    pub quote_nullifier: String,
    pub fee_asset_id: String,
...
impl RebateQuoteEntry {
    pub fn from_input(input: RebateQuoteInput) -> Self {
        Self {
            quote_id: input.quote_id,
            solver_bucket: input.solver_bucket,
            quote_nullifier: input.quote_nullifier,
    ...
    pub fn state_root(&self) -> String {
        root_from_parts(
            ...
            &[
                ...
                HashPart::Str(&self.quote_nullifier),
            ],
        )
    }
}
...
pub struct ClearingBatchEntry {
    ...
    pub clearing_efficiency_bps: u64,
    pub liquidity_depth_bps: u64,
...
impl ClearingBatchEntry {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "clearing_efficiency_bps": self.clearing_efficiency_bps,
            "liquidity_depth_bps": self.liquidity_depth_bps,
    ...
    pub fn state_root(&self) -> String {
        root_from_record("clearing-batch", &self.public_record())
    }
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct RebateClaimEntry {
    pub claim_id: String,
    pub batch_id: String,
    pub intent_id: String,
    pub quote_id: String,
...
impl RebateClaimEntry {
    ...
    pub fn state_root(&self) -> String {
        root_from_parts(
            ...
            &[
                HashPart::Json(&self.public_record()),
                HashPart::Str(&self.claim_nullifier),
            ],
        )
    }
}
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct LiquidityVaultEntry {
    pub vault_id: String,
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct PqClearingAttestationEntry {
    pub attestation_id: String,
    pub batch_id: String,
    pub signer_set_root: String,
    pub pq_transcript_root: String,
    pub clearing_verdict_root: String,
...
impl PqClearingAttestationEntry {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "clearing_verdict_root": self.clearing_verdict_root,
    ...
    pub fn state_root(&self) -> String {
        root_from_record("pq-clearing-attestation", &self.public_record())
    }
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct LowFeeRebateAuditEntry {
    pub audit_id: String,
    pub batch_id: String,
    pub measured_user_fee_bps: u64,
    pub target_user_fee_bps: u64,
    pub rebate_clearing_bps: u64,
...
impl LowFeeRebateAuditEntry {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "rebate_clearing_bps": self.rebate_clearing_bps,
...
pub struct State {
    ...
    pub roots: Roots,
    pub refresh_intents: BTreeMap<String, RefreshIntentEntry>,
    pub rebate_quotes: BTreeMap<String, RebateQuoteEntry>,
    pub clearing_batches: BTreeMap<String, ClearingBatchEntry>,
    pub rebate_claims: BTreeMap<String, RebateClaimEntry>,
    pub liquidity_vaults: BTreeMap<String, LiquidityVaultEntry>,
    pub pq_attestations: BTreeMap<String, PqClearingAttestationEntry>,
    pub low_fee_rebate_audits: BTreeMap<String, LowFeeRebateAuditEntry>,
    pub public_records: BTreeMap<String, RootsOnlyPublicRecord>,
    pub quarantined_intent_ids: BTreeSet<String>,
    pub used_quote_nullifiers: BTreeSet<String>,
    pub used_claim_nullifiers: BTreeSet<String>,
}
...
impl State {
    pub fn new(config: Config, epoch: u64, l2_height: u64, monero_height: u64) -> Self {
        ...
        Self {
            ...
            counters,
            roots,
            refresh_intents: BTreeMap::new(),
            rebate_quotes: BTreeMap::new(),
            clearing_batches: BTreeMap::new(),
            rebate_claims: BTreeMap::new(),
            liquidity_vaults: BTreeMap::new(),
            pq_attestations: BTreeMap::new(),
            low_fee_rebate_audits: BTreeMap::new(),
            public_records: BTreeMap::new(),
            quarantined_intent_ids: BTreeSet::new(),
            used_quote_nullifiers: BTreeSet::new(),
            used_claim_nullifiers: BTreeSet::new(),
        }
    }
    ...
    pub fn insert_refresh_intent(&mut self, input: RefreshIntentInput) -> Result<()> {
        ensure(!input.intent_id.is_empty(), "intent id is required")?;
        ensure(
            !self.refresh_intents.contains_key(&input.intent_id),
        ...
        if matches!(input.status, RefreshIntentStatus::Quarantined) {
            self.quarantined_intent_ids.insert(input.intent_id.clone());
        }
        let entry = RefreshIntentEntry::from_input(input);
        self.refresh_intents.insert(entry.intent_id.clone(), entry);
        self.refresh_roots();
        Ok(())
    }

    pub fn insert_rebate_quote(&mut self, input: RebateQuoteInput) -> Result<()> {
        ensure(!input.quote_id.is_empty(), "quote id is required")?;
        ensure(
            !self.rebate_quotes.contains_key(&input.quote_id),
            "rebate quote already exists",
        )?;
        ensure(
            !input.quote_nullifier.is_empty(),
            "quote nullifier is required",
        )?;
        ensure(
            !self.used_quote_nullifiers.contains(&input.quote_nullifier),
        ...
        self.used_quote_nullifiers
            .insert(input.quote_nullifier.clone());
        let entry = RebateQuoteEntry::from_input(input);
        self.rebate_quotes.insert(entry.quote_id.clone(), entry);
        self.refresh_roots();
        Ok(())
    }

    pub fn insert_clearing_batch(&mut self, entry: ClearingBatchEntry) -> Result<()> {
        ensure(!entry.batch_id.is_empty(), "batch id is required")?;
        ensure(
            !self.clearing_batches.contains_key(&entry.batch_id),
            ...
            "clearing fee above user cap",
        )?;
        ensure(
            entry.clearing_efficiency_bps >= self.config.min_rebate_clearing_bps,
            "rebate clearing efficiency below minimum",
        )?;
        ensure(
            ...
            "clearing batch already expired",
        )?;
        self.clearing_batches.insert(entry.batch_id.clone(), entry);
        self.refresh_roots();
        Ok(())
    }

    pub fn insert_rebate_claim(&mut self, entry: RebateClaimEntry) -> Result<()> {
        ensure(!entry.claim_id.is_empty(), "claim id is required")?;
        ensure(
            !self.rebate_claims.contains_key(&entry.claim_id),
            "rebate claim already exists",
        )?;
        ensure(
            self.clearing_batches.contains_key(&entry.batch_id),
            "claim references unknown clearing batch",
        )?;
        ensure(
            self.refresh_intents.contains_key(&entry.intent_id),
            "claim references unknown refresh intent",
        )?;
        ensure(
            self.rebate_quotes.contains_key(&entry.quote_id),
            "claim references unknown rebate quote",
        )?;
        ensure(
            !entry.claim_nullifier.is_empty(),
            "claim nullifier is required",
        )?;
        ensure(
            !self.used_claim_nullifiers.contains(&entry.claim_nullifier),
            ...
            "claim rebate cover below target",
        )?;
        ensure(
            entry.expires_at_height > self.monero_height,
            "rebate claim already expired",
        )?;
        self.used_claim_nullifiers
            .insert(entry.claim_nullifier.clone());
        self.rebate_claims.insert(entry.claim_id.clone(), entry);
        self.refresh_roots();
        Ok(())
    }

    pub fn insert_liquidity_vault(&mut self, entry: LiquidityVaultEntry) -> Result<()> {
        ensure(!entry.vault_id.is_empty(), "vault id is required")?;
        ensure(
            !self.liquidity_vaults.contains_key(&entry.vault_id),
            "liquidity vault already exists",
        )?;
        ensure(
        ...
        self.liquidity_vaults.insert(entry.vault_id.clone(), entry);
        self.refresh_roots();
        Ok(())
    }

    pub fn insert_pq_attestation(&mut self, entry: PqClearingAttestationEntry) -> Result<()> {
        ensure(
            ...
            self.clearing_batches.contains_key(&entry.batch_id),
            "attestation references unknown clearing batch",
        )?;
        ensure(
    ...
    pub fn insert_low_fee_rebate_audit(&mut self, entry: LowFeeRebateAuditEntry) -> Result<()> {
        ensure(!entry.audit_id.is_empty(), "audit id is required")?;
        ensure(
            !self.low_fee_rebate_audits.contains_key(&entry.audit_id),
            "audit already exists",
        )?;
        ensure(
            self.clearing_batches.contains_key(&entry.batch_id),
            "audit references unknown clearing batch",
        )?;
        ensure(
            ...
            entry.rebate_clearing_bps >= self.config.min_rebate_clearing_bps,
            "audit clearing score below minimum",
        )?;
        self.low_fee_rebate_audits
    ...
    pub fn claimed_rebate_bps(&self) -> u64 {
        ratio_bps(
            self.counters.total_claimed_rebate_bucket,
            self.counters.total_rebate_units_bucket,
        )
    }

    pub fn attested_clearing_bps(&self) -> u64 {
        ratio_bps(
            self.pq_attestations
                .values()
                .filter(|entry| entry.status.counts_for_quorum())
                .count() as u64,
            self.clearing_batches.len() as u64,
        )
    }
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "claimed_rebate_bps": self.claimed_rebate_bps(),
            "attested_clearing_bps": self.attested_clearing_bps(),
        })
    }
    ...
    pub fn refresh_roots(&mut self) {
        self.counters.refresh_intents = self.refresh_intents.len() as u64;
        self.counters.rebate_quotes = self.rebate_quotes.len() as u64;
        self.counters.clearing_batches = self.clearing_batches.len() as u64;
        self.counters.rebate_claims = self.rebate_claims.len() as u64;
        self.counters.liquidity_vaults = self.liquidity_vaults.len() as u64;
        self.counters.pq_attestations = self.pq_attestations.len() as u64;
        self.counters.fee_rebate_audits = self.low_fee_rebate_audits.len() as u64;
        self.counters.roots_only_public_records = self.public_records.len() as u64;
        self.counters.quarantined_intents = self.quarantined_intent_ids.len() as u64;
        self.counters.rejected_intents = self
            .refresh_intents
            .values()
            .filter(|entry| entry.status == RefreshIntentStatus::Rejected)
            .count() as u64;
        self.counters.slashed_quotes = self
            .rebate_quotes
            .values()
            .filter(|entry| entry.status == RebateQuoteStatus::Slashed)
            .count() as u64;
        self.counters.frozen_vaults = self
            .liquidity_vaults
            .values()
            .filter(|entry| entry.status == VaultStatus::Frozen)
            .count() as u64;
        ...
        self.counters.total_rebate_units_bucket = self
            ...
            .sum();
        self.counters.total_claimed_rebate_bucket = self
            .rebate_claims
            .values()
            .filter(|entry| matches!(entry.status, ClaimStatus::Paid | ClaimStatus::RolledForward))
            .map(|entry| entry.rebate_bucket)
            .sum();
        self.counters.max_observed_user_fee_bps = self
            ...
            .chain(self.rebate_claims.values().map(|entry| entry.user_fee_bps))
            .max()
            .unwrap_or(0);
        self.roots = Roots {
            config_root: self.config.state_root(),
            counters_root: self.counters.state_root(),
            refresh_intent_root: map_root(
                REFRESH_INTENT_SCHEME,
                self.refresh_intents
                    .iter()
                    .map(|(id, item)| (id.as_str(), item.state_root())),
            ),
            rebate_quote_root: map_root(
                REBATE_QUOTE_SCHEME,
                self.rebate_quotes
                    .iter()
                    .map(|(id, item)| (id.as_str(), item.state_root())),
            ...
            liquidity_vault_root: map_root(
                LIQUIDITY_VAULT_SCHEME,
            ...
            low_fee_rebate_audit_root: map_root(
                LOW_FEE_REBATE_AUDIT_SCHEME,
                self.low_fee_rebate_audits
                    .iter()
                    .map(|(id, item)| (id.as_str(), item.state_root())),
            ),
            quarantined_intent_root: set_root("quarantined-intent", &self.quarantined_intent_ids),
            used_quote_nullifier_root: set_root(
                "used-quote-nullifier",
                &self.used_quote_nullifiers,
            ),
            used_claim_nullifier_root: set_root(
                "used-claim-nullifier",
                &self.used_claim_nullifiers,
            ),
    ...
    fn seed_devnet(&mut self) {
        let intent_id = "rebate-refresh-intent-devnet-0".to_string();
        let quote_id = "rebate-clearing-quote-devnet-0".to_string();
        let batch_id = "rebate-clearing-batch-devnet-0".to_string();
        let claim_id = "rebate-claim-devnet-0".to_string();
        self.insert_refresh_intent(RefreshIntentInput {
            intent_id: intent_id.clone(),
            lane: RebateLane::DexFlow,
            epoch: self.epoch,
            monero_height_bucket: bucket(self.monero_height, self.config.public_bucket_size),
            ...
            decoy_pool_root: root_from_parts("devnet-decoy-pool", &[HashPart::Str(&intent_id)]),
            spendlink_shield_root: root_from_parts(
                "devnet-spendlink-shield",
                &[HashPart::Str(&intent_id)],
            ),
            refresh_plan_root: root_from_parts("devnet-refresh-plan", &[HashPart::Str(&intent_id)]),
            rebate_hint_root: root_from_parts("devnet-rebate-hint", &[HashPart::Str(&intent_id)]),
            expires_at_height: self.monero_height + self.config.refresh_intent_ttl_blocks,
            status: RefreshIntentStatus::Batched,
        })
        .expect("devnet refresh intent inserts");
        self.insert_rebate_quote(RebateQuoteInput {
            quote_id: quote_id.clone(),
            solver_bucket: "devnet-solver-bucket-0".to_string(),
            quote_nullifier: "devnet-private-quote-nullifier-0".to_string(),
            ...
            expires_at_height: self.monero_height + self.config.rebate_quote_ttl_blocks,
            status: RebateQuoteStatus::Filled,
        })
        .expect("devnet rebate quote inserts");
        self.insert_liquidity_vault(LiquidityVaultEntry {
            ...
            vault_commitment_root: root_from_parts("devnet-vault", &[HashPart::Str("0")]),
            ...
            status: VaultStatus::Rebalanced,
        })
        .expect("devnet liquidity vault inserts");
        self.insert_clearing_batch(ClearingBatchEntry {
            ...
            clearing_efficiency_bps: 9_360,
            liquidity_depth_bps: 9_620,
            matched_refresh_units_bucket: 8_192,
            gross_fee_bucket: 24,
            rebate_bucket: 8,
            net_user_fee_bps: 2,
            clearing_price_root: root_from_parts(
                "devnet-clearing-price",
            ...
            expires_at_height: self.monero_height + self.config.clearing_batch_ttl_blocks,
            status: ClearingStatus::Final,
        })
        .expect("devnet clearing batch inserts");
        self.insert_rebate_claim(RebateClaimEntry {
            claim_id: claim_id.clone(),
            batch_id: batch_id.clone(),
            intent_id: intent_id.clone(),
            quote_id: quote_id.clone(),
            claim_nullifier: "devnet-private-claim-nullifier-0".to_string(),
            refresh_unit_bucket: 8_192,
            rebate_bucket: 8,
            user_fee_bps: 2,
            rebate_cover_bps: 9_850,
            claim_commitment_root: root_from_parts(
                "devnet-claim-commitment",
                &[HashPart::Str(&claim_id)],
            ),
            payout_receipt_root: root_from_parts("devnet-payout", &[HashPart::Str(&claim_id)]),
            roll_forward_root: root_from_parts("devnet-roll-forward", &[HashPart::Str(&claim_id)]),
            expires_at_height: self.monero_height + self.config.claim_ttl_blocks,
            status: ClaimStatus::Paid,
        })
        .expect("devnet rebate claim inserts");
        self.insert_pq_attestation(PqClearingAttestationEntry {
            attestation_id: "pq-rebate-clearing-attestation-devnet-0".to_string(),
            batch_id: batch_id.clone(),
            ...
            clearing_verdict_root: root_from_parts(
                "devnet-clearing-verdict",
                &[HashPart::Str(&batch_id)],
            ),
        ...
        self.insert_low_fee_rebate_audit(LowFeeRebateAuditEntry {
            audit_id: "refresh-rebate-clearing-audit-devnet-0".to_string(),
            batch_id,
            measured_user_fee_bps: 2,
            target_user_fee_bps: self.config.max_user_refresh_fee_bps,
            rebate_clearing_bps: 9_360,
        ...
        self.publish_roots_only_record(
            "roots-only-refresh-rebate-clearing-public-record-devnet-0",
