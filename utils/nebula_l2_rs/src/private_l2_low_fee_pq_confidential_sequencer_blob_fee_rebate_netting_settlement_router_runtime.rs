...
#[rustfmt::skip]
pub type PrivateL2LowFeePqConfidentialSequencerBlobFeeRebateNettingSettlementRouterRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_LOW_FEE_PQ_CONFIDENTIAL_SEQUENCER_BLOB_FEE_REBATE_NETTING_SETTLEMENT_ROUTER_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-low-fee-pq-confidential-sequencer-blob-fee-rebate-netting-settlement-router-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_LOW_FEE_PQ_CONFIDENTIAL_SEQUENCER_BLOB_FEE_REBATE_NETTING_SETTLEMENT_ROUTER_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const PQ_ENVELOPE_SUITE: &str =
    "ml-kem-1024+ml-dsa-87-netting-settlement-router-fee-rebate-envelope-v1";
pub const NETTING_SETTLEMENT_ROUTER_SUITE: &str =
    "private-l2-low-fee-confidential-sequencer-rebate-netting-settlement-router-v1";
pub const BALANCE_COMMITMENT_SUITE: &str =
    "pedersen+bulletproofs-plus-settlement-router-balance-root-v1";
pub const SETTLEMENT_PROOF_SUITE: &str =
    "slh-dsa-shake-256f-netting-settlement-router-settlement-proof-root-v1";
pub const FAST_PATH_PROOF_SUITE: &str =
    "ml-dsa-87-fast-netting-settlement-router-attestation-root-v1";
pub const NULLIFIER_SUITE: &str = "confidential-netting-settlement-router-nullifier-set-v1";
pub const PUBLIC_RECORD_SUITE: &str =
    "roots-only-confidential-sequencer-blob-fee-rebate-netting-settlement-router-record-v1";
pub const PRIVACY_BOUNDARY: &str =
    "roots_only_no_plaintext_accounts_amounts_addresses_view_keys_blob_payloads_or_secret_keys";
pub const DEVNET_L2_NETWORK: &str = "nebula-private-l2-netting-settlement-router-devnet";
pub const DEVNET_SETTLEMENT_ROUTER_ID: &str =
    "private-l2-sequencer-blob-fee-rebate-netting-settlement-router-devnet";
pub const DEVNET_OPERATOR_SET_ID: &str = "private-l2-netting-settlement-router-operator-set-devnet";
...
pub const DEFAULT_SETTLEMENT_ROUTER_EPOCH_BLOCKS: u64 = 720;
...
pub const DEFAULT_MAX_ROUTE_COMMITMENTS: usize = 1_048_576;
pub const DEFAULT_MAX_ROUTING_SETTLEMENT_QUEUE_ENTRIES: usize = 4_194_304;
...
const D_STATE: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-ROUTER:STATE";
const D_CONFIG: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-ROUTER:CONFIG";
const D_COUNTERS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-ROUTER:COUNTERS";
const D_ROOTS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-ROUTER:ROOTS";
const D_DEBITS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-ROUTER:DEBITS";
const D_CREDITS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-ROUTER:CREDITS";
const D_WINDOWS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-ROUTER:WINDOWS";
const D_SETTLEMENTS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-ROUTER:SETTLEMENTS";
const D_BUCKETS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-ROUTER:BUCKETS";
const D_SETTLEMENT_ROUTES: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-ROUTER:SETTLEMENT_ROUTES";
const D_SETTLEMENT_QUEUE: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-ROUTER:SETTLEMENT_QUEUE";
const D_ATTESTATIONS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-ROUTER:ATTESTATIONS";
const D_NULLIFIERS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-ROUTER:NULLIFIERS";
const D_PUBLIC_RECORDS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-ROUTER:PUBLIC-RECORDS";

#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum SettlementRouterLane {
    SequencerBlobFee,
    UserRebate,
    ProverRefund,
    SponsorOffset,
...
impl SettlementRouteClass {
    pub fn as_str(self) -> &'static str {
        match self {
            Self::FastFeeRebate => "fast_fee_rebate",
            Self::PrivacyFirst => "privacy_first",
            Self::LiquiditySaver => "liquidity_saver",
            Self::CrossLaneNetting => "cross_lane_netting",
            Self::SettlementConsolidation => "settlement_consolidation",
            Self::DustSweep => "dust_sweep",
        }
    }
    pub fn base_priority(self) -> u64 {
        match self {
            Self::FastFeeRebate => 10_000,
            Self::LiquiditySaver => 9_600,
            Self::CrossLaneNetting => 9_100,
            Self::PrivacyFirst => 8_700,
            Self::SettlementConsolidation => 8_200,
            Self::DustSweep => 6_400,
        }
    }
}
...
impl SettlementRouteStatus {
    pub fn selectable(self) -> bool {
        matches!(self, Self::Advertised | Self::Eligible | Self::Selected)
    }
}

#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum SettlementQueueStatus {
    Pending,
    SettlementRouted,
    Netted,
    Settled,
...
pub struct Config {
    ...
    pub settlement_router_id: String,
    pub operator_set_id: String,
    pub fee_asset_id: String,
    pub rebate_asset_id: String,
    pub hash_suite: String,
    pub pq_envelope_suite: String,
    pub netting_settlement_router_suite: String,
    ...
    pub settlement_router_epoch_blocks: u64,
    ...
    pub max_settlement_route_commitments: usize,
    pub max_routing_settlement_queue_entries: usize,
...
impl Config {
    pub fn devnet() -> Self {
        Self {
            ...
            settlement_router_id: DEVNET_SETTLEMENT_ROUTER_ID.to_string(),
            ...
            netting_settlement_router_suite: NETTING_SETTLEMENT_ROUTER_SUITE.to_string(),
            ...
            settlement_router_epoch_blocks: DEFAULT_SETTLEMENT_ROUTER_EPOCH_BLOCKS,
            ...
            max_settlement_route_commitments: DEFAULT_MAX_ROUTE_COMMITMENTS,
            max_routing_settlement_queue_entries: DEFAULT_MAX_ROUTING_SETTLEMENT_QUEUE_ENTRIES,
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "settlement_router_id": self.settlement_router_id,
            ...
            "netting_settlement_router_suite": self.netting_settlement_router_suite,
            ...
            "settlement_router_epoch_blocks": self.settlement_router_epoch_blocks,
...
pub struct Counters {
    ...
    pub settlement_batches_settlement_queued: u64,
    pub settlement_batches_finalized: u64,
    pub liquidity_buckets_opened: u64,
    pub liquidity_buckets_released: u64,
    pub settlement_routes_advertised: u64,
    pub routing_entries_ensettlement_queued: u64,
    pub routing_entries_selected: u64,
...
impl Counters {
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "settlement_batches_settlement_queued": self.settlement_batches_settlement_queued,
            ...
            "settlement_routes_advertised": self.settlement_routes_advertised,
            "routing_entries_ensettlement_queued": self.routing_entries_ensettlement_queued,
            "routing_entries_selected": self.routing_entries_selected,
...
pub struct Roots {
    ...
    pub settlement_route_commitments_root: String,
    pub routing_settlement_queue_root: String,
...
impl Roots {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "settlement_route_commitments_root": self.settlement_route_commitments_root,
            "routing_settlement_queue_root": self.routing_settlement_queue_root,
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct SettlementRouteCommitmentInput {
    pub settlement_route_id: String,
    pub settlement_route_class: SettlementRouteClass,
    pub lane: SettlementRouterLane,
    pub settlement_route_commitment_root: String,
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct RoutingSettlementQueueEntryInput {
    pub entry_id: String,
    pub settlement_route_id: String,
    pub debit_note_id: Option<String>,
    pub credit_note_id: Option<String>,
    pub window_id: Option<String>,
    pub settlement_queue_commitment_root: String,
    pub sealed_flow_root: String,
    pub netting_hint_root: String,
...
impl SettlementRouteCommitment {
    pub fn priority_score(&self) -> u64 {
        self.settlement_route_class
            .base_priority()
            .saturating_add(self.lane.priority_weight())
            .saturating_add(self.priority_hint)
            .saturating_sub(self.max_fee_bps.saturating_mul(32))
            .saturating_sub(self.selected_entries.saturating_mul(4))
    }
    pub fn public_record(&self) -> Value {
        json!({
            "settlement_route_id": self.settlement_route_id,
            "settlement_route_class": self.settlement_route_class.as_str(),
            "lane": self.lane.as_str(),
            "status": self.status,
            "settlement_route_commitment_root": self.settlement_route_commitment_root,
    ...
    pub fn state_root(&self) -> String {
        record_root(D_SETTLEMENT_ROUTES, &self.public_record())
    }
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct RoutingSettlementQueueEntry {
    pub entry_id: String,
    pub settlement_route_id: String,
    pub status: SettlementQueueStatus,
    pub debit_note_id: Option<String>,
    pub credit_note_id: Option<String>,
    pub window_id: Option<String>,
    pub settlement_queue_commitment_root: String,
...
impl RoutingSettlementQueueEntry {
    pub fn selectable(&self, height: u64) -> bool {
        self.status == SettlementQueueStatus::Pending && height <= self.deadline_height
    }
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "settlement_queue_commitment_root": self.settlement_queue_commitment_root,
            "sealed_flow_root": self.sealed_flow_root,
            "netting_hint_root": self.netting_hint_root,
    ...
    pub fn state_root(&self) -> String {
        record_root(D_SETTLEMENT_QUEUE, &self.public_record())
    }
}
...
pub struct SettlementBatch {
    ...
    pub reserve_units: u128,
    pub protocol_take_units: u128,
    pub settlement_queued_height: u64,
...
impl SettlementBatch {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "reserve_units": self.reserve_units.to_string(),
            "protocol_take_units": self.protocol_take_units.to_string(),
            "settlement_queued_height": self.settlement_queued_height,
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct PqSettlementRouterAttestation {
    pub attestation_id: String,
    pub kind: AttestationKind,
    pub subject_id: String,
    pub subject_root: String,
...
impl PqSettlementRouterAttestation {
    pub fn public_record(&self) -> Value {
        json!({
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct SettlementRouterPublicRecord {
...
impl SettlementRouterPublicRecord {
    pub fn public_record(&self) -> Value {
        json!({
...
pub struct State {
    ...
    pub settlement_route_commitments: BTreeMap<String, SettlementRouteCommitment>,
    pub routing_settlement_queue: BTreeMap<String, RoutingSettlementQueueEntry>,
    pub attestations: BTreeMap<String, PqSettlementRouterAttestation>,
    pub nullifiers: BTreeSet<String>,
    pub public_records: BTreeMap<String, SettlementRouterPublicRecord>,
}
impl State {
    pub fn new(config: Config, height: u64, epoch: u64) -> Result<Self> {
        ...
        let mut state = Self {
            ...
            settlement_route_commitments: BTreeMap::new(),
            routing_settlement_queue: BTreeMap::new(),
    ...
    pub fn advertise_settlement_route(
        &mut self,
        input: SettlementRouteCommitmentInput,
    ) -> Result<String> {
        self.config.validate()?;
        self.ensure_capacity(
            self.settlement_route_commitments.len(),
            self.config.max_settlement_route_commitments,
            "settlement_route commitments",
        )?;
        self.ensure_unique_id(&input.settlement_route_id, "settlement_route commitment")?;
        self.validate_low_fee(input.max_fee_bps)?;
        self.validate_privacy(input.min_privacy_set_size, input.min_pq_security_bits)?;
        self.validate_commitment(
            &input.settlement_route_commitment_root,
            "settlement_route commitment root",
        )?;
        self.validate_commitment(&input.fee_policy_root, "fee policy root")?;
        self.validate_commitment(&input.privacy_policy_root, "privacy policy root")?;
        self.validate_commitment(&input.liquidity_policy_root, "liquidity policy root")?;
        self.validate_commitment(&input.settlement_policy_root, "settlement policy root")?;
        self.validate_commitment(&input.pq_envelope_root, "pq envelope root")?;
        let id = input.settlement_route_id.clone();
        let settlement_route = SettlementRouteCommitment {
            settlement_route_id: id.clone(),
            settlement_route_class: input.settlement_route_class,
            lane: input.lane,
            status: SettlementRouteStatus::Advertised,
            settlement_route_commitment_root: input.settlement_route_commitment_root,
            fee_policy_root: input.fee_policy_root,
            privacy_policy_root: input.privacy_policy_root,
            liquidity_policy_root: input.liquidity_policy_root,
            settlement_policy_root: input.settlement_policy_root,
            pq_envelope_root: input.pq_envelope_root,
            max_fee_bps: input.max_fee_bps,
            min_privacy_set_size: input.min_privacy_set_size,
            min_pq_security_bits: input.min_pq_security_bits,
            priority_hint: input.priority_hint,
            selected_entries: 0,
            epoch: self.epoch,
            created_height: self.height,
        };
        self.settlement_route_commitments
            .insert(id.clone(), settlement_route);
        self.counters.settlement_routes_advertised =
            self.counters.settlement_routes_advertised.saturating_add(1);
        self.emit_public_record("settlement_route_commitment", &id)?;
        self.recompute_roots();
        Ok(id)
    }
    pub fn ensettlement_queue_settlement_route_entry(
        &mut self,
        input: RoutingSettlementQueueEntryInput,
    ) -> Result<String> {
        self.config.validate()?;
        self.ensure_capacity(
            self.routing_settlement_queue.len(),
            self.config.max_routing_settlement_queue_entries,
            "routing settlement_queue entries",
        )?;
        self.ensure_unique_id(&input.entry_id, "routing settlement_queue entry")?;
        self.validate_low_fee(input.priority_fee_bps)?;
        self.validate_privacy(input.privacy_set_size, input.pq_security_bits)?;
        self.validate_commitment(
            &input.settlement_queue_commitment_root,
            "settlement_queue commitment root",
        )?;
        self.validate_commitment(&input.sealed_flow_root, "sealed flow root")?;
        self.validate_commitment(&input.netting_hint_root, "netting hint root")?;
        if input.deadline_height < self.height {
            return Err("routing deadline is already expired".to_string());
        }
        let settlement_route = self
            .settlement_route_commitments
            .get(&input.settlement_route_id)
            .ok_or_else(|| "missing settlement_route commitment".to_string())?;
        if !settlement_route.status.selectable() {
            return Err("settlement_route is not selectable".to_string());
        }
        if input.priority_fee_bps > settlement_route.max_fee_bps {
            return Err("entry fee exceeds selected settlement_route cap".to_string());
        }
        if input.privacy_set_size < settlement_route.min_privacy_set_size
            || input.pq_security_bits < settlement_route.min_pq_security_bits
        {
            return Err("entry does not satisfy settlement_route privacy or pq floor".to_string());
        }
        if let Some(id) = &input.debit_note_id {
            if !self.debit_notes.contains_key(id) {
                return Err("missing debit note for routing entry".to_string());
            }
        }
        if let Some(id) = &input.credit_note_id {
            if !self.credit_notes.contains_key(id) {
                return Err("missing credit note for routing entry".to_string());
            }
        }
        if let Some(id) = &input.window_id {
            if !self.netting_windows.contains_key(id) {
                return Err("missing window for routing entry".to_string());
            }
        }
        let id = input.entry_id.clone();
        let entry = RoutingSettlementQueueEntry {
            entry_id: id.clone(),
            settlement_route_id: input.settlement_route_id,
            status: SettlementQueueStatus::Pending,
            debit_note_id: input.debit_note_id,
            credit_note_id: input.credit_note_id,
            window_id: input.window_id,
            settlement_queue_commitment_root: input.settlement_queue_commitment_root,
            sealed_flow_root: input.sealed_flow_root,
            netting_hint_root: input.netting_hint_root,
            deadline_height: input.deadline_height,
            priority_fee_bps: input.priority_fee_bps,
        ...
        self.routing_settlement_queue.insert(id.clone(), entry);
        self.counters.routing_entries_ensettlement_queued = self
            .counters
            .routing_entries_ensettlement_queued
            .saturating_add(1);
        self.emit_public_record("routing_settlement_queue_entry", &id)?;
        self.recompute_roots();
        Ok(id)
    }
    pub fn select_best_settlement_route_entry(&mut self) -> Result<Option<String>> {
        let selected = self
            .routing_settlement_queue
            .iter()
            .filter_map(|(entry_id, entry)| {
                let settlement_route = self
                    .settlement_route_commitments
                    .get(&entry.settlement_route_id)?;
                if entry.selectable(self.height) && settlement_route.status.selectable() {
                    Some((
                        settlement_route
                            .priority_score()
                            .saturating_add(entry.privacy_set_size / 1024)
                            .saturating_sub(entry.priority_fee_bps.saturating_mul(16)),
            ...
            .map(|(_, _, entry_id)| entry_id);
        let Some(entry_id) = selected else {
            return Ok(None);
        };
        let settlement_route_id = self
            .routing_settlement_queue
            .get(&entry_id)
            .map(|entry| entry.settlement_route_id.clone())
            .ok_or_else(|| "selected routing entry disappeared".to_string())?;
        if let Some(entry) = self.routing_settlement_queue.get_mut(&entry_id) {
            entry.status = SettlementQueueStatus::SettlementRouted;
            entry.selected_height = Some(self.height);
        }
        if let Some(settlement_route) = self
            .settlement_route_commitments
            .get_mut(&settlement_route_id)
        {
            settlement_route.status = SettlementRouteStatus::Selected;
            settlement_route.selected_entries = settlement_route.selected_entries.saturating_add(1);
        }
        self.counters.routing_entries_selected =
            self.counters.routing_entries_selected.saturating_add(1);
        self.recompute_roots();
        Ok(Some(entry_id))
    }
    ...
    pub fn post_attestation(&mut self, input: AttestationInput) -> Result<String> {
        ...
        let attestation = PqSettlementRouterAttestation {
        ...
        self.emit_public_record("pq_settlement_router_attestation", &id)?;
        self.recompute_roots();
        Ok(id)
    }
    ...
    pub fn settlement_queue_settlement(&mut self, input: SettlementInput) -> Result<String> {
        self.config.validate()?;
        self.ensure_capacity(
        ...
        let batch = SettlementBatch {
            ...
            status: if window.fast_path {
                ...
                SettlementStatus::SettlementQueued
            },
            ...
            settlement_queued_height: self.height,
        ...
        self.counters.settlement_batches_settlement_queued = self
            .counters
            .settlement_batches_settlement_queued
            .saturating_add(1);
    ...
    pub fn advance(&mut self, input: AdvanceInput) -> Result<()> {
        ...
        } else if self.config.settlement_router_epoch_blocks > 0 {
            self.epoch = self.height / self.config.settlement_router_epoch_blocks;
        }
        self.expire_stale_notes();
        self.expire_stale_windows();
        self.expire_stale_settlement_queue();
        self.recompute_roots();
        Ok(())
    }
    ...
    pub fn public_record(&self) -> Value {
        ...
        json!({
            ...
            "settlement_router_id": self.config.settlement_router_id,
            "height": self.height,
            "epoch": self.epoch,
    ...
    pub fn recompute_roots(&mut self) {
        ...
        self.roots.settlement_route_commitments_root =
            map_root(D_SETTLEMENT_ROUTES, &self.settlement_route_commitments);
        self.roots.routing_settlement_queue_root =
            map_root(D_SETTLEMENT_QUEUE, &self.routing_settlement_queue);
        ...
        self.roots.state_root = record_root(
            ...
            &json!({
                ...
                "settlement_route_commitments_root": self.roots.settlement_route_commitments_root,
                "routing_settlement_queue_root": self.roots.routing_settlement_queue_root,
    ...
    fn ensure_unique_id(&self, id: &str, label: &str) -> Result<()> {
        ...
        if self.debit_notes.contains_key(id)
            ...
            || self.settlement_route_commitments.contains_key(id)
            || self.routing_settlement_queue.contains_key(id)
    ...
    fn emit_public_record(&mut self, record_kind: &str, subject_id: &str) -> Result<()> {
        ...
        let record = SettlementRouterPublicRecord {
    ...
    fn subject_root(&self, record_kind: &str, subject_id: &str) -> Result<String> {
        match record_kind {
            ...
            "settlement_route_commitment" => self
                .settlement_route_commitments
                .get(subject_id)
                .map(SettlementRouteCommitment::state_root)
                .ok_or_else(|| "missing settlement_route commitment for public record".to_string()),
            "routing_settlement_queue_entry" => self
                .routing_settlement_queue
                .get(subject_id)
                .map(RoutingSettlementQueueEntry::state_root)
                .ok_or_else(|| {
                    "missing routing settlement_queue entry for public record".to_string()
                }),
            "pq_settlement_router_attestation" => self
                .attestations
                .get(subject_id)
                .map(PqSettlementRouterAttestation::state_root)
    ...
    fn expire_stale_settlement_queue(&mut self) {
        for entry in self.routing_settlement_queue.values_mut() {
            if entry.status == SettlementQueueStatus::Pending && self.height > entry.deadline_height
            {
                entry.status = SettlementQueueStatus::Expired;
            }
        }
    }
}
...
pub fn devnet() -> State {
    ...
    let bucket_id = state
        .open_liquidity_bucket(LiquidityBucketInput {
            bucket_id: "devnet-netting-settlement-router-liquidity-bucket-0001".to_string(),
            lane: SettlementRouterLane::SequencerBlobFee,
    ...
    let settlement_route_id = state
        .advertise_settlement_route(SettlementRouteCommitmentInput {
            settlement_route_id: "devnet-low-fee-fast-rebate-settlement_route-0001".to_string(),
            settlement_route_class: SettlementRouteClass::FastFeeRebate,
            lane: SettlementRouterLane::UserRebate,
            settlement_route_commitment_root: "devnet-settlement_route-commitment-root-0001"
                .to_string(),
            fee_policy_root: "devnet-settlement_route-fee-policy-root-0001".to_string(),
            privacy_policy_root: "devnet-settlement_route-privacy-policy-root-0001".to_string(),
            liquidity_policy_root: "devnet-settlement_route-liquidity-policy-root-0001".to_string(),
            settlement_policy_root: "devnet-settlement_route-settlement-policy-root-0001"
                .to_string(),
            pq_envelope_root: "devnet-settlement_route-pq-envelope-root-0001".to_string(),
            max_fee_bps: DEFAULT_TARGET_FEE_BPS,
            min_privacy_set_size: DEFAULT_MIN_PRIVACY_SET_SIZE,
            min_pq_security_bits: DEFAULT_MIN_PQ_SECURITY_BITS,
            priority_hint: 240,
        })
        .expect("devnet settlement_route commitment");
    let debit_id = state
    ...
    let _settlement_queue_id = state
        .ensettlement_queue_settlement_route_entry(RoutingSettlementQueueEntryInput {
            entry_id: "devnet-routing-settlement_queue-entry-0001".to_string(),
            settlement_route_id: settlement_route_id.clone(),
            debit_note_id: Some(debit_id.clone()),
            credit_note_id: Some(credit_id.clone()),
            window_id: None,
            settlement_queue_commitment_root: "devnet-routing-settlement_queue-root-0001"
                .to_string(),
            sealed_flow_root: "devnet-routing-sealed-flow-root-0001".to_string(),
            netting_hint_root: "devnet-routing-netting-hint-root-0001".to_string(),
            deadline_height: DEVNET_HEIGHT + DEFAULT_FAST_PATH_WINDOW_BLOCKS,
            priority_fee_bps: DEFAULT_TARGET_FEE_BPS,
            privacy_set_size: DEFAULT_TARGET_PRIVACY_SET_SIZE,
            pq_security_bits: DEFAULT_MIN_PQ_SECURITY_BITS,
        })
        .expect("devnet routing settlement_queue entry");
    state
        .select_best_settlement_route_entry()
        .expect("devnet settlement_route selection");
    state
    ...
    let settlement_id = state
        .settlement_queue_settlement(SettlementInput {
