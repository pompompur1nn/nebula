...
pub type PrivateL2PqConfidentialBridgeDandelionExitRoutePrivacyFirewallRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-bridge-dandelion-exit-route-privacy-firewall-runtime-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_BRIDGE_DANDELION_EXIT_ROUTE_PRIVACY_FIREWALL_RUNTIME_PROTOCOL_VERSION:
    &str = PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const PQ_FIREWALL_SUITE: &str = "ML-DSA-87+ML-KEM-1024+SLH-DSA-SHAKE-256f";
pub const ROUTE_PRIVACY_SUITE: &str = "monero-bridge-dandelion-exit-route-privacy-root-v1";
pub const REBATE_SUITE: &str = "dandelion-exit-route-privacy-low-fee-rebate-root-v1";
pub const REDACTION_SUITE: &str = "operator-safe-dandelion-exit-route-privacy-redaction-root-v1";
...
pub const DEFAULT_ROUTE_WINDOW_SLOTS: u64 = 720;
...
impl RoutePrivacyScope {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::EmergencyRoutePrivacy => "emergency_route_privacy",
...
pub enum SignalKind {
    StemClusterPressure,
    RouteLiquidityFragmentation,
    DandelionRouteSkew,
    FluffPhaseLinkagePressure,
    DandelionStemTimingPressure,
    ReserveMismatch,
    FeeSpikeRouteFailure,
    WatchtowerEmergency,
}
...
pub enum AttestationVerdict {
    ConfirmRoutePrivacyNeed,
    ConfirmPrivacyRisk,
    RequireDandelionRouteRotation,
    RequireDandelionExitRoutePrivacy,
    RequireQuarantine,
    ClearFalsePositive,
}
...
#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum RoutePrivacyAction {
    Observe,
    QueueRoutePrivacy,
    ApplyDandelionRoutePrivacy,
    RotateDandelionRouteCohort,
    QuarantineRoute,
    EmergencyPause,
    Release,
    Reject,
...
pub struct Config {
    ...
    pub route_privacy_suite: String,
    ...
    pub route_window_slots: u64,
    pub signal_window_slots: u64,
    pub max_route_fee_bps: u64,
    pub target_rebate_bps: u64,
    pub min_stem_route_privacy_liquidity_micro_units: u64,
    pub min_fluff_route_privacy_liquidity_micro_units: u64,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            route_privacy_suite: ROUTE_PRIVACY_SUITE.to_string(),
            ...
            route_window_slots: DEFAULT_ROUTE_WINDOW_SLOTS,
            signal_window_slots: DEFAULT_SIGNAL_WINDOW_SLOTS,
            max_route_fee_bps: DEFAULT_MAX_ROUTE_FEE_BPS,
            target_rebate_bps: DEFAULT_TARGET_REBATE_BPS,
            min_stem_route_privacy_liquidity_micro_units: DEFAULT_MIN_SOURCE_LIQUIDITY_MICRO_UNITS,
            min_fluff_route_privacy_liquidity_micro_units: DEFAULT_MIN_TARGET_LIQUIDITY_MICRO_UNITS,
...
pub struct Counters {
    ...
    pub total_privacy_routed_micro_units: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct RoutePrivacyPolicy {
    pub policy_id: String,
    pub scope: RoutePrivacyScope,
    pub owner_commitment: String,
    pub policy_commitment_root: String,
    pub stem_relay_set_root: String,
    pub fluff_relay_set_root: String,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct DandelionExitRoutePrivacyCohort {
    ...
    pub route_privacy_commitment_root: String,
    pub stem_route_privacy_liquidity_micro_units: u64,
    pub fluff_route_privacy_liquidity_micro_units: u64,
    pub privacy_set_size: u64,
    pub route_fee_bps: u64,
    pub active_signal_count: u64,
    pub route_deadline_slot: u64,
...
pub struct RoutePrivacySignal {
    ...
    pub route_pressure_root: String,
    pub reporter_commitment: String,
    pub stem_route_privacy_liquidity_delta_micro_units: i128,
    pub fluff_route_privacy_liquidity_delta_micro_units: i128,
    pub privacy_set_size: u64,
    pub route_privacy_risk_score_bps: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct PqRoutePrivacyAttestation {
    ...
    pub observed_route_privacy_risk_score_bps: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct RoutePrivacyDecision {
    pub decision_id: String,
    pub signal_id: String,
    pub cohort_id: String,
    pub policy_id: String,
    pub action: RoutePrivacyAction,
    pub decision_root: String,
    pub replacement_route_root: String,
    pub privacy_routed_micro_units: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct LowFeeRoutePrivacyRebate {
...
pub struct State {
    ...
    pub roots: Roots,
    pub policies: BTreeMap<String, RoutePrivacyPolicy>,
    pub cohorts: BTreeMap<String, DandelionExitRoutePrivacyCohort>,
    pub signals: BTreeMap<String, RoutePrivacySignal>,
    pub attestations: BTreeMap<String, PqRoutePrivacyAttestation>,
    pub decisions: BTreeMap<String, RoutePrivacyDecision>,
    pub rebates: BTreeMap<String, LowFeeRoutePrivacyRebate>,
...
impl State {
    ...
    pub fn devnet() -> Self {
        ...
        let withdrawal_policy = state
            .register_policy(RegisterPolicyRequest {
                scope: RoutePrivacyScope::WithdrawalSubaddressLane,
                owner_commitment: "owner:dandelion-exit-route-privacy-council-a".to_string(),
                policy_commitment_root: devnet_root(
                    "policy",
                    "withdrawal-dandelion-exit-route-privacy",
                ),
                stem_relay_set_root: devnet_root("stem-relay-set", "withdrawal-alpha"),
                fluff_relay_set_root: devnet_root("fluff-relay-set", "withdrawal-alpha"),
                route_allowlist_root: devnet_root("route-allowlist", "withdrawal-alpha"),
                min_privacy_set_size: 524_288,
                min_stem_route_privacy_liquidity_micro_units: 160_000_000,
                min_fluff_route_privacy_liquidity_micro_units: 72_000_000,
                max_route_fee_bps: 16,
                min_attestation_quorum_bps: 7_200,
                signal_window_slots: 96,
                route_window_slots: 720,
                redaction_profile: "withdrawal-dandelion-exit-route-privacy-profile".to_string(),
            })
            .expect("devnet withdrawal policy");
        let fast_dandelion_exit_policy = state
            .register_policy(RegisterPolicyRequest {
                scope: RoutePrivacyScope::FastDandelionExitLane,
                owner_commitment: "owner:fast-dandelion-exit-route-council-b".to_string(),
                policy_commitment_root: devnet_root(
                    "policy",
                    "fast-dandelion-exit-dandelion-exit-route-privacy",
                ),
                stem_relay_set_root: devnet_root("stem-relay-set", "fast-dandelion-exit-beta"),
                fluff_relay_set_root: devnet_root("fluff-relay-set", "fast-dandelion-exit-beta"),
                route_allowlist_root: devnet_root("route-allowlist", "fast-dandelion-exit-beta"),
                min_privacy_set_size: 393_216,
                min_stem_route_privacy_liquidity_micro_units: 144_000_000,
                min_fluff_route_privacy_liquidity_micro_units: 64_000_000,
                max_route_fee_bps: 18,
                min_attestation_quorum_bps: 7_000,
                signal_window_slots: 80,
                route_window_slots: 640,
                redaction_profile: "fast-dandelion-exit-dandelion-exit-route-privacy-profile"
                    .to_string(),
            })
            .expect("devnet fast route_privacy policy");
        let withdrawal_cohort = state
            .register_cohort(RegisterCohortRequest {
                policy_id: withdrawal_policy,
                bridge_lane_id: "withdrawal-dandelion-alpha".to_string(),
                stem_relay_set_root: devnet_root("stem-relay-set", "cohort-alpha"),
                fluff_relay_set_root: devnet_root("fluff-relay-set", "cohort-alpha"),
                output_set_root: devnet_root("outputs", "cohort-alpha"),
                route_privacy_commitment_root: devnet_root("liquidity", "cohort-alpha"),
                stem_route_privacy_liquidity_micro_units: 216_000_000,
                fluff_route_privacy_liquidity_micro_units: 96_000_000,
        ...
        let fast_dandelion_exit_cohort = state
            .register_cohort(RegisterCohortRequest {
                ...
                bridge_lane_id: "fast-dandelion-exit-route-beta".to_string(),
                stem_relay_set_root: devnet_root("stem-relay-set", "cohort-beta"),
                fluff_relay_set_root: devnet_root("fluff-relay-set", "cohort-beta"),
                output_set_root: devnet_root("outputs", "cohort-beta"),
                route_privacy_commitment_root: devnet_root("liquidity", "cohort-beta"),
                stem_route_privacy_liquidity_micro_units: 168_000_000,
                fluff_route_privacy_liquidity_micro_units: 76_000_000,
                privacy_set_size: 393_216,
                route_fee_bps: 13,
                public_hint_root: devnet_root("hint", "cohort-beta"),
            })
            .expect("devnet fast route_privacy cohort");
        let signal = state
            .submit_signal(SubmitSignalRequest {
                cohort_id: withdrawal_cohort,
                kind: SignalKind::StemClusterPressure,
                ...
                route_pressure_root: devnet_root("pressure", "withdrawal-cluster-pressure"),
                reporter_commitment: "reporter:dandelion-route-watchtower-11".to_string(),
                stem_route_privacy_liquidity_delta_micro_units: -48_000_000,
                fluff_route_privacy_liquidity_delta_micro_units: 24_000_000,
                privacy_set_size: 524_288,
                route_privacy_risk_score_bps: 7_300,
        ...
        state
            .submit_attestation(SubmitAttestationRequest {
                ...
                verdict: AttestationVerdict::RequireDandelionExitRoutePrivacy,
                attestor_commitment: "attestor:pq-dandelion-exit-route-privacy-a".to_string(),
                pq_signature_root: devnet_root("ml-dsa-signature", "withdrawal-route_privacy-a"),
                pq_public_key_root: devnet_root("ml-kem-public-key", "withdrawal-route_privacy-a"),
                transcript_root: devnet_root("transcript", "withdrawal-route_privacy-a"),
                quorum_weight_bps: 7_500,
                pq_security_bits: 256,
                observed_route_privacy_risk_score_bps: 7_500,
        ...
        state
            .submit_attestation(SubmitAttestationRequest {
                signal_id: signal.clone(),
                verdict: AttestationVerdict::ConfirmRoutePrivacyNeed,
                attestor_commitment: "attestor:pq-dandelion-exit-route-privacy-b".to_string(),
                pq_signature_root: devnet_root("slh-dsa-signature", "withdrawal-route_privacy-b"),
                pq_public_key_root: devnet_root("ml-kem-public-key", "withdrawal-route_privacy-b"),
                transcript_root: devnet_root("transcript", "withdrawal-route_privacy-b"),
                quorum_weight_bps: 8_700,
                pq_security_bits: 256,
                observed_route_privacy_risk_score_bps: 7_800,
                observed_privacy_set_size: 524_288,
        ...
        let decision = state
            .settle_decision(SettleDecisionRequest {
                signal_id: signal,
                action: RoutePrivacyAction::ApplyDandelionRoutePrivacy,
                decision_root: devnet_root("decision", "withdrawal-liquidity-route_privacy"),
                replacement_route_root: devnet_root(
                    "replacement-route",
                    "withdrawal-route_privacy",
                ),
                privacy_routed_micro_units: 32_000_000,
                shielded_output_count: 4_096,
                rebate_bps: 8,
                decided_at_slot: DEVNET_SLOT + 5,
            })
            .expect("devnet route_privacy decision");
        state
            .publish_rebate(PublishRebateRequest {
                decision_id: decision,
                recipient_commitment: "recipient:dandelion-exit-route-privacy-fee-sponsor"
                    .to_string(),
                rebate_micro_units: 22_000,
                fee_saved_micro_units: 88_000,
                rebate_bps: 8,
                settlement_slot: DEVNET_SLOT + 6,
                rebate_root: devnet_root("rebate", "withdrawal-route_privacy"),
            })
        ...
        state
            .publish_redaction_budget(PublishRedactionBudgetRequest {
                ...
                public_hint_root: devnet_root("redaction-hint", "fast-dandelion-exit-beta"),
    ...
    pub fn register_policy(&mut self, request: RegisterPolicyRequest) -> Result<String> {
        ensure_capacity(
            self.policies.len(),
            MAX_POLICIES,
            "Dandelion exit-route privacy policies",
        )?;
        ...
        ensure_non_empty(&request.stem_relay_set_root, "stem_relay_set_root")?;
        ensure_non_empty(&request.fluff_relay_set_root, "fluff_relay_set_root")?;
        ...
        if request.min_stem_route_privacy_liquidity_micro_units
            < self.config.min_stem_route_privacy_liquidity_micro_units
        {
            return Err("policy source liquidity below runtime floor".to_string());
        }
        if request.min_fluff_route_privacy_liquidity_micro_units
            < self.config.min_fluff_route_privacy_liquidity_micro_units
        {
            return Err("policy target liquidity below runtime floor".to_string());
        }
        let policy_id = stable_id(
            "dandelion-exit-route-privacy-policy",
            &[
                HashPart::Str(request.scope.as_str()),
                HashPart::Str(&request.owner_commitment),
                HashPart::Str(&request.policy_commitment_root),
                HashPart::Str(&request.stem_relay_set_root),
            ],
        );
        if self.policies.contains_key(&policy_id) {
            return Err(format!(
                "Dandelion exit-route privacy policy {policy_id} already exists"
            ));
        }
        self.policies.insert(
            ...
            RoutePrivacyPolicy {
                ...
                stem_relay_set_root: request.stem_relay_set_root,
                fluff_relay_set_root: request.fluff_relay_set_root,
                route_allowlist_root: request.route_allowlist_root,
                min_privacy_set_size: request.min_privacy_set_size,
                min_stem_route_privacy_liquidity_micro_units: request
                    .min_stem_route_privacy_liquidity_micro_units,
                min_fluff_route_privacy_liquidity_micro_units: request
                    .min_fluff_route_privacy_liquidity_micro_units,
                ...
                route_window_slots: request.route_window_slots,
                active: true,
    ...
    pub fn register_cohort(&mut self, request: RegisterCohortRequest) -> Result<String> {
        ...
        let policy = self.policies.get(&request.policy_id).ok_or_else(|| {
            format!(
                "unknown Dandelion exit-route privacy policy {}",
                request.policy_id
            )
        })?;
        ...
        ensure_non_empty(
            &request.route_privacy_commitment_root,
            "route_privacy_commitment_root",
        )?;
        ...
        if request.stem_route_privacy_liquidity_micro_units
            < policy.min_stem_route_privacy_liquidity_micro_units
        {
            return Err("cohort source liquidity below policy floor".to_string());
        }
        if request.fluff_route_privacy_liquidity_micro_units
            < policy.min_fluff_route_privacy_liquidity_micro_units
        {
        ...
        let cohort_id = stable_id(
            "dandelion-exit-route-privacy-cohort",
            &[
                HashPart::Str(&request.policy_id),
                HashPart::Str(&request.bridge_lane_id),
                HashPart::Str(&request.stem_relay_set_root),
                HashPart::Str(&request.route_privacy_commitment_root),
            ],
        );
        if self.cohorts.contains_key(&cohort_id) {
            return Err(format!(
                "Dandelion exit-route privacy cohort {cohort_id} already exists"
            ));
        }
        self.cohorts.insert(
            cohort_id.clone(),
            DandelionExitRoutePrivacyCohort {
                ...
                route_privacy_commitment_root: request.route_privacy_commitment_root,
                stem_route_privacy_liquidity_micro_units: request
                    .stem_route_privacy_liquidity_micro_units,
                fluff_route_privacy_liquidity_micro_units: request
                    .fluff_route_privacy_liquidity_micro_units,
                privacy_set_size: request.privacy_set_size,
                route_fee_bps: request.route_fee_bps,
                active_signal_count: 0,
                route_deadline_slot: 0,
    ...
    pub fn submit_signal(&mut self, request: SubmitSignalRequest) -> Result<String> {
        ensure_capacity(
            self.signals.len(),
            MAX_SIGNALS,
            "Dandelion exit-route privacy signals",
        )?;
        let cohort = self
            .cohorts
            ...
            .ok_or_else(|| {
                format!(
                    "unknown Dandelion exit-route privacy cohort {}",
                    request.cohort_id
                )
            })?
            .clone();
        ...
        ensure_non_empty(&request.route_pressure_root, "route_pressure_root")?;
        ensure_non_empty(&request.reporter_commitment, "reporter_commitment")?;
        ensure_bps(
            request.route_privacy_risk_score_bps,
            "route_privacy_risk_score_bps",
        )?;
        if request.privacy_set_size < policy.min_privacy_set_size {
            return Err("signal privacy set below policy floor".to_string());
        }
        let signal_id = stable_id(
            "dandelion-exit-route-privacy-signal",
            &[
        ...
        if self.signals.contains_key(&signal_id) {
            return Err(format!(
                "Dandelion exit-route privacy signal {signal_id} already exists"
            ));
        }
        ...
        self.signals.insert(
            ...
            RoutePrivacySignal {
                ...
                route_pressure_root: request.route_pressure_root,
                reporter_commitment: request.reporter_commitment,
                stem_route_privacy_liquidity_delta_micro_units: request
                    .stem_route_privacy_liquidity_delta_micro_units,
                fluff_route_privacy_liquidity_delta_micro_units: request
                    .fluff_route_privacy_liquidity_delta_micro_units,
                privacy_set_size: request.privacy_set_size,
                route_privacy_risk_score_bps: request.route_privacy_risk_score_bps,
    ...
    pub fn submit_attestation(&mut self, request: SubmitAttestationRequest) -> Result<String> {
        ensure_capacity(
            ...
            MAX_ATTESTATIONS,
            "Dandelion exit-route privacy attestations",
        )?;
        let signal = self
            .signals
            ...
            .ok_or_else(|| {
                format!(
                    "unknown Dandelion exit-route privacy signal {}",
                    request.signal_id
                )
            })?
            .clone();
        ...
        ensure_bps(
            request.observed_route_privacy_risk_score_bps,
            "observed_route_privacy_risk_score_bps",
        )?;
        ...
        let attestation_id = stable_id(
            "dandelion-exit-route-privacy-pq-attestation",
            &[
        ...
        if self.attestations.contains_key(&attestation_id) {
            return Err(format!(
                "Dandelion exit-route privacy attestation {attestation_id} already exists"
            ));
        }
        self.attestations.insert(
            attestation_id.clone(),
            PqRoutePrivacyAttestation {
                ...
                observed_route_privacy_risk_score_bps: request
                    .observed_route_privacy_risk_score_bps,
    ...
    pub fn settle_decision(&mut self, request: SettleDecisionRequest) -> Result<String> {
        ensure_capacity(
            self.decisions.len(),
            MAX_DECISIONS,
            "Dandelion exit-route privacy decisions",
        )?;
        let signal = self
            .signals
            .get(&request.signal_id)
        ...
        let route_deadline_slot = match request.action {
            RoutePrivacyAction::QueueRoutePrivacy
            | RoutePrivacyAction::ApplyDandelionRoutePrivacy
            | RoutePrivacyAction::RotateDandelionRouteCohort => request
                .decided_at_slot
                .saturating_add(policy.route_window_slots),
            RoutePrivacyAction::QuarantineRoute | RoutePrivacyAction::EmergencyPause => request
                .decided_at_slot
                .saturating_add(policy.route_window_slots / 2),
            _ => 0,
        };
        let decision_id = stable_id(
            "dandelion-exit-route-privacy-decision",
            &[
                HashPart::Str(&request.signal_id),
        ...
        if self.decisions.contains_key(&decision_id) {
            return Err(format!(
                "Dandelion exit-route privacy decision {decision_id} already exists"
            ));
        }
        self.decisions.insert(
            ...
            RoutePrivacyDecision {
                ...
                privacy_routed_micro_units: request.privacy_routed_micro_units,
        ...
        if let Some(signal) = self.signals.get_mut(&request.signal_id) {
            signal.status = match request.action {
                RoutePrivacyAction::QueueRoutePrivacy => SignalStatus::RouteQueued,
                RoutePrivacyAction::ApplyDandelionRoutePrivacy
                | RoutePrivacyAction::RotateDandelionRouteCohort => SignalStatus::Routing,
                RoutePrivacyAction::QuarantineRoute | RoutePrivacyAction::EmergencyPause => {
                    SignalStatus::Quarantined
                }
                RoutePrivacyAction::Release => SignalStatus::Settled,
                RoutePrivacyAction::Reject => SignalStatus::Rejected,
                RoutePrivacyAction::Expire => SignalStatus::Expired,
                RoutePrivacyAction::Observe => SignalStatus::Attested,
            };
        }
        if let Some(cohort) = self.cohorts.get_mut(&signal.cohort_id) {
            match request.action {
                RoutePrivacyAction::QueueRoutePrivacy => {
                    ...
                    cohort.route_deadline_slot = route_deadline_slot;
                }
                RoutePrivacyAction::ApplyDandelionRoutePrivacy => {
                    cohort.status = CohortStatus::Routing;
                    cohort.stem_route_privacy_liquidity_micro_units = cohort
                        .stem_route_privacy_liquidity_micro_units
                        .saturating_sub(request.privacy_routed_micro_units);
                    cohort.fluff_route_privacy_liquidity_micro_units = cohort
                        .fluff_route_privacy_liquidity_micro_units
                        .saturating_add(request.privacy_routed_micro_units);
                    cohort.route_deadline_slot = route_deadline_slot;
                    self.counters.routes_settled = self.counters.routes_settled.saturating_add(1);
                    self.counters.total_privacy_routed_micro_units = self
                        .counters
                        .total_privacy_routed_micro_units
                        .saturating_add(request.privacy_routed_micro_units);
                }
                RoutePrivacyAction::RotateDandelionRouteCohort => {
                    cohort.status = CohortStatus::Rotating;
                    cohort.route_deadline_slot = route_deadline_slot;
                    self.counters.cohorts_rotated = self.counters.cohorts_rotated.saturating_add(1);
                }
                RoutePrivacyAction::QuarantineRoute => {
                    cohort.status = CohortStatus::Quarantined;
                    cohort.route_deadline_slot = route_deadline_slot;
                    self.counters.routes_quarantined =
                        self.counters.routes_quarantined.saturating_add(1);
                }
                RoutePrivacyAction::EmergencyPause => {
                    cohort.status = CohortStatus::Paused;
                    cohort.route_deadline_slot = route_deadline_slot;
                    self.counters.routes_quarantined =
                        self.counters.routes_quarantined.saturating_add(1);
                }
                RoutePrivacyAction::Release => {
                    cohort.status = CohortStatus::Settled;
                    cohort.route_deadline_slot = 0;
    ...
    pub fn publish_rebate(&mut self, request: PublishRebateRequest) -> Result<String> {
        ensure_capacity(
            self.rebates.len(),
            MAX_REBATES,
            "Dandelion exit-route privacy rebates",
        )?;
        let decision = self.decisions.get(&request.decision_id).ok_or_else(|| {
            format!(
                "unknown Dandelion exit-route privacy decision {}",
                request.decision_id
            )
        })?;
        ...
        let rebate_id = stable_id(
            "dandelion-exit-route-privacy-low-fee-rebate",
            &[
        ...
        if self.rebates.contains_key(&rebate_id) {
            return Err(format!(
                "Dandelion exit-route privacy rebate {rebate_id} already exists"
            ));
        }
        self.rebates.insert(
            rebate_id.clone(),
            LowFeeRoutePrivacyRebate {
    ...
    pub fn publish_redaction_budget(
        ...
        ensure_capacity(
            ...
            "Dandelion exit-route privacy redaction budgets",
        )?;
        ...
        let budget_id = stable_id(
            "dandelion-exit-route-privacy-redaction-budget",
            &[
                HashPart::Str(request.scope.as_str()),
                HashPart::Str(&request.cohort_id),
        ...
        if self.redaction_budgets.contains_key(&budget_id) {
            return Err(format!(
                "Dandelion exit-route privacy redaction budget {budget_id} already exists"
            ));
        }
    ...
    pub fn publish_operator_summary(
        ...
        ensure_capacity(
            ...
            "Dandelion exit-route privacy operator summaries",
        )?;
        self.refresh_live_counts();
        ...
        let summary_id = stable_id(
            "dandelion-exit-route-privacy-operator-summary",
            &[
                HashPart::U64(epoch),
                HashPart::U64(slot),
        ...
        self.operator_summaries.insert(
            ...
            OperatorSummary {
                ...
                total_privacy_routed_micro_units: self.counters.total_privacy_routed_micro_units,
    ...
    fn refresh_roots(&mut self) {
        ...
        self.roots.state_root = merkle_root(
            "bridge-dandelion-exit-route-privacy-firewall:state",
            &[
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "route_privacy_suite": self.config.route_privacy_suite,
            ...
            "route_window_slots": self.config.route_window_slots,
            ...
            "policies": self.policies.values().map(|policy| json!({
                ...
                "min_stem_route_privacy_liquidity_micro_units": policy.min_stem_route_privacy_liquidity_micro_units,
                "min_fluff_route_privacy_liquidity_micro_units": policy.min_fluff_route_privacy_liquidity_micro_units,
            ...
            "cohorts": self.cohorts.values().map(|cohort| json!({
                ...
                "stem_route_privacy_liquidity_micro_units": cohort.stem_route_privacy_liquidity_micro_units,
                "fluff_route_privacy_liquidity_micro_units": cohort.fluff_route_privacy_liquidity_micro_units,
                "privacy_set_size": cohort.privacy_set_size,
                "route_fee_bps": cohort.route_fee_bps,
                "active_signal_count": cohort.active_signal_count,
                "route_deadline_slot": cohort.route_deadline_slot,
            ...
            "signals": self.signals.values().map(|signal| json!({
                ...
                "route_privacy_risk_score_bps": signal.route_privacy_risk_score_bps,
            ...
            "decisions": self.decisions.values().map(|decision| json!({
                ...
                "privacy_routed_micro_units": decision.privacy_routed_micro_units,
                "shielded_output_count": decision.shielded_output_count,
                "route_deadline_slot": decision.route_deadline_slot,
...
pub fn demo() -> State {
    ...
    let signal = state
        .submit_signal(SubmitSignalRequest {
            ...
            route_pressure_root: devnet_root("pressure", "demo-viewtag-pressure"),
            reporter_commitment: "reporter:demo-subaddress-watchtower".to_string(),
            stem_route_privacy_liquidity_delta_micro_units: -10_000_000,
            fluff_route_privacy_liquidity_delta_micro_units: 8_000_000,
            privacy_set_size: 524_288,
            route_privacy_risk_score_bps: 6_200,
    ...
    state
        .submit_attestation(SubmitAttestationRequest {
            signal_id: signal,
            verdict: AttestationVerdict::RequireDandelionRouteRotation,
            attestor_commitment: "attestor:demo-dandelion-exit-route-privacy".to_string(),
            ...
            pq_security_bits: 256,
            observed_route_privacy_risk_score_bps: 6_400,
            observed_privacy_set_size: 524_288,
...
fn object_root<T: Serialize>(domain: &str, value: &T) -> String {
    ...
    domain_hash(
        &format!("bridge-dandelion-exit-route-privacy-firewall:{domain}"),
        &[HashPart::Json(&value)],
        32,
    )
}
...
fn devnet_root(domain: &str, label: &str) -> String {
    domain_hash(
        &format!("bridge-dandelion-exit-route-privacy-firewall:devnet:{domain}"),
