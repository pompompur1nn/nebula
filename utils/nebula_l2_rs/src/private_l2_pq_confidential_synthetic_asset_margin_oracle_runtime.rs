...
pub type PrivateL2PqConfidentialSyntheticAssetMarginOracleRuntimeResult<T> =
    std::result::Result<T, String>;
pub type Runtime = State;

pub const PRIVATE_L2_PQ_CONFIDENTIAL_SYNTHETIC_ASSET_MARGIN_ORACLE_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-synthetic-asset-margin-oracle-runtime-v1";
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const PQ_ATTESTATION_SUITE: &str = "ML-DSA-87+SLH-DSA-SHAKE-256f-confidential-margin-oracle-v1";
pub const PQ_KEM_SUITE: &str = "ML-KEM-1024-sealed-margin-feed-v1";
pub const MARGIN_BUCKET_SCHEME: &str = "shielded-synthetic-margin-bucket-root-v1";
pub const VOLATILITY_SURFACE_SCHEME: &str = "confidential-volatility-surface-commitment-v1";
pub const LIQUIDATION_GUARD_SCHEME: &str = "redacted-liquidation-guard-hint-v1";
pub const LOW_FEE_SUBSCRIPTION_SCHEME: &str = "low-fee-margin-oracle-subscription-v1";
pub const PRIVACY_REDACTION_BUDGET_SCHEME: &str = "privacy-redaction-budget-ledger-root-v1";
pub const STALE_ORACLE_QUARANTINE_SCHEME: &str = "stale-oracle-quarantine-root-v1";
pub const DEVNET_L2_NETWORK: &str = "nebula-private-l2-devnet";
pub const DEVNET_MONERO_NETWORK: &str = "monero-devnet";
pub const DEVNET_COMMITTEE_ID: &str = "synthetic-margin-oracle-devnet-committee";
...
pub enum SyntheticMarginMarketKind {
    PrivateUsdPerp,
    PrivateBtcPerp,
    PrivateXmrPerp,
    PrivateEthPerp,
...
impl SyntheticMarginMarketKind {
...
impl Config {
    pub fn devnet() -> Self {
        Self {
            ...
            protocol_version:
                PRIVATE_L2_PQ_CONFIDENTIAL_SYNTHETIC_ASSET_MARGIN_ORACLE_RUNTIME_PROTOCOL_VERSION
                    .to_string(),
    ...
    pub fn validate(&self) -> PrivateL2PqConfidentialSyntheticAssetMarginOracleRuntimeResult<()> {
...
pub struct MarginBucketRecord {
    ...
    pub asset_kind: SyntheticMarginMarketKind,
...
impl State {
    ...
    ) -> PrivateL2PqConfidentialSyntheticAssetMarginOracleRuntimeResult<String> {
    ...
    ) -> PrivateL2PqConfidentialSyntheticAssetMarginOracleRuntimeResult<()> {
    ...
    pub fn quarantine_stale_oracles(
        &mut self,
    ) -> PrivateL2PqConfidentialSyntheticAssetMarginOracleRuntimeResult<usize> {
        let stale = self
            .oracle_attestations
            .values()
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "config": {
                ...
                "margin_bucket_scheme": MARGIN_BUCKET_SCHEME,
                ...
                "volatility_surface_scheme": VOLATILITY_SURFACE_SCHEME,
            },
...
pub fn demo() -> State {
    ...
    let _ = state.register_margin_bucket(RegisterMarginBucketRequest {
        ...
        asset_kind: SyntheticMarginMarketKind::PrivateXmrPerp,
...
fn deterministic_id(domain: &str, parts: &[HashPart<'_>]) -> String {
    domain_hash(
        &format!("private_l2_pq_confidential_synthetic_asset_margin_oracle_runtime/{domain}"),
        parts,
        32,
    )
}
