...
pub type PrivateL2PqConfidentialMlKemPaymasterSessionKeyEscrowRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_PQ_CONFIDENTIAL_ML_KEM_PAYMASTER_SESSION_KEY_ESCROW_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-ml-kem-paymaster-session-key-escrow-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_PQ_CONFIDENTIAL_ML_KEM_PAYMASTER_SESSION_KEY_ESCROW_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const ML_KEM_ESCROW_ENVELOPE_SUITE: &str = "ML-KEM-1024-session-key-escrow-envelope-v1";
pub const PAYMASTER_POLICY_SUITE: &str = "private-l2-pq-confidential-paymaster-escrow-policy-v1";
pub const PRIVATE_INTENT_SUITE: &str = "sealed-private-sponsored-session-intent-v1";
pub const ROTATION_WINDOW_SUITE: &str = "ml-kem-session-key-rotation-window-v1";
pub const NULLIFIER_GUARD_SUITE: &str = "private-l2-session-key-nullifier-replay-guard-v1";
pub const LOW_FEE_CREDIT_LEDGER_SUITE: &str = "confidential-sponsored-low-fee-credit-ledger-v1";
pub const PQ_ATTESTATION_SUITE: &str =
    "ML-DSA-87+SLH-DSA-SHAKE-256f-paymaster-session-escrow-attestation-v1";
pub const OPERATOR_SUMMARY_SUITE: &str = "operator-paymaster-session-key-escrow-summary-v1";
...
pub const DEFAULT_SPONSOR_CREDIT_ASSET_ID: &str = "pq-session-sponsor-credit-devnet";
pub const DEFAULT_ESCROW_COLLATERAL_ASSET_ID: &str = "paymaster-escrow-bond-devnet";
...
pub fn generated_escrow_audit_leaf_024(subject: &str, amount: u64, nonce: u64) -> Value {
    json!({
        "leaf_kind": "escrow_audit_024",
        "subject": subject,
        "amount": amount,
        "nonce": nonce,
        "root": domain_hash(
            &domain("ESCROW-AUDIT-024"),
            &[HashPart::Str(subject), HashPart::U64(amount), HashPart::U64(nonce)],
            32,
        ),
    })
