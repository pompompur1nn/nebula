...
pub type PrivateL2FastPqConfidentialWitnessDerivativeLatencyLiquidationRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_FAST_PQ_CONFIDENTIAL_WITNESS_DERIVATIVE_LATENCY_LIQUIDATION_RUNTIME_PROTOCOL_VERSION: &str = "nebula-private-l2-fast-pq-confidential-witness-derivative-latency-liquidation-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_FAST_PQ_CONFIDENTIAL_WITNESS_DERIVATIVE_LATENCY_LIQUIDATION_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "shake256-domain-separated-canonical-json-v1";
pub const PQ_LIQUIDATION_ATTESTATION_SUITE: &str =
    "ml-dsa-87+slh-dsa-shake-256f-latency-liquidation-attestation-root-v1";
pub const LIQUIDATED_POSITION_SUITE: &str =
    "ml-kem-1024-sealed-defi-derivative-liquidated-position-root-v1";
pub const PRIVACY_BOUNDARY: &str =
    "roots_only_no_plaintext_witnesses_addresses_keys_liquidation_terms_or_positions";
pub const PUBLIC_RECORD_SUITE: &str =
    "roots-only-private-l2-fast-pq-confidential-derivative-latency-liquidation-record-v1";
...
pub const DEFAULT_LIQUIDATION_CYCLE_MS: u64 = 25;
...
pub const DEFAULT_LIQUIDATION_DISCOUNT_BPS: u64 = 620;
...
pub const DEFAULT_MAX_LIQUIDATION_ROUNDS: usize = 524_288;
pub const DEFAULT_MAX_ATTESTATIONS: usize = 1_048_576;
pub const DEFAULT_MAX_RECEIPTS: usize = 2_097_152;

const D_CONFIG: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-LIQUIDATION:CONFIG";
const D_COUNTERS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-LIQUIDATION:COUNTERS";
const D_ROOTS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-LIQUIDATION:ROOTS";
const D_STATE: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-LIQUIDATION:STATE";
const D_POOLS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-LIQUIDATION:POOLS";
const D_ORDERS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-LIQUIDATION:ORDERS";
const D_ROUNDS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-LIQUIDATION:ROUNDS";
const D_ATTESTATIONS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-LIQUIDATION:ATTESTATIONS";
const D_RECEIPTS: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-LIQUIDATION:RECEIPTS";
const D_PUBLIC: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-LIQUIDATION:PUBLIC";
const D_DEVNET: &str = "PL2-FAST-PQ-CONF-WITNESS-DERIV-LAT-LIQUIDATION:DEVNET";
...
impl OrderStatus {
    pub fn live(self) -> bool {
        matches!(self, Self::Open | Self::Nettable | Self::Liquidated)
    }
}
...
pub struct Config {
    ...
    pub pq_liquidation_attestation_suite: String,
    pub liquidated_position_suite: String,
    pub roots_only_public_records: bool,
    pub min_pq_security_bits: u16,
    pub min_privacy_set_size: u64,
    pub target_privacy_set_size: u64,
    pub liquidation_cycle_ms: u64,
    ...
    pub max_liquidation_rounds: usize,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            pq_liquidation_attestation_suite: PQ_LIQUIDATION_ATTESTATION_SUITE.to_string(),
            liquidated_position_suite: LIQUIDATED_POSITION_SUITE.to_string(),
            roots_only_public_records: true,
            min_pq_security_bits: DEFAULT_MIN_PQ_SECURITY_BITS,
            min_privacy_set_size: DEFAULT_MIN_PRIVACY_SET_SIZE,
            target_privacy_set_size: DEFAULT_TARGET_PRIVACY_SET_SIZE,
            liquidation_cycle_ms: DEFAULT_LIQUIDATION_CYCLE_MS,
            ...
            liquidation_discount_bps: DEFAULT_LIQUIDATION_DISCOUNT_BPS,
            ...
            max_liquidation_rounds: DEFAULT_MAX_LIQUIDATION_ROUNDS,
...
impl Config {
    pub fn validate(&self) -> Result<()> {
        ...
        ensure_bps("liquidation_discount_bps", self.liquidation_discount_bps)?;
        ...
        if self.min_privacy_set_size == 0 || self.liquidation_cycle_ms == 0 {
            return Err("privacy set and liquidation cycle must be non-zero".to_string());
        }
        Ok(())
    }
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "pq_liquidation_attestation_suite": self.pq_liquidation_attestation_suite,
            "liquidated_position_suite": self.liquidated_position_suite,
            "roots_only_public_records": self.roots_only_public_records,
            "min_pq_security_bits": self.min_pq_security_bits,
            "min_privacy_set_size": self.min_privacy_set_size,
            "target_privacy_set_size": self.target_privacy_set_size,
            "liquidation_cycle_ms": self.liquidation_cycle_ms,
...
pub struct Roots {
    ...
    pub liquidation_rounds_root: String,
...
pub struct RegisterPoolInput {
    ...
    pub liquidation_vault_root: String,
...
pub struct LiquidationPool {
    ...
    pub liquidated_interest_micros: u128,
    pub order_count: u64,
    pub round_count: u64,
    pub created_at_height: u64,
...
impl LiquidationPool {
    pub fn from_input(input: RegisterPoolInput) -> Self {
        Self {
            ...
            liquidation_mode: input.liquidation_mode,
            status: PoolStatus::Open,
            maker_commitment_root: input.maker_commitment_root,
            liquidation_vault_root: input.liquidation_vault_root,
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "liquidation_vault_root": self.liquidation_vault_root,
            "encrypted_curve_root": self.encrypted_curve_root,
            "privacy_set_size": self.privacy_set_size,
            "pq_security_bits": self.pq_security_bits,
            "max_latency_ms": self.max_latency_ms,
            "open_interest_micros": self.open_interest_micros,
            "liquidated_interest_micros": self.liquidated_interest_micros,
        })
    }
}
...
pub struct LiquidationOrder {
    ...
    pub expires_slot: u64,
    pub created_at_height: u64,
    pub liquidated_round_id: Option<String>,
}
...
impl LiquidationOrder {
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "liquidated_round_id": self.liquidated_round_id,
        })
    }
}

#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct RunLiquidationInput {
    pub round_id: String,
    pub pool_id: String,
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct PqLiquidationAttestationInput {
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq, Serialize)]
pub struct PqLiquidationAttestation {
    pub attestation_id: String,
    pub round_id: String,
...
pub struct State {
    ...
    pub roots: Roots,
    pub pools: BTreeMap<String, LiquidationPool>,
    pub orders: BTreeMap<String, LiquidationOrder>,
    pub liquidation_rounds: BTreeMap<String, LiquidationRound>,
    pub pq_attestations: BTreeMap<String, PqLiquidationAttestation>,
...
impl State {
    pub fn new(config: Config) -> Self {
        let mut state = Self {
            ...
            pools: BTreeMap::new(),
            orders: BTreeMap::new(),
            liquidation_rounds: BTreeMap::new(),
    ...
    pub fn register_pool(&mut self, input: RegisterPoolInput) -> Result<()> {
        ...
        let pool = LiquidationPool::from_input(input);
    ...
    pub fn open_order(&mut self, input: OpenOrderInput) -> Result<()> {
        ...
        let order = LiquidationOrder::from_input(input);
    ...
    pub fn run_liquidation(&mut self, input: RunLiquidationInput) -> Result<()> {
        ensure_capacity(
            self.liquidation_rounds.len(),
            self.config.max_liquidation_rounds,
            "liquidation rounds",
        )?;
        ensure_unique(
            &self.liquidation_rounds,
            "liquidation round",
            &input.round_id,
        )?;
        let pool = self
        ...
        if input.observed_latency_ms > pool.max_latency_ms {
            return Err("liquidation round exceeds pool latency bound".to_string());
        }
        ...
        let fee_savings_micros = fee_savings_for_cross(
            crossed_notional_micros,
            self.config.liquidation_discount_bps,
        );
        let order_ids_root = merkle_string_root(D_ORDERS, &input.order_ids);
        for order_id in &input.order_ids {
            if let Some(order) = self.orders.get_mut(order_id) {
                order.status = OrderStatus::Liquidated;
                order.liquidated_round_id = Some(input.round_id.clone());
            }
        }
        if let Some(pool_mut) = self.pools.get_mut(&input.pool_id) {
            pool_mut.liquidated_interest_micros = pool_mut
                .liquidated_interest_micros
        ...
        self.counters.orders_liquidated = self
            .counters
            .orders_liquidated
    ...
    pub fn attest_liquidation(&mut self, input: PqLiquidationAttestationInput) -> Result<()> {
        ensure_capacity(
        ...
        let attestation = PqLiquidationAttestation {
    ...
    pub fn settle_round(&mut self, round_id: &str, height: u64, epoch: u64) -> Result<()> {
        ...
        for order in self
            .orders
            .values_mut()
            .filter(|order| order.liquidated_round_id.as_deref() == Some(round_id))
        {
    ...
    pub fn refresh_roots(&mut self) {
        ...
        self.roots.liquidation_rounds_root = map_root(D_ROUNDS, &self.liquidation_rounds);
        ...
        self.roots.state_root = domain_hash(
            ...
            &[
                ...
                HashPart::from(self.roots.liquidation_rounds_root.as_str()),
    ...
    fn roots_only_record(&self) -> PublicRecord {
        PublicRecord {
            ...
            liquidation_rounds_root: self.roots.liquidation_rounds_root.clone(),
...
pub fn devnet() -> State {
    ...
    let pool_id = "devnet-fast-pq-latency-liquidation-pool-0".to_string();
    state
        .register_pool(RegisterPoolInput {
            pool_id: pool_id.clone(),
            derivative_class: DerivativeClass::LatencyFuture,
            liquidation_mode: LiquidationMode::Continuous,
            maker_commitment_root: devnet_commitment("maker", 0),
            liquidation_vault_root: devnet_commitment("liquidation-vault", 0),
    ...
    state
        .open_order(OpenOrderInput {
            order_id: "devnet-liquidation-order-pay-0".to_string(),
            pool_id: pool_id.clone(),
    ...
    state
        .open_order(OpenOrderInput {
            order_id: "devnet-liquidation-order-receive-0".to_string(),
            pool_id: pool_id.clone(),
    ...
    state
        .run_liquidation(RunLiquidationInput {
            round_id: "devnet-liquidation-round-0".to_string(),
            pool_id,
            order_ids: vec![
                "devnet-liquidation-order-pay-0".to_string(),
                "devnet-liquidation-order-receive-0".to_string(),
            ],
    ...
    state
        .attest_liquidation(PqLiquidationAttestationInput {
            attestation_id: "devnet-liquidation-attestation-0".to_string(),
            round_id: "devnet-liquidation-round-0".to_string(),
...
fn fee_for_net(gross: u128, net: u128, config: &Config) -> u64 {
    let fee_bps = config
        .taker_fee_bps
        .saturating_sub(config.liquidation_discount_bps.min(config.taker_fee_bps))
