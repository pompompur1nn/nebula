...
#[rustfmt::skip]
pub type PrivateL2LowFeePqConfidentialSequencerBlobFeeRebateNettingSettlementClearinghouseRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_LOW_FEE_PQ_CONFIDENTIAL_SEQUENCER_BLOB_FEE_REBATE_NETTING_SETTLEMENT_CLEARINGHOUSE_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-low-fee-pq-confidential-sequencer-blob-fee-rebate-netting-settlement-clearinghouse-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_LOW_FEE_PQ_CONFIDENTIAL_SEQUENCER_BLOB_FEE_REBATE_NETTING_SETTLEMENT_CLEARINGHOUSE_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const PQ_ENVELOPE_SUITE: &str =
    "ml-kem-1024+ml-dsa-87-netting-settlement-clearinghouse-fee-rebate-envelope-v1";
pub const REBATE_NETTING_SETTLEMENT_CLEARINGHOUSE_SUITE: &str =
    "private-l2-low-fee-confidential-sequencer-rebate-netting-settlement-clearinghouse-v1";
...
pub const SETTLEMENT_PROOF_SUITE: &str =
    "slh-dsa-shake-256f-netting-settlement-clearinghouse-settlement-proof-root-v1";
pub const FAST_PATH_PROOF_SUITE: &str =
    "ml-dsa-87-fast-netting-settlement-clearinghouse-attestation-root-v1";
pub const NULLIFIER_SUITE: &str = "confidential-netting-settlement-clearinghouse-nullifier-set-v1";
pub const PUBLIC_RECORD_SUITE: &str =
    "roots-only-confidential-sequencer-blob-fee-rebate-netting-settlement-clearinghouse-record-v1";
pub const PRIVACY_BOUNDARY: &str =
    "roots_only_no_plaintext_accounts_amounts_addresses_view_keys_blob_payloads_or_secret_keys";
pub const DEVNET_L2_NETWORK: &str = "nebula-private-l2-netting-settlement-clearinghouse-devnet";
pub const DEVNET_SETTLEMENT_CLEARINGHOUSE_ID: &str =
    "private-l2-sequencer-blob-fee-rebate-netting-settlement-clearinghouse-devnet";
pub const DEVNET_OPERATOR_SET_ID: &str =
    "private-l2-netting-settlement-clearinghouse-operator-set-devnet";
...
const D_STATE: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE:STATE";
const D_CONFIG: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE:CONFIG";
const D_COUNTERS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE:COUNTERS";
const D_ROOTS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE:ROOTS";
const D_DEBITS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE:DEBITS";
const D_CREDITS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE:CREDITS";
const D_WINDOWS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE:WINDOWS";
const D_SETTLEMENTS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE:SETTLEMENTS";
const D_BUCKETS: &str = "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE:BUCKETS";
const D_ATTESTATIONS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE:ATTESTATIONS";
const D_NULLIFIERS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE:NULLIFIERS";
const D_PUBLIC_RECORDS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE:PUBLIC-RECORDS";
...
pub fn devnet() -> State {
    ...
    let bucket_id = state
        .open_liquidity_bucket(LiquidityBucketInput {
            bucket_id: "devnet-netting-settlement-clearinghouse-liquidity-bucket-0001".to_string(),
