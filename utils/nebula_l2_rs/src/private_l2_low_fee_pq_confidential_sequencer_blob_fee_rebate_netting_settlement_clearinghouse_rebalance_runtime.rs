...
#[rustfmt::skip]
pub type PrivateL2LowFeePqConfidentialSequencerBlobFeeRebateNettingSettlementClearinghouseRebalanceRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_LOW_FEE_PQ_CONFIDENTIAL_SEQUENCER_BLOB_FEE_REBATE_NETTING_SETTLEMENT_CLEARINGHOUSE_REBALANCE_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-low-fee-pq-confidential-sequencer-blob-fee-rebate-netting-settlement-clearinghouse-rebalance-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_LOW_FEE_PQ_CONFIDENTIAL_SEQUENCER_BLOB_FEE_REBATE_NETTING_SETTLEMENT_CLEARINGHOUSE_REBALANCE_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const PQ_ENVELOPE_SUITE: &str =
    "ml-kem-1024+ml-dsa-87-netting-settlement-clearinghouse-rebalance-fee-rebate-envelope-v1";
pub const REBATE_NETTING_SETTLEMENT_CLEARINGHOUSE_SUITE: &str =
    "private-l2-low-fee-confidential-sequencer-rebate-netting-settlement-clearinghouse-rebalance-v1";
...
pub const SETTLEMENT_PROOF_SUITE: &str =
    "slh-dsa-shake-256f-netting-settlement-clearinghouse-rebalance-settlement-proof-root-v1";
pub const FAST_PATH_PROOF_SUITE: &str =
    "ml-dsa-87-fast-netting-settlement-clearinghouse-rebalance-attestation-root-v1";
pub const NULLIFIER_SUITE: &str =
    "confidential-netting-settlement-clearinghouse-rebalance-nullifier-set-v1";
pub const PUBLIC_RECORD_SUITE: &str =
    "roots-only-confidential-sequencer-blob-fee-rebate-netting-settlement-clearinghouse-rebalance-record-v1";
...
pub const DEVNET_L2_NETWORK: &str =
    "nebula-private-l2-netting-settlement-clearinghouse-rebalance-devnet";
pub const DEVNET_SETTLEMENT_CLEARINGHOUSE_ID: &str =
    "private-l2-sequencer-blob-fee-rebate-netting-settlement-clearinghouse-rebalance-devnet";
pub const DEVNET_OPERATOR_SET_ID: &str =
    "private-l2-netting-settlement-clearinghouse-rebalance-operator-set-devnet";
...
const D_STATE: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE:STATE";
const D_CONFIG: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE:CONFIG";
const D_COUNTERS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE:COUNTERS";
const D_ROOTS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE:ROOTS";
const D_DEBITS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE:DEBITS";
const D_CREDITS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE:CREDITS";
const D_WINDOWS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE:WINDOWS";
const D_SETTLEMENTS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE:SETTLEMENTS";
const D_BUCKETS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE:BUCKETS";
const D_ATTESTATIONS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE:ATTESTATIONS";
const D_NULLIFIERS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE:NULLIFIERS";
const D_PUBLIC_RECORDS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE:PUBLIC-RECORDS";
const D_REBALANCE_ROUNDS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE:ROUNDS";
const D_SPONSOR_CAPS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE:SPONSOR-CAPS";
...
pub fn devnet() -> State {
    ...
    let bucket_id = state
        .open_liquidity_bucket(LiquidityBucketInput {
            bucket_id: "devnet-netting-settlement-clearinghouse-rebalance-liquidity-bucket-0001"
                .to_string(),
