...
pub type PrivateL2PqConfidentialBridgeDandelionFluffPhasePrivacyFirewallRuntimeResult<T> =
    Result<T>;
pub type Runtime = State;

pub const PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-bridge-dandelion-fluff-phase-privacy-firewall-runtime-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_BRIDGE_DANDELION_FLUFF_PHASE_PRIVACY_FIREWALL_RUNTIME_PROTOCOL_VERSION:
    &str = PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const PQ_FIREWALL_SUITE: &str = "ML-DSA-87+ML-KEM-1024+SLH-DSA-SHAKE-256f";
pub const FLUFF_PRIVACY_SUITE: &str =
    "monero-bridge-dandelion-fluff-phase-privacy-firewall-root-v1";
pub const REBATE_SUITE: &str = "dandelion-fluff-phase-privacy-low-fee-rebate-root-v1";
pub const REDACTION_SUITE: &str = "operator-safe-dandelion-fluff-phase-privacy-redaction-root-v1";
...
pub const DEFAULT_FLUFF_PRIVACY_WINDOW_SLOTS: u64 = 720;
...
impl FluffPhasePrivacyScope {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::EmergencyFluffPrivacy => "emergency_fluff_phase_privacy",
...
pub enum AttestationVerdict {
    ConfirmFluffPhasePrivacyNeed,
    ConfirmPrivacyRisk,
    RequireDandelionFluffRotation,
    RequireFluffPhasePrivacyFirewall,
    RequireQuarantine,
    ClearFalsePositive,
}
...
#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum FluffPhasePrivacyAction {
    Observe,
    QueueFluffPrivacyReview,
    ApplyFluffPrivacyFirewall,
    RotateDandelionFluffCohort,
    QuarantineRoute,
    EmergencyPause,
    Release,
    Reject,
...
pub struct Config {
    ...
    pub fluff_privacy_suite: String,
    ...
    pub fluff_privacy_window_slots: u64,
    pub signal_window_slots: u64,
    pub max_route_fee_bps: u64,
    pub target_rebate_bps: u64,
    pub min_stem_fluff_phase_privacy_liquidity_micro_units: u64,
    pub min_fluff_fluff_phase_privacy_liquidity_micro_units: u64,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            fluff_privacy_suite: FLUFF_PRIVACY_SUITE.to_string(),
            ...
            fluff_privacy_window_slots: DEFAULT_FLUFF_PRIVACY_WINDOW_SLOTS,
            signal_window_slots: DEFAULT_SIGNAL_WINDOW_SLOTS,
            max_route_fee_bps: DEFAULT_MAX_ROUTE_FEE_BPS,
            target_rebate_bps: DEFAULT_TARGET_REBATE_BPS,
            min_stem_fluff_phase_privacy_liquidity_micro_units:
                DEFAULT_MIN_SOURCE_LIQUIDITY_MICRO_UNITS,
            min_fluff_fluff_phase_privacy_liquidity_micro_units:
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct FluffPhasePrivacyPolicy {
    pub policy_id: String,
    pub scope: FluffPhasePrivacyScope,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct DandelionFluffPhasePrivacyFirewallCohort {
    ...
    pub fluff_privacy_commitment_root: String,
    pub stem_fluff_phase_privacy_liquidity_micro_units: u64,
    pub fluff_fluff_phase_privacy_liquidity_micro_units: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct FluffPhasePrivacySignal {
    ...
    pub stem_fluff_phase_privacy_liquidity_delta_micro_units: i128,
    pub fluff_fluff_phase_privacy_liquidity_delta_micro_units: i128,
    pub privacy_set_size: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct PqFluffPhasePrivacyAttestation {
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct FluffPhasePrivacyDecision {
    pub decision_id: String,
    pub signal_id: String,
    pub cohort_id: String,
    pub policy_id: String,
    pub action: FluffPhasePrivacyAction,
    pub decision_root: String,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct LowFeeFluffPhasePrivacyRebate {
...
pub struct State {
    ...
    pub roots: Roots,
    pub policies: BTreeMap<String, FluffPhasePrivacyPolicy>,
    pub cohorts: BTreeMap<String, DandelionFluffPhasePrivacyFirewallCohort>,
    pub signals: BTreeMap<String, FluffPhasePrivacySignal>,
    pub attestations: BTreeMap<String, PqFluffPhasePrivacyAttestation>,
    pub decisions: BTreeMap<String, FluffPhasePrivacyDecision>,
    pub rebates: BTreeMap<String, LowFeeFluffPhasePrivacyRebate>,
...
impl State {
    ...
    pub fn devnet() -> Self {
        ...
        let withdrawal_policy = state
            .register_policy(RegisterPolicyRequest {
                scope: FluffPhasePrivacyScope::WithdrawalSubaddressLane,
                owner_commitment: "owner:dandelion-fluff-phase-privacy-firewall-council-a"
                    .to_string(),
                policy_commitment_root: devnet_root(
                    "policy",
                    "withdrawal-dandelion-fluff-phase-privacy-firewall",
                ),
                ...
                min_stem_fluff_phase_privacy_liquidity_micro_units: 160_000_000,
                min_fluff_fluff_phase_privacy_liquidity_micro_units: 72_000_000,
                max_route_fee_bps: 16,
                min_attestation_quorum_bps: 7_200,
                signal_window_slots: 96,
                fluff_privacy_window_slots: 720,
                redaction_profile: "withdrawal-dandelion-fluff-phase-privacy-firewall-profile"
                    .to_string(),
            })
            .expect("devnet withdrawal policy");
        let fast_dandelion_exit_policy = state
            .register_policy(RegisterPolicyRequest {
                scope: FluffPhasePrivacyScope::FastDandelionFluffPrivacyLane,
                owner_commitment: "owner:fast-dandelion-fluff-privacy-route-council-b".to_string(),
                policy_commitment_root: devnet_root(
                    "policy",
                    "fast-dandelion-fluff-privacy-dandelion-fluff-phase-privacy-firewall",
                ),
                source_fluff_relay_set_root: devnet_root(
                    "source-fluff-relay-set",
                    "fast-dandelion-fluff-privacy-beta",
                ),
                target_fluff_relay_set_root: devnet_root(
                    "target-fluff-relay-set",
                    "fast-dandelion-fluff-privacy-beta",
                ...
                min_stem_fluff_phase_privacy_liquidity_micro_units: 144_000_000,
                min_fluff_fluff_phase_privacy_liquidity_micro_units: 64_000_000,
                max_route_fee_bps: 18,
                min_attestation_quorum_bps: 7_000,
                signal_window_slots: 80,
                fluff_privacy_window_slots: 640,
                redaction_profile:
                    "fast-dandelion-fluff-privacy-dandelion-fluff-phase-privacy-firewall-profile"
                        .to_string(),
            })
            .expect("devnet fast fluff_phase_privacy policy");
        let withdrawal_cohort = state
            .register_cohort(RegisterCohortRequest {
                policy_id: withdrawal_policy,
                bridge_lane_id: "withdrawal-fluff-privacy-alpha".to_string(),
                ...
                fluff_privacy_commitment_root: devnet_root("liquidity", "cohort-alpha"),
                stem_fluff_phase_privacy_liquidity_micro_units: 216_000_000,
                fluff_fluff_phase_privacy_liquidity_micro_units: 96_000_000,
        ...
        let fast_dandelion_exit_cohort = state
            .register_cohort(RegisterCohortRequest {
                ...
                bridge_lane_id: "fast-dandelion-fluff-privacy-route-beta".to_string(),
                ...
                fluff_privacy_commitment_root: devnet_root("liquidity", "cohort-beta"),
                stem_fluff_phase_privacy_liquidity_micro_units: 168_000_000,
                fluff_fluff_phase_privacy_liquidity_micro_units: 76_000_000,
                privacy_set_size: 393_216,
                route_fee_bps: 13,
                public_hint_root: devnet_root("hint", "cohort-beta"),
            })
            .expect("devnet fast fluff_phase_privacy cohort");
        let signal = state
            .submit_signal(SubmitSignalRequest {
                ...
                stem_fluff_phase_privacy_liquidity_delta_micro_units: -48_000_000,
                fluff_fluff_phase_privacy_liquidity_delta_micro_units: 24_000_000,
                privacy_set_size: 524_288,
        ...
        state
            .submit_attestation(SubmitAttestationRequest {
                ...
                verdict: AttestationVerdict::RequireFluffPhasePrivacyFirewall,
                attestor_commitment: "attestor:pq-dandelion-fluff-phase-privacy-firewall-a"
                    .to_string(),
                pq_signature_root: devnet_root(
                    "ml-dsa-signature",
                    "withdrawal-fluff_phase_privacy-a",
                ),
                pq_public_key_root: devnet_root(
                    "ml-kem-public-key",
                    "withdrawal-fluff_phase_privacy-a",
                ),
                transcript_root: devnet_root("transcript", "withdrawal-fluff_phase_privacy-a"),
        ...
        state
            .submit_attestation(SubmitAttestationRequest {
                signal_id: signal.clone(),
                verdict: AttestationVerdict::ConfirmFluffPhasePrivacyNeed,
                attestor_commitment: "attestor:pq-dandelion-fluff-phase-privacy-firewall-b"
                    .to_string(),
                pq_signature_root: devnet_root(
                    "slh-dsa-signature",
                    "withdrawal-fluff_phase_privacy-b",
                ),
                pq_public_key_root: devnet_root(
                    "ml-kem-public-key",
                    "withdrawal-fluff_phase_privacy-b",
                ),
                transcript_root: devnet_root("transcript", "withdrawal-fluff_phase_privacy-b"),
        ...
        let decision = state
            .settle_decision(SettleDecisionRequest {
                signal_id: signal,
                action: FluffPhasePrivacyAction::ApplyFluffPrivacyFirewall,
                decision_root: devnet_root("decision", "withdrawal-liquidity-fluff_phase_privacy"),
                replacement_route_root: devnet_root(
                    "replacement-route",
                    "withdrawal-fluff_phase_privacy",
                ),
            ...
            .expect("devnet fluff_phase_privacy decision");
        state
            .publish_rebate(PublishRebateRequest {
                decision_id: decision,
                recipient_commitment:
                    "recipient:dandelion-fluff-phase-privacy-firewall-fee-sponsor".to_string(),
                rebate_micro_units: 22_000,
                fee_saved_micro_units: 88_000,
                rebate_bps: 8,
                settlement_slot: DEVNET_SLOT + 6,
                rebate_root: devnet_root("rebate", "withdrawal-fluff_phase_privacy"),
            })
    ...
    pub fn register_policy(&mut self, request: RegisterPolicyRequest) -> Result<String> {
        ensure_capacity(
            self.policies.len(),
            MAX_POLICIES,
            "Dandelion fluff-phase privacy firewall policies",
        )?;
        ...
        if request.min_stem_fluff_phase_privacy_liquidity_micro_units
            < self
                .config
                .min_stem_fluff_phase_privacy_liquidity_micro_units
        {
        ...
        if request.min_fluff_fluff_phase_privacy_liquidity_micro_units
            < self
                .config
                .min_fluff_fluff_phase_privacy_liquidity_micro_units
        {
        ...
        let policy_id = stable_id(
            "dandelion-fluff-phase-privacy-firewall-policy",
            &[
        ...
        if self.policies.contains_key(&policy_id) {
            return Err(format!(
                "Dandelion fluff-phase privacy firewall policy {policy_id} already exists"
            ));
        }
        self.policies.insert(
            policy_id.clone(),
            FluffPhasePrivacyPolicy {
                ...
                min_stem_fluff_phase_privacy_liquidity_micro_units: request
                    .min_stem_fluff_phase_privacy_liquidity_micro_units,
                min_fluff_fluff_phase_privacy_liquidity_micro_units: request
                    .min_fluff_fluff_phase_privacy_liquidity_micro_units,
                ...
                fluff_privacy_window_slots: request.fluff_privacy_window_slots,
                active: true,
    ...
    pub fn register_cohort(&mut self, request: RegisterCohortRequest) -> Result<String> {
        ...
        let policy = self.policies.get(&request.policy_id).ok_or_else(|| {
            format!(
                "unknown Dandelion fluff-phase privacy firewall policy {}",
                request.policy_id
            )
        })?;
        ...
        ensure_non_empty(
            &request.fluff_privacy_commitment_root,
            "fluff_privacy_commitment_root",
        )?;
        ...
        if request.stem_fluff_phase_privacy_liquidity_micro_units
            < policy.min_stem_fluff_phase_privacy_liquidity_micro_units
        {
            return Err("cohort source liquidity below policy floor".to_string());
        }
        if request.fluff_fluff_phase_privacy_liquidity_micro_units
            < policy.min_fluff_fluff_phase_privacy_liquidity_micro_units
        {
        ...
        let cohort_id = stable_id(
            "dandelion-fluff-phase-privacy-firewall-cohort",
            &[
                HashPart::Str(&request.policy_id),
                HashPart::Str(&request.bridge_lane_id),
                HashPart::Str(&request.source_fluff_relay_set_root),
                HashPart::Str(&request.fluff_privacy_commitment_root),
            ],
        );
        if self.cohorts.contains_key(&cohort_id) {
            return Err(format!(
                "Dandelion fluff-phase privacy firewall cohort {cohort_id} already exists"
            ));
        }
        self.cohorts.insert(
            cohort_id.clone(),
            DandelionFluffPhasePrivacyFirewallCohort {
                ...
                fluff_privacy_commitment_root: request.fluff_privacy_commitment_root,
                stem_fluff_phase_privacy_liquidity_micro_units: request
                    .stem_fluff_phase_privacy_liquidity_micro_units,
                fluff_fluff_phase_privacy_liquidity_micro_units: request
                    .fluff_fluff_phase_privacy_liquidity_micro_units,
    ...
    pub fn submit_signal(&mut self, request: SubmitSignalRequest) -> Result<String> {
        ensure_capacity(
            self.signals.len(),
            MAX_SIGNALS,
            "Dandelion fluff-phase privacy firewall signals",
        )?;
        let cohort = self
            .cohorts
            ...
            .ok_or_else(|| {
                format!(
                    "unknown Dandelion fluff-phase privacy firewall cohort {}",
                    request.cohort_id
                )
            })?
            .clone();
        ...
        let signal_id = stable_id(
            "dandelion-fluff-phase-privacy-firewall-signal",
            &[
        ...
        if self.signals.contains_key(&signal_id) {
            return Err(format!(
                "Dandelion fluff-phase privacy firewall signal {signal_id} already exists"
            ));
        }
        ...
        self.signals.insert(
            ...
            FluffPhasePrivacySignal {
                ...
                stem_fluff_phase_privacy_liquidity_delta_micro_units: request
                    .stem_fluff_phase_privacy_liquidity_delta_micro_units,
                fluff_fluff_phase_privacy_liquidity_delta_micro_units: request
                    .fluff_fluff_phase_privacy_liquidity_delta_micro_units,
                privacy_set_size: request.privacy_set_size,
    ...
    pub fn submit_attestation(&mut self, request: SubmitAttestationRequest) -> Result<String> {
        ensure_capacity(
            ...
            MAX_ATTESTATIONS,
            "Dandelion fluff-phase privacy firewall attestations",
        )?;
        let signal = self
            .signals
            ...
            .ok_or_else(|| {
                format!(
                    "unknown Dandelion fluff-phase privacy firewall signal {}",
                    request.signal_id
                )
            })?
            .clone();
        ...
        let attestation_id = stable_id(
            "dandelion-fluff-phase-privacy-firewall-pq-attestation",
            &[
        ...
        if self.attestations.contains_key(&attestation_id) {
            return Err(format!(
                "Dandelion fluff-phase privacy firewall attestation {attestation_id} already exists"
            ));
        }
        self.attestations.insert(
            attestation_id.clone(),
            PqFluffPhasePrivacyAttestation {
    ...
    pub fn settle_decision(&mut self, request: SettleDecisionRequest) -> Result<String> {
        ensure_capacity(
            self.decisions.len(),
            MAX_DECISIONS,
            "Dandelion fluff-phase privacy firewall decisions",
        )?;
        let signal = self
            .signals
            .get(&request.signal_id)
        ...
        let privacy_filter_deadline_slot = match request.action {
            FluffPhasePrivacyAction::QueueFluffPrivacyReview
            | FluffPhasePrivacyAction::ApplyFluffPrivacyFirewall
            | FluffPhasePrivacyAction::RotateDandelionFluffCohort => request
                .decided_at_slot
                .saturating_add(policy.fluff_privacy_window_slots),
            FluffPhasePrivacyAction::QuarantineRoute | FluffPhasePrivacyAction::EmergencyPause => {
                request
                    .decided_at_slot
                    .saturating_add(policy.fluff_privacy_window_slots / 2)
            }
            _ => 0,
        };
        let decision_id = stable_id(
            "dandelion-fluff-phase-privacy-firewall-decision",
            &[
                HashPart::Str(&request.signal_id),
        ...
        if self.decisions.contains_key(&decision_id) {
            return Err(format!(
                "Dandelion fluff-phase privacy firewall decision {decision_id} already exists"
            ));
        }
        self.decisions.insert(
            decision_id.clone(),
            FluffPhasePrivacyDecision {
        ...
        if let Some(signal) = self.signals.get_mut(&request.signal_id) {
            signal.status = match request.action {
                FluffPhasePrivacyAction::QueueFluffPrivacyReview => SignalStatus::RouteQueued,
                FluffPhasePrivacyAction::ApplyFluffPrivacyFirewall
                | FluffPhasePrivacyAction::RotateDandelionFluffCohort => SignalStatus::Routing,
                FluffPhasePrivacyAction::QuarantineRoute
                | FluffPhasePrivacyAction::EmergencyPause => SignalStatus::Quarantined,
                FluffPhasePrivacyAction::Release => SignalStatus::Settled,
                FluffPhasePrivacyAction::Reject => SignalStatus::Rejected,
                FluffPhasePrivacyAction::Expire => SignalStatus::Expired,
                FluffPhasePrivacyAction::Observe => SignalStatus::Attested,
            };
        }
        if let Some(cohort) = self.cohorts.get_mut(&signal.cohort_id) {
            match request.action {
                ...
                FluffPhasePrivacyAction::ApplyFluffPrivacyFirewall => {
                    ...
                    cohort.stem_fluff_phase_privacy_liquidity_micro_units = cohort
                        .stem_fluff_phase_privacy_liquidity_micro_units
                        .saturating_sub(request.privacy_filtered_micro_units);
                    cohort.fluff_fluff_phase_privacy_liquidity_micro_units = cohort
                        .fluff_fluff_phase_privacy_liquidity_micro_units
                ...
                FluffPhasePrivacyAction::RotateDandelionFluffCohort => {
                ...
                FluffPhasePrivacyAction::EmergencyPause => {
                    cohort.status = CohortStatus::Paused;
                    cohort.privacy_filter_deadline_slot = privacy_filter_deadline_slot;
                    self.counters.routes_quarantined =
                        self.counters.routes_quarantined.saturating_add(1);
                }
                FluffPhasePrivacyAction::Release => {
    ...
    pub fn publish_rebate(&mut self, request: PublishRebateRequest) -> Result<String> {
        ensure_capacity(
            self.rebates.len(),
            MAX_REBATES,
            "Dandelion fluff-phase privacy firewall rebates",
        )?;
        let decision = self.decisions.get(&request.decision_id).ok_or_else(|| {
            format!(
                "unknown Dandelion fluff-phase privacy firewall decision {}",
                request.decision_id
            )
        })?;
        ...
        let rebate_id = stable_id(
            "dandelion-fluff-phase-privacy-firewall-low-fee-rebate",
            &[
        ...
        if self.rebates.contains_key(&rebate_id) {
            return Err(format!(
                "Dandelion fluff-phase privacy firewall rebate {rebate_id} already exists"
            ));
        }
        self.rebates.insert(
            rebate_id.clone(),
            LowFeeFluffPhasePrivacyRebate {
    ...
    pub fn publish_redaction_budget(
        ...
        ensure_capacity(
            ...
            "Dandelion fluff-phase privacy firewall redaction budgets",
        )?;
        ...
        let budget_id = stable_id(
            "dandelion-fluff-phase-privacy-firewall-redaction-budget",
            &[
                HashPart::Str(request.scope.as_str()),
                HashPart::Str(&request.cohort_id),
        ...
        if self.redaction_budgets.contains_key(&budget_id) {
            return Err(format!(
                "Dandelion fluff-phase privacy firewall redaction budget {budget_id} already exists"
            ));
        }
    ...
    pub fn publish_operator_summary(
        ...
        ensure_capacity(
            ...
            "Dandelion fluff-phase privacy firewall operator summaries",
        )?;
        self.refresh_live_counts();
        ...
        let summary_id = stable_id(
            "dandelion-fluff-phase-privacy-firewall-operator-summary",
            &[
                HashPart::U64(epoch),
                HashPart::U64(slot),
    ...
    fn refresh_roots(&mut self) {
        ...
        self.roots.state_root = merkle_root(
            "bridge-dandelion-fluff-phase-privacy-firewall:state",
            &[
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "fluff_privacy_suite": self.config.fluff_privacy_suite,
            ...
            "fluff_privacy_window_slots": self.config.fluff_privacy_window_slots,
            ...
            "policies": self.policies.values().map(|policy| json!({
                ...
                "min_stem_fluff_phase_privacy_liquidity_micro_units": policy.min_stem_fluff_phase_privacy_liquidity_micro_units,
                "min_fluff_fluff_phase_privacy_liquidity_micro_units": policy.min_fluff_fluff_phase_privacy_liquidity_micro_units,
            ...
            "cohorts": self.cohorts.values().map(|cohort| json!({
                ...
                "stem_fluff_phase_privacy_liquidity_micro_units": cohort.stem_fluff_phase_privacy_liquidity_micro_units,
                "fluff_fluff_phase_privacy_liquidity_micro_units": cohort.fluff_fluff_phase_privacy_liquidity_micro_units,
...
pub fn demo() -> State {
    ...
    let signal = state
        .submit_signal(SubmitSignalRequest {
            ...
            stem_fluff_phase_privacy_liquidity_delta_micro_units: -10_000_000,
            fluff_fluff_phase_privacy_liquidity_delta_micro_units: 8_000_000,
            privacy_set_size: 524_288,
    ...
    state
        .submit_attestation(SubmitAttestationRequest {
            signal_id: signal,
            verdict: AttestationVerdict::RequireDandelionFluffRotation,
            attestor_commitment: "attestor:demo-dandelion-fluff-phase-privacy-firewall".to_string(),
...
fn object_root<T: Serialize>(domain: &str, value: &T) -> String {
    ...
    domain_hash(
        &format!("bridge-dandelion-fluff-phase-privacy-firewall:{domain}"),
        &[HashPart::Json(&value)],
        32,
    )
}
...
fn devnet_root(domain: &str, label: &str) -> String {
    domain_hash(
        &format!("bridge-dandelion-fluff-phase-privacy-firewall:devnet:{domain}"),
