...
const PROTOCOL_VERSION: &str = "wave102-live-heavy-gate-release-execution-rebate-sweep-reconciliation-guard-compile-lane-runtime-v1";
const WAVE: u64 = 102;
...
const LANE_ID: &str =
    "wave102-live-heavy-gate-release-execution-rebate-sweep-reconciliation-guard-compile";
...
pub fn devnet() -> State {
    ...
    let claim_labels = [
        "compile_artifact_rebate",
        "build_metadata_fee_refund",
        "rustfmt_receipt_sweep",
        "linkage_residual_settlement",
        "operator_compile_signoff",
        "release_hold_manifest",
    ];
