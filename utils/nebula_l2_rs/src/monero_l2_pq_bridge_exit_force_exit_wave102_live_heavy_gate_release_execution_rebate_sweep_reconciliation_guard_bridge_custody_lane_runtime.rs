...
const PROTOCOL_VERSION: &str = "wave102-live-heavy-gate-release-execution-rebate-sweep-reconciliation-guard-bridge-custody-lane-runtime-v1";
const WAVE: u64 = 102;
...
const LANE_ID: &str =
    "wave102-live-heavy-gate-release-execution-rebate-sweep-reconciliation-guard-bridge-custody";
...
pub fn devnet() -> State {
    ...
    let claim_labels = [
        "custody_pool_rebate",
        "escrow_fee_refund",
        "reserve_liquidity_sweep",
        "custody_residual_settlement",
        "bridge_operator_signoff",
        "custody_release_hold",
    ];
