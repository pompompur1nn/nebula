...
pub type PrivateL2PqConfidentialFalconExitReceiptReinsuranceClaimRedemptionSettlementRouterRuntimeResult<
    T,
> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_PQ_CONFIDENTIAL_FALCON_EXIT_RECEIPT_REINSURANCE_CLAIM_REDEMPTION_SETTLEMENT_ROUTER_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-falcon-exit-receipt-reinsurance-claim-redemption-settlement-router-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_PQ_CONFIDENTIAL_FALCON_EXIT_RECEIPT_REINSURANCE_CLAIM_REDEMPTION_SETTLEMENT_ROUTER_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const FALCON_ROUTER_SETTLEMENT_SUITE: &str =
    "falcon-1024-ntru-exit-receipt-reinsurance-claim-redemption-settlement-router-v1";
pub const CONFIDENTIAL_EXIT_RECEIPT_SUITE: &str =
    "falcon-confidential-exit-receipt-router-commitment-v1";
pub const CLAIM_REDEMPTION_AUTH_SUITE: &str =
    "falcon-1024-private-claim-redemption-router-authorization-v1";
pub const REINSURANCE_SETTLEMENT_ACCOUNTING_SUITE: &str =
    "roots-only-falcon-reinsurance-claim-redemption-router-accounting-v1";
pub const LOW_FEE_SETTLEMENT_BATCH_SUITE: &str = "low-fee-falcon-claim-redemption-router-batch-v1";
...
pub const ROOTS_ONLY_PUBLIC_RECORD_SUITE: &str =
    "roots-only-falcon-claim-redemption-settlement-router-public-record-v1";
...
pub struct Config {
    ...
    pub falcon_router_settlement_suite: String,
...
impl Config {
    pub fn devnet() -> Self {
        Self {
            ...
            falcon_router_settlement_suite: FALCON_ROUTER_SETTLEMENT_SUITE.to_string(),
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "suites": {
                "falcon_router_settlement": self.falcon_router_settlement_suite,
...
pub fn public_record(state: &State) -> Value {
    json!({
        ...
        "falcon_router_settlement_suite": FALCON_ROUTER_SETTLEMENT_SUITE,
