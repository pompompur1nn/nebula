...
const PROTOCOL_VERSION: &str = "wave102-live-heavy-gate-release-execution-rebate-sweep-reconciliation-guard-final-transcript-runtime-v1";
const WAVE: u64 = 102;
...
const LANE_ID: &str =
    "wave102-live-heavy-gate-release-execution-rebate-sweep-reconciliation-guard-final-transcript";
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            active_lane: LaneKind::FinalTranscript.as_str().to_string(),
...
pub fn devnet() -> State {
    ...
    let claim_labels = [
        "compile_lane_reconciliation",
        "runtime_lane_reconciliation",
        "audit_lane_reconciliation",
        "custody_lane_reconciliation",
        "wallet_lane_reconciliation",
        "pq_privacy_lane_reconciliation",
        "global_release_hold",
    ];
