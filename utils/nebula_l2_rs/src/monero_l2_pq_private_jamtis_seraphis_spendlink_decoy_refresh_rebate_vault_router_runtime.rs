...
pub type MoneroL2PqPrivateJamtisSeraphisSpendlinkDecoyRefreshRebateVaultRouterRuntimeResult<T> =
    Result<T>;
pub type Runtime = State;

pub const MONERO_L2_PQ_PRIVATE_JAMTIS_SERAPHIS_SPENDLINK_DECOY_REFRESH_REBATE_VAULT_ROUTER_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-monero-l2-pq-private-jamtis-seraphis-spendlink-decoy-refresh-rebate-vault-router-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    MONERO_L2_PQ_PRIVATE_JAMTIS_SERAPHIS_SPENDLINK_DECOY_REFRESH_REBATE_VAULT_ROUTER_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const STATE_ROOT_DOMAIN: &str =
    "MONERO-L2-PQ-PRIVATE-JAMTIS-SERAPHIS-SPENDLINK-DECOY-REFRESH-REBATE-VAULT-ROUTER";
pub const DEVNET_L2_NETWORK: &str = "nebula-private-l2-devnet";
pub const DEVNET_MONERO_NETWORK: &str = "monero-devnet";
pub const DEVNET_FEE_ASSET_ID: &str = "piconero-devnet";
pub const DEVNET_REBATE_ASSET_ID: &str = "refresh-vault-router-rebate-credit-devnet";
pub const DEVNET_ROUTE_ASSET_ID: &str = "refresh-vault-route-share-devnet";
...
pub const VAULT_ROUTER_INTENT_SCHEME: &str =
    "jamtis-seraphis-spendlink-decoy-refresh-rebate-vault-router-intent-root-v1";
pub const VAULT_ROUTER_POOL_SCHEME: &str =
    "pq-private-jamtis-seraphis-decoy-refresh-vault-router-pool-root-v1";
pub const VAULT_ROUTER_QUOTE_SCHEME: &str =
    "defi-style-private-refresh-rebate-vault-router-quote-root-v1";
pub const VAULT_ROUTE_PLAN_SCHEME: &str =
    "shielded-jamtis-seraphis-refresh-rebate-vault-route-plan-root-v1";
pub const VAULT_ROUTE_SPLIT_SCHEME: &str =
    "private-refresh-rebate-vault-router-split-commitment-root-v1";
pub const VAULT_ROUTE_SETTLEMENT_SCHEME: &str =
    "defi-style-private-refresh-rebate-vault-router-settlement-root-v1";
pub const VAULT_ROUTER_PQ_ATTESTATION_SCHEME: &str =
    "ML-DSA-87+SLH-DSA-SHAKE-256f-jamtis-seraphis-refresh-rebate-vault-router-attestation-v1";
pub const VAULT_ROUTER_AUDIT_SCHEME: &str =
    "low-fee-private-refresh-rebate-vault-router-audit-root-v1";
pub const PUBLIC_RECORD_SCHEME: &str =
    "roots-only-jamtis-seraphis-spendlink-decoy-refresh-rebate-vault-router-public-record-v1";
...
impl State {
    ...
    pub fn devnet() -> Self {
        ...
        .expect("devnet vault_router config is valid");
        state.seed_devnet();
        state
    }
    ...
    fn seed_devnet(&mut self) {
        let intent_id = "rebate-vault_router-intent-devnet-0".to_string();
        let pool_id = "rebate-vault_router-pool-devnet-0".to_string();
        let quote_id = "rebate-vault_router-quote-devnet-0".to_string();
        let plan_id = "rebate-vault_router-plan-devnet-0".to_string();
        let split_id = "rebate-vault_router-split-devnet-0".to_string();
        let settlement_id = "rebate-vault_router-settlement-devnet-0".to_string();
