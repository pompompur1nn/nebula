...
pub type PrivateL2LowFeeCrossRollupCompressionMarketRuntimeResult<T> = Result<T, String>;

pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-low-fee-cross-rollup-compression-market-runtime-v1";
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_SCHEMA_VERSION: u64 = 1;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_HASH_SUITE: &str =
    "SHAKE256-domain-separated-canonical-json";
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_COMPRESSION_SUITE: &str =
    "pq-cross-rollup-private-batch-compression-v1";
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_PQ_ATTESTATION_SUITE: &str =
    "ML-KEM-1024+ML-DSA-87+SLH-DSA-SHAKE-256f-compression-committee-v1";
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_PROOF_BATCHING_SUITE: &str =
    "recursive-stark-compressed-batch-settlement-v1";
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEVNET_HEIGHT: u64 = 880_000;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_MAX_BPS: u64 = 10_000;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_LANES: usize = 128;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_OFFERS: usize =
    2_097_152;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_QUOTES: usize =
    2_097_152;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_ATTESTATIONS:
    usize = 2_097_152;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_RESERVATIONS:
    usize = 2_097_152;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_BATCHES: usize =
    1_048_576;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_RECEIPTS: usize =
    4_194_304;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_REBATES: usize =
    2_097_152;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MIN_PRIVACY_SET_SIZE: u64 = 8_192;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_BATCH_PRIVACY_SET_SIZE: u64 =
    65_536;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MIN_PQ_SECURITY_BITS: u16 = 256;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_USER_FEE_BPS: u64 =
    14;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_TARGET_REBATE_BPS:
    u64 = 9;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_SPONSOR_COVER_BPS:
    u64 = 8_500;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_QUOTE_TTL_BLOCKS: u64 =
    12;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_RESERVATION_TTL_BLOCKS: u64 = 8;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_OFFER_TTL_BLOCKS: u64 =
    48;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_SETTLEMENT_TTL_BLOCKS: u64 = 96;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MIN_COMMITTEE_WEIGHT: u64 = 67;
pub const PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_BATCH_OFFERS:
    usize = 16_384;

#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum CompressedBatchLaneKind {
    PrivateContractCall,
...
#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum CompressionSolverClass {
    SequencerOperated,
    CommunityArchive,
    FastEdgeCache,
    ColdProofArchive,
...
impl DeliveryReceiptKind {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::OfferDelivered => "offer_delivered",
...
impl Config {
    pub fn devnet() -> Self {
        Self {
            protocol_version: PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_PROTOCOL_VERSION
                .to_string(),
            schema_version: PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_SCHEMA_VERSION,
            chain_id: CHAIN_ID.to_string(),
            hash_suite: PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_HASH_SUITE.to_string(),
            compression_suite:
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_COMPRESSION_SUITE
                    .to_string(),
            pq_attestation_suite:
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_PQ_ATTESTATION_SUITE.to_string(),
            proof_batching_suite:
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_PROOF_BATCHING_SUITE.to_string(),
            max_lanes: PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_LANES,
            max_offers: PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_OFFERS,
            max_quotes: PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_QUOTES,
            max_attestations:
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_ATTESTATIONS,
            max_reservations:
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_RESERVATIONS,
            max_batches: PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_BATCHES,
            max_receipts: PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_RECEIPTS,
            max_rebates: PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_REBATES,
            min_privacy_set_size:
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MIN_PRIVACY_SET_SIZE,
            batch_privacy_set_size:
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_BATCH_PRIVACY_SET_SIZE,
            min_pq_security_bits:
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MIN_PQ_SECURITY_BITS,
            max_user_fee_bps:
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_USER_FEE_BPS,
            target_rebate_bps:
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_TARGET_REBATE_BPS,
            sponsor_cover_bps:
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_SPONSOR_COVER_BPS,
            quote_ttl_blocks:
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_QUOTE_TTL_BLOCKS,
            reservation_ttl_blocks:
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_RESERVATION_TTL_BLOCKS,
            offer_ttl_blocks: PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_OFFER_TTL_BLOCKS,
            settlement_ttl_blocks:
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_SETTLEMENT_TTL_BLOCKS,
            min_committee_weight:
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MIN_COMMITTEE_WEIGHT,
            max_batch_offers: PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEFAULT_MAX_BATCH_OFFERS,
            devnet_height: PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEVNET_HEIGHT,
        }
    }

    pub fn validate(&self) -> PrivateL2LowFeeCrossRollupCompressionMarketRuntimeResult<()> {
        require_non_empty("protocol_version", &self.protocol_version)?;
        require_non_empty("chain_id", &self.chain_id)?;
        ensure_eq(
            &self.chain_id,
            CHAIN_ID,
            "private l2 low fee Cross-rollup compression market chain id",
        )?;
        ...
        require_positive_usize("max_batch_offers", self.max_batch_offers)?;
        Ok(())
    }
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct RegisterCompressedBatchLaneRequest {
    pub lane_owner_commitment: String,
    pub lane_kind: CompressedBatchLaneKind,
...
impl RegisterCompressedBatchLaneRequest {
    pub fn validate(
        &self,
        config: &Config,
    ) -> PrivateL2LowFeeCrossRollupCompressionMarketRuntimeResult<()> {
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct CompressedBatchLaneRecord {
    pub lane_id: String,
    pub sequence: u64,
    pub request: RegisterCompressedBatchLaneRequest,
    pub status: LaneStatus,
    pub registered_at_height: u64,
    pub accepted_offer_count: u64,
    pub settled_offer_count: u64,
    pub cumulative_fee_bps: u64,
    pub lane_score: u64,
}

impl CompressedBatchLaneRecord {
    pub fn public_record(&self) -> Value {
        json!(self)
    }
}
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct SubmitCompressedBatchOfferRequest {
    pub lane_id: String,
...
impl SubmitCompressedBatchOfferRequest {
    pub fn validate(
        &self,
        config: &Config,
        current_height: u64,
        ...
        if self.max_fee_bps > config.max_user_fee_bps {
            return Err("offer max_fee_bps exceeds runtime low-fee ceiling".to_string());
        }
        if self.expires_at_height <= current_height {
            return Err("expires_at_height must be in the future".to_string());
        }
        if self.expires_at_height > current_height.saturating_add(config.offer_ttl_blocks) {
            return Err("offer expiry exceeds runtime offer ttl".to_string());
        }
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct CompressedBatchOfferRecord {
    pub offer_id: String,
    pub sequence: u64,
    pub request: SubmitCompressedBatchOfferRequest,
...
impl CompressedBatchOfferRecord {
    pub fn public_record(&self) -> Value {
        json!(self)
    }
}
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct PostCompressionSolverQuoteRequest {
    pub offer_id: String,
    pub solver_commitment: String,
    pub solver_class: CompressionSolverClass,
...
impl PostCompressionSolverQuoteRequest {
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct CompressionSolverQuoteRecord {
    pub quote_id: String,
    pub sequence: u64,
    pub request: PostCompressionSolverQuoteRequest,
    pub status: QuoteStatus,
    pub posted_at_height: u64,
    pub quote_score: u64,
}

impl CompressionSolverQuoteRecord {
    pub fn public_record(&self) -> Value {
        json!(self)
    }
}
...
impl PublishPqAvailabilityAttestationRequest {
    pub fn validate(
        ...
        ensure_unique("offer_ids", &self.offer_ids)?;
...
impl BuildCompressionSettlementBatchRequest {
    pub fn validate(
        ...
        if self.offer_ids.len() > config.max_batch_offers {
            return Err("settlement batch exceeds max_batch_offers".to_string());
        }
...
pub struct State {
    ...
    pub lanes: BTreeMap<String, CompressedBatchLaneRecord>,
    pub offers: BTreeMap<String, CompressedBatchOfferRecord>,
    pub quotes: BTreeMap<String, CompressionSolverQuoteRecord>,
...
impl State {
    pub fn devnet() -> Self {
        Self::new(
            Config::devnet(),
            PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_DEVNET_HEIGHT,
        )
    }

    pub fn new(config: Config, current_height: u64) -> Self {
        let runtime_root = payload_root(
            "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-RUNTIME-GENESIS",
            &json!({
                "chain_id": CHAIN_ID,
                "protocol_version": PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_PROTOCOL_VERSION,
    ...
    pub fn validate_config(&self) -> PrivateL2LowFeeCrossRollupCompressionMarketRuntimeResult<()> {
    ...
    pub fn register_lane(
        &mut self,
        request: RegisterCompressedBatchLaneRequest,
    ) -> PrivateL2LowFeeCrossRollupCompressionMarketRuntimeResult<CompressedBatchLaneRecord> {
        self.config.validate()?;
        ...
        self.publish_public_record("compressed_batch_lane", &lane_id, record.public_record());
        Ok(record)
    }

    pub fn submit_offer(
        &mut self,
        request: SubmitCompressedBatchOfferRequest,
    ) -> PrivateL2LowFeeCrossRollupCompressionMarketRuntimeResult<CompressedBatchOfferRecord> {
        self.config.validate()?;
        if self.offers.len() >= self.config.max_offers {
            return Err("offer limit reached".to_string());
        }
        ...
        if !lane.status.accepts_offers() {
            return Err("lane is not accepting offers".to_string());
        }
        if request.max_fee_bps > lane.request.max_user_fee_bps {
            return Err("offer max_fee_bps exceeds lane fee ceiling".to_string());
        }
        self.counters.offer_counter = self.counters.offer_counter.saturating_add(1);
        let offer_id = compressed_batch_offer_id(&request, self.counters.offer_counter);
        if self.offers.contains_key(&offer_id) {
            return Err("offer already submitted".to_string());
        }
        lane.accepted_offer_count = lane.accepted_offer_count.saturating_add(1);
        let record = CompressedBatchOfferRecord {
            offer_id: offer_id.clone(),
            sequence: self.counters.offer_counter,
            request,
        ...
        self.offers.insert(offer_id.clone(), record.clone());
        self.publish_public_record("compressed_batch_offer", &offer_id, record.public_record());
        Ok(record)
    }

    pub fn post_solver_quote(
        &mut self,
        request: PostCompressionSolverQuoteRequest,
    ) -> PrivateL2LowFeeCrossRollupCompressionMarketRuntimeResult<CompressionSolverQuoteRecord>
    {
        self.config.validate()?;
        ...
        let offer = self
            ...
            .ok_or_else(|| "unknown offer_id".to_string())?;
        if !offer.status.live() {
            return Err("offer is not live".to_string());
        }
        if request.total_fee_bps() > offer.request.max_fee_bps {
            return Err("quote total fee exceeds offer max_fee_bps".to_string());
        }
        self.counters.quote_counter = self.counters.quote_counter.saturating_add(1);
        let quote_id = compression_solver_quote_id(&request, self.counters.quote_counter);
        if self.quotes.contains_key(&quote_id) {
            return Err("quote already posted".to_string());
        }
        offer.status = OfferStatus::Quoted;
        offer.selected_quote_ids.push(quote_id.clone());
        offer.effective_fee_bps = if offer.effective_fee_bps == 0 {
            request.total_fee_bps()
        } else {
            offer.effective_fee_bps.min(request.total_fee_bps())
        };
        let record = CompressionSolverQuoteRecord {
            quote_id: quote_id.clone(),
            sequence: self.counters.quote_counter,
            request: request.clone(),
            status: QuoteStatus::Posted,
            posted_at_height: self.current_height,
            quote_score: quote_score(&request, offer.request.priority_fee_micros),
        };
        self.quotes.insert(quote_id.clone(), record.clone());
        self.publish_public_record(
            "compression_solver_quote",
            &quote_id,
    ...
    ) -> PrivateL2LowFeeCrossRollupCompressionMarketRuntimeResult<PqAvailabilityAttestationRecord>
    {
        self.config.validate()?;
        ...
        for offer_id in &request.offer_ids {
            if !self.offers.contains_key(offer_id) {
                return Err(format!("unknown offer_id: {offer_id}"));
            }
        }
        ...
        for offer_id in &request.offer_ids {
            if let Some(offer) = self.offers.get_mut(offer_id) {
                offer.status = OfferStatus::Attested;
                offer.attestation_ids.push(attestation_id.clone());
                offer.privacy_set_size = offer
                    .privacy_set_size
        ...
        let record = PqAvailabilityAttestationRecord {
            ...
            attested_offer_count: request.offer_ids.len() as u64,
            request,
    ...
    ) -> PrivateL2LowFeeCrossRollupCompressionMarketRuntimeResult<LowFeeSponsorReservationRecord>
    {
        self.config.validate()?;
        ...
        for offer_id in &request.offer_ids {
            let offer = self
                .offers
                .get(offer_id)
                .ok_or_else(|| format!("unknown offer_id: {offer_id}"))?;
            if !matches!(offer.status, OfferStatus::Quoted | OfferStatus::Attested) {
                return Err(format!("offer is not sponsor-reservable: {offer_id}"));
            }
        }
        for quote_id in &request.quote_ids {
            let quote = self
        ...
        for offer_id in &request.offer_ids {
            if let Some(offer) = self.offers.get_mut(offer_id) {
                ...
                offer.reservation_id = Some(reservation_id.clone());
                offer.effective_fee_bps = offer.effective_fee_bps.min(request.max_total_fee_bps);
            }
        }
        let record = LowFeeSponsorReservationRecord {
            reservation_id: reservation_id.clone(),
            sequence: self.counters.reservation_counter,
            covered_offer_count: request.offer_ids.len() as u64,
            request,
    ...
    ) -> PrivateL2LowFeeCrossRollupCompressionMarketRuntimeResult<CompressionSettlementBatchRecord>
    {
        self.config.validate()?;
        ...
        if !covers_all_quotes(&self.quotes, &request.quote_ids, &request.offer_ids) {
            return Err("quote_ids do not cover every offer_id".to_string());
        }
        if !covers_all_attestations(
            ...
            return Err("attestation_ids do not cover every offer_id".to_string());
        }
        ...
        {
            return Err("reservation_ids do not cover every offer_id".to_string());
        }
        ...
        let total_effective_fee_bps = request
            ...
            .map(|offer| offer.effective_fee_bps)
            .sum::<u64>();
        for quote_id in &request.quote_ids {
            if let Some(quote) = self.quotes.get_mut(quote_id) {
        ...
        for offer_id in &request.offer_ids {
            if let Some(offer) = self.offers.get_mut(offer_id) {
                offer.status = OfferStatus::BatchReady;
                offer.batch_id = Some(batch_id.clone());
            }
        }
        ...
        let record = CompressionSettlementBatchRecord {
            ...
            total_offer_count: request.offer_ids.len() as u64,
    ...
    pub fn publish_delivery_receipt(
    ...
    ) -> PrivateL2LowFeeCrossRollupCompressionMarketRuntimeResult<DeliveryReceiptRecord> {
        self.config.validate()?;
        ...
        if let Some(offer_id) = &request.offer_id {
            if let Some(offer) = self.offers.get_mut(offer_id) {
                offer.receipt_ids.push(receipt_id.clone());
                if request.receipt_kind == DeliveryReceiptKind::OfferDelivered {
        ...
        if let Some(batch_id) = &request.batch_id {
            if let Some(batch) = self.settlement_batches.get_mut(batch_id) {
                if request.receipt_kind == DeliveryReceiptKind::CompressionSettled {
                    ...
                    for offer_id in &batch.request.offer_ids {
                        if let Some(offer) = self.offers.get_mut(offer_id) {
                            offer.status = OfferStatus::Settled;
                            if let Some(lane) = self.lanes.get_mut(&offer.request.lane_id) {
                                lane.settled_offer_count =
                                    lane.settled_offer_count.saturating_add(1);
                                lane.cumulative_fee_bps = lane
                                    .cumulative_fee_bps
                                    .saturating_add(offer.effective_fee_bps);
                            }
                        }
                    }
    ...
    pub fn publish_rebate_payout(
    ...
    ) -> PrivateL2LowFeeCrossRollupCompressionMarketRuntimeResult<RebatePayoutRecord> {
        self.config.validate()?;
        ...
        if let Some(batch) = self.settlement_batches.get_mut(&request.batch_id) {
            ...
            for offer_id in &batch.request.offer_ids {
                if let Some(offer) = self.offers.get_mut(offer_id) {
                    offer.status = OfferStatus::Rebated;
                }
            }
        }
    ...
    pub fn expire_stale_records(&mut self) {
        for offer in self.offers.values_mut() {
            if offer.status.live() && offer.request.expires_at_height <= self.current_height {
    ...
    pub fn roots(&self) -> Roots {
        let config_root = payload_root(
            "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-CONFIG",
            &self.config.public_record(),
        );
        let counter_root = payload_root(
            "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-COUNTERS",
            &self.counters.public_record(),
        );
        let lane_root = public_record_root(
            "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-LANES",
            &self
                .lanes
                .values()
                .map(CompressedBatchLaneRecord::public_record)
                .collect::<Vec<_>>(),
        );
        let offer_root = public_record_root(
            "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-OFFERS",
            &self
                .offers
                .values()
                .map(CompressedBatchOfferRecord::public_record)
                .collect::<Vec<_>>(),
        );
        let quote_root = public_record_root(
            "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-QUOTES",
            &self
                .quotes
                .values()
                .map(CompressionSolverQuoteRecord::public_record)
                .collect::<Vec<_>>(),
        );
        let attestation_root = public_record_root(
            "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-ATTESTATIONS",
            &self
                .attestations
                .values()
        ...
        let reservation_root = public_record_root(
            "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-RESERVATIONS",
            &self
                .reservations
                .values()
        ...
        let batch_root = public_record_root(
            "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-BATCHES",
            &self
                .settlement_batches
                .values()
        ...
        let receipt_root = public_record_root(
            "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-RECEIPTS",
            &self
                .receipts
                .values()
        ...
        let rebate_root = public_record_root(
            "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-REBATES",
            &self
                .rebates
                .values()
        ...
        let public_record_root = public_record_root(
            "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-PUBLIC-RECORDS",
            &public_records,
        );
    ...
    pub fn public_record_without_state_root(&self) -> Value {
        json!({
            "kind": "private_l2_low_fee_cross_rollup_compression_market_state",
            "chain_id": CHAIN_ID,
            "protocol_version": PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_PROTOCOL_VERSION,
            "schema_version": PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_SCHEMA_VERSION,
            "current_height": self.current_height,
...
pub fn compressed_batch_lane_id(
    request: &RegisterCompressedBatchLaneRequest,
    sequence: u64,
) -> String {
    domain_hash(
        "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-LANE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_PROTOCOL_VERSION,
            ),
...
pub fn compressed_batch_offer_id(
    request: &SubmitCompressedBatchOfferRequest,
    sequence: u64,
) -> String {
    domain_hash(
        "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-offer-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_PROTOCOL_VERSION,
...
pub fn compression_solver_quote_id(
    request: &PostCompressionSolverQuoteRequest,
    sequence: u64,
) -> String {
    domain_hash(
        "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-QUOTE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_PROTOCOL_VERSION,
...
pub fn pq_availability_attestation_id(
    ...
    domain_hash(
        "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-PQ-ATTESTATION-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_PROTOCOL_VERSION,
            ...
            HashPart::Int(sequence as i128),
            HashPart::Str(&id_list_root("offer_ids", &request.offer_ids)),
...
pub fn low_fee_sponsor_reservation_id(
    ...
    domain_hash(
        "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-SPONSOR-RESERVATION-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_PROTOCOL_VERSION,
...
pub fn compression_settlement_batch_id(
    ...
    domain_hash(
        "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-SETTLEMENT-BATCH-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_PROTOCOL_VERSION,
...
pub fn delivery_receipt_id(request: &PublishDeliveryReceiptRequest, sequence: u64) -> String {
    domain_hash(
        "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-DELIVERY-RECEIPT-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_PROTOCOL_VERSION,
...
pub fn rebate_payout_id(request: &PublishRebatePayoutRequest, sequence: u64) -> String {
    domain_hash(
        "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-REBATE-PAYOUT-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(
                PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_PROTOCOL_VERSION,
...
pub fn state_root_from_record(record: &Value) -> String {
    root_from_record(
        "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-STATE",
        record,
    )
}

pub fn private_l2_low_fee_cross_rollup_compression_market_state_root(state: &State) -> String {
    state.state_root()
}

pub fn private_l2_low_fee_cross_rollup_compression_market_payload_root(
    domain: &str,
    payload: &Value,
) -> String {
...
pub fn private_l2_low_fee_cross_rollup_compression_market_public_record_root(
    domain: &str,
    records: &[Value],
) -> String {
...
pub fn private_l2_low_fee_cross_rollup_compression_market_state_root_from_record(
    record: &Value,
) -> String {
    state_root_from_record(record)
}

fn lane_score(request: &RegisterCompressedBatchLaneRequest) -> u64 {
...
fn quote_score(request: &PostCompressionSolverQuoteRequest, priority_fee_micros: u64) -> u64 {
    ...
    let class_bonus = match request.solver_class {
        CompressionSolverClass::FastEdgeCache => 2_000,
        CompressionSolverClass::SequencerOperated => 1_500,
        CompressionSolverClass::SponsorBacked => 1_250,
        CompressionSolverClass::MoneroBridgeRelay => 1_100,
        CompressionSolverClass::CommunityArchive => 900,
        CompressionSolverClass::ColdProofArchive => 500,
    };
    100_000_u64
...
fn covers_all_quotes(
    quotes: &BTreeMap<String, CompressionSolverQuoteRecord>,
    quote_ids: &[String],
    offer_ids: &[String],
) -> bool {
    let covered = quote_ids
        ...
        .map(|quote| &quote.request.offer_id)
        .collect::<BTreeSet<_>>();
    offer_ids.iter().all(|offer_id| covered.contains(offer_id))
}
...
fn covers_all_attestations(
    ...
    let covered = attestation_ids
        ...
        .flat_map(|attestation| attestation.request.offer_ids.iter())
        .collect::<BTreeSet<_>>();
    offer_ids.iter().all(|offer_id| covered.contains(offer_id))
}
...
fn covers_all_reservations(
    ...
    let covered = reservation_ids
        ...
        .flat_map(|reservation| reservation.request.offer_ids.iter())
        .collect::<BTreeSet<_>>();
    offer_ids.iter().all(|offer_id| covered.contains(offer_id))
}
...
fn id_list_root(label: &str, ids: &[String]) -> String {
    public_record_root(
        &format!("PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-ID-LIST-{label}"),
...
fn public_record_id(record_kind: &str, subject_id: &str, payload: &Value) -> String {
    domain_hash(
        "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-PUBLIC-RECORD-ID",
        &[
            HashPart::Str(CHAIN_ID),
...
fn roots_only_payload(record_kind: &str, subject_id: &str, payload: &Value) -> Value {
    json!({
        "kind": "private_l2_low_fee_cross_rollup_compression_market_roots_only_payload",
        "chain_id": CHAIN_ID,
        "record_kind": record_kind,
        "subject_id": subject_id,
        "payload_root": payload_root(
            "PRIVATE-L2-LOW-FEE-CROSS-ROLLUP-COMPRESSION-MARKET-ROOTS-ONLY-PAYLOAD",
            payload,
        ),
    })
}
...
fn require_bps(
    ...
    if value > PRIVATE_L2_LOW_FEE_CROSS_ROLLUP_COMPRESSION_MARKET_RUNTIME_MAX_BPS {
