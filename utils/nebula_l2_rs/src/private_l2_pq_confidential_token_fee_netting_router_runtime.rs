...
pub const PRIVATE_L2_PQ_CONFIDENTIAL_TOKEN_FEE_NETTING_ROUTER_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-token-fee-netting-router-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_PQ_CONFIDENTIAL_TOKEN_FEE_NETTING_ROUTER_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const ROUTE_BOOK_SUITE: &str = "pq-confidential-token-fee-route-book-v1";
...
pub const FEE_REBATE_SUITE: &str = "confidential-token-fee-netting-router-fee-rebate-v1";
pub const SLASHING_EVIDENCE_SUITE: &str = "pq-signed-token-fee-netting-router-slashing-v1";
...
impl Config {
    ...
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_fee_netting_router_config",
...
impl Counters {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_fee_netting_router_counters",
...
impl SolverRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_fee_netting_router",
...
impl ClearingBatchRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_fee_netting_router_clearing_batch",
            "batch_id": self.batch_id,
            "request": self.request,
            "status": self.status.as_str(),
...
impl FeeRebateRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_fee_netting_router_fee_rebate",
...
impl SlashingEvidenceRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_fee_netting_router_slashing_evidence",
...
impl PublicRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_fee_netting_router_public_record",
...
impl Roots {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_fee_netting_router_roots",
...
impl State {
    ...
    pub fn public_record_without_roots(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_token_fee_netting_router_state",
    ...
    pub fn settle_clearing_batch(&mut self, request: SettleClearingBatchRequest) -> Result<String> {
        ...
        self.publish_public_record(
            ...
            &request.batch_id,
            json!({
                "kind": "private_l2_pq_confidential_token_fee_netting_router_settlement",
...
pub fn roots_only_payload(
    ...
    json!({
        "kind": "private_l2_pq_confidential_token_fee_netting_router_roots_only_payload",
        "chain_id": CHAIN_ID,
