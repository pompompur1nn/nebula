...
pub type PrivateL2PqConfidentialBridgeAdaptiveStemFluffMixnetGuardRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-bridge-adaptive-stem-fluff-mixnet-guard-runtime-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_BRIDGE_ADAPTIVE_STEM_FLUFF_MIXNET_GUARD_RUNTIME_PROTOCOL_VERSION:
    &str = PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const PQ_MIXNET_GUARD_SUITE: &str = "ML-DSA-87+ML-KEM-1024+SLH-DSA-SHAKE-256f";
pub const MIXNET_GUARD_SUITE: &str = "monero-bridge-adaptive-stem-fluff-mixnet-guard-root-v1";
pub const REBATE_SUITE: &str = "adaptive-stem-fluff-mixnet-low-fee-rebate-root-v1";
pub const REDACTION_SUITE: &str = "operator-safe-adaptive-stem-fluff-mixnet-redaction-root-v1";
...
pub const DEFAULT_MIXNET_GUARD_WINDOW_SLOTS: u64 = 720;
...
impl AdaptiveStemFluffMixnetScope {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::EmergencyMixnetGuard => "emergency_adaptive_stem_fluff_mixnet",
...
pub enum AttestationVerdict {
    ConfirmAdaptiveStemFluffMixnetPressure,
    ConfirmPrivacyRisk,
    RequireAdaptiveStemFluffMixnetRotation,
    RequireAdaptiveStemFluffMixnetRotationGuard,
    RequireQuarantine,
    ClearFalsePositive,
}
...
#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum AdaptiveStemFluffMixnetAction {
    Observe,
    QueueMixnetGuardReview,
    ApplyMixnetGuardGuard,
    RotateAdaptiveStemFluffMixnetCohort,
    QuarantineRoute,
    EmergencyPause,
    Release,
    Reject,
...
pub struct Config {
    ...
    pub pq_mixnet_guard_suite: String,
    pub mixnet_guard_suite: String,
    ...
    pub mixnet_guard_window_slots: u64,
    pub signal_window_slots: u64,
    pub max_route_fee_bps: u64,
    pub target_rebate_bps: u64,
    pub min_stem_lane_mixnet_liquidity_micro_units: u64,
    pub min_fluff_lane_mixnet_liquidity_micro_units: u64,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            pq_mixnet_guard_suite: PQ_MIXNET_GUARD_SUITE.to_string(),
            mixnet_guard_suite: MIXNET_GUARD_SUITE.to_string(),
            ...
            mixnet_guard_window_slots: DEFAULT_MIXNET_GUARD_WINDOW_SLOTS,
            signal_window_slots: DEFAULT_SIGNAL_WINDOW_SLOTS,
            max_route_fee_bps: DEFAULT_MAX_ROUTE_FEE_BPS,
            target_rebate_bps: DEFAULT_TARGET_REBATE_BPS,
            min_stem_lane_mixnet_liquidity_micro_units: DEFAULT_MIN_SOURCE_LIQUIDITY_MICRO_UNITS,
            min_fluff_lane_mixnet_liquidity_micro_units: DEFAULT_MIN_TARGET_LIQUIDITY_MICRO_UNITS,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct AdaptiveStemFluffMixnetPolicy {
    pub policy_id: String,
    pub scope: AdaptiveStemFluffMixnetScope,
    pub owner_commitment: String,
    pub policy_commitment_root: String,
    pub source_fluff_relay_set_root: String,
    pub target_fluff_relay_set_root: String,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct AdaptiveStemFluffMixnetGuardCohort {
    ...
    pub mixnet_guard_commitment_root: String,
    pub stem_lane_mixnet_liquidity_micro_units: u64,
    pub fluff_lane_mixnet_liquidity_micro_units: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct AdaptiveStemFluffMixnetSignal {
    ...
    pub stem_lane_mixnet_liquidity_delta_micro_units: i128,
    pub fluff_lane_mixnet_liquidity_delta_micro_units: i128,
    pub privacy_set_size: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct PqAdaptiveStemFluffMixnetAttestation {
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct AdaptiveStemFluffMixnetDecision {
    pub decision_id: String,
    pub signal_id: String,
    pub cohort_id: String,
    pub policy_id: String,
    pub action: AdaptiveStemFluffMixnetAction,
    pub decision_root: String,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct LowFeeAdaptiveStemFluffMixnetRebate {
...
pub struct State {
    ...
    pub roots: Roots,
    pub policies: BTreeMap<String, AdaptiveStemFluffMixnetPolicy>,
    pub cohorts: BTreeMap<String, AdaptiveStemFluffMixnetGuardCohort>,
    pub signals: BTreeMap<String, AdaptiveStemFluffMixnetSignal>,
    pub attestations: BTreeMap<String, PqAdaptiveStemFluffMixnetAttestation>,
    pub decisions: BTreeMap<String, AdaptiveStemFluffMixnetDecision>,
    pub rebates: BTreeMap<String, LowFeeAdaptiveStemFluffMixnetRebate>,
...
impl State {
    ...
    pub fn devnet() -> Self {
        ...
        let withdrawal_policy = state
            .register_policy(RegisterPolicyRequest {
                scope: AdaptiveStemFluffMixnetScope::WithdrawalSubaddressLane,
                owner_commitment: "owner:dandelion-adaptive-stem-fluff-mixnet-guard-council-a"
                    .to_string(),
                policy_commitment_root: devnet_root(
                    "policy",
                    "withdrawal-dandelion-adaptive-stem-fluff-mixnet-guard",
                ),
                source_fluff_relay_set_root: devnet_root(
                    "source-fluff-relay-set",
                    "withdrawal-alpha",
                ),
                target_fluff_relay_set_root: devnet_root(
                    "target-fluff-relay-set",
                    "withdrawal-alpha",
                ),
                route_allowlist_root: devnet_root("route-allowlist", "withdrawal-alpha"),
                min_privacy_set_size: 524_288,
                min_stem_lane_mixnet_liquidity_micro_units: 160_000_000,
                min_fluff_lane_mixnet_liquidity_micro_units: 72_000_000,
                max_route_fee_bps: 16,
                min_attestation_quorum_bps: 7_200,
                signal_window_slots: 96,
                mixnet_guard_window_slots: 720,
                redaction_profile: "withdrawal-dandelion-adaptive-stem-fluff-mixnet-guard-profile"
                    .to_string(),
            })
            .expect("devnet withdrawal policy");
        let fast_dandelion_exit_policy = state
            .register_policy(RegisterPolicyRequest {
                scope: AdaptiveStemFluffMixnetScope::FastDandelionMixnetGuardLane,
                owner_commitment: "owner:fast-dandelion-mixnet-guard-route-council-b".to_string(),
                policy_commitment_root: devnet_root(
                    "policy",
                    "fast-dandelion-mixnet-guard-dandelion-adaptive-stem-fluff-mixnet-guard",
                ),
                source_fluff_relay_set_root: devnet_root(
                    "source-fluff-relay-set",
                    "fast-dandelion-mixnet-guard-beta",
                ),
                target_fluff_relay_set_root: devnet_root(
                    "target-fluff-relay-set",
                    "fast-dandelion-mixnet-guard-beta",
                ...
                min_stem_lane_mixnet_liquidity_micro_units: 144_000_000,
                min_fluff_lane_mixnet_liquidity_micro_units: 64_000_000,
                max_route_fee_bps: 18,
                min_attestation_quorum_bps: 7_000,
                signal_window_slots: 80,
                mixnet_guard_window_slots: 640,
                redaction_profile:
                    "fast-dandelion-mixnet-guard-dandelion-adaptive-stem-fluff-mixnet-guard-profile"
                        .to_string(),
            })
            .expect("devnet fast adaptive_stem_fluff_mixnet policy");
        let withdrawal_cohort = state
            .register_cohort(RegisterCohortRequest {
                policy_id: withdrawal_policy,
                bridge_lane_id: "withdrawal-mixnet-guard-alpha".to_string(),
                source_fluff_relay_set_root: devnet_root("source-fluff-relay-set", "cohort-alpha"),
                target_fluff_relay_set_root: devnet_root("target-fluff-relay-set", "cohort-alpha"),
                output_set_root: devnet_root("outputs", "cohort-alpha"),
                mixnet_guard_commitment_root: devnet_root("liquidity", "cohort-alpha"),
                stem_lane_mixnet_liquidity_micro_units: 216_000_000,
                fluff_lane_mixnet_liquidity_micro_units: 96_000_000,
        ...
        let fast_dandelion_exit_cohort = state
            .register_cohort(RegisterCohortRequest {
                ...
                bridge_lane_id: "fast-dandelion-mixnet-guard-route-beta".to_string(),
                source_fluff_relay_set_root: devnet_root("source-fluff-relay-set", "cohort-beta"),
                target_fluff_relay_set_root: devnet_root("target-fluff-relay-set", "cohort-beta"),
                output_set_root: devnet_root("outputs", "cohort-beta"),
                mixnet_guard_commitment_root: devnet_root("liquidity", "cohort-beta"),
                stem_lane_mixnet_liquidity_micro_units: 168_000_000,
                fluff_lane_mixnet_liquidity_micro_units: 76_000_000,
                privacy_set_size: 393_216,
                route_fee_bps: 13,
                public_hint_root: devnet_root("hint", "cohort-beta"),
            })
            .expect("devnet fast adaptive_stem_fluff_mixnet cohort");
        let signal = state
            .submit_signal(SubmitSignalRequest {
                ...
                stem_lane_mixnet_liquidity_delta_micro_units: -48_000_000,
                fluff_lane_mixnet_liquidity_delta_micro_units: 24_000_000,
                privacy_set_size: 524_288,
        ...
        state
            .submit_attestation(SubmitAttestationRequest {
                ...
                verdict: AttestationVerdict::RequireAdaptiveStemFluffMixnetRotationGuard,
                attestor_commitment: "attestor:pq-dandelion-adaptive-stem-fluff-mixnet-guard-a"
                    .to_string(),
                pq_signature_root: devnet_root(
                    "ml-dsa-signature",
                    "withdrawal-adaptive_stem_fluff_mixnet-a",
                ),
        ...
        state
            .submit_attestation(SubmitAttestationRequest {
                signal_id: signal.clone(),
                verdict: AttestationVerdict::ConfirmAdaptiveStemFluffMixnetPressure,
                attestor_commitment: "attestor:pq-dandelion-adaptive-stem-fluff-mixnet-guard-b"
                    .to_string(),
                pq_signature_root: devnet_root(
                    "slh-dsa-signature",
                    "withdrawal-adaptive_stem_fluff_mixnet-b",
                ),
                pq_public_key_root: devnet_root(
                    "ml-kem-public-key",
                    "withdrawal-adaptive_stem_fluff_mixnet-b",
        ...
        let decision = state
            .settle_decision(SettleDecisionRequest {
                signal_id: signal,
                action: AdaptiveStemFluffMixnetAction::ApplyMixnetGuardGuard,
                decision_root: devnet_root(
                    "decision",
                    "withdrawal-liquidity-adaptive_stem_fluff_mixnet",
                ),
                replacement_route_root: devnet_root(
                    "replacement-route",
                    "withdrawal-adaptive_stem_fluff_mixnet",
                ),
            ...
            .expect("devnet adaptive_stem_fluff_mixnet decision");
        state
            .publish_rebate(PublishRebateRequest {
                decision_id: decision,
                recipient_commitment:
                    "recipient:dandelion-adaptive-stem-fluff-mixnet-guard-fee-sponsor".to_string(),
                rebate_micro_units: 22_000,
                fee_saved_micro_units: 88_000,
                rebate_bps: 8,
                settlement_slot: DEVNET_SLOT + 6,
                rebate_root: devnet_root("rebate", "withdrawal-adaptive_stem_fluff_mixnet"),
            })
        ...
        state
            .publish_redaction_budget(PublishRedactionBudgetRequest {
                ...
                public_hint_root: devnet_root("redaction-hint", "fast-dandelion-mixnet-guard-beta"),
    ...
    pub fn register_policy(&mut self, request: RegisterPolicyRequest) -> Result<String> {
        ...
        ensure_non_empty(
            &request.source_fluff_relay_set_root,
            "source_fluff_relay_set_root",
        )?;
        ensure_non_empty(
            &request.target_fluff_relay_set_root,
            "target_fluff_relay_set_root",
        )?;
        ...
        if request.min_stem_lane_mixnet_liquidity_micro_units
            < self.config.min_stem_lane_mixnet_liquidity_micro_units
        {
            return Err("policy source liquidity below runtime floor".to_string());
        }
        if request.min_fluff_lane_mixnet_liquidity_micro_units
            < self.config.min_fluff_lane_mixnet_liquidity_micro_units
        {
            return Err("policy target liquidity below runtime floor".to_string());
        }
        let policy_id = stable_id(
            "dandelion-adaptive-stem-fluff-mixnet-guard-policy",
            &[
                HashPart::Str(request.scope.as_str()),
                HashPart::Str(&request.owner_commitment),
                HashPart::Str(&request.policy_commitment_root),
                HashPart::Str(&request.source_fluff_relay_set_root),
            ],
        );
        ...
        self.policies.insert(
            policy_id.clone(),
            AdaptiveStemFluffMixnetPolicy {
                policy_id: policy_id.clone(),
                scope: request.scope,
                owner_commitment: request.owner_commitment,
                policy_commitment_root: request.policy_commitment_root,
                source_fluff_relay_set_root: request.source_fluff_relay_set_root,
                target_fluff_relay_set_root: request.target_fluff_relay_set_root,
                route_allowlist_root: request.route_allowlist_root,
                min_privacy_set_size: request.min_privacy_set_size,
                min_stem_lane_mixnet_liquidity_micro_units: request
                    .min_stem_lane_mixnet_liquidity_micro_units,
                min_fluff_lane_mixnet_liquidity_micro_units: request
                    .min_fluff_lane_mixnet_liquidity_micro_units,
                ...
                mixnet_guard_window_slots: request.mixnet_guard_window_slots,
                active: true,
    ...
    pub fn register_cohort(&mut self, request: RegisterCohortRequest) -> Result<String> {
        ...
        ensure_non_empty(
            &request.mixnet_guard_commitment_root,
            "mixnet_guard_commitment_root",
        )?;
        ...
        if request.stem_lane_mixnet_liquidity_micro_units
            < policy.min_stem_lane_mixnet_liquidity_micro_units
        {
            return Err("cohort source liquidity below policy floor".to_string());
        }
        if request.fluff_lane_mixnet_liquidity_micro_units
            < policy.min_fluff_lane_mixnet_liquidity_micro_units
        {
        ...
        let cohort_id = stable_id(
            "dandelion-adaptive-stem-fluff-mixnet-guard-cohort",
            &[
                HashPart::Str(&request.policy_id),
                HashPart::Str(&request.bridge_lane_id),
                HashPart::Str(&request.source_fluff_relay_set_root),
                HashPart::Str(&request.mixnet_guard_commitment_root),
            ],
        );
        ...
        self.cohorts.insert(
            cohort_id.clone(),
            AdaptiveStemFluffMixnetGuardCohort {
                ...
                mixnet_guard_commitment_root: request.mixnet_guard_commitment_root,
                stem_lane_mixnet_liquidity_micro_units: request
                    .stem_lane_mixnet_liquidity_micro_units,
                fluff_lane_mixnet_liquidity_micro_units: request
                    .fluff_lane_mixnet_liquidity_micro_units,
    ...
    pub fn submit_signal(&mut self, request: SubmitSignalRequest) -> Result<String> {
        ...
        let signal_id = stable_id(
            "dandelion-adaptive-stem-fluff-mixnet-guard-signal",
            &[
        ...
        self.signals.insert(
            ...
            AdaptiveStemFluffMixnetSignal {
                ...
                stem_lane_mixnet_liquidity_delta_micro_units: request
                    .stem_lane_mixnet_liquidity_delta_micro_units,
                fluff_lane_mixnet_liquidity_delta_micro_units: request
                    .fluff_lane_mixnet_liquidity_delta_micro_units,
                privacy_set_size: request.privacy_set_size,
    ...
    pub fn submit_attestation(&mut self, request: SubmitAttestationRequest) -> Result<String> {
        ...
        let attestation_id = stable_id(
            "dandelion-adaptive-stem-fluff-mixnet-guard-pq-attestation",
            &[
        ...
        self.attestations.insert(
            ...
            PqAdaptiveStemFluffMixnetAttestation {
    ...
    pub fn settle_decision(&mut self, request: SettleDecisionRequest) -> Result<String> {
        ...
        let privacy_filter_deadline_slot = match request.action {
            AdaptiveStemFluffMixnetAction::QueueMixnetGuardReview
            | AdaptiveStemFluffMixnetAction::ApplyMixnetGuardGuard
            | AdaptiveStemFluffMixnetAction::RotateAdaptiveStemFluffMixnetCohort => request
                .decided_at_slot
                .saturating_add(policy.mixnet_guard_window_slots),
            AdaptiveStemFluffMixnetAction::QuarantineRoute
            | AdaptiveStemFluffMixnetAction::EmergencyPause => request
                .decided_at_slot
                .saturating_add(policy.mixnet_guard_window_slots / 2),
            _ => 0,
        };
        let decision_id = stable_id(
            "dandelion-adaptive-stem-fluff-mixnet-guard-decision",
            &[
                HashPart::Str(&request.signal_id),
        ...
        self.decisions.insert(
            decision_id.clone(),
            AdaptiveStemFluffMixnetDecision {
        ...
        if let Some(signal) = self.signals.get_mut(&request.signal_id) {
            signal.status = match request.action {
                AdaptiveStemFluffMixnetAction::QueueMixnetGuardReview => SignalStatus::RouteQueued,
                AdaptiveStemFluffMixnetAction::ApplyMixnetGuardGuard
                | AdaptiveStemFluffMixnetAction::RotateAdaptiveStemFluffMixnetCohort => {
                    SignalStatus::Routing
                }
                AdaptiveStemFluffMixnetAction::QuarantineRoute
                | AdaptiveStemFluffMixnetAction::EmergencyPause => SignalStatus::Quarantined,
                AdaptiveStemFluffMixnetAction::Release => SignalStatus::Settled,
                AdaptiveStemFluffMixnetAction::Reject => SignalStatus::Rejected,
                AdaptiveStemFluffMixnetAction::Expire => SignalStatus::Expired,
                AdaptiveStemFluffMixnetAction::Observe => SignalStatus::Attested,
            };
        }
        if let Some(cohort) = self.cohorts.get_mut(&signal.cohort_id) {
            match request.action {
                ...
                AdaptiveStemFluffMixnetAction::ApplyMixnetGuardGuard => {
                    ...
                    cohort.stem_lane_mixnet_liquidity_micro_units = cohort
                        .stem_lane_mixnet_liquidity_micro_units
                        .saturating_sub(request.privacy_filtered_micro_units);
                    cohort.fluff_lane_mixnet_liquidity_micro_units = cohort
                        .fluff_lane_mixnet_liquidity_micro_units
                ...
                AdaptiveStemFluffMixnetAction::EmergencyPause => {
                    cohort.status = CohortStatus::Paused;
                    cohort.privacy_filter_deadline_slot = privacy_filter_deadline_slot;
                    self.counters.routes_quarantined =
                        self.counters.routes_quarantined.saturating_add(1);
                }
                AdaptiveStemFluffMixnetAction::Release => {
    ...
    pub fn publish_rebate(&mut self, request: PublishRebateRequest) -> Result<String> {
        ...
        let rebate_id = stable_id(
            "dandelion-adaptive-stem-fluff-mixnet-guard-low-fee-rebate",
            &[
        ...
        self.rebates.insert(
            rebate_id.clone(),
            LowFeeAdaptiveStemFluffMixnetRebate {
    ...
    pub fn publish_redaction_budget(
        ...
        let budget_id = stable_id(
            "dandelion-adaptive-stem-fluff-mixnet-guard-redaction-budget",
            &[
                HashPart::Str(request.scope.as_str()),
                HashPart::Str(&request.cohort_id),
    ...
    pub fn publish_operator_summary(
        ...
        let summary_id = stable_id(
            "dandelion-adaptive-stem-fluff-mixnet-guard-operator-summary",
            &[
                HashPart::U64(epoch),
                HashPart::U64(slot),
    ...
    fn refresh_roots(&mut self) {
        ...
        self.roots.state_root = merkle_root(
            "bridge-dandelion-adaptive-stem-fluff-mixnet-guard:state",
            &[
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "pq_mixnet_guard_suite": self.config.pq_mixnet_guard_suite,
            "mixnet_guard_suite": self.config.mixnet_guard_suite,
            ...
            "mixnet_guard_window_slots": self.config.mixnet_guard_window_slots,
            ...
            "policies": self.policies.values().map(|policy| json!({
                ...
                "min_stem_lane_mixnet_liquidity_micro_units": policy.min_stem_lane_mixnet_liquidity_micro_units,
                "min_fluff_lane_mixnet_liquidity_micro_units": policy.min_fluff_lane_mixnet_liquidity_micro_units,
            ...
            "cohorts": self.cohorts.values().map(|cohort| json!({
                ...
                "stem_lane_mixnet_liquidity_micro_units": cohort.stem_lane_mixnet_liquidity_micro_units,
                "fluff_lane_mixnet_liquidity_micro_units": cohort.fluff_lane_mixnet_liquidity_micro_units,
...
pub fn demo() -> State {
    ...
    let signal = state
        .submit_signal(SubmitSignalRequest {
            ...
            stem_lane_mixnet_liquidity_delta_micro_units: -10_000_000,
            fluff_lane_mixnet_liquidity_delta_micro_units: 8_000_000,
            privacy_set_size: 524_288,
    ...
    state
        .submit_attestation(SubmitAttestationRequest {
            signal_id: signal,
            verdict: AttestationVerdict::RequireAdaptiveStemFluffMixnetRotation,
            attestor_commitment: "attestor:demo-dandelion-adaptive-stem-fluff-mixnet-guard"
                .to_string(),
...
fn object_root<T: Serialize>(domain: &str, value: &T) -> String {
    ...
    domain_hash(
        &format!("bridge-dandelion-adaptive-stem-fluff-mixnet-guard:{domain}"),
        &[HashPart::Json(&value)],
        32,
    )
}
...
fn devnet_root(domain: &str, label: &str) -> String {
    domain_hash(
        &format!("bridge-dandelion-adaptive-stem-fluff-mixnet-guard:devnet:{domain}"),
