...
const PROTOCOL_VERSION: &str = "wave102-live-heavy-gate-release-execution-rebate-sweep-reconciliation-guard-audit-security-lane-runtime-v1";
const WAVE: u64 = 102;
...
const LANE_ID: &str =
    "wave102-live-heavy-gate-release-execution-rebate-sweep-reconciliation-guard-audit-security";
...
pub fn devnet() -> State {
    ...
    let claim_labels = [
        "audit_finding_rebate",
        "security_fee_refund",
        "reviewer_liquidity_sweep",
        "risk_residual_settlement",
        "circuit_review_packet",
        "audit_release_hold",
    ];
