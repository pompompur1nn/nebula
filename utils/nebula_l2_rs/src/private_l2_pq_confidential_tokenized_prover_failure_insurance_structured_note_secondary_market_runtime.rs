...
pub type PrivateL2PqConfidentialTokenizedProverFailureInsuranceStructuredNoteSecondaryMarketRuntimeResult<
    T,
> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_PQ_CONFIDENTIAL_TOKENIZED_PROVER_FAILURE_INSURANCE_STRUCTURED_NOTE_SECONDARY_MARKET_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-tokenized-prover-failure-insurance-structured-note-secondary-market-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_PQ_CONFIDENTIAL_TOKENIZED_PROVER_FAILURE_INSURANCE_STRUCTURED_NOTE_SECONDARY_MARKET_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const PQ_SECONDARY_MARKET_AUTHORIZATION_SUITE: &str =
    "ML-KEM-1024+ML-DSA-87+SLH-DSA-SHAKE-256f-prover-failure-note-secondary-market-auth-v1";
pub const MARKET_VENUE_SUITE: &str =
    "private-prover-failure-structured-note-secondary-market-venue-root-v1";
...
pub const SEALED_LISTING_SUITE: &str =
    "sealed-confidential-prover-failure-structured-note-secondary-listing-root-v1";
pub const PRIVATE_RFQ_SUITE: &str = "private-prover-failure-structured-note-secondary-rfq-root-v1";
pub const ORDER_COMMITMENT_SUITE: &str =
    "pq-private-prover-failure-structured-note-secondary-order-commitment-root-v1";
pub const MATCH_INTENT_SUITE: &str =
    "confidential-prover-failure-structured-note-secondary-match-intent-root-v1";
pub const TRADE_FILL_SUITE: &str =
    "speedy-prover-failure-structured-note-secondary-trade-fill-root-v1";
pub const ATOMIC_SETTLEMENT_SUITE: &str =
    "low-fee-prover-failure-structured-note-secondary-atomic-settlement-root-v1";
pub const LIQUIDITY_LANE_SUITE: &str =
    "defi-prover-failure-structured-note-secondary-liquidity-lane-root-v1";
pub const PRICE_BAND_SUITE: &str =
    "privacy-preserving-prover-failure-structured-note-secondary-price-band-root-v1";
pub const PQ_ATTESTATION_SUITE: &str =
    "pq-prover-failure-structured-note-secondary-market-attestation-root-v1";
pub const FEE_REBATE_SUITE: &str =
    "low-fee-prover-failure-structured-note-secondary-fee-rebate-root-v1";
pub const NULLIFIER_SUITE: &str =
    "anti-replay-prover-failure-structured-note-secondary-market-nullifier-root-v1";
pub const PUBLIC_RECORD_SUITE: &str =
    "roots-only-prover-failure-insurance-structured-note-secondary-market-public-record-v1";
pub const STATE_ROOT_SUITE: &str =
    "private-l2-pq-confidential-tokenized-prover-failure-insurance-structured-note-secondary-market-state-root-v1";
pub const PAYLOAD_ROOT_SUITE: &str =
    "private-l2-pq-confidential-tokenized-prover-failure-insurance-structured-note-secondary-market-payload-root-v1";
pub const DEVNET_REPLAY_DOMAIN: &str =
    "nebula-private-l2-pq-prover-failure-insurance-structured-note-secondary-market-devnet";
pub const DEVNET_RUNTIME_ID: &str =
    "private-l2-pq-prover-failure-insurance-structured-note-secondary-market-devnet";
...
pub const DEVNET_NOTE_TOKEN_ID: &str = "tpfi-note-secondary-devnet";
...
pub const DEFAULT_MARKET_MAKER_QUORUM: u16 = 3;
...
impl NoteSeniority {
    pub fn secondary_margin_bps(self) -> u64 {
        match self {
...
pub struct Config {
    ...
    pub pq_secondary_market_authorization_suite: String,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            pq_secondary_market_authorization_suite: PQ_SECONDARY_MARKET_AUTHORIZATION_SUITE
                .to_string(),
            ...
            market_maker_quorum: DEFAULT_MARKET_MAKER_QUORUM,
...
impl Config {
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "pq_secondary_market_authorization_suite": self.pq_secondary_market_authorization_suite,
            ...
            "market_maker_quorum": self.market_maker_quorum,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct MarketVenueInput {
    pub venue_id: String,
    pub kind: MarketVenueKind,
...
impl MarketVenue {
    pub fn public_record(&self) -> Value {
        roots_safe_record("market_venue", &self.venue_id, &self.venue_commitment_root)
    }
}
...
pub struct State {
    ...
    pub roots: Roots,
    pub venues: BTreeMap<String, MarketVenue>,
    ...
    pub pq_attestations: BTreeMap<String, PqMarketAttestation>,
...
impl State {
    ...
    pub fn devnet() -> Self {
        ...
        state.seed_devnet().expect("valid secondary market devnet");
        state
    }

    pub fn add_venue(&mut self, input: MarketVenueInput) -> Result<MarketVenue> {
        ...
        let root = payload_root("market_venue", &public_record_for(&input));
        let venue = MarketVenue {
    ...
    pub fn add_pq_attestation(&mut self, attestation: PqMarketAttestation) -> Result<()> {
        require(
    ...
    fn seed_devnet(&mut self) -> Result<()> {
        let venue = self.add_venue(MarketVenueInput {
            venue_id: "pf-note-secondary-cLOB-devnet".to_string(),
            kind: MarketVenueKind::ContinuousLimitOrderBook,
            operator_commitment: demo_root("operator", "secondary-market"),
            ...
            fee_vault_root: demo_root("fee_vault", "secondary-market"),
        ...
        let pool = self.add_note_pool(EligibleNotePoolInput {
            pool_id: "pf-note-secondary-pool-autocall-senior-devnet".to_string(),
        ...
        self.add_pq_attestation(PqMarketAttestation {
            attestation_id: "pq-secondary-attestation-devnet-0".to_string(),
            venue_id: venue.venue_id.clone(),
            subject_root: demo_root("attestation_subject", "venue-open"),
            committee_root: demo_root("committee", "secondary-market"),
        ...
        self.add_settlement(SettlementInput {
            settlement_id: "pf-note-secondary-settlement-devnet-0".to_string(),
            venue_id: venue.venue_id.clone(),
        ...
        self.add_fee_rebate_epoch(FeeRebateEpoch {
            rebate_epoch_id: "pf-note-secondary-rebate-devnet-0".to_string(),
