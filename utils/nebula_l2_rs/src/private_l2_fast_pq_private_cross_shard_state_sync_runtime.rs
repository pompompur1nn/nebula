...
pub const PROTOCOL_VERSION: &str =
    "nebula-private-l2-fast-pq-private-cross-shard-state-sync-runtime-v1";
pub const PRIVATE_L2_FAST_PQ_PRIVATE_CROSS_SHARD_STATE_SYNC_PROTOCOL: &str = PROTOCOL_VERSION;
...
pub fn deterministic_root(label: &str, subject: &str, nonce: u64) -> String {
    domain_hash(
        "PRIVATE-L2-FAST-PQ-PRIVATE-CROSS-SHARD-STATE-SYNC-DETERMINISTIC-ROOT",
        &[
...
pub fn deterministic_id(label: &str, sequence: u64, record: &Value) -> String {
    domain_hash(
        "PRIVATE-L2-FAST-PQ-PRIVATE-CROSS-SHARD-STATE-SYNC-DETERMINISTIC-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Str(label),
...
pub fn state_root_from_record(record: &Value) -> String {
    payload_root(
        "PRIVATE-L2-FAST-PQ-PRIVATE-CROSS-SHARD-STATE-SYNC-STATE-ROOT",
        record,
    )
}
