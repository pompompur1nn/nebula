...
pub type PrivateL2PqConfidentialContractSealedStorageReceiptFeeNettingSettlementReceiptVaultRebateClaimRuntimeResult<
    T,
> = std::result::Result<T, String>;
pub type Result<T> =
    PrivateL2PqConfidentialContractSealedStorageReceiptFeeNettingSettlementReceiptVaultRebateClaimRuntimeResult<T>;
pub type Runtime = State;

pub const PRIVATE_L2_PQ_CONFIDENTIAL_CONTRACT_SEALED_STORAGE_RECEIPT_FEE_NETTING_SETTLEMENT_RECEIPT_VAULT_REBATE_CLAIM_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-contract-sealed-storage-receipt-fee-netting-settlement-RECEIPT-VAULT-REBATE-CLAIM-claim-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_PQ_CONFIDENTIAL_CONTRACT_SEALED_STORAGE_RECEIPT_FEE_NETTING_SETTLEMENT_RECEIPT_VAULT_REBATE_CLAIM_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const VAULT_SUITE: &str =
    "pq-confidential-contract-sealed-storage-receipt-fee-netting-settlement-RECEIPT-VAULT-REBATE-CLAIM-claim-v1";
pub const ROOTS_ONLY_PUBLIC_RECORD_SUITE: &str =
    "roots-only-confidential-contract-RECEIPT-VAULT-REBATE-CLAIM-claim-public-record-v1";
pub const RECEIPT_CUSTODY_SCHEME: &str = "rebate-claim-sealed-receipt-private-custody-root-v1";
pub const STORAGE_COMMITMENT_SCHEME: &str = "rebate-claim-vault-storage-commitment-root-v1";
pub const CONTRACT_AUTHORIZATION_SCHEME: &str = "rebate-claim-pq-contract-authorization-root-v1";
pub const CONTRACT_ATTESTATION_SCHEME: &str = "rebate-claim-pq-contract-attestation-root-v1";
pub const VAULT_SEAL_SCHEME: &str = "rebate-claim-receipt-vault-seal-root-v1";
pub const NET_SETTLEMENT_SCHEME: &str = "rebate-claim-receipt-vault-fee-net-settlement-root-v1";
pub const LOW_FEE_REBATE_SCHEME: &str = "rebate-claim-receipt-vault-low-fee-rebate-root-v1";
pub const LOW_FEE_CLAIM_SCHEME: &str = "rebate-claim-receipt-vault-low-fee-claim-root-v1";
pub const DISCLOSURE_BUDGET_SCHEME: &str = "rebate-claim-receipt-vault-disclosure-budget-root-v1";
pub const QUARANTINE_SCHEME: &str = "rebate-claim-receipt-vault-quarantine-root-v1";
pub const NULLIFIER_SCHEME: &str = "rebate-claim-receipt-vault-nullifier-root-v1";
pub const PUBLIC_RECORD_ROOT_SCHEME: &str =
    "rebate-claim-receipt-vault-roots-only-public-record-root-v1";
pub const POLICY_ROOT_SCHEME: &str = "rebate-claim-receipt-vault-privacy-pq-policy-root-v1";
...
impl LowFeeClaim {
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "claim_nullifier_commitment": payload_root("RECEIPT-VAULT-REBATE-CLAIM:CLAIM-NULLIFIER", &json!({ "nullifier": self.claim_nullifier })),
            "rebate_commitment": payload_root("RECEIPT-VAULT-REBATE-CLAIM:CLAIM-AMOUNT", &json!({ "micro_fee": self.rebate_micro_fee })),
...
impl State {
    ...
    pub fn allocate_rebate(&mut self, input: RebateAllocationInput) -> Result<String> {
        ...
        if self.low_fee_rebates.len() >= self.config.max_rebates {
            return Err("receipt vault rebate claim capacity exceeded".to_string());
        }
        let settlement = self
            .net_settlements
    ...
    pub fn file_rebate_claim(&mut self, input: LowFeeClaimInput) -> Result<String> {
        self.claim_low_fee_rebate(input)
    }
...
pub fn low_fee_claim_id(
    ...
    deterministic_id(
        "PRIVATE-L2-PQ-CONFIDENTIAL-CONTRACT-RECEIPT-VAULT-REBATE-CLAIM:LOW-FEE-CLAIM-ID",
        &[
            HashPart::Str(PROTOCOL_VERSION),
