...
pub type PrivateL2FastPqConfidentialWitnessDerivativeLatencyBankruptcyInsuranceFundBackstopLiquidationRuntimeResult<
    T,
> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_FAST_PQ_CONFIDENTIAL_WITNESS_DERIVATIVE_LATENCY_BANKRUPTCY_INSURANCE_FUND_BACKSTOP_LIQUIDATION_RUNTIME_PROTOCOL_VERSION: &str = "nebula-private-l2-fast-pq-confidential-witness-derivative-latency-bankruptcy-insurance-fund-backstop-liquidation-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_FAST_PQ_CONFIDENTIAL_WITNESS_DERIVATIVE_LATENCY_BANKRUPTCY_INSURANCE_FUND_BACKSTOP_LIQUIDATION_RUNTIME_PROTOCOL_VERSION;
...
pub fn devnet() -> State {
    ...
    state
        .settle_case(
            "devnet-insurance_fund-resolution-0",
            DEVNET_HEIGHT + 7,
            DEVNET_EPOCH + 3,
        )
        .expect("devnet insurance_fund resolution must settle");
    state.refresh_roots();
    state
}
