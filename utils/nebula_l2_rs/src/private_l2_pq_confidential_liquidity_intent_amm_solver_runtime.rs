...
pub const PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-liquidity-intent-amm-solver-runtime-v1";
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const SEALED_INTENT_SUITE: &str = "ML-KEM-1024+zk-encrypted-confidential-swap-intent-v1";
...
pub const MAX_RESERVE_UPDATES: usize = 1_048_576;
...
impl LiquidityIntentKind {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::BridgeThenAmm => "bridge_then_amm",
            Self::AmmThenBridge => "amm_then_bridge",
        }
    }
}
...
impl LiquidityVenueKind {
    pub fn as_str(self) -> &'static str {
        match self {
            Self::ConfidentialCpamm => "confidential_cpamm",
            Self::StableCurveAmm => "stable_curve_amm",
...
impl PublicRecordKind {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ReserveUpdate => "reserve_update",
            Self::Rebate => "rebate",
...
pub struct Config {
    ...
    pub encrypted_intent_suite: String,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            encrypted_intent_suite: SEALED_INTENT_SUITE.to_string(),
...
impl Config {
    ...
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_liquidity_intent_amm_solver_config",
            "protocol_version": self.protocol_version,
            "schema_version": self.schema_version,
            "chain_id": self.chain_id,
            "hash_suite": self.hash_suite,
            "encrypted_intent_suite": self.encrypted_intent_suite,
...
pub struct Counters {
    ...
    pub reserve_updates_recorded: u64,
...
impl Counters {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_liquidity_intent_amm_solver_counters",
            "next_solver_nonce": self.next_solver_nonce,
            "next_intent_nonce": self.next_intent_nonce,
            "next_pool_nonce": self.next_pool_nonce,
            ...
            "next_reserve_update_nonce": self.next_reserve_update_nonce,
            ...
            "reserve_updates_recorded": self.reserve_updates_recorded,
...
pub struct RegisterSolverRequest {
    ...
    pub allowed_venue_kinds: Vec<LiquidityVenueKind>,
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct SubmitEncryptedLiquidityIntentRequest {
...
impl SubmitEncryptedLiquidityIntentRequest {
    pub fn validate(&self, config: &Config) -> Result<()> {
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct RegisterPoolCommitmentRequest {
    pub pool_label: String,
    pub pool_key_root: String,
    pub asset_pair_root: String,
    pub invariant_commitment_root: String,
    pub reserve_commitment_root: String,
    pub lp_supply_commitment_root: String,
...
impl RegisterPoolCommitmentRequest {
    pub fn validate(&self, config: &Config) -> Result<()> {
        require_non_empty("pool label", &self.pool_label)?;
        require_root("pool key root", &self.pool_key_root)?;
        require_root("asset pair root", &self.asset_pair_root)?;
        require_root("invariant commitment root", &self.invariant_commitment_root)?;
        require_root("reserve commitment root", &self.reserve_commitment_root)?;
        require_root("lp supply commitment root", &self.lp_supply_commitment_root)?;
        require_bps("fee tier bps", self.fee_tier_bps)?;
        require(
            self.fee_tier_bps <= config.max_solver_fee_bps,
            "pool fee tier exceeds solver fee cap",
        )?;
        require(
            self.privacy_set_size >= config.min_privacy_set_size,
            "pool privacy set below config minimum",
        )?;
        require(
            self.pq_security_bits >= config.min_pq_security_bits,
            "pool pq security below config minimum",
        )?;
        Ok(())
    }
}
...
pub struct RevealRouteQuoteRequest {
    ...
    pub solver_id: String,
    pub intent_id: String,
    pub venues: Vec<LiquidityVenueKind>,
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct RecordReserveUpdateRequest {
    pub pool_id: String,
    pub batch_id: String,
    pub solver_id: String,
    pub reserve_root_before: String,
    pub reserve_root_after: String,
    pub invariant_delta_root: String,
    pub netted_settlement_root: String,
    pub slippage_bound_bps: u64,
    pub privacy_set_size: u64,
    pub pq_signature_root: String,
    pub updated_at_height: u64,
}

impl RecordReserveUpdateRequest {
    pub fn validate(&self, config: &Config) -> Result<()> {
        require_root("pool id", &self.pool_id)?;
        require_root("batch id", &self.batch_id)?;
        require_root("solver id", &self.solver_id)?;
        require_root("reserve root before", &self.reserve_root_before)?;
        require_root("reserve root after", &self.reserve_root_after)?;
        require_root("invariant delta root", &self.invariant_delta_root)?;
        require_root("netted settlement root", &self.netted_settlement_root)?;
        require_bps("slippage bound bps", self.slippage_bound_bps)?;
        require(
            self.slippage_bound_bps <= config.max_price_impact_bps,
            "reserve update slippage exceeds config cap",
        )?;
        require(
            self.privacy_set_size >= config.min_privacy_set_size,
            "reserve update privacy set below config minimum",
        )?;
        require_root("pq signature root", &self.pq_signature_root)?;
        Ok(())
    }
...
impl SolverRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_liquidity_intent_amm_solver",
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct EncryptedLiquidityIntentRecord {
    pub intent_id: String,
    pub request: SubmitEncryptedLiquidityIntentRequest,
...
impl EncryptedLiquidityIntentRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_liquidity_intent",
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct PoolCommitmentRecord {
    pub pool_id: String,
    pub request: RegisterPoolCommitmentRequest,
    pub current_reserve_commitment_root: String,
    pub last_update_id: Option<String>,
    pub total_batches_settled: u64,
}

impl PoolCommitmentRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_amm_pool_commitment",
            "pool_id": self.pool_id,
            "request": self.request,
            "current_reserve_commitment_root": self.current_reserve_commitment_root,
            "last_update_id": self.last_update_id,
            "total_batches_settled": self.total_batches_settled,
        })
    }
}
...
impl ClearingBatchRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_liquidity_intent_amm_clearing_batch",
            "batch_id": self.batch_id,
            "request": self.request,
            "status": self.status.as_str(),
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct ReserveUpdateRecord {
    pub update_id: String,
    pub request: RecordReserveUpdateRequest,
    pub state_root_before: String,
    pub state_root_after: String,
}

impl ReserveUpdateRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_amm_reserve_update",
...
impl FeeRebateRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_liquidity_intent_amm_fee_rebate",
...
impl SlashingEvidenceRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_liquidity_intent_amm_slashing_evidence",
...
impl PublicRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_liquidity_intent_amm_public_record",
...
impl Roots {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_liquidity_intent_amm_roots",
...
pub struct State {
    ...
    pub intents: BTreeMap<String, EncryptedLiquidityIntentRecord>,
    pub pools: BTreeMap<String, PoolCommitmentRecord>,
    ...
    pub reserve_updates: BTreeMap<String, ReserveUpdateRecord>,
...
impl State {
    ...
    pub fn devnet() -> Self {
        ...
        let solver_a = state
            .register_solver(RegisterSolverRequest {
                ...
                allowed_venue_kinds: vec![
                    LiquidityVenueKind::ConfidentialCpamm,
                    LiquidityVenueKind::StableCurveAmm,
                    LiquidityVenueKind::InternalNetting,
                ],
        ...
        let solver_b = state
            .register_solver(RegisterSolverRequest {
                ...
                allowed_venue_kinds: vec![
                    LiquidityVenueKind::Darkpool,
                    LiquidityVenueKind::PrivateRfq,
                    LiquidityVenueKind::MoneroBridgeLiquidity,
                ],
        ...
        let intent_a = state
            .submit_encrypted_intent(SubmitEncryptedLiquidityIntentRequest {
                account_commitment: deterministic_root("ACCOUNT", "alice"),
                intent_kind: LiquidityIntentKind::ExactInput,
                input_asset_root: deterministic_root("ASSET", "dxmr"),
                output_asset_root: deterministic_root("ASSET", "dusd"),
                encrypted_intent_root: deterministic_root("SEALED-INTENT", "alice-swap"),
        ...
        let intent_b = state
            .submit_encrypted_intent(SubmitEncryptedLiquidityIntentRequest {
                ...
                intent_kind: LiquidityIntentKind::LimitSell,
                input_asset_root: deterministic_root("ASSET", "dusd"),
                output_asset_root: deterministic_root("ASSET", "dxmr"),
                encrypted_intent_root: deterministic_root("SEALED-INTENT", "bob-swap"),
        ...
        let quote_b = state
            .reveal_route_quote(RevealRouteQuoteRequest {
                ...
                solver_id: solver_b,
                intent_id: intent_b.clone(),
                venues: vec![LiquidityVenueKind::Darkpool, LiquidityVenueKind::PrivateRfq],
    ...
    pub fn roots(&self) -> Roots {
        ...
        Roots {
            ...
            intent_root: map_root(
                ...
                self.intents
                    .values()
                    .map(EncryptedLiquidityIntentRecord::public_record)
                    .collect::<Vec<_>>(),
            ),
            pool_root: map_root(
                "POOLS",
                self.pools
                    .values()
                    .map(PoolCommitmentRecord::public_record)
                    .collect::<Vec<_>>(),
            ),
            ...
            reserve_update_root: map_root(
                "RESERVE-UPDATES",
                self.reserve_updates
                    .values()
                    .map(ReserveUpdateRecord::public_record)
                    .collect::<Vec<_>>(),
            ),
    ...
    pub fn public_record_without_roots(&self) -> Value {
        json!({
            "kind": "private_l2_pq_confidential_liquidity_intent_amm_solver_state",
    ...
    pub fn submit_encrypted_intent(
        &mut self,
        request: SubmitEncryptedLiquidityIntentRequest,
    ) -> Result<String> {
        ...
        let record = EncryptedLiquidityIntentRecord {
    ...
    pub fn register_pool_commitment(
        &mut self,
        request: RegisterPoolCommitmentRequest,
    ) -> Result<String> {
        require(self.pools.len() < MAX_POOLS, "pool registry full")?;
        request.validate(&self.config)?;
        let pool_id = pool_id(&request, self.counters.next_pool_nonce);
        require(
            !self.pools.contains_key(&pool_id),
            "pool already registered",
        )?;
        let record = PoolCommitmentRecord {
            pool_id: pool_id.clone(),
            current_reserve_commitment_root: request.reserve_commitment_root.clone(),
            request,
            last_update_id: None,
            total_batches_settled: 0,
        };
        self.pools.insert(pool_id.clone(), record.clone());
        self.counters.next_pool_nonce = self.counters.next_pool_nonce.saturating_add(1);
        self.counters.pools_registered = self.counters.pools_registered.saturating_add(1);
        self.publish_public_record(
            PublicRecordKind::PoolCommitment,
            &pool_id,
    ...
    pub fn settle_clearing_batch(&mut self, request: SettleClearingBatchRequest) -> Result<String> {
        ...
        self.publish_public_record(
            ...
            &request.batch_id,
            json!({
                "kind": "private_l2_pq_confidential_liquidity_intent_amm_settlement",
    ...
    pub fn record_reserve_update(&mut self, request: RecordReserveUpdateRequest) -> Result<String> {
        require(
            self.reserve_updates.len() < MAX_RESERVE_UPDATES,
            "reserve update registry full",
        )?;
        request.validate(&self.config)?;
        let pool = self
            .pools
        ...
        require(
            pool.current_reserve_commitment_root == request.reserve_root_before,
            "reserve root before does not match pool commitment",
        )?;
        let batch = self
            .batches
            .get(&request.batch_id)
            .ok_or_else(|| "unknown batch for reserve update".to_string())?;
        require(
            matches!(batch.status, ClearingStatus::Settled),
            "reserve update requires settled batch",
        )?;
        require(
            self.solvers.contains_key(&request.solver_id),
            "unknown solver for reserve update",
        )?;
        let state_root_before = self.state_root();
        let update_id = reserve_update_id(
            &request,
            &state_root_before,
            self.counters.next_reserve_update_nonce,
        );
        let state_root_after = payload_root(
            "AMM-RESERVE-UPDATE-AFTER",
            &json!({
                "update_id": update_id,
                "pool_id": request.pool_id,
                "reserve_root_after": request.reserve_root_after,
                "netted_settlement_root": request.netted_settlement_root,
            }),
        );
        ...
        if let Some(pool) = self.pools.get_mut(&request.pool_id) {
            pool.current_reserve_commitment_root = request.reserve_root_after.clone();
            pool.last_update_id = Some(update_id.clone());
            pool.total_batches_settled = pool.total_batches_settled.saturating_add(1);
        }
        self.reserve_updates
            .insert(update_id.clone(), record.clone());
        self.runtime_root = state_root_after;
        self.counters.next_reserve_update_nonce =
            self.counters.next_reserve_update_nonce.saturating_add(1);
        self.counters.reserve_updates_recorded =
            self.counters.reserve_updates_recorded.saturating_add(1);
        self.publish_public_record(
            PublicRecordKind::ReserveUpdate,
            &update_id,
            record.public_record(),
        );
        self.refresh_pool_record(&request.pool_id);
        Ok(update_id)
    }
    ...
    fn refresh_pool_record(&mut self, pool_id: &str) {
        if let Some(payload) = self
            .pools
            .get(pool_id)
            .map(PoolCommitmentRecord::public_record)
        {
            self.publish_public_record(PublicRecordKind::PoolCommitment, pool_id, payload);
        }
    }
}
...
pub fn payload_root(domain: &str, payload: &Value) -> String {
    domain_hash(
        &format!("PRIVATE-L2-PQ-CONFIDENTIAL-LIQUIDITY-INTENT-AMM-SOLVER-{domain}"),
...
pub fn solver_id(request: &RegisterSolverRequest, nonce: u64) -> String {
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-LIQUIDITY-INTENT-AMM-SOLVER-ID",
        &[
            HashPart::Str(CHAIN_ID),
...
pub fn intent_id(request: &SubmitEncryptedLiquidityIntentRequest, nonce: u64) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-LIQUIDITY-INTENT-AMM-INTENT-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
...
pub fn pool_id(request: &RegisterPoolCommitmentRequest, nonce: u64) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-LIQUIDITY-INTENT-AMM-POOL-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
            HashPart::Str(&request.pool_label),
            HashPart::Str(&request.pool_key_root),
            HashPart::Str(&request.asset_pair_root),
            HashPart::Str(&request.invariant_commitment_root),
            HashPart::Str(&request.reserve_commitment_root),
            HashPart::Str(&request.lp_supply_commitment_root),
            HashPart::Int(request.fee_tier_bps as i128),
        ],
        32,
    )
}
...
pub fn commitment_id(request: &CommitSolverRouteRequest, score: u128, nonce: u64) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-LIQUIDITY-INTENT-AMM-COMMITMENT-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
...
pub fn quote_id(request: &RevealRouteQuoteRequest, score: u128, nonce: u64) -> String {
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-LIQUIDITY-INTENT-AMM-QUOTE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
...
pub fn fence_id(request: &RecordPrivacyFenceRequest, nonce: u64) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-LIQUIDITY-INTENT-AMM-FENCE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
            HashPart::Str(&request.intent_id),
...
pub fn batch_id(
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-LIQUIDITY-INTENT-AMM-BATCH-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
...
pub fn settlement_receipt_root(
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-LIQUIDITY-INTENT-AMM-SETTLEMENT-RECEIPT",
        &[
            HashPart::Str(CHAIN_ID),
...
pub fn reserve_update_id(
    request: &RecordReserveUpdateRequest,
    state_root_before: &str,
    nonce: u64,
) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-LIQUIDITY-INTENT-AMM-RESERVE-UPDATE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
            ...
            HashPart::Str(&request.batch_id),
            HashPart::Str(&request.solver_id),
            HashPart::Str(&request.reserve_root_before),
            HashPart::Str(&request.reserve_root_after),
            HashPart::Str(&request.invariant_delta_root),
            HashPart::Str(&request.netted_settlement_root),
            HashPart::Str(state_root_before),
        ],
        32,
    )
...
pub fn rebate_id(request: &IssueFeeRebateRequest, nonce: u64) -> String {
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-LIQUIDITY-INTENT-AMM-REBATE-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
            HashPart::Str(&request.intent_id),
...
pub fn slash_id(
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-LIQUIDITY-INTENT-AMM-SLASH-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Int(nonce as i128),
            HashPart::Str(&request.solver_id),
...
pub fn public_record_id(
    ...
    domain_hash(
        "PRIVATE-L2-PQ-CONFIDENTIAL-LIQUIDITY-INTENT-AMM-PUBLIC-RECORD-ID",
        &[
            HashPart::Str(CHAIN_ID),
...
pub fn roots_only_payload(
    ...
    json!({
        "kind": "private_l2_pq_confidential_liquidity_intent_amm_roots_only_payload",
        "chain_id": CHAIN_ID,
...
fn venues_allowed(allowed: &[LiquidityVenueKind], requested: &[LiquidityVenueKind]) -> bool {
