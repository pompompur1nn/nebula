...
pub type PrivateL2PqConfidentialBridgeDandelionOutputNoteReorgInsuranceRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-bridge-dandelion-output-note-reorg-insurance-runtime-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_BRIDGE_DANDELION_OUTPUT_NOTE_REORG_INSURANCE_RUNTIME_PROTOCOL_VERSION:
    &str = PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const PQ_DANDELION_OUTPUT_NOTE_REORG_INSURANCE_SUITE: &str =
    "ML-DSA-87+ML-KEM-1024+SLH-DSA-SHAKE-256f";
pub const DANDELION_OUTPUT_NOTE_REORG_INSURANCE_SUITE: &str =
    "monero-bridge-dandelion-output-note-reorg-insurance-root-v1";
pub const REBATE_SUITE: &str = "dandelion-output-note-reorg-insurance-low-fee-rebate-root-v1";
pub const REDACTION_SUITE: &str =
    "operator-safe-dandelion-output-note-reorg-insurance-redaction-root-v1";
...
pub const DEFAULT_DANDELION_OUTPUT_NOTE_REORG_WINDOW_SLOTS: u64 = 720;
...
pub enum DandelionOutputNoteReorgScope {
    DepositOutputNoteLane,
    WithdrawalOutputNoteLane,
    FastDandelionOutputNoteReorgRecoveryLane,
    MerchantPaymentOutputNoteLane,
    AtomicSwapOutputNoteLane,
    ReserveMirror,
    EmergencyDandelionOutputNoteReorgInsurance,
    WatchtowerRecovery,
}

impl DandelionOutputNoteReorgScope {
    pub fn as_str(self) -> &'static str {
        match self {
            Self::DepositOutputNoteLane => "deposit_output-note_lane",
            Self::WithdrawalOutputNoteLane => "withdrawal_output-note_lane",
            Self::FastDandelionOutputNoteReorgRecoveryLane => {
                "fast_dandelion_output_note_reorg_recovery_lane"
            }
            Self::MerchantPaymentOutputNoteLane => "merchant_payment_output-note_lane",
            Self::AtomicSwapOutputNoteLane => "atomic_swap_output-note_lane",
            Self::ReserveMirror => "reserve_mirror",
            Self::EmergencyDandelionOutputNoteReorgInsurance => {
                "emergency_dandelion_output_note_reorg_insurance"
            }
...
pub enum CohortStatus {
    Active,
    OutputNoteReorgPathPending,
    DandelionOutputNoteReorgInsuring,
    Quarantined,
    Rotating,
    Paused,
    Settled,
...
#[serde(rename_all = "snake_case")]
pub enum SignalKind {
    DandelionOutputNoteReorgLinkagePressure,
    DandelionOutputNoteReorgPathFragmentation,
    DandelionOutputNoteReorgPathSkew,
    DandelionOutputNoteReorgGraphLinkagePressure,
    DandelionOutputNoteReorgTimingCorrelationPressure,
    ReserveMismatch,
    OutputNoteReorgDepthInsuranceClaimPressure,
    WatchtowerEmergency,
}
...
pub enum AttestationVerdict {
    ConfirmDandelionOutputNoteReorg,
    ConfirmPrivacyRisk,
    RequireDandelionOutputNoteReorgCoverage,
    RequireDandelionOutputNoteReorgCoverageGuard,
    RequireQuarantine,
    ClearFalsePositive,
}
...
#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum DandelionOutputNoteReorgAction {
    Observe,
    QueueDandelionOutputNoteReorgInsuranceClaimReview,
    SettleDandelionOutputNoteReorg,
    RotateDandelionOutputNoteReorgInsuranceSettlementCohort,
    QuarantineOutputNoteReorgPath,
    EmergencyPause,
    Release,
    Reject,
    Expire,
...
pub struct Config {
    ...
    pub dandelion_output_note_reorg_insurance_suite: String,
    ...
    pub dandelion_output_note_reorg_window_slots: u64,
    pub signal_window_slots: u64,
    pub max_claim_settlement_fee_bps: u64,
    pub target_rebate_bps: u64,
    pub min_pre_dandelion_output_note_reorg_reserve_micro_units: u64,
    pub min_dandelion_output_note_reorg_lane_claim_reserve_micro_units: u64,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            pq_claim_settlement_insurance_suite: PQ_DANDELION_OUTPUT_NOTE_REORG_INSURANCE_SUITE
                .to_string(),
            dandelion_output_note_reorg_insurance_suite:
                DANDELION_OUTPUT_NOTE_REORG_INSURANCE_SUITE.to_string(),
            ...
            dandelion_output_note_reorg_window_slots:
                DEFAULT_DANDELION_OUTPUT_NOTE_REORG_WINDOW_SLOTS,
            signal_window_slots: DEFAULT_SIGNAL_WINDOW_SLOTS,
            max_claim_settlement_fee_bps: DEFAULT_MAX_ROUTE_FEE_BPS,
            target_rebate_bps: DEFAULT_TARGET_REBATE_BPS,
            min_pre_dandelion_output_note_reorg_reserve_micro_units:
                DEFAULT_MIN_SOURCE_LIQUIDITY_MICRO_UNITS,
            min_dandelion_output_note_reorg_lane_claim_reserve_micro_units:
...
pub struct Counters {
    ...
    pub dandelion_output_note_reorg_filters_settled: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct DandelionOutputNoteReorgPolicy {
    pub policy_id: String,
    pub scope: DandelionOutputNoteReorgScope,
    pub owner_commitment: String,
    pub policy_commitment_root: String,
    pub claim_source_dandelion_output_note_reorg_set_root: String,
    pub claim_target_dandelion_output_note_reorg_set_root: String,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct DandelionOutputNoteReorgInsuranceCohort {
    ...
    pub pre_dandelion_output_note_reorg_reserve_micro_units: u64,
    pub dandelion_output_note_reorg_lane_claim_reserve_micro_units: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct DandelionOutputNoteReorgSignal {
    ...
    pub dandelion_output_note_reorg_pressure_root: String,
    pub reporter_commitment: String,
    pub pre_reorg_reserve_delta_micro_units: i128,
    pub output_note_reorg_lane_claim_reserve_delta_micro_units: i128,
    pub privacy_set_size: u64,
    pub output_note_reorg_risk_score_bps: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct PqDandelionOutputNoteReorgInsuranceAttestation {
    ...
    pub observed_output_note_reorg_risk_score_bps: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct DandelionOutputNoteReorgDecision {
    pub decision_id: String,
    pub signal_id: String,
    pub cohort_id: String,
    pub policy_id: String,
    pub action: DandelionOutputNoteReorgAction,
    pub decision_root: String,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct LowFeeDandelionOutputNoteReorgInsuranceRebate {
...
pub struct State {
    ...
    pub roots: Roots,
    pub policies: BTreeMap<String, DandelionOutputNoteReorgPolicy>,
    pub cohorts: BTreeMap<String, DandelionOutputNoteReorgInsuranceCohort>,
    pub signals: BTreeMap<String, DandelionOutputNoteReorgSignal>,
    pub attestations: BTreeMap<String, PqDandelionOutputNoteReorgInsuranceAttestation>,
    pub decisions: BTreeMap<String, DandelionOutputNoteReorgDecision>,
    pub rebates: BTreeMap<String, LowFeeDandelionOutputNoteReorgInsuranceRebate>,
...
impl State {
    ...
    pub fn devnet() -> Self {
        ...
        let withdrawal_policy = state
            .register_policy(RegisterPolicyRequest {
                scope: DandelionOutputNoteReorgScope::WithdrawalOutputNoteLane,
                owner_commitment: "owner:dandelion-output-note-reorg-insurance-council-a"
                    .to_string(),
                policy_commitment_root: devnet_root(
                    "policy",
                    "withdrawal-dandelion-output-note-reorg-insurance",
                ),
                claim_source_dandelion_output_note_reorg_set_root: devnet_root(
                    "source-dandelion-tail-output-note-reorg-set",
                    "withdrawal-alpha",
                ),
                claim_target_dandelion_output_note_reorg_set_root: devnet_root(
                    "target-dandelion-tail-output-note-reorg-set",
                    "withdrawal-alpha",
                ),
                ...
                min_pre_dandelion_output_note_reorg_reserve_micro_units: 160_000_000,
                min_dandelion_output_note_reorg_lane_claim_reserve_micro_units: 72_000_000,
                max_claim_settlement_fee_bps: 16,
                min_attestation_quorum_bps: 7_200,
                signal_window_slots: 96,
                dandelion_output_note_reorg_window_slots: 720,
                redaction_profile: "withdrawal-dandelion-output-note-reorg-insurance-profile"
                    .to_string(),
            })
            .expect("devnet withdrawal policy");
        let fast_dandelion_exit_policy = state
            .register_policy(RegisterPolicyRequest {
                scope: DandelionOutputNoteReorgScope::FastDandelionOutputNoteReorgRecoveryLane,
                owner_commitment: "owner:fast-dandelion-decoy-insurance-reorg_path-council-b"
                    .to_string(),
                policy_commitment_root: devnet_root(
                    "policy",
                    "fast-dandelion-decoy-insurance-dandelion-output-note-reorg-insurance",
                ),
                claim_source_dandelion_output_note_reorg_set_root: devnet_root(
                    "source-dandelion-tail-output-note-reorg-set",
                ...
                min_pre_dandelion_output_note_reorg_reserve_micro_units: 144_000_000,
                min_dandelion_output_note_reorg_lane_claim_reserve_micro_units: 64_000_000,
                max_claim_settlement_fee_bps: 18,
                min_attestation_quorum_bps: 7_000,
                signal_window_slots: 80,
                dandelion_output_note_reorg_window_slots: 640,
                redaction_profile:
                    "fast-dandelion-decoy-insurance-dandelion-output-note-reorg-insurance-profile"
                        .to_string(),
            })
            .expect("devnet fast dandelion_output_note_reorg policy");
        let withdrawal_cohort = state
            .register_cohort(RegisterCohortRequest {
                ...
                pre_dandelion_output_note_reorg_reserve_micro_units: 216_000_000,
                dandelion_output_note_reorg_lane_claim_reserve_micro_units: 96_000_000,
        ...
        let fast_dandelion_exit_cohort = state
            .register_cohort(RegisterCohortRequest {
                ...
                pre_dandelion_output_note_reorg_reserve_micro_units: 168_000_000,
                dandelion_output_note_reorg_lane_claim_reserve_micro_units: 76_000_000,
                privacy_set_size: 393_216,
                claim_settlement_fee_bps: 13,
                public_hint_root: devnet_root("hint", "cohort-beta"),
            })
            .expect("devnet fast dandelion_output_note_reorg cohort");
        let signal = state
            .submit_signal(SubmitSignalRequest {
                cohort_id: withdrawal_cohort,
                kind: SignalKind::DandelionOutputNoteReorgLinkagePressure,
                ...
                dandelion_output_note_reorg_pressure_root: devnet_root(
                    "pressure",
                    "withdrawal-cluster-pressure",
                ),
                reporter_commitment: "reporter:dandelion-reorg_path-watchtower-11".to_string(),
                pre_reorg_reserve_delta_micro_units: -48_000_000,
                output_note_reorg_lane_claim_reserve_delta_micro_units: 24_000_000,
                privacy_set_size: 524_288,
                output_note_reorg_risk_score_bps: 7_300,
        ...
        state
            .submit_attestation(SubmitAttestationRequest {
                ...
                verdict: AttestationVerdict::RequireDandelionOutputNoteReorgCoverageGuard,
                attestor_commitment: "attestor:pq-dandelion-output-note-reorg-insurance-a"
                    .to_string(),
                pq_signature_root: devnet_root(
                    "ml-dsa-signature",
                    "withdrawal-dandelion_output_note_reorg-a",
                ),
                ...
                observed_output_note_reorg_risk_score_bps: 7_500,
        ...
        state
            .submit_attestation(SubmitAttestationRequest {
                signal_id: signal.clone(),
                verdict: AttestationVerdict::ConfirmDandelionOutputNoteReorg,
                attestor_commitment: "attestor:pq-dandelion-output-note-reorg-insurance-b"
                    .to_string(),
                pq_signature_root: devnet_root(
                    "slh-dsa-signature",
                    "withdrawal-dandelion_output_note_reorg-b",
                ),
                pq_public_key_root: devnet_root(
                    "ml-kem-public-key",
                    "withdrawal-dandelion_output_note_reorg-b",
                ...
                pq_security_bits: 256,
                observed_output_note_reorg_risk_score_bps: 7_800,
                observed_privacy_set_size: 524_288,
        ...
        let decision = state
            .settle_decision(SettleDecisionRequest {
                signal_id: signal,
                action: DandelionOutputNoteReorgAction::SettleDandelionOutputNoteReorg,
                decision_root: devnet_root(
                    "decision",
                    "withdrawal-liquidity-dandelion_output_note_reorg",
                ),
                replacement_claim_reorg_path_root: devnet_root(
                    "replacement-reorg_path",
                    "withdrawal-dandelion_output_note_reorg",
                ),
            ...
            .expect("devnet dandelion_output_note_reorg decision");
        state
            .publish_rebate(PublishRebateRequest {
                decision_id: decision,
                recipient_commitment: "recipient:dandelion-output-note-reorg-insurance-fee-sponsor"
                    .to_string(),
                rebate_micro_units: 22_000,
                fee_saved_micro_units: 88_000,
                rebate_bps: 8,
                settlement_slot: DEVNET_SLOT + 6,
                rebate_root: devnet_root("rebate", "withdrawal-dandelion_output_note_reorg"),
            })
    ...
    pub fn register_policy(&mut self, request: RegisterPolicyRequest) -> Result<String> {
        ensure_capacity(
            self.policies.len(),
            MAX_POLICIES,
            "Dandelion output-note reorg-phase privacy guard policies",
        )?;
        ...
        ensure_non_empty(
            &request.claim_source_dandelion_output_note_reorg_set_root,
            "claim_source_dandelion_output_note_reorg_set_root",
        )?;
        ensure_non_empty(
            &request.claim_target_dandelion_output_note_reorg_set_root,
            "claim_target_dandelion_output_note_reorg_set_root",
        )?;
        ensure_non_empty(
        ...
        if request.min_pre_dandelion_output_note_reorg_reserve_micro_units
            < self
                .config
                .min_pre_dandelion_output_note_reorg_reserve_micro_units
        {
        ...
        if request.min_dandelion_output_note_reorg_lane_claim_reserve_micro_units
            < self
                .config
                .min_dandelion_output_note_reorg_lane_claim_reserve_micro_units
        {
        ...
        let policy_id = stable_id(
            "dandelion-output-note-reorg-insurance-policy",
            &[
                HashPart::Str(request.scope.as_str()),
                HashPart::Str(&request.owner_commitment),
                HashPart::Str(&request.policy_commitment_root),
                HashPart::Str(&request.claim_source_dandelion_output_note_reorg_set_root),
            ],
        );
        if self.policies.contains_key(&policy_id) {
            return Err(format!(
                "Dandelion output-note reorg-phase privacy guard policy {policy_id} already exists"
            ));
        }
        self.policies.insert(
            policy_id.clone(),
            DandelionOutputNoteReorgPolicy {
                policy_id: policy_id.clone(),
                scope: request.scope,
                owner_commitment: request.owner_commitment,
                policy_commitment_root: request.policy_commitment_root,
                claim_source_dandelion_output_note_reorg_set_root: request
                    .claim_source_dandelion_output_note_reorg_set_root,
                claim_target_dandelion_output_note_reorg_set_root: request
                    .claim_target_dandelion_output_note_reorg_set_root,
                claim_rotation_allowlist_root: request.claim_rotation_allowlist_root,
                min_privacy_set_size: request.min_privacy_set_size,
                min_pre_dandelion_output_note_reorg_reserve_micro_units: request
                    .min_pre_dandelion_output_note_reorg_reserve_micro_units,
                min_dandelion_output_note_reorg_lane_claim_reserve_micro_units: request
                    .min_dandelion_output_note_reorg_lane_claim_reserve_micro_units,
                ...
                dandelion_output_note_reorg_window_slots: request
                    .dandelion_output_note_reorg_window_slots,
                active: true,
    ...
    pub fn register_cohort(&mut self, request: RegisterCohortRequest) -> Result<String> {
        ...
        let policy = self.policies.get(&request.policy_id).ok_or_else(|| {
            format!(
                "unknown Dandelion output-note reorg-phase privacy guard policy {}",
                request.policy_id
            )
        })?;
        ...
        if request.pre_dandelion_output_note_reorg_reserve_micro_units
            < policy.min_pre_dandelion_output_note_reorg_reserve_micro_units
        {
            return Err("cohort source liquidity below policy floor".to_string());
        }
        if request.dandelion_output_note_reorg_lane_claim_reserve_micro_units
            < policy.min_dandelion_output_note_reorg_lane_claim_reserve_micro_units
        {
        ...
        let cohort_id = stable_id(
            "dandelion-output-note-reorg-insurance-cohort",
            &[
        ...
        if self.cohorts.contains_key(&cohort_id) {
            return Err(format!(
                "Dandelion output-note reorg-phase privacy guard cohort {cohort_id} already exists"
            ));
        }
        self.cohorts.insert(
            cohort_id.clone(),
            DandelionOutputNoteReorgInsuranceCohort {
                ...
                pre_dandelion_output_note_reorg_reserve_micro_units: request
                    .pre_dandelion_output_note_reorg_reserve_micro_units,
                dandelion_output_note_reorg_lane_claim_reserve_micro_units: request
                    .dandelion_output_note_reorg_lane_claim_reserve_micro_units,
    ...
    pub fn submit_signal(&mut self, request: SubmitSignalRequest) -> Result<String> {
        ensure_capacity(
            self.signals.len(),
            MAX_SIGNALS,
            "Dandelion output-note reorg-phase privacy guard signals",
        )?;
        let cohort = self
            .cohorts
            ...
            .ok_or_else(|| {
                format!(
                    "unknown Dandelion output-note reorg-phase privacy guard cohort {}",
                    request.cohort_id
                )
            })?
            .clone();
        ...
        ensure_non_empty(
            &request.dandelion_output_note_reorg_pressure_root,
            "dandelion_output_note_reorg_pressure_root",
        )?;
        ensure_non_empty(&request.reporter_commitment, "reporter_commitment")?;
        ensure_bps(
            request.output_note_reorg_risk_score_bps,
            "output_note_reorg_risk_score_bps",
        )?;
        if request.privacy_set_size < policy.min_privacy_set_size {
            return Err("signal privacy set below policy floor".to_string());
        }
        let signal_id = stable_id(
            "dandelion-output-note-reorg-insurance-signal",
            &[
        ...
        if self.signals.contains_key(&signal_id) {
            return Err(format!(
                "Dandelion output-note reorg-phase privacy guard signal {signal_id} already exists"
            ));
        }
        ...
        self.signals.insert(
            signal_id.clone(),
            DandelionOutputNoteReorgSignal {
                ...
                dandelion_output_note_reorg_pressure_root: request
                    .dandelion_output_note_reorg_pressure_root,
                ...
                output_note_reorg_lane_claim_reserve_delta_micro_units: request
                    .output_note_reorg_lane_claim_reserve_delta_micro_units,
                privacy_set_size: request.privacy_set_size,
                output_note_reorg_risk_score_bps: request.output_note_reorg_risk_score_bps,
    ...
    pub fn submit_attestation(&mut self, request: SubmitAttestationRequest) -> Result<String> {
        ensure_capacity(
            ...
            MAX_ATTESTATIONS,
            "Dandelion output-note reorg-phase privacy guard attestations",
        )?;
        let signal = self
            .signals
            ...
            .ok_or_else(|| {
                format!(
                    "unknown Dandelion output-note reorg-phase privacy guard signal {}",
                    request.signal_id
                )
            })?
            .clone();
        ...
        ensure_bps(
            request.observed_output_note_reorg_risk_score_bps,
            "observed_output_note_reorg_risk_score_bps",
        )?;
        ...
        let attestation_id = stable_id(
            "dandelion-output-note-reorg-insurance-pq-attestation",
            &[
        ...
        if self.attestations.contains_key(&attestation_id) {
            return Err(format!(
                "Dandelion output-note reorg-phase privacy guard attestation {attestation_id} already exists"
            ));
        }
        self.attestations.insert(
            attestation_id.clone(),
            PqDandelionOutputNoteReorgInsuranceAttestation {
                ...
                observed_output_note_reorg_risk_score_bps: request
                    .observed_output_note_reorg_risk_score_bps,
    ...
    pub fn settle_decision(&mut self, request: SettleDecisionRequest) -> Result<String> {
        ensure_capacity(
            self.decisions.len(),
            MAX_DECISIONS,
            "Dandelion output-note reorg-phase privacy guard decisions",
        )?;
        let signal = self
            .signals
            .get(&request.signal_id)
        ...
        let privacy_filter_deadline_slot = match request.action {
            DandelionOutputNoteReorgAction::QueueDandelionOutputNoteReorgInsuranceClaimReview
            | DandelionOutputNoteReorgAction::SettleDandelionOutputNoteReorg
            | DandelionOutputNoteReorgAction::RotateDandelionOutputNoteReorgInsuranceSettlementCohort => {
                request
                    .decided_at_slot
                    .saturating_add(policy.dandelion_output_note_reorg_window_slots)
            }
            DandelionOutputNoteReorgAction::QuarantineOutputNoteReorgPath
            | DandelionOutputNoteReorgAction::EmergencyPause => request
                .decided_at_slot
                .saturating_add(policy.dandelion_output_note_reorg_window_slots / 2),
            _ => 0,
        };
        let decision_id = stable_id(
            "dandelion-output-note-reorg-insurance-decision",
            &[
                HashPart::Str(&request.signal_id),
        ...
        if self.decisions.contains_key(&decision_id) {
            return Err(format!(
                "Dandelion output-note reorg-phase privacy guard decision {decision_id} already exists"
            ));
        }
        self.decisions.insert(
            decision_id.clone(),
            DandelionOutputNoteReorgDecision {
        ...
        if let Some(signal) = self.signals.get_mut(&request.signal_id) {
            signal.status = match request.action {
                DandelionOutputNoteReorgAction::QueueDandelionOutputNoteReorgInsuranceClaimReview => {
                    SignalStatus::OutputNoteReorgPathQueued
                }
                DandelionOutputNoteReorgAction::SettleDandelionOutputNoteReorg
                | DandelionOutputNoteReorgAction::RotateDandelionOutputNoteReorgInsuranceSettlementCohort => {
                    SignalStatus::DandelionOutputNoteReorgInsuring
                }
                DandelionOutputNoteReorgAction::QuarantineOutputNoteReorgPath
                | DandelionOutputNoteReorgAction::EmergencyPause => SignalStatus::Quarantined,
                DandelionOutputNoteReorgAction::Release => SignalStatus::Settled,
                DandelionOutputNoteReorgAction::Reject => SignalStatus::Rejected,
                DandelionOutputNoteReorgAction::Expire => SignalStatus::Expired,
                DandelionOutputNoteReorgAction::Observe => SignalStatus::Attested,
            };
        }
        if let Some(cohort) = self.cohorts.get_mut(&signal.cohort_id) {
            match request.action {
                DandelionOutputNoteReorgAction::QueueDandelionOutputNoteReorgInsuranceClaimReview => {
                    cohort.status = CohortStatus::OutputNoteReorgPathPending;
                    cohort.privacy_filter_deadline_slot = privacy_filter_deadline_slot;
                }
                DandelionOutputNoteReorgAction::SettleDandelionOutputNoteReorg => {
                    cohort.status = CohortStatus::DandelionOutputNoteReorgInsuring;
                    cohort.pre_dandelion_output_note_reorg_reserve_micro_units = cohort
                        .pre_dandelion_output_note_reorg_reserve_micro_units
                        .saturating_sub(request.privacy_filtered_micro_units);
                    cohort.dandelion_output_note_reorg_lane_claim_reserve_micro_units = cohort
                        .dandelion_output_note_reorg_lane_claim_reserve_micro_units
                        .saturating_add(request.privacy_filtered_micro_units);
                    cohort.privacy_filter_deadline_slot = privacy_filter_deadline_slot;
                    self.counters.dandelion_output_note_reorg_filters_settled = self
                        .counters
                        .dandelion_output_note_reorg_filters_settled
                        .saturating_add(1);
                ...
                DandelionOutputNoteReorgAction::EmergencyPause => {
                ...
                DandelionOutputNoteReorgAction::Release => {
    ...
    pub fn publish_rebate(&mut self, request: PublishRebateRequest) -> Result<String> {
        ensure_capacity(
            self.rebates.len(),
            MAX_REBATES,
            "Dandelion output-note reorg-phase privacy guard rebates",
        )?;
        let decision = self.decisions.get(&request.decision_id).ok_or_else(|| {
            format!(
                "unknown Dandelion output-note reorg-phase privacy guard decision {}",
                request.decision_id
            )
        })?;
        ...
        let rebate_id = stable_id(
            "dandelion-output-note-reorg-insurance-low-fee-rebate",
            &[
        ...
        if self.rebates.contains_key(&rebate_id) {
            return Err(format!(
                "Dandelion output-note reorg-phase privacy guard rebate {rebate_id} already exists"
            ));
        }
        self.rebates.insert(
            rebate_id.clone(),
            LowFeeDandelionOutputNoteReorgInsuranceRebate {
    ...
    pub fn publish_redaction_budget(
        ...
        ensure_capacity(
            ...
            "Dandelion output-note reorg-phase privacy guard redaction budgets",
        )?;
        ...
        let budget_id = stable_id(
            "dandelion-output-note-reorg-insurance-redaction-budget",
            &[
                HashPart::Str(request.scope.as_str()),
                HashPart::Str(&request.cohort_id),
        ...
        if self.redaction_budgets.contains_key(&budget_id) {
            return Err(format!(
                "Dandelion output-note reorg-phase privacy guard redaction budget {budget_id} already exists"
            ));
        }
    ...
    pub fn publish_operator_summary(
        ...
        ensure_capacity(
            ...
            "Dandelion output-note reorg-phase privacy guard operator summaries",
        )?;
        self.refresh_live_counts();
        ...
        let summary_id = stable_id(
            "dandelion-output-note-reorg-insurance-operator-summary",
            &[
                HashPart::U64(epoch),
                HashPart::U64(slot),
    ...
    fn refresh_roots(&mut self) {
        ...
        self.roots.state_root = merkle_root(
            "bridge-dandelion-output-note-reorg-insurance:state",
            &[
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "dandelion_output_note_reorg_insurance_suite": self.config.dandelion_output_note_reorg_insurance_suite,
            ...
            "dandelion_output_note_reorg_window_slots": self.config.dandelion_output_note_reorg_window_slots,
            ...
            "policies": self.policies.values().map(|policy| json!({
                ...
                "min_pre_dandelion_output_note_reorg_reserve_micro_units": policy.min_pre_dandelion_output_note_reorg_reserve_micro_units,
                "min_dandelion_output_note_reorg_lane_claim_reserve_micro_units": policy.min_dandelion_output_note_reorg_lane_claim_reserve_micro_units,
            ...
            "cohorts": self.cohorts.values().map(|cohort| json!({
                ...
                "pre_dandelion_output_note_reorg_reserve_micro_units": cohort.pre_dandelion_output_note_reorg_reserve_micro_units,
                "dandelion_output_note_reorg_lane_claim_reserve_micro_units": cohort.dandelion_output_note_reorg_lane_claim_reserve_micro_units,
            ...
            "signals": self.signals.values().map(|signal| json!({
                ...
                "output_note_reorg_risk_score_bps": signal.output_note_reorg_risk_score_bps,
...
pub fn demo() -> State {
    ...
    let signal = state
        .submit_signal(SubmitSignalRequest {
            cohort_id,
            kind: SignalKind::DandelionOutputNoteReorgGraphLinkagePressure,
            signal_commitment_root: devnet_root("signal", "demo-output-note-reorg-pressure"),
            observed_claim_reorg_path_root: devnet_root(
                "observed-reorg-path",
                "demo-output-note-reorg-pressure",
            ),
            dandelion_output_note_reorg_pressure_root: devnet_root(
                "pressure",
                "demo-output-note-reorg-pressure",
            ),
            reporter_commitment: "reporter:demo-output-note-watchtower".to_string(),
            pre_reorg_reserve_delta_micro_units: -10_000_000,
            output_note_reorg_lane_claim_reserve_delta_micro_units: 8_000_000,
            privacy_set_size: 524_288,
            output_note_reorg_risk_score_bps: 6_200,
    ...
    state
        .submit_attestation(SubmitAttestationRequest {
            signal_id: signal,
            verdict: AttestationVerdict::RequireDandelionOutputNoteReorgCoverage,
            attestor_commitment: "attestor:demo-dandelion-output-note-reorg-insurance".to_string(),
            pq_signature_root: devnet_root("ml-dsa-signature", "demo-output-note-reorg-pressure"),
            pq_public_key_root: devnet_root("ml-kem-public-key", "demo-output-note-reorg-pressure"),
            transcript_root: devnet_root("transcript", "demo-output-note-reorg-pressure"),
            quorum_weight_bps: 7_200,
            pq_security_bits: 256,
            observed_output_note_reorg_risk_score_bps: 6_400,
            observed_privacy_set_size: 524_288,
...
fn object_root<T: Serialize>(domain: &str, value: &T) -> String {
    ...
    domain_hash(
        &format!("bridge-dandelion-output-note-reorg-insurance:{domain}"),
        &[HashPart::Json(&value)],
        32,
    )
}
...
fn devnet_root(domain: &str, label: &str) -> String {
    domain_hash(
        &format!("bridge-dandelion-output-note-reorg-insurance:devnet:{domain}"),
