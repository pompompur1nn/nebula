...
pub type PrivateL2PqConfidentialBridgeMixnetDecoyLiquiditySchedulerRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-bridge-mixnet-decoy-liquidity-scheduler-runtime-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_BRIDGE_MIXNET_DECOY_LIQUIDITY_SCHEDULER_RUNTIME_PROTOCOL_VERSION:
    &str = PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const PQ_MIXNET_SCHEDULER_SUITE: &str = "ML-DSA-87+ML-KEM-1024+SLH-DSA-SHAKE-256f";
pub const DECOY_LIQUIDITY_SCHEDULER_SUITE: &str =
    "monero-bridge-mixnet-decoy-liquidity-scheduler-root-v1";
pub const REBATE_SUITE: &str = "mixnet-decoy-liquidity-scheduler-low-fee-rebate-root-v1";
pub const REDACTION_SUITE: &str =
    "operator-safe-mixnet-decoy-liquidity-scheduler-redaction-root-v1";
...
pub const DEFAULT_DECOY_LIQUIDITY_WINDOW_SLOTS: u64 = 720;
...
impl MixnetDecoyLiquidityScope {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::EmergencyDecoyLiquidity => "emergency_decoy_liquidity_scheduler",
...
pub enum AttestationVerdict {
    ConfirmDecoyLiquidityPressure,
    ConfirmPrivacyRisk,
    RequireDecoyLiquidityReschedule,
    RequireDecoyLiquidityRescheduleGuard,
    RequireQuarantine,
    ClearFalsePositive,
}
...
#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum MixnetDecoyLiquidityAction {
    Observe,
    QueueDecoyLiquidityReview,
    ApplyDecoyLiquiditySchedule,
    RotateMixnetDecoyLiquidityCohort,
    QuarantineRoute,
    EmergencyPause,
    Release,
    Reject,
...
pub struct Config {
    ...
    pub pq_mixnet_scheduler_suite: String,
    pub decoy_liquidity_scheduler_suite: String,
    ...
    pub decoy_liquidity_window_slots: u64,
    pub signal_window_slots: u64,
    pub max_route_fee_bps: u64,
    pub target_rebate_bps: u64,
    pub min_stem_lane_decoy_liquidity_micro_units: u64,
    pub min_fluff_lane_decoy_liquidity_micro_units: u64,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            pq_mixnet_scheduler_suite: PQ_MIXNET_SCHEDULER_SUITE.to_string(),
            decoy_liquidity_scheduler_suite: DECOY_LIQUIDITY_SCHEDULER_SUITE.to_string(),
            ...
            decoy_liquidity_window_slots: DEFAULT_DECOY_LIQUIDITY_WINDOW_SLOTS,
            signal_window_slots: DEFAULT_SIGNAL_WINDOW_SLOTS,
            max_route_fee_bps: DEFAULT_MAX_ROUTE_FEE_BPS,
            target_rebate_bps: DEFAULT_TARGET_REBATE_BPS,
            min_stem_lane_decoy_liquidity_micro_units: DEFAULT_MIN_SOURCE_LIQUIDITY_MICRO_UNITS,
            min_fluff_lane_decoy_liquidity_micro_units: DEFAULT_MIN_TARGET_LIQUIDITY_MICRO_UNITS,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct MixnetDecoyLiquidityPolicy {
    pub policy_id: String,
    pub scope: MixnetDecoyLiquidityScope,
    pub owner_commitment: String,
    pub policy_commitment_root: String,
    pub source_decoy_relay_set_root: String,
    pub target_decoy_relay_set_root: String,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct MixnetDecoyLiquiditySchedulerCohort {
    ...
    pub decoy_scheduler_commitment_root: String,
    pub stem_lane_decoy_liquidity_micro_units: u64,
    pub fluff_lane_decoy_liquidity_micro_units: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct MixnetDecoyLiquiditySignal {
    ...
    pub stem_lane_decoy_liquidity_delta_micro_units: i128,
    pub fluff_lane_decoy_liquidity_delta_micro_units: i128,
    pub privacy_set_size: u64,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct PqMixnetDecoyLiquidityAttestation {
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct MixnetDecoyLiquidityDecision {
    pub decision_id: String,
    pub signal_id: String,
    pub cohort_id: String,
    pub policy_id: String,
    pub action: MixnetDecoyLiquidityAction,
    pub decision_root: String,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct LowFeeMixnetDecoyLiquidityRebate {
...
pub struct State {
    ...
    pub roots: Roots,
    pub policies: BTreeMap<String, MixnetDecoyLiquidityPolicy>,
    pub cohorts: BTreeMap<String, MixnetDecoyLiquiditySchedulerCohort>,
    pub signals: BTreeMap<String, MixnetDecoyLiquiditySignal>,
    pub attestations: BTreeMap<String, PqMixnetDecoyLiquidityAttestation>,
    pub decisions: BTreeMap<String, MixnetDecoyLiquidityDecision>,
    pub rebates: BTreeMap<String, LowFeeMixnetDecoyLiquidityRebate>,
...
impl State {
    ...
    pub fn devnet() -> Self {
        ...
        let withdrawal_policy = state
            .register_policy(RegisterPolicyRequest {
                scope: MixnetDecoyLiquidityScope::WithdrawalSubaddressLane,
                owner_commitment: "owner:dandelion-mixnet-decoy-liquidity-scheduler-council-a"
                    .to_string(),
                policy_commitment_root: devnet_root(
                    "policy",
                    "withdrawal-dandelion-mixnet-decoy-liquidity-scheduler",
                ),
                source_decoy_relay_set_root: devnet_root(
                    "source-fluff-relay-set",
                    "withdrawal-alpha",
                ),
                target_decoy_relay_set_root: devnet_root(
                    "target-fluff-relay-set",
                    "withdrawal-alpha",
                ),
                route_allowlist_root: devnet_root("route-allowlist", "withdrawal-alpha"),
                min_privacy_set_size: 524_288,
                min_stem_lane_decoy_liquidity_micro_units: 160_000_000,
                min_fluff_lane_decoy_liquidity_micro_units: 72_000_000,
                max_route_fee_bps: 16,
                min_attestation_quorum_bps: 7_200,
                signal_window_slots: 96,
                decoy_liquidity_window_slots: 720,
                redaction_profile: "withdrawal-dandelion-mixnet-decoy-liquidity-scheduler-profile"
                    .to_string(),
            })
            .expect("devnet withdrawal policy");
        let fast_dandelion_exit_policy = state
            .register_policy(RegisterPolicyRequest {
                scope: MixnetDecoyLiquidityScope::FastDandelionDecoyLiquidityLane,
                owner_commitment: "owner:fast-dandelion-decoy-scheduler-route-council-b".to_string(),
                policy_commitment_root: devnet_root(
                    "policy",
                    "fast-dandelion-decoy-scheduler-dandelion-mixnet-decoy-liquidity-scheduler",
                ),
                source_decoy_relay_set_root: devnet_root(
                    "source-fluff-relay-set",
                    "fast-dandelion-decoy-scheduler-beta",
                ),
                target_decoy_relay_set_root: devnet_root(
                    "target-fluff-relay-set",
                    "fast-dandelion-decoy-scheduler-beta",
                ...
                min_stem_lane_decoy_liquidity_micro_units: 144_000_000,
                min_fluff_lane_decoy_liquidity_micro_units: 64_000_000,
                max_route_fee_bps: 18,
                min_attestation_quorum_bps: 7_000,
                signal_window_slots: 80,
                decoy_liquidity_window_slots: 640,
                redaction_profile:
                    "fast-dandelion-decoy-scheduler-dandelion-mixnet-decoy-liquidity-scheduler-profile"
                        .to_string(),
            })
            .expect("devnet fast mixnet_decoy_liquidity policy");
        let withdrawal_cohort = state
            .register_cohort(RegisterCohortRequest {
                policy_id: withdrawal_policy,
                bridge_lane_id: "withdrawal-decoy-scheduler-alpha".to_string(),
                source_decoy_relay_set_root: devnet_root("source-fluff-relay-set", "cohort-alpha"),
                target_decoy_relay_set_root: devnet_root("target-fluff-relay-set", "cohort-alpha"),
                output_set_root: devnet_root("outputs", "cohort-alpha"),
                decoy_scheduler_commitment_root: devnet_root("liquidity", "cohort-alpha"),
                stem_lane_decoy_liquidity_micro_units: 216_000_000,
                fluff_lane_decoy_liquidity_micro_units: 96_000_000,
        ...
        let fast_dandelion_exit_cohort = state
            .register_cohort(RegisterCohortRequest {
                ...
                bridge_lane_id: "fast-dandelion-decoy-scheduler-route-beta".to_string(),
                source_decoy_relay_set_root: devnet_root("source-fluff-relay-set", "cohort-beta"),
                target_decoy_relay_set_root: devnet_root("target-fluff-relay-set", "cohort-beta"),
                output_set_root: devnet_root("outputs", "cohort-beta"),
                decoy_scheduler_commitment_root: devnet_root("liquidity", "cohort-beta"),
                stem_lane_decoy_liquidity_micro_units: 168_000_000,
                fluff_lane_decoy_liquidity_micro_units: 76_000_000,
                privacy_set_size: 393_216,
                route_fee_bps: 13,
                public_hint_root: devnet_root("hint", "cohort-beta"),
            })
            .expect("devnet fast mixnet_decoy_liquidity cohort");
        let signal = state
            .submit_signal(SubmitSignalRequest {
                ...
                stem_lane_decoy_liquidity_delta_micro_units: -48_000_000,
                fluff_lane_decoy_liquidity_delta_micro_units: 24_000_000,
                privacy_set_size: 524_288,
        ...
        state
            .submit_attestation(SubmitAttestationRequest {
                ...
                verdict: AttestationVerdict::RequireDecoyLiquidityRescheduleGuard,
                attestor_commitment: "attestor:pq-dandelion-mixnet-decoy-liquidity-scheduler-a"
                    .to_string(),
                pq_signature_root: devnet_root(
                    "ml-dsa-signature",
                    "withdrawal-mixnet_decoy_liquidity-a",
                ),
                pq_public_key_root: devnet_root(
                    "ml-kem-public-key",
                    "withdrawal-mixnet_decoy_liquidity-a",
                ),
                transcript_root: devnet_root("transcript", "withdrawal-mixnet_decoy_liquidity-a"),
        ...
        state
            .submit_attestation(SubmitAttestationRequest {
                signal_id: signal.clone(),
                verdict: AttestationVerdict::ConfirmDecoyLiquidityPressure,
                attestor_commitment: "attestor:pq-dandelion-mixnet-decoy-liquidity-scheduler-b"
                    .to_string(),
                pq_signature_root: devnet_root(
                    "slh-dsa-signature",
                    "withdrawal-mixnet_decoy_liquidity-b",
                ),
                pq_public_key_root: devnet_root(
                    "ml-kem-public-key",
                    "withdrawal-mixnet_decoy_liquidity-b",
                ),
                transcript_root: devnet_root("transcript", "withdrawal-mixnet_decoy_liquidity-b"),
        ...
        let decision = state
            .settle_decision(SettleDecisionRequest {
                signal_id: signal,
                action: MixnetDecoyLiquidityAction::ApplyDecoyLiquiditySchedule,
                decision_root: devnet_root(
                    "decision",
                    "withdrawal-liquidity-mixnet_decoy_liquidity",
                ),
                replacement_route_root: devnet_root(
                    "replacement-route",
                    "withdrawal-mixnet_decoy_liquidity",
                ),
            ...
            .expect("devnet mixnet_decoy_liquidity decision");
        state
            .publish_rebate(PublishRebateRequest {
                decision_id: decision,
                recipient_commitment:
                    "recipient:dandelion-mixnet-decoy-liquidity-scheduler-fee-sponsor".to_string(),
                rebate_micro_units: 22_000,
                fee_saved_micro_units: 88_000,
                rebate_bps: 8,
                settlement_slot: DEVNET_SLOT + 6,
                rebate_root: devnet_root("rebate", "withdrawal-mixnet_decoy_liquidity"),
            })
    ...
    pub fn register_policy(&mut self, request: RegisterPolicyRequest) -> Result<String> {
        ...
        ensure_non_empty(
            &request.source_decoy_relay_set_root,
            "source_decoy_relay_set_root",
        )?;
        ensure_non_empty(
            &request.target_decoy_relay_set_root,
            "target_decoy_relay_set_root",
        )?;
        ...
        if request.min_stem_lane_decoy_liquidity_micro_units
            < self.config.min_stem_lane_decoy_liquidity_micro_units
        {
            return Err("policy source liquidity below runtime floor".to_string());
        }
        if request.min_fluff_lane_decoy_liquidity_micro_units
            < self.config.min_fluff_lane_decoy_liquidity_micro_units
        {
            return Err("policy target liquidity below runtime floor".to_string());
        }
        let policy_id = stable_id(
            "dandelion-mixnet-decoy-liquidity-scheduler-policy",
            &[
                HashPart::Str(request.scope.as_str()),
                HashPart::Str(&request.owner_commitment),
                HashPart::Str(&request.policy_commitment_root),
                HashPart::Str(&request.source_decoy_relay_set_root),
            ],
        );
        ...
        self.policies.insert(
            policy_id.clone(),
            MixnetDecoyLiquidityPolicy {
                policy_id: policy_id.clone(),
                scope: request.scope,
                owner_commitment: request.owner_commitment,
                policy_commitment_root: request.policy_commitment_root,
                source_decoy_relay_set_root: request.source_decoy_relay_set_root,
                target_decoy_relay_set_root: request.target_decoy_relay_set_root,
                route_allowlist_root: request.route_allowlist_root,
                min_privacy_set_size: request.min_privacy_set_size,
                min_stem_lane_decoy_liquidity_micro_units: request
                    .min_stem_lane_decoy_liquidity_micro_units,
                min_fluff_lane_decoy_liquidity_micro_units: request
                    .min_fluff_lane_decoy_liquidity_micro_units,
                ...
                decoy_liquidity_window_slots: request.decoy_liquidity_window_slots,
                active: true,
    ...
    pub fn register_cohort(&mut self, request: RegisterCohortRequest) -> Result<String> {
        ...
        ensure_non_empty(
            &request.decoy_scheduler_commitment_root,
            "decoy_scheduler_commitment_root",
        )?;
        ...
        if request.stem_lane_decoy_liquidity_micro_units
            < policy.min_stem_lane_decoy_liquidity_micro_units
        {
            return Err("cohort source liquidity below policy floor".to_string());
        }
        if request.fluff_lane_decoy_liquidity_micro_units
            < policy.min_fluff_lane_decoy_liquidity_micro_units
        {
        ...
        let cohort_id = stable_id(
            "dandelion-mixnet-decoy-liquidity-scheduler-cohort",
            &[
                HashPart::Str(&request.policy_id),
                HashPart::Str(&request.bridge_lane_id),
                HashPart::Str(&request.source_decoy_relay_set_root),
                HashPart::Str(&request.decoy_scheduler_commitment_root),
            ],
        );
        ...
        self.cohorts.insert(
            cohort_id.clone(),
            MixnetDecoyLiquiditySchedulerCohort {
                ...
                decoy_scheduler_commitment_root: request.decoy_scheduler_commitment_root,
                stem_lane_decoy_liquidity_micro_units: request
                    .stem_lane_decoy_liquidity_micro_units,
                fluff_lane_decoy_liquidity_micro_units: request
                    .fluff_lane_decoy_liquidity_micro_units,
    ...
    pub fn submit_signal(&mut self, request: SubmitSignalRequest) -> Result<String> {
        ...
        let signal_id = stable_id(
            "dandelion-mixnet-decoy-liquidity-scheduler-signal",
            &[
        ...
        self.signals.insert(
            ...
            MixnetDecoyLiquiditySignal {
                ...
                stem_lane_decoy_liquidity_delta_micro_units: request
                    .stem_lane_decoy_liquidity_delta_micro_units,
                fluff_lane_decoy_liquidity_delta_micro_units: request
                    .fluff_lane_decoy_liquidity_delta_micro_units,
                privacy_set_size: request.privacy_set_size,
    ...
    pub fn submit_attestation(&mut self, request: SubmitAttestationRequest) -> Result<String> {
        ...
        let attestation_id = stable_id(
            "dandelion-mixnet-decoy-liquidity-scheduler-pq-attestation",
            &[
        ...
        self.attestations.insert(
            ...
            PqMixnetDecoyLiquidityAttestation {
    ...
    pub fn settle_decision(&mut self, request: SettleDecisionRequest) -> Result<String> {
        ...
        let privacy_filter_deadline_slot = match request.action {
            MixnetDecoyLiquidityAction::QueueDecoyLiquidityReview
            | MixnetDecoyLiquidityAction::ApplyDecoyLiquiditySchedule
            | MixnetDecoyLiquidityAction::RotateMixnetDecoyLiquidityCohort => request
                .decided_at_slot
                .saturating_add(policy.decoy_liquidity_window_slots),
            MixnetDecoyLiquidityAction::QuarantineRoute
            | MixnetDecoyLiquidityAction::EmergencyPause => request
                .decided_at_slot
                .saturating_add(policy.decoy_liquidity_window_slots / 2),
            _ => 0,
        };
        let decision_id = stable_id(
            "dandelion-mixnet-decoy-liquidity-scheduler-decision",
            &[
                HashPart::Str(&request.signal_id),
        ...
        if let Some(signal) = self.signals.get_mut(&request.signal_id) {
            signal.status = match request.action {
                MixnetDecoyLiquidityAction::QueueDecoyLiquidityReview => SignalStatus::RouteQueued,
                MixnetDecoyLiquidityAction::ApplyDecoyLiquiditySchedule
                | MixnetDecoyLiquidityAction::RotateMixnetDecoyLiquidityCohort => {
                    SignalStatus::Routing
                }
                MixnetDecoyLiquidityAction::QuarantineRoute
                | MixnetDecoyLiquidityAction::EmergencyPause => SignalStatus::Quarantined,
                MixnetDecoyLiquidityAction::Release => SignalStatus::Settled,
                MixnetDecoyLiquidityAction::Reject => SignalStatus::Rejected,
                MixnetDecoyLiquidityAction::Expire => SignalStatus::Expired,
                MixnetDecoyLiquidityAction::Observe => SignalStatus::Attested,
            };
        }
        if let Some(cohort) = self.cohorts.get_mut(&signal.cohort_id) {
            match request.action {
                ...
                MixnetDecoyLiquidityAction::ApplyDecoyLiquiditySchedule => {
                    ...
                    cohort.stem_lane_decoy_liquidity_micro_units = cohort
                        .stem_lane_decoy_liquidity_micro_units
                        .saturating_sub(request.privacy_filtered_micro_units);
                    cohort.fluff_lane_decoy_liquidity_micro_units = cohort
                        .fluff_lane_decoy_liquidity_micro_units
                ...
                MixnetDecoyLiquidityAction::EmergencyPause => {
                    cohort.status = CohortStatus::Paused;
                    cohort.privacy_filter_deadline_slot = privacy_filter_deadline_slot;
                    self.counters.routes_quarantined =
                        self.counters.routes_quarantined.saturating_add(1);
                }
                MixnetDecoyLiquidityAction::Release => {
    ...
    pub fn publish_rebate(&mut self, request: PublishRebateRequest) -> Result<String> {
        ...
        let rebate_id = stable_id(
            "dandelion-mixnet-decoy-liquidity-scheduler-low-fee-rebate",
            &[
        ...
        self.rebates.insert(
            rebate_id.clone(),
            LowFeeMixnetDecoyLiquidityRebate {
    ...
    pub fn publish_redaction_budget(
        ...
        let budget_id = stable_id(
            "dandelion-mixnet-decoy-liquidity-scheduler-redaction-budget",
            &[
                HashPart::Str(request.scope.as_str()),
                HashPart::Str(&request.cohort_id),
    ...
    pub fn publish_operator_summary(
        ...
        let summary_id = stable_id(
            "dandelion-mixnet-decoy-liquidity-scheduler-operator-summary",
            &[
                HashPart::U64(epoch),
                HashPart::U64(slot),
    ...
    fn refresh_roots(&mut self) {
        ...
        self.roots.state_root = merkle_root(
            "bridge-dandelion-mixnet-decoy-liquidity-scheduler:state",
            &[
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "pq_mixnet_scheduler_suite": self.config.pq_mixnet_scheduler_suite,
            "decoy_liquidity_scheduler_suite": self.config.decoy_liquidity_scheduler_suite,
            ...
            "decoy_liquidity_window_slots": self.config.decoy_liquidity_window_slots,
            ...
            "policies": self.policies.values().map(|policy| json!({
                ...
                "min_stem_lane_decoy_liquidity_micro_units": policy.min_stem_lane_decoy_liquidity_micro_units,
                "min_fluff_lane_decoy_liquidity_micro_units": policy.min_fluff_lane_decoy_liquidity_micro_units,
            ...
            "cohorts": self.cohorts.values().map(|cohort| json!({
                ...
                "stem_lane_decoy_liquidity_micro_units": cohort.stem_lane_decoy_liquidity_micro_units,
                "fluff_lane_decoy_liquidity_micro_units": cohort.fluff_lane_decoy_liquidity_micro_units,
...
pub fn demo() -> State {
    ...
    let signal = state
        .submit_signal(SubmitSignalRequest {
            ...
            stem_lane_decoy_liquidity_delta_micro_units: -10_000_000,
            fluff_lane_decoy_liquidity_delta_micro_units: 8_000_000,
            privacy_set_size: 524_288,
    ...
    state
        .submit_attestation(SubmitAttestationRequest {
            signal_id: signal,
            verdict: AttestationVerdict::RequireDecoyLiquidityReschedule,
            attestor_commitment: "attestor:demo-dandelion-mixnet-decoy-liquidity-scheduler"
                .to_string(),
...
fn object_root<T: Serialize>(domain: &str, value: &T) -> String {
    ...
    domain_hash(
        &format!("bridge-dandelion-mixnet-decoy-liquidity-scheduler:{domain}"),
        &[HashPart::Json(&value)],
        32,
    )
}
...
fn devnet_root(domain: &str, label: &str) -> String {
    domain_hash(
        &format!("bridge-dandelion-mixnet-decoy-liquidity-scheduler:devnet:{domain}"),
