...
pub type PrivateL2LowFeePrivateStateChannelNettingRuntimeResult<T> = Result<T, String>;
pub type Runtime = State;

pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-low-fee-private-state-channel-netting-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_PROTOCOL_VERSION;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_SCHEMA_VERSION: u64 = 1;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEVNET_HEIGHT: u64 = 214_000;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEVNET_MONERO_NETWORK: &str =
    "monero-devnet";
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEVNET_L2_NETWORK: &str =
    "nebula-devnet";
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEVNET_CHANNEL_BOOK: &str =
    "devnet-PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-book";
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEVNET_LIQUIDITY_POOL: &str =
    "devnet-private-l2-low-fee-private-state-channel-liquidity-pool";
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_HASH_SUITE: &str =
    "SHAKE256-domain-separated-canonical-json";
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_CHANNEL_UPDATE_SCHEME: &str =
    "roots-only-PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-update-v1";
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_PQ_COMMITMENT_SCHEME: &str =
    "ml-dsa-87-channel-state-commitment-root-v1";
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_REBALANCE_BATCH_SCHEME: &str =
    "private-channel-liquidity-rebalance-batch-root-v1";
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DISPUTE_WINDOW_SCHEME: &str =
    "private-channel-dispute-window-root-v1";
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_LOW_FEE_SPONSOR_SCHEME: &str =
    "low-fee-private-channel-sponsor-receipt-root-v1";
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_FAST_SETTLEMENT_SCHEME: &str =
    "fast-private-channel-settlement-receipt-root-v1";
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_NULLIFIER_SCHEME: &str =
    "private-channel-liquidity-nullifier-root-v1";
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_MAX_BPS: u64 = 10_000;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_UPDATE_TTL_BLOCKS: u64 =
    32;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_BATCH_TTL_BLOCKS: u64 =
    48;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_DISPUTE_WINDOW_BLOCKS:
    u64 = 96;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_FAST_SETTLEMENT_BLOCKS: u64 =
    6;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_MIN_PRIVACY_SET_SIZE:
    u64 = 4_096;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_MIN_BATCH_PRIVACY_SET_SIZE:
    u64 = 8_192;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_MIN_PQ_SECURITY_BITS:
    u16 = 192;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_TARGET_PQ_SECURITY_BITS: u16 =
    256;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_MAX_USER_FEE_BPS: u64 =
    24;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_LOW_FEE_BPS: u64 = 6;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_SPONSOR_COVER_BPS: u64 =
    7_500;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_MAX_NET_IMBALANCE_BPS:
    u64 = 175;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_MAX_UPDATES: usize = 262_144;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_MAX_COMMITMENTS: usize = 262_144;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_MAX_BATCHES: usize = 131_072;
pub const PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_MAX_RECEIPTS: usize = 262_144;
...
impl Config {
    pub fn devnet() -> Self {
        Self {
            ...
            schema_version: PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_SCHEMA_VERSION,
            monero_network:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEVNET_MONERO_NETWORK
                    .to_string(),
            l2_network: PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEVNET_L2_NETWORK
                .to_string(),
            channel_book:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEVNET_CHANNEL_BOOK
                    .to_string(),
            liquidity_pool:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEVNET_LIQUIDITY_POOL
                    .to_string(),
            hash_suite: PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_HASH_SUITE
                .to_string(),
            channel_update_scheme:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_CHANNEL_UPDATE_SCHEME
                    .to_string(),
            pq_commitment_scheme:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_PQ_COMMITMENT_SCHEME
                    .to_string(),
            rebalance_batch_scheme:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_REBALANCE_BATCH_SCHEME
                    .to_string(),
            dispute_window_scheme:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DISPUTE_WINDOW_SCHEME
                    .to_string(),
            low_fee_sponsor_scheme:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_LOW_FEE_SPONSOR_SCHEME
                    .to_string(),
            fast_settlement_scheme:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_FAST_SETTLEMENT_SCHEME
                    .to_string(),
            nullifier_scheme:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_NULLIFIER_SCHEME.to_string(),
            genesis_height: PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEVNET_HEIGHT,
            update_ttl_blocks:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_UPDATE_TTL_BLOCKS,
            batch_ttl_blocks:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_BATCH_TTL_BLOCKS,
            dispute_window_blocks:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_DISPUTE_WINDOW_BLOCKS,
            fast_settlement_blocks:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_FAST_SETTLEMENT_BLOCKS,
            min_privacy_set_size:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_MIN_PRIVACY_SET_SIZE,
            min_batch_privacy_set_size:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_MIN_BATCH_PRIVACY_SET_SIZE,
            min_pq_security_bits:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_MIN_PQ_SECURITY_BITS,
            target_pq_security_bits:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_TARGET_PQ_SECURITY_BITS,
            max_user_fee_bps:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_MAX_USER_FEE_BPS,
            low_fee_bps: PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_LOW_FEE_BPS,
            sponsor_cover_bps:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_SPONSOR_COVER_BPS,
            max_net_imbalance_bps:
                PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEFAULT_MAX_NET_IMBALANCE_BPS,
            roots_only: true,
        }
    }

    pub fn validate(&self) -> PrivateL2LowFeePrivateStateChannelNettingRuntimeResult<()> {
        ...
        if self.low_fee_bps > self.max_user_fee_bps
            || self.max_user_fee_bps
                > PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_MAX_BPS
            || self.sponsor_cover_bps
                > PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_MAX_BPS
    ...
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_config",
...
impl Counters {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_counters",
...
impl SubmitChannelUpdateRequest {
    pub fn validate(
        &self,
        config: &Config,
    ) -> PrivateL2LowFeePrivateStateChannelNettingRuntimeResult<()> {
...
impl PrivateChannelUpdateRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_low_fee_private_state_channel_update",
    ...
    pub fn state_root(&self) -> String {
        payload_root(
            "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-UPDATE-RECORD",
            &self.public_record(),
        )
    }
}
...
impl PqStateCommitmentRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_low_fee_private_state_channel_pq_state_commitment",
...
impl ChannelRebalanceBatchRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_low_fee_private_state_channel_netting_batch",
...
impl DisputeWindowRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_low_fee_private_state_channel_dispute_window",
...
impl LowFeeSponsorReceiptRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_low_fee_private_state_channel_low_fee_sponsor_receipt",
...
impl FastSettlementReceiptRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_low_fee_private_state_channel_batched_settlement_receipt",
            "receipt_id": self.receipt_id,
            "batch_id": self.batch_id,
...
impl PublicRecord {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_low_fee_private_state_channel_netting_public_record",
...
impl Roots {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "private_l2_low_fee_private_state_channel_netting_roots",
    ...
    pub fn state_root(&self) -> String {
        payload_root(
            "private-l2-low-fee-private-state-channel-netting-ROOTS",
            &self.public_record(),
        )
    }
}
...
impl State {
    pub fn devnet() -> PrivateL2LowFeePrivateStateChannelNettingRuntimeResult<Self> {
        let config = Config::devnet();
        config.validate()?;
        let mut state = Self {
            config,
            height: PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_DEVNET_HEIGHT,
    ...
    pub fn submit_channel_update(
    ...
    ) -> PrivateL2LowFeePrivateStateChannelNettingRuntimeResult<PrivateChannelUpdateRecord> {
        self.config.validate()?;
        if self.channel_updates.len()
            >= PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_MAX_UPDATES
        {
        ...
        let nullifier_root = secret_root(
            "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-UPDATE-NULLIFIER",
            &request.nullifier,
        );
        let replay_fence_root = secret_root(
            "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-UPDATE-REPLAY-FENCE",
    ...
    ) -> PrivateL2LowFeePrivateStateChannelNettingRuntimeResult<PqStateCommitmentRecord> {
        self.config.validate()?;
        if self.pq_commitments.len()
            >= PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_MAX_COMMITMENTS
        {
    ...
    pub fn build_rebalance_batch(
    ...
    ) -> PrivateL2LowFeePrivateStateChannelNettingRuntimeResult<ChannelRebalanceBatchRecord> {
        self.config.validate()?;
        if self.rebalance_batches.len()
            >= PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_MAX_BATCHES
        {
        ...
        let update_root = merkle_root(
            "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-REBALANCE-BATCH-UPDATE-ID",
            &request
                .update_ids
                .iter()
    ...
    ) -> PrivateL2LowFeePrivateStateChannelNettingRuntimeResult<DisputeWindowRecord> {
        self.config.validate()?;
        request.validate(&self.config)?;
        let batch = self
            .rebalance_batches
    ...
    ) -> PrivateL2LowFeePrivateStateChannelNettingRuntimeResult<LowFeeSponsorReceiptRecord> {
        self.config.validate()?;
        if self.low_fee_sponsor_receipts.len()
            >= PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_MAX_RECEIPTS
        {
    ...
    ) -> PrivateL2LowFeePrivateStateChannelNettingRuntimeResult<FastSettlementReceiptRecord> {
        self.config.validate()?;
    ...
    pub fn roots(&self) -> Roots {
        Roots {
            config_root: payload_root(
                "private-l2-low-fee-private-state-channel-netting-CONFIG",
                &self.config.public_record(),
            ),
            channel_update_root: map_root(
                "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-UPDATE-MAP",
                &self.channel_updates,
                PrivateChannelUpdateRecord::public_record,
            ),
            pq_commitment_root: map_root(
                "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-PQ-COMMITMENT-MAP",
                &self.pq_commitments,
                PqStateCommitmentRecord::public_record,
            ),
            rebalance_batch_root: map_root(
                "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-REBALANCE-BATCH-MAP",
                &self.rebalance_batches,
                ChannelRebalanceBatchRecord::public_record,
            ),
            dispute_window_root: map_root(
                "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-DISPUTE-WINDOW-MAP",
                &self.dispute_windows,
                DisputeWindowRecord::public_record,
            ),
            low_fee_sponsor_receipt_root: map_root(
                "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-LOW-FEE-SPONSOR-RECEIPT-MAP",
                &self.low_fee_sponsor_receipts,
                LowFeeSponsorReceiptRecord::public_record,
            ),
            fast_settlement_receipt_root: map_root(
                "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-FAST-SETTLEMENT-RECEIPT-MAP",
                &self.fast_settlement_receipts,
                FastSettlementReceiptRecord::public_record,
            ),
            nullifier_root: set_root(
                "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-NETTING-NULLIFIER-SET",
                &self.used_nullifiers,
            ),
            replay_fence_root: set_root(
                "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-NETTING-REPLAY-FENCE-SET",
                &self.used_replay_fences,
            ),
            public_record_root: map_root(
                "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-NETTING-PUBLIC-RECORD-MAP",
                &self.public_records,
    ...
    pub fn public_record(&self) -> Value {
        ...
        json!({
            "kind": "PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_state",
            "chain_id": CHAIN_ID,
    ...
    pub fn state_root(&self) -> String {
        private_l2_low_fee_private_state_channel_netting_state_root_from_record(
    ...
    fn publish_public_record(&mut self, record_kind: &str, subject_id: &str, payload: &Value) {
        let payload_root = payload_root(
            "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-NETTING-PUBLIC-PAYLOAD",
            payload,
        );
...
pub fn private_l2_low_fee_private_state_channel_netting_state_root_from_record(
    record: &Value,
) -> String {
    payload_root(
        "private-l2-low-fee-private-state-channel-netting-STATE",
        record,
    )
}
...
pub fn channel_update_id(
    ...
    domain_hash(
        "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-UPDATE-ID",
        &[
...
pub fn pq_state_commitment_id(
    ...
    domain_hash(
        "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-PQ-STATE-COMMITMENT-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Int(sequence as i128),
...
pub fn rebalance_batch_id(
    ...
    domain_hash(
        "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-REBALANCE-BATCH-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Int(sequence as i128),
...
pub fn dispute_window_id(
    ...
    domain_hash(
        "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-DISPUTE-WINDOW-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Int(sequence as i128),
...
pub fn low_fee_sponsor_receipt_id(
    ...
    domain_hash(
        "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-LOW-FEE-SPONSOR-RECEIPT-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Int(sequence as i128),
...
pub fn fast_settlement_receipt_id(
    ...
    domain_hash(
        "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-FAST-SETTLEMENT-RECEIPT-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PROTOCOL_VERSION),
            HashPart::Int(sequence as i128),
...
pub fn public_record_id(
    ...
    domain_hash(
        "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-NETTING-PUBLIC-RECORD-ID",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PROTOCOL_VERSION),
...
fn settlement_state_root_after(
    ...
    domain_hash(
        "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-SETTLEMENT-STATE-ROOT-AFTER",
        &[
            HashPart::Str(CHAIN_ID),
            HashPart::Str(PROTOCOL_VERSION),
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, PartialOrd, Ord, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum LowFeeDaVoucherStatus {
    Offered,
    Reserved,
    Attached,
    Redeemed,
...
impl LowFeeDaVoucherStatus {
    ...
    pub fn live(self) -> bool {
        matches!(self, Self::Offered | Self::Reserved | Self::Attached)
    }
}

#[derive(Clone, Copy, Debug, PartialEq, Eq, PartialOrd, Ord, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum LowFeeDaVoucherLane {
    ChannelOpen,
    ChannelUpdate,
    NettingRound,
    DisputeEvidence,
...
impl LowFeeDaVoucherLane {
    ...
    pub fn settlement_critical(self) -> bool {
        matches!(
            self,
            Self::DisputeEvidence | Self::BatchedSettlement | Self::EmergencyClose
        )
    }
}
...
impl SlashingEvidenceKind {
    pub fn as_str(self) -> &'static str {
        match self {
            Self::DoubleSignedUpdate => "double_signed_update",
            Self::InvalidNettingProof => "invalid_netting_proof",
            Self::WithheldDaShard => "withheld_da_shard",
            Self::LateSettlement => "late_settlement",
            Self::ReplayFenceBreach => "replay_fence_breach",
            Self::PrivacySetDowngrade => "privacy_set_downgrade",
            Self::InvalidRebateClaim => "invalid_rebate_claim",
            Self::FraudulentDispute => "fraudulent_dispute",
        }
    }
}
...
impl EvidenceStatus {
    ...
    pub fn actionable(self) -> bool {
        matches!(self, Self::Submitted | Self::Challenged | Self::Proven)
    }
}

#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct LowFeeDaVoucherRequest {
    pub sponsor_commitment: String,
    pub lane: LowFeeDaVoucherLane,
...
impl LowFeeDaVoucherRequest {
    pub fn validate(
        &self,
        config: &Config,
    ) -> PrivateL2LowFeePrivateStateChannelNettingRuntimeResult<()> {
        require_non_empty("sponsor commitment", &self.sponsor_commitment)?;
        require_non_empty("target subject id", &self.target_subject_id)?;
        ...
        require_root("retrieval hint root", &self.retrieval_hint_root)?;
        require_privacy_set(
            config,
            self.privacy_set_size,
            self.lane.settlement_critical(),
        )?;
        require_pq_security(config, self.pq_security_bits)?;
        if self.max_fee_micro_units == 0 {
            return Err("voucher max fee must be non-zero".to_string());
        }
        if self.sponsor_cover_bps > PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_MAX_BPS
            || self.rebate_bps > PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_MAX_BPS
        {
            return Err("voucher basis points exceed max bps".to_string());
        }
        Ok(())
    }
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct LowFeeDaVoucher {
    pub voucher_id: String,
    pub status: LowFeeDaVoucherStatus,
    pub sponsor_commitment: String,
    pub lane: LowFeeDaVoucherLane,
    pub target_subject_id: String,
    pub fee_asset_id: String,
    ...
    pub redeemed_fee_micro_units: u64,
...
impl LowFeeDaVoucher {
    pub fn from_request(voucher_id: String, request: LowFeeDaVoucherRequest, height: u64) -> Self {
        Self {
            voucher_id,
            status: LowFeeDaVoucherStatus::Offered,
    ...
    pub fn reserve(
        ...
        if !self.status.live() {
            return Err("voucher is not reservable".to_string());
        }
        if height > self.expires_at_height {
            self.status = LowFeeDaVoucherStatus::Expired;
            return Err("voucher expired".to_string());
        }
        if reserved_fee_micro_units > self.max_fee_micro_units {
            return Err("reserved fee exceeds voucher maximum".to_string());
        }
        self.reserved_fee_micro_units = reserved_fee_micro_units;
        self.status = LowFeeDaVoucherStatus::Reserved;
        Ok(())
    }

    pub fn attach_da(
        &mut self,
        da_commitment_root: String,
    ) -> PrivateL2LowFeePrivateStateChannelNettingRuntimeResult<()> {
        require_root("attached DA commitment root", &da_commitment_root)?;
        if self.status != LowFeeDaVoucherStatus::Reserved {
            return Err("voucher must be reserved before DA attachment".to_string());
        }
        self.da_commitment_root = da_commitment_root;
        self.status = LowFeeDaVoucherStatus::Attached;
        Ok(())
    }

    pub fn redeem(
        &mut self,
        redeemed_fee_micro_units: u64,
        height: u64,
    ) -> PrivateL2LowFeePrivateStateChannelNettingRuntimeResult<()> {
        if self.status != LowFeeDaVoucherStatus::Attached {
            return Err("voucher must have attached DA before redemption".to_string());
        }
        if redeemed_fee_micro_units > self.max_fee_micro_units {
            return Err("redeemed fee exceeds voucher maximum".to_string());
        }
        self.redeemed_fee_micro_units = redeemed_fee_micro_units;
        self.rebate_micro_units = redeemed_fee_micro_units.saturating_mul(self.rebate_bps)
            / PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_MAX_BPS;
        self.redeemed_at_height = height;
        self.status = LowFeeDaVoucherStatus::Redeemed;
        Ok(())
    }
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "redeemed_fee_micro_units": self.redeemed_fee_micro_units,
    ...
    pub fn commitment_root(&self) -> String {
        payload_root(
            "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-NETTING-DA-VOUCHER",
            &self.public_record(),
        )
    }
}
...
impl SubmitSlashingEvidenceRequest {
    pub fn validate(
        ...
        require_non_empty("accused commitment", &self.accused_commitment)?;
        require_non_empty("reporter commitment", &self.reporter_commitment)?;
        require_non_empty("subject id", &self.subject_id)?;
        require_root("evidence root", &self.evidence_root)?;
        require_root("transcript root", &self.transcript_root)?;
        require_root("contradiction root", &self.contradiction_root)?;
        require_root("public hint root", &self.public_hint_root)?;
        require_privacy_set(config, self.privacy_set_size, true)?;
        require_pq_security(config, self.pq_security_bits)?;
        ...
        if self.challenge_deadline_height <= self.opened_at_height {
            return Err("challenge deadline must be after evidence open height".to_string());
        }
        Ok(())
    }
...
impl SlashingEvidenceRecord {
    pub fn from_request(evidence_id: String, request: SubmitSlashingEvidenceRequest) -> Self {
        Self {
            evidence_id,
    ...
    pub fn prove(
        ...
        if !self.status.actionable() {
            return Err("evidence is not actionable".to_string());
        }
        if reporter_reward_bps > PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_MAX_BPS {
            return Err("reporter reward bps exceeds max bps".to_string());
        }
        self.reporter_reward_micro_units = self
            .slash_bond_micro_units
            .saturating_mul(reporter_reward_bps)
            / PRIVATE_L2_LOW_FEE_PRIVATE_STATE_CHANNEL_NETTING_RUNTIME_MAX_BPS;
        self.protocol_treasury_micro_units = self
            .slash_bond_micro_units
            .saturating_sub(self.reporter_reward_micro_units);
        self.status = EvidenceStatus::Proven;
        Ok(())
    }
    ...
    pub fn execute(
        ...
        if self.status != EvidenceStatus::Proven {
            return Err("only proven evidence can be executed".to_string());
        }
        self.executed_at_height = height;
        self.status = EvidenceStatus::Executed;
        Ok(())
    }
    ...
    pub fn commitment_root(&self) -> String {
        payload_root(
            "PRIVATE-L2-LOW-FEE-PRIVATE-STATE-CHANNEL-NETTING-SLASHING-EVIDENCE",
            &self.public_record(),
        )
    }
}
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct PrivacyFenceSnapshot {
    pub fence_id: String,
    pub epoch: u64,
...
impl PrivacyFenceSnapshot {
    pub fn validate(
        &self,
        config: &Config,
    ) -> PrivateL2LowFeePrivateStateChannelNettingRuntimeResult<()> {
        require_non_empty("fence id", &self.fence_id)?;
        require_root("channel root", &self.channel_root)?;
        require_root("nullifier root", &self.nullifier_root)?;
        require_root("key image root", &self.key_image_root)?;
        require_root("replay root", &self.replay_root)?;
        require_root("decoy root", &self.decoy_root)?;
        require_root("member commitment root", &self.member_commitment_root)?;
        require_privacy_set(config, self.observed_privacy_set_size, true)?;
        if self.observed_privacy_set_size < self.min_privacy_set_size {
            return Err("observed privacy set below snapshot minimum".to_string());
        }
        if self.expires_at_height <= self.opened_at_height {
            return Err("privacy fence expiration must be after open height".to_string());
        }
        Ok(())
    }
