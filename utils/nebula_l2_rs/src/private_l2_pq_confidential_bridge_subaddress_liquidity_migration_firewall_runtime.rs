...
pub type PrivateL2PqConfidentialBridgeSubaddressLiquidityMigrationFirewallRuntimeResult<T> =
    Result<T>;
pub type Runtime = State;

pub const PROTOCOL_VERSION: &str =
    "nebula-private-l2-pq-confidential-bridge-subaddress-liquidity-migration-firewall-runtime-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_BRIDGE_SUBADDRESS_LIQUIDITY_MIGRATION_FIREWALL_RUNTIME_PROTOCOL_VERSION:
    &str = PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const PQ_FIREWALL_SUITE: &str = "ML-DSA-87+ML-KEM-1024+SLH-DSA-SHAKE-256f";
pub const MIGRATION_SUITE: &str = "monero-bridge-subaddress-liquidity-migration-root-v1";
pub const REBATE_SUITE: &str = "subaddress-liquidity-migration-low-fee-rebate-root-v1";
pub const REDACTION_SUITE: &str = "operator-safe-subaddress-migration-redaction-root-v1";
...
pub const DEFAULT_MIGRATION_WINDOW_SLOTS: u64 = 720;
...
pub enum AttestationVerdict {
    ConfirmMigrationNeed,
    ConfirmPrivacyRisk,
    RequireSubaddressRotation,
    RequireLiquidityMigration,
    RequireQuarantine,
    ClearFalsePositive,
}
...
pub struct Config {
    ...
    pub migration_window_slots: u64,
    pub signal_window_slots: u64,
    pub max_route_fee_bps: u64,
    pub target_rebate_bps: u64,
    pub min_source_liquidity_micro_units: u64,
    pub min_target_liquidity_micro_units: u64,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            migration_suite: MIGRATION_SUITE.to_string(),
            ...
            migration_window_slots: DEFAULT_MIGRATION_WINDOW_SLOTS,
            signal_window_slots: DEFAULT_SIGNAL_WINDOW_SLOTS,
            max_route_fee_bps: DEFAULT_MAX_ROUTE_FEE_BPS,
            target_rebate_bps: DEFAULT_TARGET_REBATE_BPS,
            min_source_liquidity_micro_units: DEFAULT_MIN_SOURCE_LIQUIDITY_MICRO_UNITS,
            min_target_liquidity_micro_units: DEFAULT_MIN_TARGET_LIQUIDITY_MICRO_UNITS,
...
pub struct Counters {
    ...
    pub total_migrated_micro_units: u64,
...
pub struct MigrationPolicy {
    ...
    pub source_subaddress_root: String,
    pub target_subaddress_root: String,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SubaddressLiquidityCohort {
    ...
    pub source_liquidity_micro_units: u64,
    pub target_liquidity_micro_units: u64,
    pub privacy_set_size: u64,
    pub route_fee_bps: u64,
    pub active_signal_count: u64,
    pub migration_deadline_slot: u64,
...
pub struct MigrationSignal {
    ...
    pub source_liquidity_delta_micro_units: i128,
    pub target_liquidity_delta_micro_units: i128,
    pub privacy_set_size: u64,
    pub migration_score_bps: u64,
...
pub struct PqMigrationAttestation {
    ...
    pub observed_migration_score_bps: u64,
...
pub struct State {
    ...
    pub roots: Roots,
    pub policies: BTreeMap<String, MigrationPolicy>,
    pub cohorts: BTreeMap<String, SubaddressLiquidityCohort>,
    pub signals: BTreeMap<String, MigrationSignal>,
    pub attestations: BTreeMap<String, PqMigrationAttestation>,
    pub decisions: BTreeMap<String, MigrationDecision>,
    pub rebates: BTreeMap<String, LowFeeMigrationRebate>,
...
impl State {
    ...
    pub fn devnet() -> Self {
        ...
        let withdrawal_policy = state
            .register_policy(RegisterPolicyRequest {
                scope: MigrationScope::WithdrawalSubaddressLane,
                owner_commitment: "owner:subaddress-migration-council-a".to_string(),
                policy_commitment_root: devnet_root("policy", "withdrawal-subaddress-migration"),
                source_subaddress_root: devnet_root("source-subaddress", "withdrawal-alpha"),
                target_subaddress_root: devnet_root("target-subaddress", "withdrawal-alpha"),
                route_allowlist_root: devnet_root("route-allowlist", "withdrawal-alpha"),
                min_privacy_set_size: 524_288,
                min_source_liquidity_micro_units: 160_000_000,
                min_target_liquidity_micro_units: 72_000_000,
                max_route_fee_bps: 16,
                min_attestation_quorum_bps: 7_200,
                signal_window_slots: 96,
                migration_window_slots: 720,
                redaction_profile: "withdrawal-subaddress-migration-profile".to_string(),
            })
            .expect("devnet withdrawal policy");
        let fast_exit_policy = state
            .register_policy(RegisterPolicyRequest {
                scope: MigrationScope::FastExitSubaddressLane,
                owner_commitment: "owner:fast-exit-subaddress-council-b".to_string(),
                policy_commitment_root: devnet_root("policy", "fast-exit-subaddress-migration"),
                source_subaddress_root: devnet_root("source-subaddress", "fast-exit-beta"),
                target_subaddress_root: devnet_root("target-subaddress", "fast-exit-beta"),
                route_allowlist_root: devnet_root("route-allowlist", "fast-exit-beta"),
                min_privacy_set_size: 393_216,
                min_source_liquidity_micro_units: 144_000_000,
                min_target_liquidity_micro_units: 64_000_000,
                max_route_fee_bps: 18,
                min_attestation_quorum_bps: 7_000,
                signal_window_slots: 80,
                migration_window_slots: 640,
                redaction_profile: "fast-exit-subaddress-migration-profile".to_string(),
            })
        ...
        let withdrawal_cohort = state
            .register_cohort(RegisterCohortRequest {
                ...
                source_subaddress_root: devnet_root("source-subaddress", "cohort-alpha"),
                target_subaddress_root: devnet_root("target-subaddress", "cohort-alpha"),
                output_set_root: devnet_root("outputs", "cohort-alpha"),
                liquidity_commitment_root: devnet_root("liquidity", "cohort-alpha"),
                source_liquidity_micro_units: 216_000_000,
                target_liquidity_micro_units: 96_000_000,
        ...
        let fast_exit_cohort = state
            .register_cohort(RegisterCohortRequest {
                ...
                source_subaddress_root: devnet_root("source-subaddress", "cohort-beta"),
                target_subaddress_root: devnet_root("target-subaddress", "cohort-beta"),
                output_set_root: devnet_root("outputs", "cohort-beta"),
                liquidity_commitment_root: devnet_root("liquidity", "cohort-beta"),
                source_liquidity_micro_units: 168_000_000,
                target_liquidity_micro_units: 76_000_000,
        ...
        let signal = state
            .submit_signal(SubmitSignalRequest {
                ...
                source_liquidity_delta_micro_units: -48_000_000,
                target_liquidity_delta_micro_units: 24_000_000,
                privacy_set_size: 524_288,
                migration_score_bps: 7_300,
        ...
        state
            .submit_attestation(SubmitAttestationRequest {
                ...
                verdict: AttestationVerdict::RequireLiquidityMigration,
                attestor_commitment: "attestor:pq-subaddress-migration-a".to_string(),
                pq_signature_root: devnet_root("ml-dsa-signature", "withdrawal-migration-a"),
                pq_public_key_root: devnet_root("ml-kem-public-key", "withdrawal-migration-a"),
                transcript_root: devnet_root("transcript", "withdrawal-migration-a"),
                quorum_weight_bps: 7_500,
                pq_security_bits: 256,
                observed_migration_score_bps: 7_500,
        ...
        state
            .submit_attestation(SubmitAttestationRequest {
                signal_id: signal.clone(),
                verdict: AttestationVerdict::ConfirmMigrationNeed,
                attestor_commitment: "attestor:pq-subaddress-migration-b".to_string(),
                pq_signature_root: devnet_root("slh-dsa-signature", "withdrawal-migration-b"),
                pq_public_key_root: devnet_root("ml-kem-public-key", "withdrawal-migration-b"),
                transcript_root: devnet_root("transcript", "withdrawal-migration-b"),
                quorum_weight_bps: 8_700,
                pq_security_bits: 256,
                observed_migration_score_bps: 7_800,
                observed_privacy_set_size: 524_288,
        ...
        let decision = state
            .settle_decision(SettleDecisionRequest {
                signal_id: signal,
                action: MigrationAction::MigrateLiquidity,
                decision_root: devnet_root("decision", "withdrawal-liquidity-migration"),
                replacement_route_root: devnet_root("replacement-route", "withdrawal-migration"),
                migrated_micro_units: 32_000_000,
                shielded_output_count: 4_096,
                rebate_bps: 8,
                decided_at_slot: DEVNET_SLOT + 5,
            })
            .expect("devnet migration decision");
        state
            .publish_rebate(PublishRebateRequest {
                decision_id: decision,
                recipient_commitment: "recipient:subaddress-migration-fee-sponsor".to_string(),
                rebate_micro_units: 22_000,
                fee_saved_micro_units: 88_000,
                rebate_bps: 8,
                settlement_slot: DEVNET_SLOT + 6,
                rebate_root: devnet_root("rebate", "withdrawal-migration"),
            })
    ...
    pub fn register_policy(&mut self, request: RegisterPolicyRequest) -> Result<String> {
        ...
        ensure_non_empty(&request.source_subaddress_root, "source_subaddress_root")?;
        ensure_non_empty(&request.target_subaddress_root, "target_subaddress_root")?;
        ...
        if request.min_source_liquidity_micro_units < self.config.min_source_liquidity_micro_units {
            return Err("policy source liquidity below runtime floor".to_string());
        }
        if request.min_target_liquidity_micro_units < self.config.min_target_liquidity_micro_units {
            return Err("policy target liquidity below runtime floor".to_string());
        }
        let policy_id = stable_id(
            "subaddress-liquidity-migration-policy",
            &[
                HashPart::Str(request.scope.as_str()),
                HashPart::Str(&request.owner_commitment),
                HashPart::Str(&request.policy_commitment_root),
                HashPart::Str(&request.source_subaddress_root),
            ],
        );
        if self.policies.contains_key(&policy_id) {
            return Err(format!(
                "subaddress migration policy {policy_id} already exists"
            ));
        }
        self.policies.insert(
            ...
            MigrationPolicy {
                ...
                source_subaddress_root: request.source_subaddress_root,
                target_subaddress_root: request.target_subaddress_root,
                route_allowlist_root: request.route_allowlist_root,
                min_privacy_set_size: request.min_privacy_set_size,
                min_source_liquidity_micro_units: request.min_source_liquidity_micro_units,
                min_target_liquidity_micro_units: request.min_target_liquidity_micro_units,
                ...
                migration_window_slots: request.migration_window_slots,
                active: true,
    ...
    pub fn register_cohort(&mut self, request: RegisterCohortRequest) -> Result<String> {
        ...
        let policy = self
            ...
            .ok_or_else(|| format!("unknown subaddress migration policy {}", request.policy_id))?;
        ...
        if request.source_liquidity_micro_units < policy.min_source_liquidity_micro_units {
            return Err("cohort source liquidity below policy floor".to_string());
        }
        if request.target_liquidity_micro_units < policy.min_target_liquidity_micro_units {
        ...
        let cohort_id = stable_id(
            "subaddress-liquidity-migration-cohort",
            &[
        ...
        if self.cohorts.contains_key(&cohort_id) {
            return Err(format!(
                "subaddress migration cohort {cohort_id} already exists"
            ));
        }
        self.cohorts.insert(
            cohort_id.clone(),
            SubaddressLiquidityCohort {
    ...
    pub fn submit_signal(&mut self, request: SubmitSignalRequest) -> Result<String> {
        ensure_capacity(
            self.signals.len(),
            MAX_SIGNALS,
            "subaddress migration signals",
        )?;
        let cohort = self
            .cohorts
            .get(&request.cohort_id)
            .ok_or_else(|| format!("unknown subaddress migration cohort {}", request.cohort_id))?
            .clone();
        let policy = self
            .policies
            .get(&cohort.policy_id)
            .ok_or_else(|| format!("unknown subaddress migration policy {}", cohort.policy_id))?;
        ...
        ensure_bps(request.migration_score_bps, "migration_score_bps")?;
        if request.privacy_set_size < policy.min_privacy_set_size {
            return Err("signal privacy set below policy floor".to_string());
        }
        let signal_id = stable_id(
            "subaddress-migration-signal",
            &[
        ...
        if self.signals.contains_key(&signal_id) {
            return Err(format!(
                "subaddress migration signal {signal_id} already exists"
            ));
        }
        ...
        self.signals.insert(
            ...
            MigrationSignal {
                ...
                source_liquidity_delta_micro_units: request.source_liquidity_delta_micro_units,
                target_liquidity_delta_micro_units: request.target_liquidity_delta_micro_units,
                privacy_set_size: request.privacy_set_size,
                migration_score_bps: request.migration_score_bps,
    ...
    pub fn submit_attestation(&mut self, request: SubmitAttestationRequest) -> Result<String> {
        ensure_capacity(
            ...
            MAX_ATTESTATIONS,
            "subaddress migration attestations",
        )?;
        let signal = self
            .signals
            .get(&request.signal_id)
            .ok_or_else(|| format!("unknown subaddress migration signal {}", request.signal_id))?
            .clone();
        let policy = self
            .policies
            .get(&signal.policy_id)
            .ok_or_else(|| format!("unknown subaddress migration policy {}", signal.policy_id))?;
        ...
        ensure_bps(
            request.observed_migration_score_bps,
            "observed_migration_score_bps",
        )?;
        ...
        let attestation_id = stable_id(
            "subaddress-migration-pq-attestation",
            &[
        ...
        if self.attestations.contains_key(&attestation_id) {
            return Err(format!(
                "subaddress migration attestation {attestation_id} already exists"
            ));
        }
        self.attestations.insert(
            ...
            PqMigrationAttestation {
                ...
                observed_migration_score_bps: request.observed_migration_score_bps,
    ...
    pub fn settle_decision(&mut self, request: SettleDecisionRequest) -> Result<String> {
        ensure_capacity(
            self.decisions.len(),
            MAX_DECISIONS,
            "subaddress migration decisions",
        )?;
        let signal = self
            .signals
            .get(&request.signal_id)
        ...
        let migration_deadline_slot = match request.action {
            MigrationAction::QueueMigration
            | MigrationAction::MigrateLiquidity
            | MigrationAction::RotateSubaddressCohort => request
                .decided_at_slot
                .saturating_add(policy.migration_window_slots),
            MigrationAction::QuarantineRoute | MigrationAction::EmergencyPause => request
                .decided_at_slot
                .saturating_add(policy.migration_window_slots / 2),
            _ => 0,
        };
        let decision_id = stable_id(
            "subaddress-migration-decision",
            &[
                HashPart::Str(&request.signal_id),
        ...
        if self.decisions.contains_key(&decision_id) {
            return Err(format!(
                "subaddress migration decision {decision_id} already exists"
            ));
        }
        self.decisions.insert(
            ...
            MigrationDecision {
                ...
                migrated_micro_units: request.migrated_micro_units,
                shielded_output_count: request.shielded_output_count,
                migration_deadline_slot,
        ...
        if let Some(signal) = self.signals.get_mut(&request.signal_id) {
            signal.status = match request.action {
                MigrationAction::QueueMigration => SignalStatus::MigrationQueued,
                MigrationAction::MigrateLiquidity | MigrationAction::RotateSubaddressCohort => {
                    SignalStatus::Migrating
                }
                MigrationAction::QuarantineRoute | MigrationAction::EmergencyPause => {
                    SignalStatus::Quarantined
                }
                MigrationAction::Release => SignalStatus::Settled,
                MigrationAction::Reject => SignalStatus::Rejected,
                MigrationAction::Expire => SignalStatus::Expired,
                MigrationAction::Observe => SignalStatus::Attested,
            };
        }
        if let Some(cohort) = self.cohorts.get_mut(&signal.cohort_id) {
            match request.action {
                MigrationAction::QueueMigration => {
                    cohort.status = CohortStatus::MigrationPending;
                    cohort.migration_deadline_slot = migration_deadline_slot;
                }
                MigrationAction::MigrateLiquidity => {
                    cohort.status = CohortStatus::Migrating;
                    cohort.source_liquidity_micro_units = cohort
                        .source_liquidity_micro_units
                        .saturating_sub(request.migrated_micro_units);
                    cohort.target_liquidity_micro_units = cohort
                        .target_liquidity_micro_units
                        .saturating_add(request.migrated_micro_units);
                    cohort.migration_deadline_slot = migration_deadline_slot;
                    self.counters.migrations_settled =
                        self.counters.migrations_settled.saturating_add(1);
                    self.counters.total_migrated_micro_units = self
                        .counters
                        .total_migrated_micro_units
                        .saturating_add(request.migrated_micro_units);
                }
                MigrationAction::RotateSubaddressCohort => {
                    cohort.status = CohortStatus::Rotating;
                    cohort.migration_deadline_slot = migration_deadline_slot;
                    self.counters.cohorts_rotated = self.counters.cohorts_rotated.saturating_add(1);
                }
                MigrationAction::QuarantineRoute => {
                    cohort.status = CohortStatus::Quarantined;
                    cohort.migration_deadline_slot = migration_deadline_slot;
                    self.counters.routes_quarantined =
                        self.counters.routes_quarantined.saturating_add(1);
                }
                MigrationAction::EmergencyPause => {
                    cohort.status = CohortStatus::Paused;
                    cohort.migration_deadline_slot = migration_deadline_slot;
                    self.counters.routes_quarantined =
                        self.counters.routes_quarantined.saturating_add(1);
                }
                MigrationAction::Release => {
                    cohort.status = CohortStatus::Settled;
                    cohort.migration_deadline_slot = 0;
    ...
    pub fn publish_rebate(&mut self, request: PublishRebateRequest) -> Result<String> {
        ensure_capacity(
            self.rebates.len(),
            MAX_REBATES,
            "subaddress migration rebates",
        )?;
        let decision = self.decisions.get(&request.decision_id).ok_or_else(|| {
            format!(
                "unknown subaddress migration decision {}",
                request.decision_id
            )
        })?;
        ...
        let rebate_id = stable_id(
            "subaddress-migration-low-fee-rebate",
            &[
        ...
        if self.rebates.contains_key(&rebate_id) {
            return Err(format!(
                "subaddress migration rebate {rebate_id} already exists"
            ));
        }
        self.rebates.insert(
            rebate_id.clone(),
            LowFeeMigrationRebate {
    ...
    pub fn publish_redaction_budget(
        ...
        let budget_id = stable_id(
            "subaddress-migration-redaction-budget",
            &[
                HashPart::Str(request.scope.as_str()),
                HashPart::Str(&request.cohort_id),
        ...
        if self.redaction_budgets.contains_key(&budget_id) {
            return Err(format!(
                "subaddress migration redaction budget {budget_id} already exists"
            ));
        }
    ...
    pub fn publish_operator_summary(
        ...
        ensure_capacity(
            ...
            "subaddress migration operator summaries",
        )?;
        self.refresh_live_counts();
        ...
        let summary_id = stable_id(
            "subaddress-migration-operator-summary",
            &[
                HashPart::U64(epoch),
                HashPart::U64(slot),
        ...
        self.operator_summaries.insert(
            ...
            OperatorSummary {
                ...
                total_migrated_micro_units: self.counters.total_migrated_micro_units,
    ...
    fn refresh_roots(&mut self) {
        ...
        self.roots.state_root = merkle_root(
            "bridge-subaddress-liquidity-migration-firewall:state",
            &[
    ...
    pub fn public_record(&self) -> Value {
        json!({
            ...
            "migration_suite": self.config.migration_suite,
            ...
            "migration_window_slots": self.config.migration_window_slots,
            ...
            "policies": self.policies.values().map(|policy| json!({
                ...
                "min_source_liquidity_micro_units": policy.min_source_liquidity_micro_units,
                "min_target_liquidity_micro_units": policy.min_target_liquidity_micro_units,
            ...
            "cohorts": self.cohorts.values().map(|cohort| json!({
                ...
                "source_liquidity_micro_units": cohort.source_liquidity_micro_units,
                "target_liquidity_micro_units": cohort.target_liquidity_micro_units,
                "privacy_set_size": cohort.privacy_set_size,
                "route_fee_bps": cohort.route_fee_bps,
                "active_signal_count": cohort.active_signal_count,
                "migration_deadline_slot": cohort.migration_deadline_slot,
            ...
            "signals": self.signals.values().map(|signal| json!({
                ...
                "migration_score_bps": signal.migration_score_bps,
            ...
            "decisions": self.decisions.values().map(|decision| json!({
                ...
                "migrated_micro_units": decision.migrated_micro_units,
                "shielded_output_count": decision.shielded_output_count,
                "migration_deadline_slot": decision.migration_deadline_slot,
...
pub fn demo() -> State {
    ...
    let signal = state
        .submit_signal(SubmitSignalRequest {
            ...
            source_liquidity_delta_micro_units: -10_000_000,
            target_liquidity_delta_micro_units: 8_000_000,
            privacy_set_size: 524_288,
            migration_score_bps: 6_200,
    ...
    state
        .submit_attestation(SubmitAttestationRequest {
            signal_id: signal,
            verdict: AttestationVerdict::RequireSubaddressRotation,
            attestor_commitment: "attestor:demo-subaddress-migration".to_string(),
            ...
            pq_security_bits: 256,
            observed_migration_score_bps: 6_400,
            observed_privacy_set_size: 524_288,
...
fn object_root<T: Serialize>(domain: &str, value: &T) -> String {
    ...
    domain_hash(
        &format!("bridge-subaddress-liquidity-migration-firewall:{domain}"),
        &[HashPart::Json(&value)],
        32,
    )
}
...
fn devnet_root(domain: &str, label: &str) -> String {
    domain_hash(
        &format!("bridge-subaddress-liquidity-migration-firewall:devnet:{domain}"),
