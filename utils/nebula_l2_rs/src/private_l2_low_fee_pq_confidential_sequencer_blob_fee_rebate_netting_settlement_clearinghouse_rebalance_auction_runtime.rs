...
#[rustfmt::skip]
pub type PrivateL2LowFeePqConfidentialSequencerBlobFeeRebateNettingSettlementClearinghouseRebalanceAuctionRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_LOW_FEE_PQ_CONFIDENTIAL_SEQUENCER_BLOB_FEE_REBATE_NETTING_SETTLEMENT_CLEARINGHOUSE_REBALANCE_AUCTION_RUNTIME_PROTOCOL_VERSION: &str =
    "nebula-private-l2-low-fee-pq-confidential-sequencer-blob-fee-rebate-netting-settlement-clearinghouse-rebalance-auction-runtime-v1";
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_LOW_FEE_PQ_CONFIDENTIAL_SEQUENCER_BLOB_FEE_REBATE_NETTING_SETTLEMENT_CLEARINGHOUSE_REBALANCE_AUCTION_RUNTIME_PROTOCOL_VERSION;
pub const SCHEMA_VERSION: u64 = 1;
pub const HASH_SUITE: &str = "SHAKE256-domain-separated-canonical-json";
pub const PQ_ENVELOPE_SUITE: &str =
    "ml-kem-1024+ml-dsa-87-netting-settlement-clearinghouse-rebalance-auction-fee-rebate-envelope-v1";
pub const REBATE_NETTING_SETTLEMENT_CLEARINGHOUSE_SUITE: &str =
    "private-l2-low-fee-confidential-sequencer-rebate-netting-settlement-clearinghouse-rebalance-auction-v1";
...
pub const FAST_PATH_PROOF_SUITE: &str =
    "ml-dsa-87-fast-netting-settlement-clearinghouse-rebalance-auction-attestation-root-v1";
pub const NULLIFIER_SUITE: &str =
    "confidential-netting-settlement-clearinghouse-rebalance-auction-nullifier-set-v1";
pub const PUBLIC_RECORD_SUITE: &str =
    "roots-only-confidential-sequencer-blob-fee-rebate-netting-settlement-clearinghouse-rebalance-auction-record-v1";
...
pub const DEVNET_L2_NETWORK: &str =
    "nebula-private-l2-netting-settlement-clearinghouse-rebalance-auction-devnet";
pub const DEVNET_SETTLEMENT_CLEARINGHOUSE_ID: &str =
    "private-l2-sequencer-blob-fee-rebate-netting-settlement-clearinghouse-rebalance-auction-devnet";
pub const DEVNET_OPERATOR_SET_ID: &str =
    "private-l2-netting-settlement-clearinghouse-rebalance-auction-operator-set-devnet";
...
const D_STATE: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE-AUCTION:STATE";
const D_CONFIG: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE-AUCTION:CONFIG";
const D_COUNTERS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE-AUCTION:COUNTERS";
const D_ROOTS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE-AUCTION:ROOTS";
const D_DEBITS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE-AUCTION:DEBITS";
const D_CREDITS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE-AUCTION:CREDITS";
const D_WINDOWS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE-AUCTION:WINDOWS";
const D_SETTLEMENTS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE-AUCTION:SETTLEMENTS";
const D_BUCKETS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE-AUCTION:BUCKETS";
const D_ATTESTATIONS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE-AUCTION:ATTESTATIONS";
const D_NULLIFIERS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE-AUCTION:NULLIFIERS";
const D_PUBLIC_RECORDS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE-AUCTION:PUBLIC-RECORDS";
const D_REBALANCE_ROUNDS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE-AUCTION:ROUNDS";
const D_SPONSOR_CAPS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE-AUCTION:SPONSOR-CAPS";
const D_AUCTION_BIDS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE-AUCTION:BIDS";
const D_AUCTION_CLEARINGS: &str =
    "PL2-LF-PQ-CONF-SEQ-BLOB-REBATE-NETTING-SETTLEMENT-CLEARINGHOUSE-REBALANCE-AUCTION:CLEARINGS";
...
pub fn devnet() -> State {
    ...
    let bucket_id = state
        .open_liquidity_bucket(LiquidityBucketInput {
            bucket_id:
                "devnet-netting-settlement-clearinghouse-rebalance-auction-liquidity-bucket-0001"
                    .to_string(),
    ...
    let clearing_id = state
        .clear_reserve_rebalance_auction(AuctionClearingInput {
            clearing_id: "devnet-reserve-rebalance-auction-clearing-0001".to_string(),
