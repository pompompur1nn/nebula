...
pub type PrivateL2PqConfidentialTokenizedPrivateCreditReceivableAmmRuntimeResult<T> = Result<T>;
pub type Runtime = State;

pub const PRIVATE_L2_PQ_CONFIDENTIAL_TOKENIZED_PRIVATE_CREDIT_RECEIVABLE_AMM_RUNTIME_PROTOCOL_VERSION:
    &str = "nebula-private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_TOKENIZED_PRIVATE_CREDIT_RECEIVABLE_AMM_RUNTIME_SCHEMA_VERSION: u64 =
    1;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_TOKENIZED_PRIVATE_CREDIT_RECEIVABLE_AMM_RUNTIME_HASH_SUITE:
    &str = "SHAKE256-domain-separated-canonical-json";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_TOKENIZED_PRIVATE_CREDIT_RECEIVABLE_AMM_RUNTIME_PQ_AUTH_SUITE: &str =
    "ML-KEM-1024+ML-DSA-87+SLH-DSA-SHAKE-256s-confidential-private-credit-receivable-v1";
pub const PRIVATE_L2_PQ_CONFIDENTIAL_TOKENIZED_PRIVATE_CREDIT_RECEIVABLE_AMM_RUNTIME_DEVNET_HEIGHT: u64 =
    918_000;
pub const PRIVATE_L2_PQ_CONFIDENTIAL_TOKENIZED_PRIVATE_CREDIT_RECEIVABLE_AMM_RUNTIME_MAX_BPS: u64 =
    10_000;
pub const PROTOCOL_VERSION: &str =
    PRIVATE_L2_PQ_CONFIDENTIAL_TOKENIZED_PRIVATE_CREDIT_RECEIVABLE_AMM_RUNTIME_PROTOCOL_VERSION;

#[derive(Clone, Copy, Debug, Deserialize, Eq, Ord, PartialEq, PartialOrd, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum ReceivableNoteStatus {
    Draft,
    OriginatorAttested,
    DebtorAccepted,
    OracleVerified,
...
impl ReceivableNoteStatus {
    pub fn as_str(self) -> &'static str {
        match self {
            Self::Draft => "draft",
            Self::OriginatorAttested => "originator_attested",
...
pub struct Config {
    ...
    pub receivable_note_asset_prefix: String,
    pub low_fee_lane: String,
    pub min_privacy_set_size: u64,
    pub batch_privacy_set_size: u64,
    pub min_pq_security_bits: u16,
    pub max_receivable_face_value: u128,
    ...
    pub receivable_ttl_blocks: u64,
    pub attestation_ttl_blocks: u64,
    pub max_receivable_notes: usize,
    pub max_pools: usize,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            receivable_note_asset_prefix: "cpcar".to_string(),
            low_fee_lane: "private-l2-private-credit-receivable-amm".to_string(),
            min_privacy_set_size: 16_384,
            batch_privacy_set_size: 262_144,
            min_pq_security_bits: 256,
            max_receivable_face_value: 50_000_000_000,
            ...
            receivable_ttl_blocks: 86_400,
            attestation_ttl_blocks: 14_400,
            max_receivable_notes: 4_194_304,
            max_pools: 524_288,
...
impl Config {
    ...
    pub fn validate(&self) -> Result<()> {
        ...
        if self.default_haircut_bps
            > PRIVATE_L2_PQ_CONFIDENTIAL_TOKENIZED_PRIVATE_CREDIT_RECEIVABLE_AMM_RUNTIME_MAX_BPS
        {
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct Roots {
    pub receivable_note_root: String,
...
impl Default for Roots {
    fn default() -> Self {
        Self {
            receivable_note_root: empty_root("receivable_notes"),
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct ReceivableNoteToken {
    pub receivable_note_id: String,
    pub note_asset_id: String,
    pub originator_commitment: String,
...
impl ReceivableNoteToken {
    ...
    pub fn mature(&mut self, height: u64) -> bool {
        if height >= self.maturity_height && !self.status.terminal() {
            self.status = ReceivableNoteStatus::Matured;
            true
        } else {
            false
        }
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct PrivateCreditReceivableAmmPool {
    pub pool_id: String,
...
impl DebtorOracleAttestation {
    pub fn public_record(&self) -> Value {
        json!({ "kind": "debtor_oracle_attestation", "attestation_id": self.attestation_id, "receivable_note_id": self.receivable_note_id, "attestation_kind": self.kind.as_str(), "subject_commitment": self.subject_commitment, "statement_root": self.statement_root, "confidence_bps": self.confidence_bps, "issued_at_height": self.issued_at_height, "expires_at_height": self.expires_at_height, "pq_signature_root": self.pq_signature_root, "selective_disclosure_root": self.selective_disclosure_root })
    }
    pub fn record_root(&self) -> String {
...
pub struct OperatorSummary {
    ...
    pub height: u64,
    pub receivable_note_count: u64,
    pub pool_count: u64,
    pub sealed_liquidity_count: u64,
    pub maturity_settlement_count: u64,
    pub defaulted_receivable_note_count: u64,
...
pub struct State {
    ...
    pub roots: Roots,
    pub receivable_notes: BTreeMap<String, ReceivableNoteToken>,
    pub pools: BTreeMap<String, PrivateCreditReceivableAmmPool>,
...
impl State {
    ...
    pub fn public_record_without_state_root(&self) -> Value {
        json!({ "protocol_version": PROTOCOL_VERSION, "config": self.config.public_record(), "counters": self.counters.public_record(), "roots": self.roots.public_record(), "receivable_notes": records(self.receivable_notes.values().map(ReceivableNoteToken::public_record)), "pools": records(self.pools.values().map(PrivateCreditReceivableAmmPool::public_record)), "attestations": records(self.attestations.values().map(DebtorOracleAttestation::public_record)), "sealed_liquidity": records(self.sealed_liquidity.values().map(SealedLiquidityNote::public_record)), "settlements": records(self.settlements.values().map(MaturitySettlement::public_record)), "default_haircuts": records(self.default_haircuts.values().map(DefaultHaircut::public_record)), "fee_credit_rebates": records(self.fee_credit_rebates.values().map(FeeCreditRebate::public_record)), "privacy_redactions": records(self.privacy_redactions.values().map(PrivacyRedaction::public_record)), "operator_summaries": records(self.operator_summaries.values().map(OperatorSummary::public_record)), "nullifier_root": merkle_root_for_strings("nullifiers", &self.nullifiers), "public_records": records(self.public_records.values().cloned()) })
    }
    pub fn mint_receivable_note(
        &mut self,
        mut receivable_note: ReceivableNoteToken,
    ) -> Result<String> {
        self.config.validate()?;
        if self.receivable_notes.len() >= self.config.max_receivable_notes {
            return Err("receivable_note capacity reached".to_string());
        }
        if receivable_note.discount_bps > self.config.max_discount_bps {
            return Err("receivable_note discount exceeds cap".to_string());
        }
        if receivable_note.privacy_set_size < self.config.min_privacy_set_size {
            return Err("receivable_note privacy set too small".to_string());
        }
        let id = if receivable_note.receivable_note_id.is_empty() {
            deterministic_id(
                "receivable_note",
                &receivable_note.public_record(),
                self.counters.receivable_notes + 1,
            )
        } else {
            receivable_note.receivable_note_id.clone()
        };
        receivable_note.receivable_note_id = id.clone();
        receivable_note.note_asset_id = format!(
            "{}-{}",
            self.config.receivable_note_asset_prefix,
            short_hash(&id)
        );
        self.record_public(
            format!("receivable_note:{id}"),
            receivable_note.public_record(),
        )?;
        self.receivable_notes.insert(id.clone(), receivable_note);
        self.counters.receivable_notes = self.receivable_notes.len() as u64;
        self.refresh_roots();
        Ok(id)
    }
    pub fn create_pool(&mut self, mut pool: PrivateCreditReceivableAmmPool) -> Result<String> {
    ...
    pub fn submit_attestation(
        ...
        if !self
            .receivable_notes
            .contains_key(&attestation.receivable_note_id)
        {
            return Err("attestation receivable_note is unknown".to_string());
        }
    ...
    pub fn apply_default_haircut(&mut self, mut haircut: DefaultHaircut) -> Result<String> {
        if !self
            .receivable_notes
            .contains_key(&haircut.receivable_note_id)
        {
            return Err("haircut receivable_note is unknown".to_string());
        }
        ...
        if let Some(receivable_note) = self.receivable_notes.get_mut(&haircut.receivable_note_id) {
            receivable_note.haircut_bps = haircut.final_haircut_bps;
            receivable_note.status = ReceivableNoteStatus::Defaulted;
        }
    ...
    pub fn settle_maturity(&mut self, mut settlement: MaturitySettlement) -> Result<String> {
        ...
        if !self
            .receivable_notes
            .contains_key(&settlement.receivable_note_id)
        {
            return Err("settlement receivable_note is unknown".to_string());
        }
        ...
        if let Some(receivable_note) = self
            .receivable_notes
            .get_mut(&settlement.receivable_note_id)
        {
            receivable_note.status = if settlement.defaulted {
                ReceivableNoteStatus::Defaulted
            } else {
                ReceivableNoteStatus::Settled
            };
        }
    ...
    pub fn operator_summary(
        ...
        self.refresh_roots();
        let defaulted_receivable_note_count = self
            .receivable_notes
            .values()
            .filter(|receivable_note| receivable_note.status == ReceivableNoteStatus::Defaulted)
            .count() as u64;
        let total_face_value = self
            .receivable_notes
            .values()
            .map(|receivable_note| receivable_note.face_value_hint)
            .sum::<u128>();
        let average_discount_bps = if self.receivable_notes.is_empty() {
            0
        } else {
            self.receivable_notes
                .values()
                .map(|receivable_note| receivable_note.discount_bps)
                .sum::<u64>()
                / self.receivable_notes.len() as u64
        };
        let summary = OperatorSummary {
            operator_id: operator_id.into(),
            height,
            receivable_note_count: self.receivable_notes.len() as u64,
            ...
            defaulted_receivable_note_count,
    ...
    fn refresh_roots(&mut self) {
        ...
        self.counters.public_records = self.public_records.len() as u64;
        self.roots = Roots {
            receivable_note_root: map_root(
                "receivable_notes",
                &self.receivable_notes,
                ReceivableNoteToken::public_record,
            ),
            pool_root: map_root(
                "pools",
                &self.pools,
                PrivateCreditReceivableAmmPool::public_record,
            ),
    ...
    fn seed_devnet(&mut self) {
        let receivable_note = ReceivableNoteToken {
            receivable_note_id: "devnet-private-credit-receivable-001".to_string(),
            note_asset_id: "cpcar-devnet-001".to_string(),
            originator_commitment: demo_hash("originator", 1),
            debtor_commitment: demo_hash("debtor", 1),
            face_value_commitment: demo_hash("face-value", 1),
            face_value_hint: 1_250_000_000,
            maturity_height:
                PRIVATE_L2_PQ_CONFIDENTIAL_TOKENIZED_PRIVATE_CREDIT_RECEIVABLE_AMM_RUNTIME_DEVNET_HEIGHT
                    + 7_200,
            token_supply: 1_250_000_000,
            discount_bps: 720,
            haircut_bps: self.config.default_haircut_bps,
            status: ReceivableNoteStatus::Tokenized,
            ...
            nullifier_root: demo_hash("receivable_note-nullifiers", 1),
        };
        let pool = PrivateCreditReceivableAmmPool {
            pool_id: "devnet-pool-cpcar-usdc-001".to_string(),
            base_asset_id: self.config.settlement_asset_id.clone(),
            note_asset_id: receivable_note.note_asset_id.clone(),
            ...
            discount_bps: 720,
            maturity_height: receivable_note.maturity_height,
        ...
        let attestation = DebtorOracleAttestation {
            ...
            receivable_note_id: receivable_note.receivable_note_id.clone(),
            kind: AttestationKind::debtor,
            subject_commitment: receivable_note.debtor_commitment.clone(),
        ...
        self.receivable_notes
            .insert(receivable_note.receivable_note_id.clone(), receivable_note);
        ...
        let _ = self.redact_private_view(PrivacyRedaction {
            ...
            subject_id: "devnet-private-credit-receivable-001".to_string(),
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct ReceivableNoteCommitmentView {
    pub view_id: String,
    pub subject_id: String,
    pub pool_id: String,
    pub asset_id: String,
...
impl ReceivableNoteCommitmentView {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "receivable_note_commitment_view",
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-receivable_note_commitment_view",
            &self.public_record(),
        )
    }
}
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct ReceivableNoteCashflowView {
    pub view_id: String,
    pub subject_id: String,
    pub pool_id: String,
    pub asset_id: String,
...
impl ReceivableNoteCashflowView {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "receivable_note_cashflow_view",
            "view_id": self.view_id,
            "subject_id": self.subject_id,
            "pool_id": self.pool_id,
            "asset_id": self.asset_id,
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-receivable_note_cashflow_view",
            &self.public_record(),
        )
    }
}
...
impl debtorRiskView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-debtor_risk_view",
            &self.public_record(),
        )
    }
}
...
impl OraclePriceView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-oracle_price_view",
            &self.public_record(),
        )
    }
}
...
impl PoolReserveView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-pool_reserve_view",
            &self.public_record(),
        )
    }
}
...
impl PoolInvariantView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-pool_invariant_view",
            &self.public_record(),
        )
    }
}
...
impl LpPositionView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-lp_position_view",
            &self.public_record(),
        )
    }
}
...
impl FeeCreditView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-fee_credit_view",
            &self.public_record(),
        )
    }
}
...
impl SettlementReceiptView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-settlement_receipt_view",
            &self.public_record(),
        )
    }
}
...
impl DefaultScenarioView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-default_scenario_view",
            &self.public_record(),
        )
    }
}
...
impl InsurerCoverageView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-insurer_coverage_view",
            &self.public_record(),
        )
    }
}
...
impl ServicerActionView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-servicer_action_view",
            &self.public_record(),
        )
    }
}
...
impl AuditorTrailView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-auditor_trail_view",
            &self.public_record(),
        )
    }
}
...
impl SelectiveDisclosureView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-selective_disclosure_view",
            &self.public_record(),
        )
    }
}
...
impl ComplianceMemoView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-compliance_memo_view",
            &self.public_record(),
        )
    }
}
...
impl MaturityBucketView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-maturity_bucket_view",
            &self.public_record(),
        )
    }
}
...
impl DiscountCurveView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-discount_curve_view",
            &self.public_record(),
        )
    }
}
...
impl HaircutPolicyView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-haircut_policy_view",
            &self.public_record(),
        )
    }
}
...
impl RebateEpochView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-rebate_epoch_view",
            &self.public_record(),
        )
    }
}
...
impl NullifierSetView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-nullifier_set_view",
            &self.public_record(),
        )
    }
}
...
impl PqCommitteeView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-pq_committee_view",
            &self.public_record(),
        )
    }
}
...
impl EncryptedMemoView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-encrypted_memo_view",
            &self.public_record(),
        )
    }
}
...
impl BatchAuctionView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-batch_auction_view",
            &self.public_record(),
        )
    }
}
...
impl LowFeeLaneView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-low_fee_lane_view",
            &self.public_record(),
        )
    }
}
...
impl PrivacyBudgetView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-privacy_budget_view",
            &self.public_record(),
        )
    }
}
...
impl LiquidityDepthView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-liquidity_depth_view",
            &self.public_record(),
        )
    }
}
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct ReceivableNoteAgingView {
    pub view_id: String,
    pub subject_id: String,
    pub pool_id: String,
    pub asset_id: String,
...
impl ReceivableNoteAgingView {
    pub fn public_record(&self) -> Value {
        json!({
            "kind": "receivable_note_aging_view",
            "view_id": self.view_id,
            "subject_id": self.subject_id,
            "pool_id": self.pool_id,
            "asset_id": self.asset_id,
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-receivable_note_aging_view",
            &self.public_record(),
        )
    }
}
...
impl debtorConcentrationView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-debtor_concentration_view",
            &self.public_record(),
        )
    }
}
...
impl CountryRiskView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-country_risk_view",
            &self.public_record(),
        )
    }
}
...
impl IndustryRiskView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-industry_risk_view",
            &self.public_record(),
        )
    }
}
...
impl PaymentRailView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-payment_rail_view",
            &self.public_record(),
        )
    }
}
...
impl CreditInsuranceView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-credit_insurance_view",
            &self.public_record(),
        )
    }
}
...
impl DisputeCaseView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-dispute_case_view",
            &self.public_record(),
        )
    }
}
...
impl RecoveryWaterfallView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-recovery_waterfall_view",
            &self.public_record(),
        )
    }
}
...
impl ReserveProofView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-reserve_proof_view",
            &self.public_record(),
        )
    }
}
...
impl KycRedactionView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-kyc_redaction_view",
            &self.public_record(),
        )
    }
}
...
impl SanctionsScreenView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-sanctions_screen_view",
            &self.public_record(),
        )
    }
}
...
impl OperatorRiskView {
    ...
    pub fn record_root(&self) -> String {
        root_from_record(
            "private-l2-pq-confidential-tokenized-private-credit-receivable-amm-runtime-operator_risk_view",
            &self.public_record(),
        )
    }
}
