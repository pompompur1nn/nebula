...
fn run_rpc_node(args: &[String]) {
    ...
    eprintln!(
        "Nebula RPC listening on {bind_addr}; block target {} ms; validator {}; role {}; sequencer key {}; admin rpc {}; max mempool {} txs; max request {} bytes; rate limit {} requests/min",
