...
fn prove_live_rpc_devnet(args: &[String], wants_json: bool) {
        ...
        .any(|arg| ARTIFACT_BOUND_REHEARSAL_FLAGS.contains(&arg.as_str()))
    {
        let inputs = read_launch_package_inputs(args, wants_json);
        let bundle_input = read_launch_package_bundle_input(args, wants_json);
        nebula_testnet::prove_live_rpc_devnet_rehearsal_with_jsons(
            &bundle_input,
            &inputs.deployment_input,
            &inputs.public_status_input,
            &inputs.public_probe_input,
        ...
        nebula_testnet::prove_live_rpc_devnet_rehearsal()
    };
...
fn print_help() {
    ...
    nebula-testnet --verify-public-testnet-launch-readiness <path> --public-observer-confirmation <path> --runtime-surface-evidence <path> --live-rpc-devnet-rehearsal <path> --operator-join-confirmation <path> --validator-join <path> --validator-activation <path> --launch-package-bundle <path> --deployment-attestation <path> --public-status <path> --public-probe <path> --validator-set <path> --operator-handoff <path> --operator-acceptance <path> --genesis-manifest <path> [--json]
...
FINAL PUBLIC LAUNCH READINESS:
    ...
    advertised endpoint and a live RPC devnet rehearsal report bound to the same
    endpoint and launch-package bundle.
