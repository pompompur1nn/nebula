...
operator IDs/keys, and observer IDs/keys must be unique. Deployment evidence
must be generated within `24` hours, expire within `7` days, carry TLS pins with
at least `7` days remaining, and include a rollback drill from the last `7`
days.
